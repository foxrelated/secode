...
<div class="ynfullslider_manage_sliders">
    ...
    <div class="ynfullslider_manage_sliders-select-all ynfullslider_manage-select-all">
        ...
        <ul class="ynfullslider_manage_sliders-status <?php echo $this->formValues['status'] ?>">
            <li class="<?php echo $this->formValues['status'] == '' ? 'active' : '' ?>"><a href="javascript:void(0)" onclick="setStatus('')"><?php echo $this->translate("All") ?></a></li>
            <li class="ynfullslider_manage_sliders-status-dotted">.</li>
            <li class="<?php echo $this->formValues['status'] == 'ongoing' ? 'active' : '' ?>"><a href="javascript:void(0)" onclick="setStatus('ongoing')"><?php echo $this->translate("Ongoing") ?></a></li>
            <li class="ynfullslider_manage_sliders-status-dotted">.</li>
            <li class="<?php echo $this->formValues['status'] == 'upcoming' ? 'active' : '' ?>"><a href="javascript:void(0)" onclick="setStatus('upcoming')"><?php echo $this->translate("Upcoming") ?></a></li>
            <li class="ynfullslider_manage_sliders-status-dotted">.</li>
            <li class="<?php echo $this->formValues['status'] == 'expired' ? 'active' : '' ?>"><a href="javascript:void(0)" onclick="setStatus('expired')"><?php echo $this->translate("Expired") ?></a></li>
        </ul>
    </div>

    <div class="ynfullslider_manage_sliders-description-status">
        <p><span><?php echo $this->translate("ONGOING: ") ?></span> <?php echo $this->translate("The sliders which valid times are still within the current date or set as “Unlimited”") ?>.</p>
        <p><span><?php echo $this->translate("UPCOMING: ") ?></span><?php echo $this->translate("The sliders which start dates have not reached the current date yet.") ?></p>
        <p><span><?php echo $this->translate("EXPIRED: ") ?></span><?php echo $this->translate("The sliders which end dates have been already passed the current date.") ?></p>
    </div>
