 ...
 */
class Sitestore_PostController extends Seaocore_Controller_Action_Standard {
  ...
  public function deleteAction() {
    ...
    //MAKE FORM
    $this->view->form = $form = new Sitestore_Form_Post_Delete();
    ...
    $href = ( null == $topic ? $sitestore->getHref() : $topic->getHref() );
    return $this->_forwardCustom('success', 'utility', 'core', array(
            'closeSmoothbox' => true,
            'parentRedirect' => $href,
