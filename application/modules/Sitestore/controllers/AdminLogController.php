 ...
 */
class Sitestore_AdminLogController extends Core_Controller_Action_Admin {
  ...
  public function indexAction() {
    ...
    foreach (scandir($logPath) as $file) {
      if ($file == 'CSVToStoreImport.log' || $file == 'ListingToStoreImport.log') {
    ...
    //MAKE FORM
		$csvImportVar = $this->view->translate('Store Import From a CSV File');
		$listingImportVar = $this->view->translate('Store Import From Listings');
    $labels = array(
        'CSVToStoreImport' => $csvImportVar,
        'ListingToStoreImport' => $listingImportVar
    );
    ...
    $this->view->formFilter = $formFilter = new Sitestore_Form_Admin_Import_Log();
