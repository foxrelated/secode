 ...
 */
class Sitestore_Model_Photo extends Core_Model_Item_Collectible {

  protected $_parent_type = 'sitestore_album';
  protected $_owner_type = 'user';
  protected $_collection_type = 'sitestore_album';
  ...
  /**
   * Gets an absolute Photo URL to the store to view this item
   *
   * @param char $type
   * @return string
   */
  ...
  public function getAuthorizationItem() {
    ...
    return $this->getParent('sitestore_store');
  }
  ...
  protected function _postDelete() {
		...
		if($sitestore->store_cover == $this->photo_id){
  ...
  public function setPhoto($photo, $isCover = false) {
	...
	protected function _delete() {
		...
		Engine_Api::_()->getApi('subCore', 'sitestore')->deleteCreateActivityOfExtensionsItem($this, array('sitestorealbum_photo_new', 'sitestorealbum_admin_photo_new'));
		parent::_delete();
  }
