...
class Sitestore_Widget_ExtensionUpgradeController extends Engine_Content_Widget_Abstract
{
  public function indexAction()
  {
    ...
    $includeModules = array("sitestoredocument" => 'Documents', "sitestoreoffer" => 'Offers', "sitestoreform" => "Form", "sitestorediscussion" => "Discussions", "sitestorenote" => "Notes", "sitestorealbum" => "Photos", "sitestorevideo" => "Videos", "sitestoreevent" => "Events", "sitestorepoll" => "Polls", "sitestoreinvite" => "Invite & Promote", "sitestorebadge" => "Badges", "sitestorelikebox" => "External Badge", "sitestoremusic" => "Music","sitestorereview" => "Reviews","sitestoreadmincontact" => "Contact Page Owners", "sitestoremember" => "Member");
