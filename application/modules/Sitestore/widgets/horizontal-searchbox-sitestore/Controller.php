 ...
 */
class Sitestore_Widget_HorizontalSearchboxSitestoreController extends Engine_Content_Widget_Abstract {
    ...
    public function indexAction() {
        ...
        //PREPARE FORM
        $this->view->form = $form = new Sitestore_Form_Horizontalsearchbox(array('widgetSettings' => $widgetSettings));
