        ...
        if(!position.address) {
          ...
          service.search(request, function(results, status) { 
            if (status  ==  'OK') {
              ...
              document.getElementById('sitestore_location').value = (results[index].vicinity) ? results[index].vicinity :'';
          ...
          document.getElementById('sitestore_location').value = location;
					document.getElementById('Latitude').value = lat;
					document.getElementById('Longitude').value = lng;
					document.getElementById('locationmiles').value = 1000;
          //form submit by ajax
