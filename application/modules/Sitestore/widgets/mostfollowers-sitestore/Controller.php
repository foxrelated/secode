 ...
 */
class Sitestore_Widget_MostfollowersSitestoreController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $this->view->sitestores = Engine_Api::_()->sitestore()->getLising('Most Followers',$params,$interval, $sqlTimeStr);
