...
<div id="sitestore_options">
  <ul>   
    <?php $c= Engine_Api::_()->getApi('settings', 'core')->getSetting('sitestore.showmore', 9); $i=0; $flage = 0; $id = 0;
    ...
    ?>
      ...
      <?php $l++;?>
         ...
         <?php if(isset($item['content_resource'])):?>
           <?php $url = $this->url(array('store_url' => Engine_Api::_()->sitestore()->getStoreUrl($this->subject->store_id), 'tab' => $item['content_id'], 'resource_type' => $item['content_resource']), 'sitestore_entry_view', true);?>
         <?php else:?>
           <?php $url = $this->url(array('store_url' => Engine_Api::_()->sitestore()->getStoreUrl($this->subject->store_id), 'tab' => $item['content_id']), 'sitestore_entry_view', true);?>
         <?php endif;?>
