...
<?php 
  ...
  $temp_menu_route = "sitestore_general";
?>
<?php 
include_once APPLICATION_PATH . '/application/modules/Sitestore/views/scripts/common_style_css.tpl';
?>
<script type="text/javascript">
var tempPlusSignFlag = 0;
  var form;
  ...
  function show_subcat_new(cat_id)
  {
    if(document.getElementById('subcat_' + cat_id)) {
      if(document.getElementById('subcat_' + cat_id).style.display == 'block') {
        ...
        if( tempPlusSignFlag == 0 ){                  
          document.getElementById('img_' + cat_id).src = '<?php echo $this->layout()->staticBaseUrl ?>application/modules/Sitestore/externals/images/icons/plus_red.gif';
        }else {
...
window.addEvent('domready', function() {  
    ...
    show_subcat_new('<?php echo $this->category; ?>');
  }
...
<?php $sitestore_subcategory = Zend_Registry::isRegistered('sitestore_subcategory') ? Zend_Registry::get('sitestore_subcategory') : null; ?>
<?php if (count($this->categories)): ?>
  ...
  <ul class="seaocore_browse_category">
    ...
    <?php foreach ($this->categories as $category) : ?>
      ...
      <?php if (empty($this->sitestore_categories)) {
        exit();
      } ?>
      <?php if ($total_subcat > 0): ?>
        <li>
          <div class="cat" >
            <a href="javascript:show_subcat_new('<?php echo $category['category_id'] ?>')" id='button_<?php echo $category['category_id'] ?>'>
              <?php if ($this->category != $category['category_id']): ?>
                <img alt=""  src='<?php echo $this->layout()->staticBaseUrl ?>application/modules/Sitestore/externals/images/icons/plus16.gif' class='icon' border='0' id='img_<?php echo $category['category_id'] ?>'/>
              <?php elseif ($this->subcategorys != 0 && $this->category == $category['category_id']): ?>
                <img alt="" src='<?php echo $this->layout()->staticBaseUrl ?>application/modules/Sitestore/externals/images/icons/plus_red.gif' class='icon' border='0' id='img_<?php echo $category['category_id'] ?>'/>
              <?php elseif ($this->category != 0 && $this->category == $category['category_id']): ?>
                <img alt="" src='<?php echo $this->layout()->staticBaseUrl ?>application/modules/Sitestore/externals/images/icons/plus16.gif' class='icon' border='0' id='img_<?php echo $category['category_id'] ?>'/>
              <?php endif; ?>
           </a>
	         <a <?php if ($this->category == $category['category_id']): ?> class="bold"<?php endif; ?> href='javascript:void(0);' onclick="javascript:subcategoryAction('<?php echo $category['category_id'] ?>',0, '<?php echo Engine_Api::_()->getDbTable('categories', 'sitestore')->getCategorySlug($this->translate($category['category_name'])) ?>',0, '<?php echo $this->url(array('action' => 'index', 'category' => $category["category_id"], 'categoryname' => Engine_Api::_()->getDbTable('categories', 'sitestore')->getCategorySlug($this->translate($category['category_name']))), $temp_menu_route, true);?>', 0, 0);">
	         
              <?php
              $a = trim($category['category_name']);
              echo $this->translate($a); ?>
            </a>
          </div>
          <?php if (empty($sitestore_subcategory)) {
            return;
          } ?>      
                ...
                <?php if ($total_subsubcat > 0): ?>
                	<div class="subcat_second">
	                  <a href="javascript:show_subsubcat('<?php echo $subcategory['sub_cat_id'] ?>')" id='button_<?php echo $subcategory['sub_cat_id'] ?>'>
	                    ...
	                    <img alt=""  src='<?php echo $this->layout()->staticBaseUrl ?>application/modules/Sitestore/externals/images/icons/plus16.gif' class='icon' border='0' id='img_<?php echo $subcategory['sub_cat_id'] ?>'/>
	                  <?php elseif ($this->subsubcategorys != 0 && $this->subcategorys == $subcategory['sub_cat_id']): ?>
	                    <img alt="" src='<?php echo $this->layout()->staticBaseUrl ?>application/modules/Sitestore/externals/images/icons/plus_red.gif' class='icon' border='0' id='img_<?php echo $subcategory['sub_cat_id'] ?>'/>
	                  <?php elseif ($this->subcategorys != 0 && $this->subcategorys == $subcategory['sub_cat_id']): ?>
	                    <img alt="" src='<?php echo $this->layout()->staticBaseUrl ?>application/modules/Sitestore/externals/images/icons/plus16.gif' class='icon' border='0' id='img_<?php echo $subcategory['sub_cat_id'] ?>'/>
	                  <?php endif; ?>
	                  </a>
	                  <a <?php if ($this->subcategorys == $subcategory['sub_cat_id']): ?>class="bold"<?php endif; ?>  href='javascript:void(0);' onclick="javascript:subcategoryAction('<?php echo $category['category_id'] ?>','<?php echo $subcategory['sub_cat_id'] ?>','<?php echo Engine_Api::_()->getDbTable('categories', 'sitestore')->getCategorySlug($this->translate($category['category_name'])) ?>','<?php echo Engine_Api::_()->getDbTable('categories', 'sitestore')->getCategorySlug($this->translate($subcategory['sub_cat_name'])) ?>','<?php echo $this->url(array('action' => 'index', 'category' => $category["category_id"], 'categoryname' => Engine_Api::_()->getDbTable('categories', 'sitestore')->getCategorySlug($this->translate($category['category_name'])), 'subcategory' => $subcategory["sub_cat_id"],'subcategoryname' => Engine_Api::_()->getDbTable('categories', 'sitestore')->getCategorySlug($this->translate($subcategory['sub_cat_name']))), $temp_menu_route, true);?>', 0, 0);">
                  ...
                  <div class="subcat_third" id="subsubcat_<?php echo $subcategory['sub_cat_id'] ?>" <?php if ($this->subcategorys != $subcategory['sub_cat_id'] || $this->subsubcategorys == 0): ?>style="display:none;"<?php endif; ?> >
                      ...
                      <?php foreach ($subcategory['tree_sub_cat'] as $subsubcategory) : ?>
                        <a <?php if ($this->subsubcategorys == $subsubcategory['tree_sub_cat_id']): ?>class="bold"<?php endif; ?>  href='javascript:void(0);' onclick="javascript:subcategoryAction('<?php echo $category['category_id'] ?>','<?php echo $subcategory['sub_cat_id'] ?>','<?php echo Engine_Api::_()->getDbTable('categories', 'sitestore')->getCategorySlug($this->translate($category['category_name'])) ?>','<?php echo Engine_Api::_()->getDbTable('categories', 'sitestore')->getCategorySlug($subcategory['sub_cat_name']) ?>','<?php echo $this->url(array('action' => 'index', 'category' => $category["category_id"], 'categoryname' => Engine_Api::_()->getDbTable('categories', 'sitestore')->getCategorySlug($this->translate($category['category_name'])),'subcategory' => $subcategory["sub_cat_id"],'subcategoryname' => Engine_Api::_()->getDbTable('categories', 'sitestore')->getCategorySlug($this->translate($subcategory['sub_cat_name'])),'subsubcategory' => $subsubcategory["tree_sub_cat_id"],'
subsubcategoryname' => Engine_Api::_()->getDbTable('categories', 'sitestore')->getCategorySlug($this->translate($subsubcategory['tree_sub_cat_name'])),), $temp_menu_route, true);?>', '<?php echo $subsubcategory['tree_sub_cat_id'] ?>', '<?php echo $this->translate($subsubcategory['tree_sub_cat_name'])?>');">
                        	<img src="<?php echo $this->layout()->staticBaseUrl ?>application/modules/Sitestore/externals/images/gray_arrow.png" alt="">
                ...
                <?php else:?>
                	<div class="subcat_second">
	                  <img  src="<?php echo $this->layout()->staticBaseUrl ?>application/modules/Sitestore/externals/images/icons/minus16_disabled.gif" class='icon' border="0" />
	                  <a <?php if ($this->subcategorys == $subcategory['sub_cat_id']): ?>class="bold"<?php endif; ?>  href='javascript:void(0);' onclick="javascript:subcategoryAction('<?php echo $category['category_id'] ?>','<?php echo $subcategory['sub_cat_id'] ?>','<?php echo Engine_Api::_()->getDbTable('categories', 'sitestore')->getCategorySlug($this->translate($category['category_name'])) ?>','<?php echo Engine_Api::_()->getDbTable('categories', 'sitestore')->getCategorySlug($this->translate($subcategory['sub_cat_name'])) ?>','<?php echo $this->url(array('action' => 'index', 'category' => $category["category_id"], 'categoryname' => Engine_Api::_()->getDbTable('categories', 'sitestore')->getCategorySlug($this->translate($category['category_name'])),'subcategory' => $subcategory["sub_cat_id"],'subcategoryname' => Engine_Api::_()->getDbTable('categories', 'sitestore')->getCategorySlug($this->translate($subcategory['sub_cat_name']))), $temp_menu_route, true);?>',0, 0);">
	                   <?php echo $this->translate($subcategory['sub_cat_name']) ?>
	                  </a>
	                </div>  
      ...
      <?php else: ?>
        <li>
          <div class="cat">
            ...
            <a <?php if ($this->category == $category['category_id']): ?>class="bold"<?php endif; ?>  href='javascript:void(0);' onclick="javascript:categoryAction('<?php echo $category["category_id"] ?>',0, '<?php echo Engine_Api::_()->getDbTable('categories', 'sitestore')->getCategorySlug($this->translate($category['category_name'])) ?>','<?php echo $this->url(array('action' => 'index', 'category' => $category["category_id"], 'categoryname' => Engine_Api::_()->getDbTable('categories', 'sitestore')->getCategorySlug($this->translate($category['category_name']))), $temp_menu_route, true);?>');"><?php echo $this->translate($category['category_name']) ?>
            </a>
          </div>
        </li>
      <?php endif; ?>
