 ...
 */
class Sitestore_Widget_AjaxCarouselSitestoreController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $this->view->listings = $listing = Engine_Api::_()->getDbtable('stores', 'sitestore')->getListing('', $values);
