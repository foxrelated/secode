 ...
 */
class Sitestore_Widget_MostlikesSitestoreController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    //GET SITESTORE FOR MOST LIKE
    $this->view->sitestore = Engine_Api::_()->sitestore()->getLising('Most Likes',$params,$interval, $sqlTimeStr);

    //NOT RENDER IF SITESTORE COUNT ZERO
    if (!(count($this->view->sitestore) > 0)) {
