 ...
 * @version    $Id: sendupdate.tpl 2013-09-02 00:00:00Z SocialEngineAddOns $
...
<?php if(empty($this->sitestore->like_count)): ?>
	<div class="global_form_popup">	
		<div class="tip">
			<span>
				<?php echo $this->translate('No one has liked this Store yet.'); ?>
			</span>
		</div>
		<button onclick='javascript:parent.Smoothbox.close()'><?php echo $this->translate("Close");?></button>
	</div>
	<?php return; ?>
<?php elseif($this->sitestore->like_count == 1 && $this->self_liked == 1):?>
	<div class="global_form_popup">	
		<div class="tip">
			<span>
				<?php echo $this->translate('No one has liked this store other than you.'); ?>
			</span>
		</div>
		<button onclick='javascript:parent.Smoothbox.close()'><?php echo $this->translate("Close");?></button>
	</div>
...
//      'element' : 'label',
//      'positionOptions' : {
//        position: ( sm4.orientation == 'rtl' ? 'upperRight' : 'upperLeft' ),
//        edge: ( sm4.orientation == 'rtl' ? 'upperRight' : 'upperLeft' ),
//        offset: {
//          x: ( sm4.orientation == 'rtl' ? -4 : 4 ),
//          y: 2
//        }
//      }
//    });
