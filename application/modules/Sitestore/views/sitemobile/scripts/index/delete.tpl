  ...
  <form method="post" class="global_form">
    <div>
      <div>
        ...
        <p>
          <?php echo $this->translate('Are you sure that you want to delete the Store with the title "%1$s" last modified %2$s? It will not be recoverable after being deleted.', $this->sitestore->title, $this->timestamp($this->sitestore->modified_date)); ?>
        </p>
        <br />
        <p>
          ...
          <a href='<?php echo $this->url(array('action' => 'manage'), 'sitestore_general', true) ?>'><?php echo $this->translate('cancel'); ?></a>
        </p>
      </div>
    </div>
  </form>
