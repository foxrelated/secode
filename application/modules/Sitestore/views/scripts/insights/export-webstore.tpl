 ...
 * @version    $Id: export-webstore.tpl 2013-09-02 00:00:00Z SocialEngineAddOns $
...
<?php include_once APPLICATION_PATH . '/application/modules/Sitestore/views/scripts/payment_navigation_views.tpl'; ?>
    ...
    <div id="show_tab_content">
			<div class="sitestore_report_head">
				<h3><?php echo $this->translate('View Store Report') ?></h3>
				<div class="cmad_hr_link">
					<a href='<?php echo $this->url(array('store_id' => $this->store_id), 'sitestore_reports', true) ?>'>&laquo; <?php echo $this->translate('Generate Another Report')?></a>
				</div>	
			</div>
		
			<div class="sitestore_report_table">
				<table>
					<thead>
						<tr>
...
<?php if(count($this->rawdata)) : ?>
	<?php 
		...
		?>
		<div class="sitestore_total_reports">
		...
		<div class="sitestore_reports_list_wrapper">
			<div id='stat_table'>
				<table border="0">
					<tr>
