                    ...
                    <b><?php echo $this->translate("Commission"). ": "; ?> </b>
                     <?php
                      if (empty($commissionType)):
                        echo $this->locale()->toCurrency((int)$commissionFee, $currency) . ' [ '. $this->translate("Payment made to %s on sub-total of each order.", Engine_Api::_()->getApi('settings', 'core')->getSetting('core.general.site.title', '')) .' ]';
                      else:
