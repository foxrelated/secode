 ...
 * @version    $Id: guidelines.tpl 2013-09-02 00:00:00Z SocialEngineAddOns $
...
<div class='clear'>
  <a href="<?php echo $this->url(array('module' => 'sitestore', 'controller' => 'settings'), 'admin_default', true) ?>" class="buttonlink" style="background-image:url(<?php echo $this->layout()->staticBaseUrl ?>application/modules/Seaocore/externals/images/back.png);padding-left:23px;"><?php echo $this->translate("Back to Global Settings"); ?></a>
