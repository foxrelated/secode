...
<form method="post" class="global_form_popup">
  <div>
    ...
    <p>
      <?php echo $this->translate('Are you sure you want to to replace core "Activity Feed" widget with "SocialEngineAddOns Activity Feed" widget for existing Stores on your website.'); ?>
    </p>
    <br />
    <p>    
