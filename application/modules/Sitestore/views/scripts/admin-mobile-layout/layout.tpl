...
<script type="text/javascript">
  ...
  var saveChanges = function()
  {
    ...
    var url = '<?php echo $this->url(array('action' => 'update', 'controller' => 'mobile-layout', 'module' => 'sitestore'), 'admin_default', true)?>';
    var store_reload = '<?php echo Zend_Controller_Front::getInstance()->getRequest()->getParam('store_reload', 1);?>';
    var reload_count = '<?php echo round($this->totalStores / $this->limit);?>';
  ...
  var openWidgetParamEdit = function(name, element) {
    ...
    var url = '<?php echo $this->url(array('action' => 'widget', 'controller' => 'mobile-layout', 'module' => 'sitestore'), 'admin_default', true)?>';
  ...
  var saveCurrentStoreInfo = function(formElement) {
    var url = '<?php echo $this->url(array('action' => 'save', 'controller' => 'mobile-layout', 'module' => 'sitestore'), 'admin_default', true)?>';
...
<h2><?php echo $this->translate('Store Profile Layout Editor for Mobile / Tablet'); ?></h2>
<p>
...
<script type="text/javascript">
	...
	var widgetshowhide = function(widgetname, option) {
		  ...
		  $('backgroundimage_' + widgetname).innerHTML = '<div class="form-label"></div><div  class="form-element"><img src="<?php echo $this->layout()->staticBaseUrl ?>application/modules/Sitestore/externals/images/loading.gif" /></center></div>';
			var url = '<?php echo $this->url(array('action' => 'show-hide-widget', 'controller' => 'mobile-layout', 'module' => 'sitestore'), 'admin_default', true)?>';
    var request = new Request.HTML({
      'url' : url,
      'data' : {
        'format' : 'html',
