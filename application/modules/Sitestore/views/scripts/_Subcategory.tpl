...
<?php $cateDependencyArray = Engine_Api::_()->getDbTable('categories', 'sitestore')->getCatDependancyArray();
	$request = Zend_Controller_Front::getInstance()->getRequest();
	$module = $request->getModuleName();
	$action = $request->getActionName();
?>

<?php if($module == 'sitestore' && ($action == 'home' || $action == 'manage' || $action == 'index')):?>
	<?php
	echo "
