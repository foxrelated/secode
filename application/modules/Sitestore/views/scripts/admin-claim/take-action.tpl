 ...
 * @version    $Id: takeaction.tpl 2013-09-02 00:00:00Z SocialEngineAddOns $
...
<div class="global_form_popup sitestore_claim_action_popup">
	<div class="settings">
	  <form class="global_form" method="POST">
	    <div>
	      <?php
	      $url = Zend_Controller_Front::getInstance()->getRouter()->assemble(array('store_url' => Engine_Api::_()->sitestore()->getStoreUrl($this->sitestore_id)), 'sitestore_entry_view');
	      $sitestore_title = "<a href='$url' target='_blank'>$this->sitestore_title</a>";
	      ?>
	      ...
	      <?php else: ?>	
	        ...
	        <p><?php echo $this->translate("Please take an appropriate action on the claim for this store: ") ?><?php echo $sitestore_title; ?></p>
	      ...
	      <div class="form-wrapper">
	        <div class="form-label">
	          <label><?php echo $this->translate("About Claimer and Store:") ?></label>
	        </div>
	        <div class="form-element">
