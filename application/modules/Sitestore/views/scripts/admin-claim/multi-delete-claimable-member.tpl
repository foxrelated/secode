 ...
 * @version    $Id: memberdeletedelected.tpl 2013-09-02 00:00:00Z SocialEngineAddOns $
...
<div class="settings" >
  <div class='global_form'>
    <?php if ($this->ids): ?>
      <form method="post" class="global_form_popup">
        <div>
          ...
          <p>
            <?php echo $this->translate("Are you sure that you want to delete the %d members? These will not be recoverable after being deleted.", $this->count) ?>
          </p>
          <br />
          <p>
    ...
    <?php else: ?>
      <?php echo $this->translate("Please select a member to be deleted.") ?> <br/><br/>
