  ...
  <?php endif; ?>
    ...
    var subcategory = function(category_id, sub, subcatname)
    {
      ...
      if($('subcategory_id-label'))
        ...
        $('subcategory_backgroundimage').innerHTML = '<div class="form-label"></div><div  class="form-element"><img src="'+en4.core.staticBaseUrl+'application/modules/Sitestore/externals/images/loading.gif" /></center></div>';
    ...
    function changesubcategory(subcatid) {
      ...
      if($('subsubcategory_id-label'))
        $('subsubcategory_id-label').style.display = 'none';
        $('subsubcategory_backgroundimage').innerHTML = '<div class="form-label"></div><div  class="form-element"><img src="'+en4.core.staticBaseUrl+'application/modules/Sitestore/externals/images/loading.gif" /></center></div>';
        en4.core.request.send(new Request.JSON({
        url : url,
        data : {
          format : 'json',
