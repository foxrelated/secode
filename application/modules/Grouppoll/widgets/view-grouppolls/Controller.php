 ...
 */
class Grouppoll_Widget_ViewGrouppollsController extends Engine_Content_Widget_Abstract
{ 
  public function indexAction()
  {
    //GET LOGGED IN USER INFORMATION
  	...
  	$total_grouppolls = Engine_Api::_()->getApi('settings', 'core')->grouppoll_view_widgets;
  	$values = array();
    $values['group_id'] = $group_id;
    $values['total_grouppolls'] = $total_grouppolls;
    $this->view->listViewedPolls = $listViewedPolls = Engine_Api::_()->getDbtable('polls', 'grouppoll')->getPollListing('Most Viewed', $values);
