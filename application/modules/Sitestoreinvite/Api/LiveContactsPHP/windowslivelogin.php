 ...
 * @version    $Id: windowlivelogin.php 2013-09-02 00:00:00Z SocialEngineAddOns $
...
class WindowsLiveLogin {
  ...
  public static function initFromXml($settingsFile) {
    ...
    $settings['returnurl'] = ( _ENGINE_SSL ? 'https://' : 'http://' ) . $_SERVER['HTTP_HOST'] . Zend_Controller_Front::getInstance()->getBaseUrl() . '/sitestoreinvite/usercontacts/getwindowlivecontacts';
   ...
   * in to. This is done by calling the handler store for each
   ...
   * specifying 'ru' here.
   *
   * You can change the language in which the consent store is displayed
