 ...
 * @version    $Id: aollogin.tpl 2013-09-02 00:00:00Z SocialEngineAddOns $
...
#sugg-aol-signin #signin-form button {
  background-image:url(<?php echo $this->layout()->staticBaseUrl ?>application/modules/Sitestoreinvite/externals/images/aol-signin-btn.gif);
...
<div id="sugg-aol-signin">
  <div class="top">
    <?php $image_url = $this->layout()->staticBaseUrl . "application/modules/Sitestoreinvite/externals/images/aol.png"; ?>
