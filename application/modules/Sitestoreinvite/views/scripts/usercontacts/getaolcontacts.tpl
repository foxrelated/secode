 ...
 * @version    $Id: getaolcontacts.tpl 2013-09-02 00:00:00Z SocialEngineAddOns $
...
if (!$this->errormessage) {
	...
	if ($total > 0) { ?>
		<div class="header">	
			<div class="title">	
				<?php echo $this->translate("Found %s Aol contacts you can promote this Store to.", $total);?>
			<div>
	...
	if (!empty($this->addtononfriend)) { ?>
		...
		<?php  
			$getAolPer = Zend_Registry::isRegistered('sitestoreinvite_getAolPer') ? Zend_Registry::get('sitestoreinvite_getAolPer') : null;
			if( !empty($getAolPer) ):
		?>
			<div class="buttons">
