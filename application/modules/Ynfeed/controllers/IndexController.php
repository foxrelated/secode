...
class Ynfeed_IndexController extends Core_Controller_Action_Standard {
    ...
    public function postAction() {
        ...
        if(Engine_Api::_() -> hasModuleBootstrap('socialbridge') && Engine_Api::_() -> hasModuleBootstrap('socialpublisher') && !$session -> mobile)
        {
            if ($action)
            {
    ...
    public function likeAction() {
        ...
        try {
          ...
          if (!$comment_id) {
            ...
            if($action && $action->getCommentObject() && !in_array($action->getCommentObject() -> getType(), array('core_link', 'ynfeed_map')))
            {
                 // Check authorization
