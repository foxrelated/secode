...
class Yncontest_Api_Core extends Core_Api_Abstract
{
	...
	public function getEntries($param = null)
	{
		...
		$select -> joinLeft("engine4_yncontest_contests", "engine4_yncontest_contests.contest_id = $Name.contest_id", "engine4_yncontest_contests.contest_name AS contest_name");
	...
	// public function checkFeature($feature, $premium)
	// {
	// if ($feature == 1)
	// return 1;
	// if ($premium == 1)
