 ...
 */
class Facebookse_Widget_FacebookseEventprofilelikeController extends Engine_Content_Widget_Abstract
{
  public function indexAction()
  {
    ...
    $front = Zend_Controller_Front::getInstance();
		$event_like = Zend_Registry::get('facebookse_eventlike');
    ...
    $this->view->fblike_moduletype_id = $fblike_moduletype_id;
		$this->view->event_type = Zend_Registry::get('facebookse_eventtype');
