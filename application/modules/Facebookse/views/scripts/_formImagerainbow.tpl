 ...
 * @version    $Id: _formImagerainbow.tpl 6590 2011-01-06 9:40:21Z SocialEngineAddOns $
...
<script type="text/javascript">
	...
	<div id="widget_border_color-wrapper" class="form-wrapper">
		...
		<div id="widget_border_color-element" class="form-element">
			...
			<input name="widget_border_color" id="widget_border_color" value="<?php echo Engine_Api::_()->getApi('settings', 'core')->getSetting('activity.feed.border.color', '#f1f2f1')?>" type="text">
