 ...
 */
class Sitestorereview_Widget_CommentSitestorereviewsController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $sitestorereview_isComment = Zend_Registry::isRegistered('sitestorereview_isComment') ? Zend_Registry::get('sitestorereview_isComment') : null;
    if (empty($sitestorereview_isComment)) {
      return $this->setNoRender();
    }
