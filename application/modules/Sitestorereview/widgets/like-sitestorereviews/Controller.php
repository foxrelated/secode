 ...
 */
class Sitestorereview_Widget_LikeSitestorereviewsController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $sitestorereview_isLike = Zend_Registry::isRegistered('sitestorereview_isLike') ? Zend_Registry::get('sitestorereview_isLike') : null;
    if (empty($sitestorereview_isLike)) {
      return $this->setNoRender();
    }
