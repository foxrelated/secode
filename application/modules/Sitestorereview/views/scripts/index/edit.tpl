...
<?php if(Engine_Api::_()->getDbtable('modules', 'core')->isModuleEnabled('communityad') && Engine_Api::_()->getApi('settings', 'core')->getSetting('sitestore.communityads', 1) && Engine_Api::_()->getApi('settings', 'core')->getSetting('sitestore.adreviewedit', 3) && $store_communityad_integration && Engine_Api::_()->sitestore()->showAdWithPackage($this->sitestore)):?>
	<div class="layout_right" id="communityad_reviewedit">
		<?php echo $this->content()->renderWidget("communityad.ads", array( "itemCount"=>Engine_Api::_()->getApi('settings', 'core')->getSetting('sitestore.adreviewedit', 3),"loaded_by_ajax"=>0,'widgetId'=>"store_reviewedit"))?>
	</div>
<?php endif;?>
					...
					<?php if($this->showRecommendField): ?>
						<div id="end_settings-wrapper">
							...
							<div class="form-element" id="end_settings-element">
								<p class="description"><?php echo $this->translate("Would you recommend ").$this->store_title_with_link ?> <?php echo $this->translate(" to a friend?");?></p>
...
.rating{background-image: url(<?php echo $this->layout()->staticBaseUrl; ?>application/modules/Sitestorereview/externals/images/star-matrix.png);}		
