...
<?php if(Engine_Api::_()->getDbtable('modules', 'core')->isModuleEnabled('communityad') && Engine_Api::_()->getApi('settings', 'core')->getSetting('sitestore.communityads', 1) && Engine_Api::_()->getApi('settings', 'core')->getSetting('sitestore.adreviewcreate', 3) && $store_communityad_integration && Engine_Api::_()->sitestore()->showAdWithPackage($this->sitestore)):?>
	<div class="layout_right" id="communityad_reviewcreate">

<?php echo $this->content()->renderWidget("communityad.ads", array( "itemCount"=>Engine_Api::_()->getApi('settings', 'core')->getSetting('sitestore.adreviewcreate', 3),"loaded_by_ajax"=>0,'widgetId'=>"store_reviewcreate"))?>
	</div>
<?php endif;?>
	...
	<form id="sitestore_review_create" enctype="application/x-www-form-urlencoded" class="global_form" action='' method="post">
		<div>
			<div>
				...
				<p><?php echo $this->translate("Give rating and write a review for %s below.", $this->store_title_with_link) ?></p>
