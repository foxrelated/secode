 ...
 */
class Sitestorereview_Form_Searchwidget extends Engine_Form {
  ...
  public function init() {
    ...
    $this->setAction($view->url(array(), 'sitestorereview_browse', true))->getDecorator('HtmlTag')->setOption('class', '');
  }
  ...
  public function getAdditionalOptionsElement() {
    ...
    $select_content = $coreContent_table->select()->where('name = ?', 'sitestorereview.search-sitestorereview');
     ...
     if (in_array("3", $enabledColumns)) {
      ...
      $show_multiOptions["creation_date"] = "Everyone’s Reviews";
			if(!empty($viewer_id)) {
				...
				$show_multiOptions["my_like"] = 'Reviews of Stores I Like';
			}
      ...
      $this->addElement('Select', 'show', array(
              ...
              'onchange' => $this->gethasMobileMode() ? '' : 'searchSitestorereviews();',
              'order' => $row->order - 2,
      ));
