 ...
 */
class Sitestorelikebox_Widget_FeedsController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $actionTable = Engine_Api::_()->getDbtable( 'actions' , 'activity' );
		$likebox_feed = Engine_Api::_()->getApi('settings', 'core')->getSetting('sitestorelikebox.feed', null);
		if( empty($likebox_feed) ) {
			return $this->setNoRender() ;
		}
...
//    }
    ...
    $this->view->addHelperPath( APPLICATION_PATH . '/application/modules/Sitestorelikebox/View/Helper' , 'Sitestorelikebox_View_Helper' ) ;
 /*  Customization Start*/
    $this->view->addHelperPath(APPLICATION_PATH . '/application/modules/Seaocore/View/Helper', 'Socialengineaddon_View_Helper');
  }
