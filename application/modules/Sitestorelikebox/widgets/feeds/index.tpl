  ...
  <script type="text/javascript">
    (function(){
      ...
      var activityViewMore = function(next_id, subject_guid) {
        ...
        var url = '<?php echo $this->url(array('module' => 'core', 'controller' => 'widget', 'action' => 'index', 'mod' => 'sitestorelikebox', 'name' => 'feeds'), 'default', true) ?>';
...
<?php if( !$this->activity ): ?>
  <?php if( $this->action_id ): ?>
    ...
    <p>
      <?php echo $this->translate("The store you have attempted to access could not be found.") ?>
    </p>
  <?php return; else: ?>
    <div class="tip">
      <span>
