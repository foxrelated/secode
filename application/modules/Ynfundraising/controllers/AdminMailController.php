<?php
class Ynfundraising_AdminMailController extends Core_Controller_Action_Admin
{

  public function templatesAction()
  {
  	$this->view->navigation = $navigation = Engine_Api::_()->getApi('menus', 'core')
      ->getNavigation('ynfundraising_admin_main', array(), 'ynfundraising_admin_main_emailtemplates');
      
    $this->view->form = $form = new Ynfundraising_Form_Admin_Mail_Templates();
    ...
    // Get template
    $this->view->template = $template = $this->_getParam('template', '6');
    $this->view->templateObject = $templateObject = Engine_Api::_()->getItem('ynfundraising_mail_template', $template);
    if( !$templateObject ) {
  ...
  public function manageEmailsAction(){
  	$this->view->form =  $form =  new Ynfundraising_Form_Admin_Mail_Search();
	$table = Engine_Api::_()->getDbTable('LogEmails','ynfundraising');
	$select =  $table->select();
