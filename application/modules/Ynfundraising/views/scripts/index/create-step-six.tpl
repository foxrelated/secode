<?php
  $this->headScript()
    ->appendFile($this->layout()->staticBaseUrl . 'application/modules/Ynfundraising/externals/scripts/Observer.js')
    ->appendFile($this->layout()->staticBaseUrl . 'application/modules/Ynfundraising/externals/scripts/Autocompleter.js')
    ->appendFile($this->layout()->staticBaseUrl . 'application/modules/Ynfundraising/externals/scripts/Autocompleter.Local.js')
    ->appendFile($this->layout()->staticBaseUrl . 'application/modules/Ynfundraising/externals/scripts/Autocompleter.Request.js');
?>
...
<?php
$menu_create = $this->partial('_menu_create.tpl', array('active_menu'=>'step06','campaign_id'=>$this->campaign_id));
echo $menu_create;
...
<script type="text/javascript">
  ...
  en4.core.runonce.add(function() {
    if( !isPopulated ) { // NOT POPULATED
      //new Autocompleter.Request.JSON('to', '<?php echo $this->url(array('module' => 'ynfundraising', 'controller' => 'index', 'action' => 'suggest','campaign_id' => $this->campaign_id), 'default', true) ?>', {
      ...
      new Composer.OverText($('to'), {
        'textOverride' : '<?php echo $this->translate('Type your friend name...') ?>',
        'element' : 'label',
        'isPlainText' : true,
        'positionOptions' : {
