...
class Ynfundraising_Model_DbTable_Countries extends Engine_Db_Table {
	protected $_rowClass = 'Ynfundraising_Model_Country';
	...
	public function getCountry($name = NULL) {
		if($name == NULL) {
			$name = Engine_Api::_() -> getApi('core','ynfundraising') -> getDefaultCountry();
		}
