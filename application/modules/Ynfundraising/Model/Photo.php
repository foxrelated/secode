<?php
class Ynfundraising_Model_Photo extends Core_Model_Item_Collectible
{
  protected $_searchTriggers = false;
  protected $_parent_type = 'ynfundraising_album';

  protected $_owner_type = 'user';

  protected $_collection_type = 'ynfundraising_album';
  ...
  {
    return Engine_Api::_()->getItem('ynfundraising', $this->campaign_id);
  }
