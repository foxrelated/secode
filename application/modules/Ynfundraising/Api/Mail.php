 ...
 public function create()
  {
	 ...
	 */
  	public function getTemplate($type, $locale = 'en') {
		...
		$table = Engine_Api::_()->getDbtable('MailTemplates', 'ynfundraising');
    ...
    $mailTemplateTable = Engine_Api::_()->getDbtable('MailTemplates', 'ynfundraising');
	...
	$vars = array();
    $params = Engine_Api::_()->getApi('ConvertMailVars', 'ynfundraising')->process($params, $vars, $type);
