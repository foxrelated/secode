<ul class="global_form_box">
    <span id="script">
	  ...
	  <a class="ynFRaising_tagloudA" href='javascript:void(0);'onclick='javascript:tagAction(<?php echo $tag->tag_id; ?>);' ><?php echo $tag->text?></a>
	  </span>
...
<script type="text/javascript">
  /*
   var tagAction =function(tag){
    window.location = en4.core.baseUrl + 'fundraising/list?search=&tag=' + tag;
  }
  */
