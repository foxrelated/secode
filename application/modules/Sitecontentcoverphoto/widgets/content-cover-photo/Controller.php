 ...
 */
class Sitecontentcoverphoto_Widget_ContentCoverPhotoController extends Engine_Content_Widget_Abstract {
    ...
    public function indexAction() {
        ...
        $this->view->checkTabContainerExists = 1;

        if ($moduleName == 'siteevent') {
            $this->view->checkTabContainerExists = Engine_Api::_()->siteevent()->getTabId();
        }
        ...
        $this->view->active = $active = $themeTable->select()
