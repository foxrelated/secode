...
class Ynrestapi_Helper_Video extends Ynrestapi_Helper_Base
{
    ...
    public function field_thumb()
    {
        $item = $this->entry;
        if ($item->photo_id) {
            $thumb = Ynrestapi_Helper_Utils::prepareUrl(Ynrestapi_Helper_ItemPhoto::getInstance()->itemPhoto($item, 'thumb.normal'));
        } else {
    ...
    public function field_can_edit()
    {
        ...
        $this->data['can_edit'] = $this->params['can_edit'] ? true : false;
    }
    ...
    public function field_can_delete()
    {
        ...
        $this->data['can_delete'] = $this->params['can_delete'] ? true : false;
    }
