<?php $item = $this -> item;?>
<div class="ynmusic-playlist-feed music-item"  id="<?php echo $item->getGuid()?>">
	...
	<div class="playlist-photo music-photo">
		...
		<?php if ($item->getCountAvailableSongs()) :?>
			...
			<div class="play-btn-<?php echo $item->getGuid()?> music-play-btn parent">
	...
	<?php if (count($songs)) :?>
	<div class="playlist-songs music-songs" style="width: calc(100% - 162px)">
