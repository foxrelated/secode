	...
	<div class="grid-view-album-action-add-playlist show-hide-action">
		...
		<div class="action-pop-up" style="display: none">
			...
			<div class="album-action-dropdown music-action-dropdown">
				...
				<a class="action-link download" href="<?php echo $url?>" rel="<?php echo $item->getIdentity()?>"><i class="fa fa-download"></i><span class="label"><?php echo $this->translate('Download')?></span></a>
