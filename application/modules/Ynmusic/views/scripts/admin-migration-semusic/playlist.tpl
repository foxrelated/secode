...
<h3><?php echo $this->translate('Migrate From Mp3 Music') ?></h3>

<p><?php echo $this->translate("YNMUSIC_ADMIN_MIGRATE_DESCRIPTION") ?></p>

<?php echo $this->htmlLink(
    array('route' => 'admin_default', 'module' => 'ynmusic', 'controller' => 'migration', 'action' => 'report'),
    '<i class="fa fa-history"></i>'.$this->translate('View Report'),
   	array('class' => 'view-report')
)?>

<ul class="item-tab">
	<li id="item-tab-album"><a href="<?php echo $this->url(array('module'=>'ynmusic','controller'=>'migration'), 'admin_default', true)?>"><?php echo $this->translate('Albums')?></a></li>
	<li id="item-tab-playlist" class="active"><a href="<?php echo $this->url(array('module'=>'ynmusic','controller'=>'migration','action'=>'playlist'), 'admin_default', true)?>"><?php echo $this->translate('Playlists')?></a></li>
</ul>
    ...
    <table class='admin_table'>
        ...
        <?php foreach ($this->paginator as $item): ?>
            <tr id="import-item_<?php echo $item->getIdentity()?>">
                ...
                <td>
                <?php echo $this->htmlLink(
                    array('route' => 'admin_default', 'module' => 'ynmusic', 'controller' => 'migration', 'action' => 'import', 'item' => $item->getGuid()),
...
<script type="text/javascript">
	...
	function importSelected(){
	    ...
	    if (selecteditems.length == 0) {
	    	...
	    	var url = '<?php echo $this->url(array('module'=>'ynmusic','controller'=>'migration','action'=>'multiimport'), 'admin_default', true)?>/items/'+selecteditems.join(',');
			Smoothbox.open(url);
	    }
	}
