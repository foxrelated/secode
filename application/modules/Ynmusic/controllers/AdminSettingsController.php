...
class Ynmusic_AdminSettingsController extends Core_Controller_Action_Admin {
    ...
    public function levelAction() {
		...
		$elements = array(
			'album' => array('create', 'edit', 'delete', 'view', 'comment', 'max_songs', 'auth_view', 'auth_comment'),
			'playlist' => array('create', 'edit', 'delete', 'view', 'comment', 'max_songs', 'auth_view', 'auth_comment'),
			'song' => array('create', 'edit', 'delete', 'view', 'comment', 'max_filesize', 'max_storage', 'auth_view', 'auth_comment')
		);
