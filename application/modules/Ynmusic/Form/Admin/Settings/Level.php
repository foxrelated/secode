		...
		if( !$this->isPublic() ) {
			...
			foreach ($types2 as $key => $value) {
				...
				$this->addElement('Radio', $name, array(
	                ...
	                'multiOptions' => array(
	                    2 => 'Yes, allow users to edit all '.strtolower($value),
				...
				$this->addElement('Radio', $name, array(
	                ...
	                'multiOptions' => array(
	                    2 => 'Yes, allow users to delete all '.strtolower($value),
			...
			$this->addElement('Radio', 'song_edit', array(
                ...
                'multiOptions' => array(
                    2 => 'Yes, allow users to edit all songs',
			...
			$this->addElement('Radio', 'song_delete', array(
                ...
                'multiOptions' => array(
                    2 => 'Yes, allow users to delete all songs',
