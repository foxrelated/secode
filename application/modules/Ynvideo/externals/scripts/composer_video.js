...
Composer.Plugin.Ynvideo = new Class({
...
//    $('compose-video-form-type').options[2] = new Option(this._lang('Vimeo'), '2');
    for (var i = 0; i < ynvideo.types.length; i++) {
        var type = ynvideo.types[i];
    ...
    this.elements.previewDescription = new Element('div', {
      ...
      'html' : this._lang('To upload a video from your computer, please use our <a href="/videos/create/type/3">full uploader</a>.'),
      'style': 'display:none;'
    }).inject(this.elements.body);
