...
{
	$this->headScript()
		->appendFile($this->layout()->staticBaseUrl . 'application/modules/Ynvideo/externals/slideshow/responsiveslides.min.js');
	$this->headLink()
		->appendStylesheet($this->layout()->staticBaseUrl . 'application/modules/Ynvideo/externals/slideshow/responsiveslides.css');
?>
