...
<div class="photo video_thumb_wrapper" style="width:<?php echo $this -> width?>px">
    <?php 
    $thumbnail = $this->itemPhoto($this->video, 'thumb.normal', '', array('style' => 'width:'.$this -> width.'px;height:'.$this->height.'px;margin-left:'.$this->margin_left.'px'));
    if($this->video -> getPhotoUrl('thumb.large'))
	{
		$thumbnail = $this->itemPhoto($this->video, 'thumb.large', '', array('style' => 'width:'.$this -> width.'px;height:'.$this->height.'px;margin-left:'.$this->margin_left.'px'));
	}
