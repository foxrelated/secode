...
class Ynvideo_Form_Admin_Global extends Engine_Form {
    ...
    public function init() {
		...
		$this->addElement('Text', 'ynvideo_youtube_apikey', array(
            'label' => 'YouTube Data API v3 key',
            'description' => 'Please fill in the api key for parsing youtube video (YouTube Data API v3)',
            'value' => Engine_Api::_()->getApi('settings', 'core')->getSetting('ynvideo.youtube.apikey', 'AIzaSyDpUPT_nafV_MFSAlc-8AH4e1Gy578iK0M'),
        	'required' => true,
        	'allowEmpty' => false
		));
