<?php
class Money_Form_Admin_Gateway_2Checkout extends Money_Form_Admin_Gateway_Abstract
{
  public function init()
  {
    ...
    $description = $this->getTranslator()->translate('MONEY_FORM_ADMIN_GATEWAY_2CHECKOUT_DESCRIPTION');
