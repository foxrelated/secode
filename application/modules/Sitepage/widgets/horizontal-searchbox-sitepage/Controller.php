 ...
 */
class Sitepage_Widget_HorizontalSearchboxSitepageController extends Engine_Content_Widget_Abstract {
    ...
    public function indexAction() {
        ...
        //PREPARE FORM
        $this->view->form = $form = new Sitepage_Form_Horizontalsearchbox(array('widgetSettings' => $widgetSettings));
