 ...
 * @version    $Id: pageintergration_app.tpl 2011-05-05 9:40:21Z SocialEngineAddOns $
					...
					if (Engine_Api::_()->sitepage()->allowPackageContent($this->subject->package_id,
						...
						<li> <?php $canShowMessage = false;?>
							<div class="sitepage_getstarted_num">
								<?php
									$Params = Engine_Api::_()->sitepageintegration()->integrationParams($modNameValue["resource_type"], $modNameValue['listingtype_id'],$this->page_id);
									$URL =  $Params['URL'] ; 
								?>
								<a href='<?php echo $URL ?>'>
