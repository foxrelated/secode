...
<div>
	<div class="o_hidden t_center">
		...
		<?php if (!empty($this->viewer_id)): ?>
			<div class="generic_layout_container layout_sitepage_options_sitepage clr">
	...
	<div class="clr">
		...
		<div class="generic_layout_container layout_core_container_tabs">
			...
			<div id="infocontentshow">
				 <?php 	echo $this->content()->renderWidget("sitepage.sitemobile-info-sitepage", array()); ?>
			</div>
			<?php if ($this->sitepage->overview && !empty($this->can_edit_overview)) :?>
				<div id="overviewcontentshow" >
					<?php echo $this->content()->renderWidget("sitepage.sitemobile-overview-sitepage", array()); ?>
				</div>
			<?php endif; ?>
	  </div>
	</div>
