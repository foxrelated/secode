...
class Profileinfochecker_Widget_MorePluginsController extends Engine_Content_Widget_Abstract
{
  public function indexAction()
  {
   ...
   // Zend_Feed required DOMDocument
    ...
    foreach( $rss as $item )
    {
	  $install = $this->getPlugins('spurit', trim($item->title()), $packageManager);
	  if ( $install ) {
  ...
  public function getPlugins($author, $title_word, $packageManager)
  {
