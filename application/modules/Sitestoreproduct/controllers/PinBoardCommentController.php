 ...
 * @version    $Id: PinBoardCommentController.php 2013-09-02 00:00:00Z SocialEngineAddOns $
 * @author     SocialEngineAddOns
 */
class Sitestoreproduct_PinBoardCommentController extends Core_Controller_Action_Standard {
  ...
  public function createAction() {
    ...
    $this->view->body = $this->view->action('list', 'pin-board-comment', 'sitestoreproduct', array(
        'type' => $this->_getParam('type'),
  ...
  public function likeAction() {
    ...
    try {
      ...
      if (strpos($subject->getType(), "sitestore") !== false && $sitestoreVersion >= '4.2.9p3') {
