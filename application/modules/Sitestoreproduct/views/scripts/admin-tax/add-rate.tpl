...
<?php
$allRegionsAdded = $this->allRegionsAdded;
if(!empty($allRegionsAdded['all_country']) && !empty($allRegionsAdded['all_regions']) ):
  ?>
<div class="tip">
  <span><?php echo $this->translate('All available regions for this tax is already added.') ?></span></div>
<div class='buttons'>
    ...
    en4.core.request.send(new Request.JSON({
      ...
      onSuccess : function(responseJSON) {
        ...
        if(states != 0){
          ...
          $('all_regions-wrapper').setStyle('display', 'block');
          if(all_region == 1)
