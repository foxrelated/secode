...
// url is read from the form, so you just have to change one place
		 ...
		 *
		 * This example creates a list of error elements directly in the file sitestoreproduct, which
		 * hide on click.
		 */
		onSelectFail: function(files) {
			files.each(function(file) {
				...
				}).inject(this.sitestoreproduct, 'top');
			}, this);
		},
		...
		onFileStart: function() {
		  uploadCount += 1;
              ...
              onFileRemove: function(file) {
                  ...
                  request = new Request.JSON({
                   'format' : 'json',
                   'url' : '<?php echo $this->url(Array('module' => 'sitestoreproduct', 'controller' => 'photo', 'action' => 'remove'), 'default') ?>',
                   'data': {
                     'photo_id' : file_id,
                     'is_ajax' : 1
                   },
		  ...
		  if (uploadCount == 0)
		  {
    		    ...
    		    var demositestoreproduct = document.getElementById("demo-list");
		    var demosubmit = document.getElementById("submit-wrapper");
		    democlear.style.display = "none";
		    demositestoreproduct.style.display = "none";
...
<div id="demo-status" class="hide">
  <div>
    <?php echo $this->translate("Click 'Add Photos' to select one or more photos from your computer. After you have selected the photos, they will begin to upload right away. When your upload is finished, click the button below your photo to save them to your product.");?>
  </div>
  <div>
