 ...
 * @version    $Id: _storeCategory.tpl 2013-09-02 00:00:00Z SocialEngineAddOns $
...
<script type="text/javascript">
  ...
  function setHiddenValues(element_id) {
    ...
    if(element_value <= 0) return;  
  	...
  	var url = '<?php echo $this->url(array('module' => 'sitestoreproduct', 'controller' => 'general', 'action' => 'store-categories'), "admin_default", true);?>';
