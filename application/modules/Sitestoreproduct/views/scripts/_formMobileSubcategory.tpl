...
<script type="text/javascript">
  ...
  function showFields(cat_value, cat_level) {
    ...
    if(cat_level == 1 || (previous_mapped_level >= cat_level && previous_mapped_level != 1) || (profile_type == null || profile_type == '' || profile_type == 0)) {
      ...
      changeFields(document.getElementById(defaultProfileFieldId));
    }
  ...
  <?php endif; ?>
	...
	var subcategories = function(category_id, sub, subcatname)
	{
	  ...
	  if(document.getElementById('subsubcategory_id-label'))
			...
			document.getElementById('subcategory_backgroundimage').innerHTML = '<div class="form-label"></div><div class="form-element"><img src="<?php echo $this->layout()->staticBaseUrl; ?>application/modules/Core/externals/images/loading.gif" alt="" /></div>';	        
    ...
    document.getElementById('subsubcategory_backgroundimage').style.display = 'block';
	  document.getElementById('subsubcategory_id-wrapper').style.display = 'none';
		...
		if(document.getElementById('subsubcategory_id-label'))
			document.getElementById('subsubcategory_id-label').style.display = 'none';
			document.getElementById('subsubcategory_backgroundimage').innerHTML = '<div class="form-label"></div><div  class="form-element"><img src="<?php echo $this->layout()->staticBaseUrl; ?>application/modules/Core/externals/images/loading.gif" /></center></div>';
			en4.core.request.send(new Request.JSON({
			url : url,
			data : {
				format : 'json',
