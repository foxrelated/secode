...
<script type="text/javascript">
	...
	function startImporting(file_id) {
		...
		en4.core.request.send(new Request({
			url : en4.core.baseUrl+'admin/sitestoreproduct/importproduct/data-import?importfile_id='+importfile_id,
			method: 'get',
			data : {
				//'format' : 'json',
			},
  ...
  function multiImport() {
    ...
    //alert(en4.core.baseUrl+'admin/sitestoreproduct/importproduct/data-import?multi_import=1&'+importfile_ids);
    Smoothbox.open($('startImporting').innerHTML);
		importfile_ids = $('multidelete_form').toQueryString();
		en4.core.request.send(new Request({
			url : en4.core.baseUrl+'admin/sitestoreproduct/importproduct/data-import?multi_import=1&'+importfile_ids,
			method: 'get',
			data : {
				//'format' : 'html'
			},
	...
	function stopImoprt() {
		...
		var request = new Request.JSON({
			'url' : en4.core.baseUrl+'admin/sitestoreproduct/importproduct/stop',
			'data' : {
								'format' : 'json'
							},
			onSuccess : function(responseJSON) {
...
<div id="startImporting" style="display:none;">
	<center class="bold">
		<?php echo $this->translate("Import products..."); ?>
	</center>
	<center class="mtop10">
		<img src="<?php echo $this->layout()->staticBaseUrl ?>application/modules/Sitestoreproduct/externals/images/loader.gif" alt="Importing sitestoreproducts" />
	</center>
	<br />
...
<?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sitestoreproduct', 'controller' => 'importproduct', 'action' => 'index'), $this->translate('Import a new file'), array('class' => 'buttonlink icon_sitestoreproduct_admin_import')) ?>

<?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sitestoreproduct', 'controller' => 'log', 'action' => 'index'), $this->translate('Import History'), array('class' => 'buttonlink icon_sitestoreproducts_log')) ?><br/><br/>
...
<?php if($this->paginator->getTotalItemCount()): ?>	
	...
	<ul class="importproduct_form_sitestoreproduct">

		<li>
			<?php echo $this->translate("Pending: You have not started the product imports from this file. Click on 'start' link and start importing.");?>
		</li>

		<li>
			<?php echo $this->translate("Running: You have started the product imports from this file.");?>
		</li>

		<li>
			<?php echo $this->translate("Stopped: You have stopped the product imports from this file. You can continue it anytime from the same point.");?>
		</li>

		<li>
			<?php echo $this->translate("Completed: Product imports has been done successfully from this file.");?>
		</li>

	</ul>
	<br />

	<div class="admin_files_sitestoreproducts">
		<?php $sitestoreproductInfo = $this->paginator->getPages(); ?>
		<?php echo $this->translate("Showing ");?><?php echo $sitestoreproductInfo->firstItemNumber ?>-<?php echo $sitestoreproductInfo->lastItemNumber ?><?php echo $this->translate(" of "); ?><?php echo $sitestoreproductInfo->totalItemCount ?><?php echo $this->translate(" files.")?>
	</div>
            ...
            <?php endif; ?>
					...
					<td width="20%" style="text-align:left;">
						<?php if($item->status != 'Running'): ?>
							...
							<?php endif; ?>
							<?php if($item->status != 'Pending'): ?>
								<?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sitestoreproduct', 'controller' => 'importproduct', 'action' => 'rollback', 'importfile_id' => $item->importfile_id), $this->translate('Rollback'), array('class' => 'smoothbox')) ?>
								|
							<?php endif; ?>
							<?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sitestoreproduct', 'controller' => 'importproduct', 'action' => 'delete', 'importfile_id' => $item->importfile_id), $this->translate('Delete'), array('class' => 'smoothbox')) ?>
						<?php else: ?>
							<?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sitestoreproduct', 'controller' => 'importproduct', 'action' => 'stop', 'importfile_id' => $item->importfile_id, 'forceStop' => 1), $this->translate('Stop')) ?>
						<?php endif;?>
					</td>
