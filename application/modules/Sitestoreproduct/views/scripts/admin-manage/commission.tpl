      ...
      <table class='admin_table seaocore_admin_table' width="100%">
        ...
        <?php foreach( $this->paginator as $item ): ?>
          <tbody>
            ...
            <td><?php echo Engine_Api::_()->sitestoreproduct()->getPriceWithCurrency($item->order_total) ?></td>          
            <td><?php echo Engine_Api::_()->sitestoreproduct()->getPriceWithCurrency($item->commission) ?></td>
            <td>                 
              <?php if( !empty($this->storePaidCommission[$item->store_id]['paid_commission']) ) : ?>
                <?php echo Engine_Api::_()->sitestoreproduct()->getPriceWithCurrency($this->storePaidCommission[$item->store_id]['paid_commission']) ?>
              ...
              <?php else: ?>
                <?php if(Engine_Api::_()->hasModuleBootstrap('sitegateway')):?>
                    <?php $commissionPaid = Engine_Api::_()->sitegateway()->getStripeConnectCommission(array('resource_type' => 'sitestoreproduct_order', 'resource_id' => $item->store_id, 'resource_key' => 'store_id', 'payment_split' => 1)); ?>
                    <?php echo Engine_Api::_()->sitestoreproduct()->getPriceWithCurrency($commissionPaid) ?>
                    <?php $remaining_commission = $item->commission - Engine_Api::_()->sitegateway()->getStripeConnectCommission(array('resource_type' => 'sitestoreproduct_order', 'resource_id' => $item->store_id, 'resource_key' => 'store_id', 'payment_split' => 1)); ?>
                <?php else: ?>
                    <?php echo Engine_Api::_()->sitestoreproduct()->getPriceWithCurrency(0) ?>
            ...
            <td>
              <?php if( $remaining_commission > 0 ) : ?>
                <?php echo Engine_Api::_()->sitestoreproduct()->getPriceWithCurrency($remaining_commission) ?>
              <?php else: ?>
                <?php echo Engine_Api::_()->sitestoreproduct()->getPriceWithCurrency(0) ?>
              <?php endif; ?>
            </td>
