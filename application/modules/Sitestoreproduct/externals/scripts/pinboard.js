/* $Id: pinboard.js 2013-09-02 00:00:00Z SocialEngineAddOns Copyright 2012-2013 BigStep Technologies Pvt. Ltd. $ */
...
en4.srpinboard.comments = {
  ...
  loadComments : function(type, id, page,widget_id){
    en4.core.request.send(new Request.HTML({
      url : en4.core.baseUrl + 'sitestoreproduct/pin-board-comment/list',
      data : {
        format : 'html',
        type : type,
        id : id,
  ...
  submit:function(formElement,type,id,widget_id){
    ...
    en4.core.request.send(new Request.JSON({
      url : en4.core.baseUrl + 'sitestoreproduct/pin-board-comment/create',
      data : form_values,
      onSuccess : function(responseJSON) {
        en4.srpinboard.comments.setLayout();
  ...
  like : function(type, id, widget_id, comment_id) {
    en4.core.request.send(new Request.JSON({
      url : en4.core.baseUrl + 'sitestoreproduct/pin-board-comment/like',
      data : {
        format : 'json',
        type : type,
        id : id,
  ...
  unlike : function(type, id, widget_id, comment_id) {
    en4.core.request.send(new Request.JSON({
      url : en4.core.baseUrl + 'sitestoreproduct/pin-board-comment/unlike',
      data : {
        format : 'json',
        type : type,
        id : id,
