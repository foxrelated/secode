					...
					<a href="<?php echo $sitestoreproduct->getHref(array('profile_link' => 1));?>">
						...
						<p>
							<?php if ($ratingValue == 'rating_both'): ?>
								<?php echo $this->showRatingStarSitestoreproduct($sitestoreproduct->rating_editor, 'editor'); ?><br />
								<?php echo $this->showRatingStarSitestoreproduct($sitestoreproduct->rating_users, 'user', $ratingShow,1); ?>
							<?php else: ?>
								<?php echo $this->showRatingStarSitestoreproduct($sitestoreproduct->$ratingValue, $ratingType, $ratingShow,1); ?>
							<?php endif; ?>
						</p>
						<p>
					...
					<li style="height:<?php echo $this->columnHeight ?>px;">
						<a href="<?php echo $sitestoreproduct->getHref(array('profile_link' => 1)); ?>" class="ui-link-inherit">
							<div class="p_list_grid_top_sec">
								<div class="p_list_grid_img">
									<?php $url = $this->layout()->staticBaseUrl . 'application/modules/Sitepage/externals/images/nophoto_product_thumb_profile.png';
						...
						<div class="p_list_grid_info">	
							<span class="p_list_grid_stats">
								<?php if ($ratingValue == 'rating_both'): ?>
									<?php echo $this->showRatingStarSitestoreproduct($sitestoreproduct->rating_editor, 'editor', $ratingShow,1); ?><br />
									<?php echo $this->showRatingStarSitestoreproduct($sitestoreproduct->rating_users, 'user', $ratingShow,1); ?>
								<?php else: ?>
									<?php echo $this->showRatingStarSitestoreproduct($sitestoreproduct->$ratingValue, $ratingType, $ratingShow,1); ?>
								<?php endif; ?>
                  ...
                  echo $this->getProductInfo($sitestoreproduct, $this->identity, 'grid_view', 0, $this->showinStock); ?>
							...
							<span class="p_list_grid_stats">
								<?php 
									...
									if($this->statistics && in_array('reviewCount', $this->statistics)){
									  $statistics .= $this->partial(
																	'_showReview.tpl', 'sitestoreproduct', array('sitestoreproduct' => $sitestoreproduct));
                  }
...
.layout_sitestoreproduct_userproduct_sitestoreproduct > h3 {
	display:none;
}
