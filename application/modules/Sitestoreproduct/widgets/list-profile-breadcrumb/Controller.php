 ...
 */
class Sitestoreproduct_Widget_ListProfileBreadcrumbController extends Seaocore_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $this->view->viewStoreBreadCrumb = $this->_getParam('viewStoreBreadCrumb', 1);
