...
<script type="text/javascript">
  ...
  function videoRate(rating,video_id) {
    ...
    sm4.core.request.send({
      ...
      'data': {
        ...
        'rating': rating,
        'video_id' : video_id,
        'product_id': <?php echo $this->video->product_id; ?>
      },
      beforeSend: function() {
  ...
  sm4.core.runonce.add(function() { 
    ...
    $.mobile.activePage.data('product_id',<?php echo $this->video->product_id; ?>);
    set_rating();
  });
...
$breadcrumb = array(
    ...
    array("href"=>$this->sitestoreproduct->getHref(array('tab' => $this->tab_selected_id)),"title"=>"Videos","icon"=>"arrow-r"),
