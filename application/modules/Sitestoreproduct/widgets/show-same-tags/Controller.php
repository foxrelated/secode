 ...
 */
class Sitestoreproduct_Widget_ShowSameTagsController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $this->view->product_id = $sitestoreproduct_video->product_id;

    //FETCH VIDEOS
    $params = array();
    $widgetType = 'showsametag';
    $params['resource_type'] = $sitestoreproduct_video->getType();
    $params['resource_id'] = $sitestoreproduct_video->getIdentity();
