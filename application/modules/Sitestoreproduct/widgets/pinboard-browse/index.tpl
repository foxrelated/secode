  ...
  <script type="text/javascript">
   ...
   if($("pinboard_<?php echo $this->identity ?>").getParent('.layout_left')){
    ...
    PinBoardSRObject[layoutColumn].add({
      ...
      responseContainerClass :'layout_sitestoreproduct_pinboard_browse'
    });
      ...
      <div class="seaocore_list_wrapper" style="width:<?php echo $this->params['itemWidth'] ?>px;">
        <div class="seaocore_board_list b_medium sitestoreproduct_q_v_wrap" style="width:<?php echo $this->params['itemWidth'] - 18 ?>px;">
          <div>
            ...
            <?php elseif ($sitestoreproduct->newlabel): ?>
        ...
        <?php echo $this->itemPhoto($sitestoreproduct, ($this->params['itemWidth']>300)?'thumb.main':'thumb.profile', '', $options); ?>
            ...
            <div class="seaocore_board_list_btm clr">
              ...
              <div class="o_hidden seaocore_stats seaocore_txt_light">
                <?php if ($this->postedby): ?>
                  <b><?php echo $this->htmlLink($sitestoreproduct->getOwner()->getHref(), $this->translate($sitestoreproduct->getOwner()->getTitle())) ?></b><br />
                <?php endif; ?>
                <?php echo $this->translate("in %s", $this->htmlLink($sitestoreproduct->getCategory()->getHref(), $this->translate($sitestoreproduct->getCategory()->getTitle(true)))) ?>
            ...
            <div class="tip">
                <span>
                    <?php if (isset($this->formValues['tag_id']) || isset($this->formValues['category_id']) || isset($this->formValues['location']) || isset($this->formValues['search'])): ?> 
                        <?php echo $this->translate('Nobody has created a product with that criteria.'); ?>
                    <?php else: ?>  
                        <?php echo $this->translate('No products have been created yet.'); ?>
                    <?php endif; ?>  
                </span>
