 ...
 */
class Sitestoreproduct_Widget_SocialshareSitestoreproductController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    if (!Engine_Api::_()->core()->hasSubject() || empty($this->view->code)) {
