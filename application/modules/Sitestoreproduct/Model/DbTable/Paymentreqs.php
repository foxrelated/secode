 ...
 * @version    $Id: Paymentreqs.php 2013-09-02 00:00:00Z SocialEngineAddOns $
 * @author     SocialEngineAddOns
 */
class Sitestoreproduct_Model_DbTable_Paymentreqs extends Engine_Db_Table
{
  protected $_name = 'sitestoreproduct_gateways';
  
  protected $_rowClass = 'Sitestoreproduct_Model_Paymentreq';
