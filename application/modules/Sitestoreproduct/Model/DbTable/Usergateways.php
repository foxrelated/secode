 ...
 * @version    $Id: Usergateways.php 2013-09-02 00:00:00Z SocialEngineAddOns $
 * @author     SocialEngineAddOns
 */
class Sitestoreproduct_Model_DbTable_Usergateways extends Engine_Db_Table
{
  protected $_name = 'payment_gateways';
  
  protected $_rowClass = 'Sitestoreproduct_Model_Usergateway';
