 ...
 * @version    $Id: Storepaypalbill.php 2013-09-02 00:00:00Z SocialEngineAddOns $
 * @author     SocialEngineAddOns
 */
class Sitestoreproduct_Model_Storepaypalbill extends Core_Model_Item_Abstract {
  ...
  public function getPlugin() {
    // if (null === $this->_plugin) {
        ...
        $class = "Sitestoreproduct_Plugin_Gateway_Store_PayPal";
