 ...
 */
class Sitestoreproduct_View_Helper_ShowRatingStarSitestoreproductSM extends Zend_View_Helper_Abstract {
   ...
   * @return string
   */
  public function showRatingStarSitestoreproductSM($rating, $type='user', $sizeType='small-star', $html_title=null, $isCompare = false) { 
