 ...
 */
class Sitestoreproduct_Plugin_Gateway_Admin_PayPal extends Engine_Payment_Plugin_Abstract {
  ...
  public function createUserRequestTransaction(User_Model_User $user, $request_id, array $params = array()) {
    ...
    $store_title = Engine_Api::_()->getItem('sitestore_store', $response[0]['store_id'])->getTitle();
