 ...
 */
class Sitestoreproduct_Form_TellAFriend extends Engine_Form {
    ...
    public function init() {
        ...
        $this->setTitle('Tell a Friend')
                ->setDescription('Please fill the form given below and send it to your friends. Through this you can let them know about this Product.')
