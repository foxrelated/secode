 ...
 * @version    $Id: Update.php 2013-09-02 00:00:00Z SocialEngineAddOns $
 * @author     SocialEngineAddOns
 */
class Sitestoreproduct_Form_Review_Update extends Engine_Form {
  ...
  public function init() {
    ...
    $this->addElement('Button', 'submit', array(
        ...
        'order' => 10,
        'type' => 'submit',
        'onclick' => "return submitForm('$hasPosted', $('sitestoreproduct_update'), 'update');",
        'ignore' => true
    ));
  }
