 ...
 * @version    $Id: Searchfields.php 2013-09-02 00:00:00Z SocialEngineAddOns $
 * @author     SocialEngineAddOns
 */
class Sitestoreproduct_Form_Searchfields extends Engine_Form {
  ...
  public function generate() {
    $profileTypeIds = array();
		...
		if ($this->_fieldType == 'sitestoreproduct_review') {
			$profile_type = 'profile_type_review';
		} elseif ($this->_fieldType == 'sitestoreproduct_product') {
    ...
    $structure = Engine_Api::_()->sitestoreproduct()->getFieldsStructureSearch($this->_fieldType, $this->_topLevelId, $this->_topLevelValue, true, $profileTypeIds);
