...
class Siteusercoverphoto_ProfileController extends Core_Controller_Action_Standard {
    ...
    public function getMainPhotoAction() {
        ...
        $photo_type = "album_photo";
        if(Engine_Api::_() -> hasModuleBootstrap('advalbum'))
        {
            $photo_type = "advalbum_photo";
        }
        if (Engine_Api::_()->getItem($photo_type, $user->user_cover))
            $this->view->photo = $photo = Engine_Api::_()->getItem($photo_type, $user->user_cover);
