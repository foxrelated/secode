 ...
 * @version    $Id: Usergateway.php 2015-05-11 00:00:00Z SocialEngineAddOns $
 * @author     SocialEngineAddOns
 */
class Siteeventticket_Model_Usergateway extends Core_Model_Item_Abstract {
    ...
    public function getPlugin() {
        if (null === $this->_plugin) {
            $class = $this->plugin; // "Siteeventticket_Plugin_Gateway_PayPal";

            $classArray = explode('_', $class);

            if($classArray[0] === 'Payment') {
                $classArray[0] = 'Siteeventticket';
            }
