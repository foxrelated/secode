 ...
 * @version    $Id: Paymentreqs.php 2015-05-11 00:00:00Z SocialEngineAddOns $
 * @author     SocialEngineAddOns
 */
class Siteeventticket_Model_DbTable_Paymentreqs extends Engine_Db_Table {

    protected $_name = 'siteeventticket_gateways';
    protected $_rowClass = 'Siteeventticket_Model_Paymentreq';
