...
class Sitegroup_AdminExtensionController extends Core_Controller_Action_Admin
{
	public function indexAction()
  {
		$this->view->navigation = $navigation = Engine_Api::_()->getApi('menus', 'core')->getNavigation('sitegroup_admin_main', array(), 'sitegroup_admin_extension');
	}
  ...
  public function informationAction()
  {
    ...
    $this->_redirect('admin/sitegroup/extension');
  }
}
?>