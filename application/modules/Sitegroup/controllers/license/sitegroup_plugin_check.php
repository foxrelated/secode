 ...
 * @version    $Id: sitegroup_plugin_version.php 2011-05-05 9:40:21Z SocialEngineAddOns $
 * @author     SocialEngineAddOns
 */
 
$db = $this->getDb();
$sitegroup_version_correct = true;
$errorMsg = '';
...
//$isModSupport = strcasecmp($getModVersion->version, $sitegroup_plugin_version); 
    $running_version = $getModVersion->version;
  $product_version = $sitegroup_plugin_version;
  $shouldUpgrade = false;
...
if (!empty($shouldUpgrade)) {
	$errorMsg .= '<div class="tip"><span style="background-color: #da5252;color:#FFFFFF;">Note: You do not have the latest version of the Groups / Communities Plugin. Please upgrade Groups / Communities Plugin on your website to the latest version available in your SocialEngineAddOns Client Area to enable its integration with "Groups / Communities Plugin".<br/> Please <a class="" href="' . $base_url . '/manage">Click here</a> to go Manage Packages.</span></div>';
  $sitegroup_version_correct = false;
