 ...
 */
class Sitegroup_View_Helper_AdminFieldMetaQuestion extends Zend_View_Helper_Abstract {

  public function adminFieldMetaQuestion($map) {

    $meta = $map->getChild();
    if (!empty($map->option_id))
      $profileTypeLabel = Engine_Api::_()->getApi('core', 'sitegroup')->getProfileTypeName($map->option_id);
