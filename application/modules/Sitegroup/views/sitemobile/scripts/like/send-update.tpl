...
<?php if(empty($this->sitegroup->like_count)): ?>
	<div class="global_form_popup">	
		<div class="tip">
			<span>
				<?php echo $this->translate('No one has liked this Group yet.'); ?>
			</span>
		</div>
		<button onclick='javascript:parent.Smoothbox.close()'><?php echo $this->translate("Close");?></button>
	</div>
	<?php return; ?>
<?php elseif($this->sitegroup->like_count == 1 && $this->self_liked == 1):?>
	<div class="global_form_popup">	
		<div class="tip">
			<span>
				<?php echo $this->translate('No one has liked this group other than you.'); ?>
			</span>
		</div>
		<button onclick='javascript:parent.Smoothbox.close()'><?php echo $this->translate("Close");?></button>
	</div>
