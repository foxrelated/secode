...
<form method="post" action="<?php echo $this->url(array('action'=>'list'));?>" class="global_form global_form_popup">
	<div>
		<div>
			<h3> <?php echo $this->translate('Manage Featured Group Admins'); ?> </h3>
			<p><?php echo $this->translate("Below you can select / unselect group admins as featured.") ?></p>
			<div class="sitegroup_featuredadmins_add_list">
