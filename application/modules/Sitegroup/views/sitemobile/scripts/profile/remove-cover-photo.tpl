...
<form method="post" class="global_form_popup">
  <div>
		<h3><?php echo $this->translate('Remove Group Profile Cover Photo?'); ?></h3>
		<p><?php echo $this->translate("Are you sure you want to remove your Group Profile Cover Photo?"); ?></p>
    <br />
    <p>
