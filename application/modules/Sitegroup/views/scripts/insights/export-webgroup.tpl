 ...
 * @version    $Id: export-webgroup.tpl 2011-05-05 9:40:21Z SocialEngineAddOns $
...
<?php include_once APPLICATION_PATH . '/application/modules/Sitegroup/views/scripts/payment_navigation_views.tpl'; ?>
    ...
    <div id="show_tab_content">
			<div class="sitegroup_report_head">
				<h3><?php echo $this->translate('View Group Report') ?></h3>
				<div class="cmad_hr_link">
					<a href='<?php echo $this->url(array('group_id' => $this->group_id), 'sitegroup_reports', true) ?>'>&laquo; <?php echo $this->translate('Generate Another Report')?></a>
				</div>	
			</div>
		
			<div class="sitegroup_report_table">
				<table>
					<thead>
						<tr>
...
<?php if(count($this->rawdata)) : ?>
	<?php 
		...
		?>
		<div class="sitegroup_total_reports">
		...
		<div class="sitegroup_reports_list_wrapper">
			<div id='stat_table'>
				<table border="0">
					<tr>
