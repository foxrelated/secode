...
<script type="text/javascript">
  <?php $user = Engine_Api::_()->user()->getViewer(); ?>
	window.addEvent('domready', function() {
		contactoption('<?php echo Engine_Api::_()->authorization()->getAdapter('levels')->getAllowed('sitegroup_group', $user, 'contact') ?>');
	});

	var fetchLevelSettings =function(level_id){
		window.location.href= en4.core.baseUrl+'admin/sitegroup/level/index/id/'+level_id;
	}
