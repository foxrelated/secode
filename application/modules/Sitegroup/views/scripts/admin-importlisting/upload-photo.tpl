...
<h2 class="fleft"><?php echo $this->translate('Directory / Groups Plugin'); ?></h2>

<?php if (count($this->navigation)): ?>
  <div class='seaocore_admin_tabs'> <?php echo $this->navigation()->menu()->setContainer($this->navigation)->render() ?> </div>
<?php endif; ?>

<?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sitegroup', 'controller' => 'importlisting','action' => 'manage'), $this->translate('Back to Manage Import Files'), array('class' => 'buttonlink seaocore_icon_back')) ?>
<br /><br />
	...
	function startImporting(file_id) {
		...
		en4.core.request.send(new Request({
			...
			onSuccess : function(responseJSON) {
				window.location.href= en4.core.baseUrl+'admin/sitegroup/importlisting/manage';
...
<div id="startImporting" style="display:none;">
	<center class="bold">
		<?php echo $this->translate("Import groups..."); ?>
	</center>
	<center class="mtop10">
		<img src="<?php echo $this->layout()->staticBaseUrl ?>application/modules/Sitegroup/externals/images/loader.gif" alt="Importing sitegroups" />
	</center>
	<br />
...
<div class="importlisting_form">
	<div>
		...
		<p>
		 <?php echo $this->translate("Below, you can upload a zip folder containing all the profile photos of groups which you want to import by using the \"Upload Photos\" link below. After successfully uploading the folder, you can start importing the csv file by using the \”Start Import\” button. Before starting to use this tool, please read the following points carefully.
