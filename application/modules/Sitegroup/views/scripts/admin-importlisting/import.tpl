...
<script type="text/javascript">
	...
	{	
		$('import_form1').innerHTML = "<div><center><b class='bold'>" + '<?php echo $this->string()->escapeJavascript($this->translate("Importing file content...")) ?>' + "</b></center><center class='mtop10'><img src='"+en4.core.staticBaseUrl+"application/modules/Sitegroup/externals/images/admin/loader.gif' alt='<?php echo $this->string()->escapeJavascript($this->translate("Importing file content...")) ?>' /></center></div>";
		$('import_form').style.display = 'none';
	}
</script>

<div id='import_form1' class="sitegroup_upload_csv_popup_loader"></div>

<div class='clear global_form_popup sitegroup_upload_csv_popup'>
