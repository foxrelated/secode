...
<script type="text/javascript">
  ...
  window.addEvent('domready', function() {
    ...
    showEditingOptions("sitegroupfeed_likegroup_dummy-wrapper",'<?php echo Engine_Api::_()->getApi('settings', 'core')->getSetting('sitegroup.feed.type', 0); ?>');
    var feedTypeVale='<?php echo Engine_Api::_()->getApi('settings', 'core')->getSetting('sitegroupfeed.likegroup.dummy', 'c') ?>';
    if(feedTypeVale=='a'){
