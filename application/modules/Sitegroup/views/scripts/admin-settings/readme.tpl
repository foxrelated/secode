...
<div class="tabs">
  <ul class="navigation">
    <li class="active">
      <a href="<?php echo $this->baseUrl() . '/admin/sitegroup/settings/readme' ?>" ><?php echo $this->translate('Please go through these important points and proceed by clicking the button at the bottom of this group.') ?></a>
    </li>
  </ul>
</div>		
...
<script type="text/javascript" >
  function form_submit() {
    ...
    var url='<?php echo $this->url(array('module' => 'sitegroup', 'controller' => 'settings'), 'admin_default', true) ?>';
