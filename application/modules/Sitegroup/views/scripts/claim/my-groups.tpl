 ...
 * @version    $Id: myclaimgroups.tpl 2011-05-05 9:40:21Z SocialEngineAddOns $
...
<div class='layout_middle'>
	...
	<h3 class="sitegroup_mygroup_head"><?php echo $this->translate('Groups I Have Claimed'); ?></h3>
		      ...
		      <div class='seaocore_browse_list_photo'>
		        <?php echo $this->htmlLink(Engine_Api::_()->sitegroup()->getHref($item->group_id, $item->owner_id), $this->itemPhoto($item, 'thumb.normal')) ?>
					...
					<?php if( $item->status == 3 && $this->viewer_id == $item->user_id) :?>
					  <div class='seaocore_browse_list_options'>
						  <a href='<?php echo $this->url(array('action' => 'delete', 'claim_id' => $item->claim_id), 'sitegroup_claimgroups', true) ?>' class='buttonlink smoothbox icon_sitegroups_delete'><?php echo $this->translate('Delete Claim Request'); ?></a>
					  </div>	
					<?php endif; ?> 
                ...
                endswitch; ?>
						...
						<?php if(!empty($item->usercomments)): ?>
							<div class='seaocore_browse_list_info_date'>
								<?php echo $this->translate("About You and Your Group: ") ?><?php echo $item->about; ?>
							</div>
						<?php endif; ?>
						<?php if(!empty($item->usercomments)): ?>
						...
						<?php if(!empty($item->comments)): ?>
							<div class="sitegroup_claim_comment">
  ...
  <?php else: ?>
		<div class="tip">
			<span> <?php echo $this->translate('You have not claimed for any groups yet.'); ?></span>
		</div>
	<?php endif; ?>
