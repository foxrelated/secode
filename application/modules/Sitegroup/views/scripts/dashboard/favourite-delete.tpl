...
<form method="post" class="global_form_popup sitegroup_addremove_fav_popup_wrapper">
	<div class="sitegroup_addremove_fav_popup_title">
		<?php echo $this->translate('Unlink ') .$this->sitegroup->title. $this->translate(" from your Group:") ?>
	</div>
	<div class="sitegroup_addremove_fav_popup">
		<div class="sitegroup_addremove_fav_popup_img">
			<?php echo $this->htmlLink($this->sitegroup->getHref(), $this->itemPhoto($this->sitegroup)); ?>
		</div>
		<div class="sitegroup_addremove_fav_popup_detail">
			<b><?php echo $this->translate('Select your Group to be unlinked from ') .$this->sitegroup->title . $this->translate(".") ?> </b>
			...
			<p>
				<!--<input type="hidden" name="confirm" value="<?php //echo $package['sitegroup_id'] ?>"/>-->
