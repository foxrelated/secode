 ...
 * @version    $Id: editlocation.tpl 2011-05-05 9:40:21Z SocialEngineAddOns $
					...
					<div class="global_form_box">
						...
						<?php if (!empty($this->location->locationname)) : ?>
							...
							<?php
								...
								'class' => 'smoothbox icon_sitegroups_map_edit buttonlink fright',
								));
							?>
			...
			<?php else: ?>
				<div class="tip">
					...
					<?php echo $this->translate('You have not added a location for your group. Click'); ?>
											<a  onclick="javascript:Smoothbox.open('<?php echo Zend_Controller_Front::getInstance()->getRouter()->assemble(array('action' => 'edit-address', 'group_id' => $this->sitegroup->group_id), 'sitegroup_dashboard', true) ?>');"
