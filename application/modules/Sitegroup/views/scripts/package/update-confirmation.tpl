...
<form method="post" class="global_form_popup">
  <div>
    ...
    <p>
      <?php echo $this->translate('Are you sure you want to change package for this Group? Once you change package, all the settings of this group will be applied according to the new package, including apps available, features available, price, etc.'); ?>
    </p>
    <br />
