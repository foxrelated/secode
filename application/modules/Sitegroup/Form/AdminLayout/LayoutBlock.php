 ...
 */
class Sitegroup_Form_AdminLayout_LayoutBlock extends Engine_Form {

  public function init() {

    $this
            ->setTitle('Group Profile Layout Settings')
            ->setDescription('Below you can select / unselect the blocks / widgets of "Core" module to be shown on the User Group Profile Layout Editor in the "Available Blocks" section. In this way you can decide that whether or not you want Group Owners to place / remove these blocks from their Group Profile. If you do not select a block below, then that block will NOT be available to Group Owners for placing on the Group and in that case if that widget has been placed by you in the Group Profile Placement area, then Group Owners will NOT be able to remove it or drag-n-drop it and it will be displayed to them as "Locked". Please click on "Save Changes" to save the settings below.');
