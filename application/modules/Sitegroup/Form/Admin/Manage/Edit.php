 ...
 */
class Sitegroup_Form_Admin_Manage_Edit extends Engine_Form {

  public function init() {

    $this
            ->setTitle('Edit Group')
            ->setDescription('Edit the Group below, and then click "Save Changes". You can change various parameters like payment status, approval status, etc.');
    ...
    // Element: status_group
    $this->addElement('select', 'status_group', array(
        'label' => 'Status',
    ));
