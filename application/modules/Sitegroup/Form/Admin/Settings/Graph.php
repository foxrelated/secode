 ...
 */
class Sitegroup_Form_Admin_Settings_Graph extends Engine_Form {
  ...
  public function init() {
    ...
    $this
            ...
            ->setDescription("Group Admins can view graphical insights of various performance metrics like Views, Likes, Comments and Active Users of their groups over different time periods. Below, you can customize the theme and other parameters of the graph.");

    // COLOR VALUE FOR GRAPH BACKGROUND
    $this->addElement('Text', 'sitegroup_graph_bgcolor', array(
    ...
    $this->addElement('Text', 'sitegroup_graphview_width', array(
        ...
        'value' => Engine_Api::_()->getApi('settings', 'core')->getSetting('sitegroup.graphview.width', 3),
        'filters' => array(
            'StripTags',
    ...
    $this->addElement('Text', 'sitegroup_graphview_color', array(
        'decorators' => array(array('ViewScript', array(
    ...
    $this->addElement('Text', 'sitegroup_graphlike_width', array(
        ...
        'value' => Engine_Api::_()->getApi('settings', 'core')->getSetting('sitegroup.graphlike.width', 3),
        'filters' => array(
            'StripTags',
            new Engine_Filter_Censor(),
            new Engine_Filter_StringLength(array('max' => '1')),
    ...
    $this->addElement('Text', 'sitegroup_graphlike_color', array(
        'decorators' => array(array('ViewScript', array(
    ...
    $this->addElement('Text', 'sitegroup_graphuser_width', array(
        ...
        'value' => Engine_Api::_()->getApi('settings', 'core')->getSetting('sitegroup.graphuser.width', 3),
        'filters' => array(
            'StripTags',
            new Engine_Filter_Censor(),
            new Engine_Filter_StringLength(array('max' => '1')),
    ...
    $this->addElement('Text', 'sitegroup_graphuser_color', array(
        'decorators' => array(array('ViewScript', array(
    ...
    if (!empty($show_comments)) {
      ...
      $this->addElement('Text', 'sitegroup_graphcomment_width', array(
          ...
          'value' => Engine_Api::_()->getApi('settings', 'core')->getSetting('sitegroup.graphcomment.width', 3),
          'filters' => array(
              'StripTags',
              new Engine_Filter_Censor(),
              new Engine_Filter_StringLength(array('max' => '1')),
      ...
      $this->addElement('Text', 'sitegroup_graphcomment_color', array(
          'decorators' => array(array('ViewScript', array(
