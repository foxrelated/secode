 ...
 */
class Sitegroup_Model_DbTable_Metas extends Engine_Db_Table {

  protected $_name = 'sitegroup_group_fields_meta';
  protected $_rowClass = 'Sitegroup_Model_Meta';
  ...
  public function getFields($mp_id) {
    ...
    $maptable = Engine_Api::_()->getDBTable('maps', 'sitegroup');
