 ...
 */
class Sitegroup_Widget_MostcommentedSitegroupController extends Engine_Content_Widget_Abstract {

  public function indexAction() {

    //DONT RENDER IF DISABLE COMMENT
    if (!Engine_Api::_()->getApi('settings', 'core')->getSetting('sitegroup.checkcomment.widgets', 1)) {
    ...
    $this->view->sitegroups = Engine_Api::_()->getDbTable('groups', 'sitegroup')->getListings('Most Commented',$params,$interval, $sqlTimeStr, array('group_id', 'photo_id', 'group_url', 'title', 'owner_id', 'comment_count'));
