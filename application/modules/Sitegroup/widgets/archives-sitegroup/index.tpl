...
<form id='filter_form_archive' class='global_form_box' method='get' action='<?php echo $this->url(array('module' => 'sitegroup', 'action' => 'index'), 'sitegroup_general', true) ?>' style='display: none;'>
  <input type="hidden" id="start_date" name="start_date"  value=""/>
  <input type="hidden" id="end_date" name="end_date"  value=""/>
</form>
<?php if (count($this->archive_sitegroup)): ?>
  <ul class="sitegroup_sidebar_list">
    <?php foreach ($this->archive_sitegroup as $archive): ?>
      <li>
