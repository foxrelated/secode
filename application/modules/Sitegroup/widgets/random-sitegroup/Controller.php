 ...
 */
class Sitegroup_Widget_RandomSitegroupController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $this->view->sitegroups = Engine_Api::_()->getDbTable('groups', 'sitegroup')->getListings('Random List',$params, null, null, $columnsArray);
    $sitegroup_random = Zend_Registry::isRegistered('sitegroup_random') ? Zend_Registry::get('sitegroup_random') : null;

    if ( !(count($this->view->sitegroups) > 0) || empty($sitegroup_random) ) {
