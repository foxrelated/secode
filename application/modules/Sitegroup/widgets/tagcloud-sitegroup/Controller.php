 ...
 */
class Sitegroup_Widget_TagcloudSitegroupController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $this->view->category_id = $category_id = $this->_getParam('category_id',0);
		...
		$this->view->count_only = $groupTable->getTagCloud(20,$category_id, 1);
    ...
    if (!$is_ajax_load || ($is_ajax_load && $isajax)) {
        $tag_cloud_array = $groupTable->getTagCloud(20, $category_id, 0);
