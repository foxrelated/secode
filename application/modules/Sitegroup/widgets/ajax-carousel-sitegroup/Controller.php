 ...
 */
class Sitegroup_Widget_AjaxCarouselSitegroupController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $this->view->listings = $listing = Engine_Api::_()->getDbTable('groups', 'sitegroup')->getListing('', $values);
