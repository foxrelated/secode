...
class Sitegroup_Widget_ExtensionUpgradeController extends Engine_Content_Widget_Abstract
{
  public function indexAction()
  {
    ...
    $includeModules = array("sitegroupdocument" => 'Documents', "sitegroupoffer" => 'Offers', "sitegroupform" => "Form", "sitegroupdiscussion" => "Discussions", "sitegroupnote" => "Notes", "sitegroupalbum" => "Photos", "sitegroupvideo" => "Videos", "sitegroupevent" => "Events", "sitegrouppoll" => "Polls", "sitegroupinvite" => "Invite & Promote", "sitegroupbadge" => "Badges", "sitegrouplikebox" => "External Badge", "sitegroupmusic" => "Music","sitegroupreview" => "Reviews","sitegroupadmincontact" => "Contact Page Owners", "sitegroupmember" => "Member");
	...
	public function module_info($product_type)
	{
		...
		switch($product_type) {
			...
			break;
			case 'contactgroupowners':
			  $name = 'sitegroupadmincontact';
			break;
			default:
				$name = $product_type;
