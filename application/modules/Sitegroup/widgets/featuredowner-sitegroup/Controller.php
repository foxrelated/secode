 ...
 */
class Sitegroup_Widget_FeaturedownerSitegroupController extends Seaocore_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $manageadmin = Engine_Api::_()->getApi('settings', 'core')->getSetting('sitegroup.manageadmin', 1);
    ...
    $this->view->featuredowners = $featuredowners = Engine_Api::_()->getDbtable('manageadmins', 'sitegroup')->featuredAdmins($sitegroup->group_id);
		if (!Engine_API::_()->seaocore()->checkSitemobileMode('fullsite-mode')) {
			...
			$this->view->featuredowners = $featuredowners->setCurrentPageNumber($this->_getParam('group', 1));
