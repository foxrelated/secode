 ...
 */
class Sitegroup_Widget_RecentfriendSitegroupController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $this->view->sitegroups = Engine_Api::_()->getDbtable('groupstatistics', 'sitegroup')->recentFriendList($params);
