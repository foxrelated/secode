...
<?php 
  ...
  $temp_menu_route = "sitegroup_general";
?>
<?php 
...
<?php $sitegroup_subcategory = Zend_Registry::isRegistered('sitegroup_subcategory') ? Zend_Registry::get('sitegroup_subcategory') : null; ?>
<?php if (count($this->categories)): ?>
  ...
  <ul class="seaocore_browse_category">
    ...
    <?php foreach ($this->categories as $category) : ?>
      ...
      <?php if (empty($this->sitegroup_categories)) {
        exit();
      } ?>
          ...
          <div class="cat" >
            <a href="javascript:show_subcat('<?php echo $category['category_id'] ?>')" id='button_<?php echo $category['category_id'] ?>'>
              <?php if ($this->category != $category['category_id']): ?>
                <img alt=""  src='<?php echo $this->layout()->staticBaseUrl ?>application/modules/Sitegroup/externals/images/icons/plus16.gif' class='icon' border='0' id='img_<?php echo $category['category_id'] ?>'/>
              <?php elseif ($this->subcategorys != 0 && $this->category == $category['category_id']): ?>
                <img alt="" src='<?php echo $this->layout()->staticBaseUrl ?>application/modules/Sitegroup/externals/images/icons/minus16.gif' class='icon' border='0' id='img_<?php echo $category['category_id'] ?>'/>
              <?php elseif ($this->category != 0 && $this->category == $category['category_id']): ?>
                <img alt="" src='<?php echo $this->layout()->staticBaseUrl ?>application/modules/Sitegroup/externals/images/icons/plus16.gif' class='icon' border='0' id='img_<?php echo $category['category_id'] ?>'/>
              <?php endif; ?>
           </a>
	         <a <?php if ($this->category == $category['category_id']): ?> class="bold"<?php endif; ?> href='javascript:void(0);' onclick="javascript:subcategoryAction('<?php echo $category['category_id'] ?>',0, '<?php echo Engine_Api::_()->getDbTable('categories', 'sitegroup')->getCategorySlug($this->translate($category['category_name'])) ?>',0, '<?php echo $this->url(array('action' => 'index', 'category' => $category["category_id"], 'categoryname' => Engine_Api::_()->getDbTable('categories', 'sitegroup')->getCategorySlug($this->translate($category['category_name']))), $temp_menu_route, true);?>', 0, 0);">
	         
              <?php echo $this->translate($category['category_name']) ?>
            </a>
          </div>
          <?php if (empty($sitegroup_subcategory)) {
            return;
          } ?>      
                ...
                <?php if ($total_subsubcat > 0): ?>
                	<div class="subcat_second">
	                  <a href="javascript:show_subsubcat('<?php echo $subcategory['sub_cat_id'] ?>')" id='button_<?php echo $subcategory['sub_cat_id'] ?>'>
	                    ...
	                    <img alt=""  src='<?php echo $this->layout()->staticBaseUrl ?>application/modules/Sitegroup/externals/images/icons/plus16.gif' class='icon' border='0' id='img_<?php echo $subcategory['sub_cat_id'] ?>'/>
	                  <?php elseif ($this->subsubcategorys != 0 && $this->subcategorys == $subcategory['sub_cat_id']): ?>
	                    <img alt="" src='<?php echo $this->layout()->staticBaseUrl ?>application/modules/Sitegroup/externals/images/icons/minus16.gif' class='icon' border='0' id='img_<?php echo $subcategory['sub_cat_id'] ?>'/>
	                  <?php elseif ($this->subcategorys != 0 && $this->subcategorys == $subcategory['sub_cat_id']): ?>
	                    <img alt="" src='<?php echo $this->layout()->staticBaseUrl ?>application/modules/Sitegroup/externals/images/icons/plus16.gif' class='icon' border='0' id='img_<?php echo $subcategory['sub_cat_id'] ?>'/>
	                  <?php endif; ?>
	                  </a>
	                  <a <?php if ($this->subcategorys == $subcategory['sub_cat_id']): ?>class="bold"<?php endif; ?>  href='javascript:void(0);' onclick="javascript:subcategoryAction('<?php echo $category['category_id'] ?>','<?php echo $subcategory['sub_cat_id'] ?>','<?php echo Engine_Api::_()->getDbTable('categories', 'sitegroup')->getCategorySlug($this->translate($category['category_name'])) ?>','<?php echo Engine_Api::_()->getDbTable('categories', 'sitegroup')->getCategorySlug($this->translate($subcategory['sub_cat_name'])) ?>','<?php echo $this->url(array('action' => 'index', 'category' => $category["category_id"], 'categoryname' => Engine_Api::_()->getDbTable('categories', 'sitegroup')->getCategorySlug($this->translate($category['category_name'])), 'subcategory' => $subcategory["sub_cat_id"],'subcategoryname' => Engine_Api::_()->getDbTable('categories', 'sitegroup')->getCategorySlug($this->translate($subcategory['sub_cat_name']))), $temp_menu_route, true);?>', 0, 0);">
...
subsubcategoryname' => Engine_Api::_()->getDbTable('categories', 'sitegroup')->getCategorySlug($this->translate($subsubcategory['tree_sub_cat_name'])),), $temp_menu_route, true);?>', '<?php echo $subsubcategory['tree_sub_cat_id'] ?>', '<?php echo $this->translate($subsubcategory['tree_sub_cat_name'])?>');">
                        	<img src="<?php echo $this->layout()->staticBaseUrl ?>application/modules/Sitegroup/externals/images/gray_arrow.png" alt="">
                ...
                <?php else:?>
                	<div class="subcat_second">
	                  <img  src="<?php echo $this->layout()->staticBaseUrl ?>application/modules/Sitegroup/externals/images/icons/minus16_disabled.gif" class='icon' border="0" />
	                  <a <?php if ($this->subcategorys == $subcategory['sub_cat_id']): ?>class="bold"<?php endif; ?>  href='javascript:void(0);' onclick="javascript:subcategoryAction('<?php echo $category['category_id'] ?>','<?php echo $subcategory['sub_cat_id'] ?>','<?php echo Engine_Api::_()->getDbTable('categories', 'sitegroup')->getCategorySlug($this->translate($category['category_name'])) ?>','<?php echo Engine_Api::_()->getDbTable('categories', 'sitegroup')->getCategorySlug($this->translate($subcategory['sub_cat_name'])) ?>','<?php echo $this->url(array('action' => 'index', 'category' => $category["category_id"], 'categoryname' => Engine_Api::_()->getDbTable('categories', 'sitegroup')->getCategorySlug($this->translate($category['category_name'])),'subcategory' => $subcategory["sub_cat_id"],'subcategoryname' => Engine_Api::_()->getDbTable('categories', 'sitegroup')->getCategorySlug($this->translate($subcategory['sub_cat_name']))), $temp_menu_route, true);?>',0, 0);">
	                   <?php echo $this->translate($subcategory['sub_cat_name']) ?>
	                  </a>
	                </div>  
      ...
      <?php else: ?>
        <li>
          <div class="cat">
            ...
            <a <?php if ($this->category == $category['category_id']): ?>class="bold"<?php endif; ?>  href='javascript:void(0);' onclick="javascript:categoryAction('<?php echo $category["category_id"] ?>',0, '<?php echo Engine_Api::_()->getDbTable('categories', 'sitegroup')->getCategorySlug($this->translate($category['category_name'])) ?>','<?php echo $this->url(array('action' => 'index', 'category' => $category["category_id"], 'categoryname' => Engine_Api::_()->getDbTable('categories', 'sitegroup')->getCategorySlug($this->translate($category['category_name']))), $temp_menu_route, true);?>');"><?php echo $this->translate($category['category_name']) ?>
            </a>
          </div>
        </li>
      <?php endif; ?>
