...
<div id="sitegroup_options">
  <ul>   
    <?php $c= Engine_Api::_()->getApi('settings', 'core')->getSetting('sitegroup.showmore', 8); $i=0; $flage = 0; $id = 0;
    ...
    ?>
      ...
      <?php $l++;?>
         ...
         <?php if(isset($item['content_resource'])):?>
           <?php $url = $this->url(array('group_url' => Engine_Api::_()->sitegroup()->getGroupUrl($this->subject->group_id), 'tab' => $item['content_id'], 'resource_type' => $item['content_resource']), 'sitegroup_entry_view', true);?>
         <?php else:?>
           <?php $url = $this->url(array('group_url' => Engine_Api::_()->sitegroup()->getGroupUrl($this->subject->group_id), 'tab' => $item['content_id']), 'sitegroup_entry_view', true);?>
         <?php endif;?>
