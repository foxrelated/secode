 ...
 */
class Sitegroup_Widget_MostlikesSitegroupController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $this->view->sitegroups = Engine_Api::_()->getDbTable('groups', 'sitegroup')->getListings('Most Likes',$params,$interval, $sqlTimeStr, array('group_id', 'photo_id', 'group_url', 'title', 'owner_id', 'like_count'));
