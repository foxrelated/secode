...
class Sitegroup_Widget_MostviewedSitegroupController extends Engine_Content_Widget_Abstract
{
  public function indexAction()
  {
    ...
    //GET SITEGROUP FOR MOST VIEWED
    $this->view->sitegroups = Engine_Api::_()->getDbTable('groups', 'sitegroup')->getListings('Most Viewed List',$params,$interval, $sqlTimeStr, array('group_id', 'photo_id', 'group_url', 'title', 'owner_id', 'view_count'));
