...
class Ynmobile_Api_Forum extends Core_Api_Abstract
{
	...
	public function topic_delete($aData) 
    {
		...
		if(!$topic){
			return array(
				'error_code'=>1,
				'error_message'=>Zend_Registry::get('Zend_Translate') -> _("Invalid topic"),
			);
		}
        ...
        if(!$forum -> checkPermission($viewer, 'forum', 'yntopic.delete'))
		{
			return array(
				'error_code'=>1,
				'error_message'=>Zend_Registry::get('Zend_Translate') -> _("You do not have permission to delete this topic"),
			);
		}
