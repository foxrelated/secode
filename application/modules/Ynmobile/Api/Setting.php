...
class Ynmobile_Api_Setting{
    ...
    function privacy_browse($aData){
        ...
        if($_SERVER['REQUEST_METHOD'] == 'POST'){
            ...
            return array(
                'message'=>Zend_Registry::get('Zend_Translate') -> _("Your changes has been saved"),
    ...
    public function privacy_view($aData){
        ...
        foreach($view_options as $key=>$val){
            $view_options_objs[] = array(
                'key'=>$key,
                'val'=>Zend_Registry::get('Zend_Translate')->_($val)
            );
        }
    ...
    public function privacy_activity($aData){
        ...
        foreach($actionTypes as $key=>$val){
            $actionTypes_objs[] =  array('key'=>$key,
                'val'=>Zend_Registry::get('Zend_Translate')->_($val),
                'checked'=> array_search($key, $actionTypesEnabled) !== false? true:false);
        }
