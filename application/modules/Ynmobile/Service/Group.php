...
class Ynmobile_Service_Group extends Ynmobile_Service_Base
{
    ...
    public function leave($aData)
    {
        ...
        catch( Exception $e )
        {
         ...
         return array(
            'message'=>Zend_Registry::get('Zend_Translate') -> _("You have left this group"),
            'result'=> Ynmobile_AppMeta::_export_one($group, array('detail')),
        );
    }
    ...
    public function accept($aData)
    {
        ...
        return array(
            'message'=>Zend_Registry::get('Zend_Translate') -> _("You have accepted the invite"),
            'result'=> Ynmobile_AppMeta::_export_one($group, array('detail')),
        );
    }
    ...
    public function reject($aData)
    {
        ...
        return array(
            'message'=>Zend_Registry::get('Zend_Translate') -> _("You have ignored the invite"),
    ...
    public function approve($aData)
    {
        ...
        if(!$group){
            return array(
                'error_code'=>1,
                'error_message'=>Zend_Registry::get('Zend_Translate') -> _("Group not found"));
        }
    ...
    public function request($aData)
    {
        ...
        return array(
            'message'=>Zend_Registry::get('Zend_Translate') -> _("Your group membership request has been sent."),
