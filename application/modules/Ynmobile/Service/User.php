...
class Ynmobile_Service_User extends Ynmobile_Service_Base
{
    ...
    const AUTO_VERIFY_EMAIL_WHEN_SIGNUP_VIA_MOBILE = 1;
    ...
    function detail($aData){
        ...
        if(!$user){
            return array(
                'error_code'=>1,
                'error_message'=>Zend_Registry::get('Zend_Translate') -> _("Member not found!"),
            );
        }
    ...
    protected function simpleLogin($viewer, $source = 'facebook')
    {
        ...
        {
            return Ynmobile_AppMeta::_export_one($viewer, array(
                'detail',
                'subscription'
            ), array(
                    'token'=> Engine_Api::_() -> getDbtable('tokens', 'ynmobile')->createToken($viewer)
                )
            );
    ...
    public function verify_account($aData){
        ...
        if(!$viewer || !$viewer->getIdentity() || !$viewer->email ){
            return array('error_code'=>1, 'error_message'=>Zend_Registry::get('Zend_Translate') -> _("Invalid account"));
        }
    ...
    public function edit_info($aData){
        ...
        if (!$id){
            return array( 'error_code' => 1, 'error_message'=>Zend_Registry::get('Zend_Translate') -> _("Missing user identity") );
        }

        $user = Engine_Api::_()->user()->getUser($id);

        if(!$user || !$user->getIdentity()){
            return array( 'error_code' => 1, 'error_message'=>Zend_Registry::get('Zend_Translate') -> _("Invalid user") );
        }

        if (@$first_name == ""){
            return array( 'error_code' => 1, 'error_message'=>Zend_Registry::get('Zend_Translate') -> _("first_name is invalid") );
        }

        if (@$last_name == ""){
            return array( 'error_code' => 1, 'error_message'=>Zend_Registry::get('Zend_Translate') -> _("last_name is invalid") );
        }
    ...
    protected function loginByFacebook($aData)
    {
        if (!isset($aData['sLoginUID']))
        {
            return array(
                ...
                'error_message'=>Zend_Registry::get('Zend_Translate') -> _("missing sLoginUID")
            );
        }
        else
        {
            ...
            else if (isset ($aData['sEmail']))
            {
                ...
                if (is_object($viewer) && $viewer->getIdentity()) //THIS USER SIGNED UP OUR SYSTEM BEFORE
                {
                    ...
                    if ( isset($aData['connectAccount']) && $aData['connectAccount']) {
    ...
    protected function loginByLinkedin($aData)
    {
        //DO NOTHING
        return array(
            'error_message'=>Zend_Registry::get('Zend_Translate') -> _("will update later"),
            'error_code' => 1
        );
    }
    ...
    public function login($aData, $id = null)
    {
        ...
        if (isset($aData['sLoginBy']))
        {
            ...
            {
                return array(
                    'error_message'=>Zend_Registry::get('Zend_Translate') -> _("login by invalid method"),
                    'error_code' => 9
                );
            }
            else
        ...
        {
            return array(
                'error_message'=>Zend_Registry::get('Zend_Translate') -> _("Missing password"),
        ...
        return Ynmobile_AppMeta::_export_one($user, array(
            'detail',
            'subscription'
        ), array(
                'token'=> Engine_Api::_() -> getDbtable('tokens', 'ynmobile')->createToken($user)
            )
        );
    ...
    function logout($aData)
    {
        ...
        {
            return array(
                'error_message'=>Zend_Registry::get('Zend_Translate') -> _("token required!"),
                'error_code' => 1,
                'result' => 0
            );
        }
        ...
        $oDevice = Engine_Api::_() -> getDbtable('userdevices', 'ynmobile');
        $oDevice->delete("token='{$token}'");
    ...
    protected function checkEmail($sEmail)
    {
        ...
        {
            return array(
                'error_message'=>Zend_Registry::get('Zend_Translate') -> _("Email address invalid"),
                'error_element' => 'email',
                'error_step' => '1',
                'error_code' => 2
            );
        ...
        {
            return array(
                'error_message'=>Zend_Registry::get('Zend_Translate') -> _("Someone has already registered this email address, please use another one."),
                'error_element' => 'email',
                'error_step' => '1',
                'error_code' => 3
            );
        ...
        {
            return array(
                'error_message'=>Zend_Registry::get('Zend_Translate') -> _("This email address is not available, please use another one."),
                'error_element' => 'email',
                'error_step' => '1',
                'error_code' => 4
            );
    ...
    protected function checkUserName($sUserName)
    {
        ...
        {
            return array(
                'error_message'=>Zend_Registry::get('Zend_Translate') -> _("Missing user name"),
        ...
        if (!($oRegex->isValid($sUserName)))
            return array(
                'error_message'=>Zend_Registry::get('Zend_Translate') -> _("User name is not valid."),
                'error_element' => 'username',
                'error_step' => '1',
                'error_code' => 1
            );
        ...
        if (!($oStringLength->isValid($sUserName)))
            return array(
                'error_message'=>Zend_Registry::get('Zend_Translate') -> _("User name is must between 4 and 64 characters."),
                'error_element' => 'username',
                'error_step' => '1',
                'error_code' => 1
            );
        ...
        {
            return array(
                'error_message'=>Zend_Registry::get('Zend_Translate') -> _("Someone has already registered this user name, please use another one."),
                'error_element' => 'username',
                'error_step' => '1',
                'error_code' => 1
            );
        ...
        {
            return array(
                'error_message'=>Zend_Registry::get('Zend_Translate') -> _("This user name is not available, please use another one."),
                'error_element' => 'username',
                'error_step' => '1',
                'error_code' => 2
            );
    ...
    public function forgot($aData)
    {
        ...
        {
            return array(
                'error_message'=>Zend_Registry::get('Zend_Translate') -> _("Invalid email address "),
                'error_element' => 'email',
                'error_step' => '1',
                'error_code' => 2
            );
...
//      ini_set('error_reporting', -1);
        ...
        return array(
            'error' => 0,
            'message'=>Zend_Registry::get('Zend_Translate') -> _("Check in successfully")
        );
    ...
    public function signup_account($aData)
    {
        if (self::REQUIRED_FOR_SIGNUP)
        {
            ...
            for ($i = 0; $i < count($requiredArr); $i++)
            {
                ...
                {
                    return array(
                        'error_message'=>Zend_Registry::get('Zend_Translate') -> _("Missing $key"),
                        'error_code' => 1
                    );
                }
        ...
        try
        {
            ...
            if ($formArgs)
            {
                ...
                // auto verify user if signup from mobile app
                $user->verified = self::AUTO_VERIFY_EMAIL_WHEN_SIGNUP_VIA_MOBILE? 1: 0;
    ...
    function edit_cover($aData){
        ...
        try{
            if (isset($_FILES['image']))
            {
                ...
                return array(
                    ...
                    'message'=>Zend_Registry::get('Zend_Translate') -> _("cover is updated")
                );
            }
        }catch(Exception $ex){
            return array(
        ...
        return array(
            'error_code' => 1,
            'error_message'=>Zend_Registry::get('Zend_Translate') -> _("There is no file.")
        );
    }
    ...
    public function signup_avatar($aData)
    {
        ...
        if (!($iUserId) || !is_numeric($iUserId))
            return array( 'error_code' => 1, 'error_message'=>Zend_Registry::get('Zend_Translate') -> _("iUserId is invalid") );

        try
        {
            $user = Engine_Api::_()->user()->getUser($iUserId);
            if ( $user->getIdentity() <= 0 )
                return array( 'error_code' => 1, 'error_message'=>Zend_Registry::get('Zend_Translate') -> _("This user is not existed") );
    ...
    public function edit_profile($aData)
    {
        ...
        try
        {
            ...
            if (isset($sFirstName) && $sFirstName == "")
                return array( 'error_code' => 1, 'error_message'=>Zend_Registry::get('Zend_Translate') -> _("sFirstName is invalid") );

            if (isset($sLastName) && $sLastName == "")
                return array( 'error_code' => 1, 'error_message'=>Zend_Registry::get('Zend_Translate') -> _("sLastName is invalid") );
    ...
    function change_password($aData){
        ...
        if(empty($sNewPassword)
            ...
            return array(
                'error_code'=>1,
                'error_message'=>Zend_Registry::get('Zend_Translate') -> _("Invalid parameters")
            );
        };
        ...
        if( !$valid ) {
            return array(
                'error_code'=>1,
                'error_message'=>Zend_Registry::get('Zend_Translate') -> _("Save successful"),
            );
        }
        ...
        return array(
            'error_code'=>0,
            'message'=>Zend_Registry::get('Zend_Translate') -> _("Your password has been updated")
        );
    }
}
