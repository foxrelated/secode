...
class Ynmobile_Service_Network extends Ynmobile_Service_Base{
    ...
    function join_network($aData){
        ...
        if(!$network ||$network->assignment != 0){
            return array(
            'error_code'=>1,
            'error_message'=>Zend_Registry::get('Zend_Translate') -> _("Invalid network"));
        }
        ...
        return array(
            'message'=>Zend_Registry::get('Zend_Translate') -> _("Joined successful"),
            );
    }
    ...
    function leave_network($aData){
        ...
        return array(
            'message'=>Zend_Registry::get('Zend_Translate') -> _("Leave successful"),
        );
    }
}
