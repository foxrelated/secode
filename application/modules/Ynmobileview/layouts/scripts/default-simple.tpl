...
<script type="text/javascript">
	...
	{
	    var list_middle = screen.width;
	    var widthPopup = (list_middle * 80)/100;
	    var testPopup = document.getElementById('global_content_simple');
	    testPopup.setAttribute("style",'width:' + widthPopup + 'px;');
	});
