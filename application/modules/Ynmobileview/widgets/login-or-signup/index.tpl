...
<div class="ynmb_LoginInner">
	<form id="user_form_login" enctype="application/x-www-form-urlencoded" class="global_form_box" action="<?php echo $this->url(array(), 'ynmobi_login', true).'?return_url=64-' . base64_encode($_SERVER['REQUEST_URI']);?>" method="post">
		...
		<div class="ynmb_loginForm_wrapper">
			...
			<div class="ynmb_login_passWrapper">
				<input autocorrect="off" autocapitalize="off" class="" name="password" id="password" placeholder="<?php echo $this->translate('Password');?>" autofocus="autofocus" type="password">
			</div>
		</div>
