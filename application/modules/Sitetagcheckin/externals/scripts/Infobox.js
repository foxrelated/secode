...
InfoBox.prototype.createInfoBoxDiv_ = function() {
  ...
  if (!div) {
    ...
    closeImg.style.margin = this.closeBoxMargin_ + ";";
    closeImg.style.cursor = "pointer";
    closeImg.src = this.closeBoxURL_;
    ...
    $('map_canvas_contener').appendChild(div);
...
InfoBox.prototype.createInfoBoxDiv_1_ = function () {
...
InfoBox.prototype.draw = function () {
  ...
  var divWidth= parseInt(this.div_.style.width.slice(0,-2));
  var positionHorizontal=(mapDiv.offsetLeft + pixPosition.x+ this.pixelOffset_.width) - (divWidth/2); 


  if((positionHorizontal+ divWidth - scroll.x) > (size.x -30) ){ 
    positionHorizontal=positionHorizontal - (positionHorizontal + divWidth + 30 - size.x  );   
  }else  if((positionHorizontal - scroll.x) <= 30 ){
    positionHorizontal=positionHorizontal + ((scroll.x - positionHorizontal) + 30  );  
  } 
  this.div_.style.left = (positionHorizontal) + "px";
  
  this.div_.style.top = (mapDiv.offsetTop + pixPosition.y + this.pixelOffset_.height) + "px";
