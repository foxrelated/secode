...
return array(
  '4.8.9' => array(
    'Model/Action.php' => 'Fixed issues with few activity feeds are sometimes missing in the main feed on "Members Home Page"',
    'settings/manifest.php' => 'Incremented version',
    'settings/my.sql' => 'Incremented version',
  ),
  '4.8.8' => array(
    'controllers/IndexController.php' => ' Fixed issue where users are unable to like comments on certain activity feed posts',
    'Model/Action.php' => 'Fixed issues where users are unable to like comments on certain activity feed posts and posts without attachments are not appearing on user / content profile',
    'Model/Helper/Var.php' => 'Fixed issue with the translation of content sharing feed\'s text',
    'settings/manifest.php' => 'Incremented version',
    'settings/my.sql' => 'Incremented version',
    'views/scripts/_activityComments.tpl' => 'Fixed issue where users are unable to like comments on certain activity feed posts',
    'views/scripts/_activityText.tpl' => 'Fixed issues where users are unable to like comments on certain activity feed posts and duplicacy of photo caption in activity feed when status is updated along with a photo',
  ),
  '4.8.7' => array(
