...
<?php if (empty($this->parent_comment_id)): ?>
    ...
    <?php if ($this->viewer()->getIdentity() && $this->canComment): ?>
      ...
      <?php if (Engine_Api::_()->getDbtable('likes', 'yncomment')->likes($this->subject)->isLike($this->viewer())): ?>
        <a href="javascript:void(0);" onclick="en4.yncomment.yncomments.unlike('<?php echo
        $this->subject->getType() ?>', '<?php echo $this->subject->getIdentity() ?>', '', '<?php echo $this->order ?>', '<?php echo $this->parent_comment_id ?>', 'parent', '<?php echo $this->taggingContent ?>', '<?php echo $this->showComposerOptions ?>', '<?php echo $this->showAsNested ?>', '<?php echo $this->showAsLike ?>', '<?php echo $this->showDislikeUsers ?>', '<?php echo $this->showLikeWithoutIcon ?>', '<?php echo $this->showLikeWithoutIconInReplies ?>');">
            <?php if(!$this->showLikeWithoutIcon):?><i class="fa fa-thumbs-down ynfontawesome"></i><?php endif; ?>
...
<ul>
              ...
              <div class="yncomment_replies_sorting fright" id="yncomment_replies_sorting">
                ...
                <div class="yncomment_replies_pulldown yncomment_pulldown">
                  ...
                  <?php if ($this->order == 'DESC'): ?>
                  	<a href="javascript:void(0);" onclick="showSortComments();"><?php echo $this->translate("Sort by Newest"); ?>&nbsp;
                    <i class="fa fa-caret-down ynfontawesome"></i></a>
                  <?php elseif($this->order == 'ASC'):?>
                  	<a href="javascript:void(0);" onclick="showSortComments();"><?php echo $this->translate("Sort by Oldest"); ?>&nbsp;
                    <i class="fa fa-caret-down ynfontawesome"></i></a>
                  <?php elseif($this->order == 'like_count'):?>
                  	<a href="javascript:void(0);" onclick="showSortComments();"><?php echo $this->translate("Sort by Most Liked"); ?>&nbsp;
                    <i class="fa fa-caret-down ynfontawesome"></i></a>
                  <?php endif;?>
                </div>
              </div>
  ...
  <?php if ($this->comments->getTotalItemCount() > 0): // REPLIES ------- ?>
    <?php if ($this->page && $this->comments->getCurrentPageNumber() > 1): ?>
      <li class="yncomment_replies_list yncomment_prev_count">
        <div> </div>
        ...
        <div class="yncomment_replies_content <?php if($total_child) echo "yncomment_content_hasChild";?>">
          ...
          <div class="yncomment_replies_info">
            ...
            <div class='yncomment_replies_author yncomment_txt_light'>
                ...
                <div class="yncomment_comment_tips_wrap">
                  <span class="yncomment_comment_tips">
                    <a href="<?php echo $posterParent->getHref()?>">&nbsp;<i class="fa fa-long-arrow-right ynfontawesome"></i>&nbsp;<?php echo $posterParent->getTitle() ?>
                    </a>
                  </span>
                      ...
                      <b><?php echo $posterParent->getTitle(); ?></b>
                          ...
                          <?php $content = $item->body ?>
                            ...
                            if (isset($comment->params))
                            {
                              ...
                              {
                                  // Convert emoticons
                                  echo $this->smileyToEmoticons($this->viewMore($content, null, 3 * 1027));
                              }
                            }
                            ?>
            ...
            <div id="yncomment_data-<?php echo $comment->comment_id ?>">
              <div class="yncomment_replies_comment" id="yncomment_comment_data-<?php echo $comment->comment_id ?>">
                ...
                <?php if($this->viewer()->getIdentity()):?>
                    <div id="close_edit_box-<?php echo $comment->comment_id;?>" class="yncomment_txt_light f_small comment_close" style="display:none;">
                        <a class="yncomment_cancel_edit" href='javascript:void(0);' onclick="closeEdit('<?php echo $this->subject->getType() ?>', '<?php echo $this->subject->getIdentity(); ?>', '<?php echo $comment->getIdentity() ?>','<?php echo $comment->parent_comment_id ?>');"><i class="fa fa-times ynfontawesome"></i><?php echo $this->translate(' Cancel edit');?></a>
                    </div>
                <?php endif; ?>
                  ...
                  <?php if ($this->showAsNested): ?>
                      <?php if (isset($this->formComment)):  ?>
                            <?php if(!empty($replyLink)):?>
                                ...
                                <?php if($this->showLikeWithoutIconInReplies != 2):?><?php echo $this->translate('Reply') ?><?php endif; ?>
                                </a><?php if($this->showLikeWithoutIconInReplies != 1):?>&nbsp;&nbsp;<?php else:?>&nbsp;&#183;&nbsp;<?php endif;?>
                            <?php else:?>
                    ...
                    <?php if (!$isLiked): ?>
                      <a href="javascript:void(0)" onclick="en4.yncomment.yncomments.like(<?php echo sprintf("'%s', %d, %d", $this->subject->getType(), $this->subject->getIdentity(), $comment->getIdentity()) ?>, '<?php echo $this->order ?>', '<?php echo $this->parent_comment_id ?>', 'child', '<?php echo $this->taggingContent ?>', '<?php echo $this->showComposerOptions ?>', '<?php echo $this->showAsNested ?>', '<?php echo $this->showAsLike ?>', '<?php echo $this->showDislikeUsers ?>', '<?php echo $this->showLikeWithoutIcon ?>', '<?php echo $this->showLikeWithoutIconInReplies ?>')">
                          <b class="yn_like_dislike">
                              <?php if($this->showLikeWithoutIconInReplies != 1):?><i class="fa fa-thumbs-up ynfontawesome"></i><?php endif; ?>
                              <?php if($this->showLikeWithoutIconInReplies != 2):?><?php echo $this->translate('like') ?><?php endif; ?>
                          </b>
                        </a>
                        <div class="yncomment_commentlike_loading" id="like_comments_<?php echo $comment->getIdentity(); ?>" style="display:none;"></div>
                    <?php else: ?>
                      <a href="javascript:void(0)" onclick="en4.yncomment.yncomments.unlike(<?php echo sprintf("'%s', %d, %d", $this->subject->getType(), $this->subject->getIdentity(), $comment->getIdentity()) ?>, '<?php echo $this->order ?>','<?php echo $this->parent_comment_id ?>', 'child', '<?php echo $this->taggingContent ?>', '<?php echo $this->showComposerOptions ?>', '<?php echo $this->showAsNested ?>', '<?php echo $this->showAsLike ?>', '<?php echo $this->showDislikeUsers ?>', '<?php echo $this->showLikeWithoutIcon ?>', '<?php echo $this->showLikeWithoutIconInReplies ?>')">
                          <b class="yn_like_dislike">
                              <?php if($this->showLikeWithoutIconInReplies != 1):?><i class="fa fa-thumbs-down ynfontawesome"></i><?php endif; ?>
                              <?php if($this->showLikeWithoutIconInReplies != 2):?><?php echo $this->translate('unlike') ?><?php endif; ?>
                          </b>
                       </a>
                       <div class="yncomment_commentlike_loading" id="unlike_comments_<?php echo $comment->getIdentity(); ?>" style="display:none;"></div>
                    <?php endif ?>
                <?php endif ?>
    ...
    <?php if ($this->comments->getCurrentPageNumber() < $this->comments->count()): ?>
      <li class="yncomment_replies_list">
        <div> </div>
        <div class="yncomment_replies_viewall">
          <?php
          ...
          echo $this->htmlLink('javascript:void(0);', '<i class="fa fa-long-arrow-right"></i> '.$viewLaterTitle, array(
              'onclick' => 'en4.yncomment.yncomments.loadComments("' . $this->subject->getType() . '", "' . $this->subject->getIdentity() . '", "' . ($this->page + 1) . '", "' . $this->order . '", "' . $this->parent_comment_id . '", "' . $this->taggingContent . '", "' . $this->showComposerOptions . '", 1, "' . $this->showAsNested . '", "' . $this->showAsLike . '", "' . $this->showDislikeUsers . '", "' . $this->showLikeWithoutIcon . '", "' . $this->showLikeWithoutIconInReplies . '")', 'class' => 'mright5'
          ))
          ?>
