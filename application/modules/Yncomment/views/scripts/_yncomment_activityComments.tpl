            ...
            <?php if($showAsLike):?>
                ...
                <?php else: ?>
                  <li class="feed_item_option_like">
                    <span>&nbsp;-&nbsp;</span>
                    <?php if(!$showLikeWithoutIcon):?>
                        <?php echo $this->htmlLink('javascript:void(0);', '<i class="fa fa-thumbs-up ynfontawesome"></i> '.$this->translate('Like'), array('onclick'=>'javascript:en4.ynfeed.like(this, '.$action->action_id.');', 'action-title' => '<img width = "12" src="application/modules/Yncomment/externals/images/loading.gif" />')) ?>
                    <?php else:?>
                        <?php echo $this->htmlLink('javascript:void(0);', $this->translate('Like'), array('onclick'=>'javascript:en4.ynfeed.like(this, '.$action->action_id.');', 'action-title' => '<img width = "12" src="application/modules/Yncomment/externals/images/loading.gif" />')) ?>
                    <?php endif;?>
                  </li>
                <?php endif; ?>
             <?php else :?>
              ...
              <?php foreach ($action->getComments($this->viewAllComments) as $comment): ?>
                ...
                <li id="comment-<?php echo $comment->comment_id ?>" class="yncomment_nestcomment <?php if($openHide) echo 'yncomment_hidden_open'?>">
                  ...
                  <div class="comments_info">
                    ...
                    if (isset($comment->params)) {
                      ...
                      if (isset($actionParams['tags']))
                      {
                          ...
                          // Convert emoticons
                          echo _smileyToEmoticons ? $this->smileyToEmoticons($content): $content ;
                      }
                      else
                      {
                          // Convert emoticons
                        ...
                        <?php if($showAsLike):?>
                            ...
                            <li class="comments_like">
                             <span>&nbsp;-&nbsp;</span>
                              ...
                              <?php else: ?>
                                <a title="<?php echo $this->translate('Unlike') ?>" href="javascript:void(0)" onclick="en4.ynfeed.unlike(this,<?php echo sprintf("'%d', %d", $action->getIdentity(), $comment->getIdentity()) ?>);" action-title='<img width = "12" src="application/modules/Yncomment/externals/images/loading.gif" />'>
                                  <?php if($showLikeWithoutIconInReplies != 1):?>
                                         <i class="fa fa-thumbs-down ynfontawesome"></i>
                                    <?php endif ?>
                                    <?php if($showLikeWithoutIconInReplies != 2):?>
                  ...
                  if(count($replies)):?>
                    ...
                    <a <?php if($this->hideReply):?> style="display:none;" <?php else:?> style="display:inline-block;" <?php endif;?>  id="replies_show_<?php echo $comment->comment_id ?>" class="fright buttonlink activity_icon_reply_yncomment_reply comments_viewall mtop5" href="javascript:void(0);" onclick="en4.yncomment.yncomments.loadCommentReplies('<?php echo $comment->comment_id;?>');"><?php echo $this->translate(array("View %s Reply", "View %s Replies", count($action->getReplies($comment->comment_id))), count($action->getReplies($comment->comment_id)));?></a>
