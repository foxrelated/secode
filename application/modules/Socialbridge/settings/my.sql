...
('core_admin_main_plugins_socialbridge', 'socialbridge', 'Social Bridge', '', '{"route":"admin_default","module":"socialbridge","controller":"settings","action":"fbsetting"}', 'core_admin_main_plugins', '', 999);
