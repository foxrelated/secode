...
class Socialbridge_Form_Admin_Twsettings extends Engine_Form
{
  public function init()
  {
	...
	$moreinfo = $this->getTranslator()->translate( 
        '<br>To get your Twitter App Consumer Key and Twitter App Consumer Secret strings, please follow this <a href="http://knowledgebase.younetco.com/2016/01/18/how-to-set-up-twitter-app-to-get-twitter-api/" target="_blank">tutorial</a>.');
	} else {
	$moreinfo = $this->getTranslator()->translate( 
        '');
	}
