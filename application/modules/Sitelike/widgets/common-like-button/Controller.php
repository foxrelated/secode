 ...
 */
class Sitelike_Widget_CommonLikeButtonController extends Seaocore_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $this->view->hasLike = Engine_Api::_()->getApi('like', 'seaocore')->hasLike($resource_type, $this->view->resource_id);
    ...
    if (empty($enabled) || empty($modulesEnabled) || empty($viewer_id) || empty($moduleName) || empty($resource_type)) {
