...
<?php
	...
	$title = $this->translate('Message All Who Like this %s', $title);
?>
...
// // $.mobile.activePage.find('#toValues-wrapper').css('display', 'none');
// // sm4.core.Module.autoCompleter.attach("to", url, {'singletextbox': false, 'limit':10, 'minLength': 1, 'showPhoto' : true, 'search' : 'search'}, 'toValues');
//        $(this).clearQueue();});
    } else {
