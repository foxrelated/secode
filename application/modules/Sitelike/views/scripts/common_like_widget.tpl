        ...
        ?>
              ...
              echo $this->htmlLink($item->getHref(), Engine_Api::_()->sitelike()->turncation($item->getTitle()), array('title'=> $item->getTitle(), 'class' => 'seao_common_add_tooltip_link', 'rel'=> $this->resource_type.' '.$item->$id));
					...
					<div class='sitelike_stats' id = "<?php echo $this->resource_type ?>_num_of_like_<?php echo $item->$id;?>">
						<?php
							$num_of_sitepage = Engine_Api::_()->getApi('like', 'seaocore')->likeCount($this->resource_type , $item->$id);
                      // $URL = $this->url(array('module' => 'sitelike', 'controller'=> 'index' , 'action' => 'vijay' , 'resource_type' => $this->resource_type , 'id' =>  $item->$id), 'default', true);
              ?>

<!--              <a href="<?php //echo $URL ?>" class="smoothbox">  <?php //echo $this->translate(array('%s like', '%s likes', $num_of_sitepage), $this->locale()->toNumber($num_of_sitepage));?> </a>-->
              
              
              
						<?php 	echo $this->translate(array('%s like', '%s likes', $num_of_sitepage), $this->locale()->toNumber($num_of_sitepage));
						?>
					</div>
					<?php
          ...
          <div class="sitelike_button" id="<?php echo $this->resource_type ?>_most_likes_<?php echo $item->$id;?>" style ='<?php echo $like_show;?>'>
            <a href = "javascript:void(0);" onclick = "app_likes('<?php echo $item->$id; ?>', '<?php  echo $this->resource_type ?>', '<?php echo $this->resource_type ?>');">
              ...
              <span><?php echo $this->translate('Like');  ?></span>
					...
					<?php } ?>
					<input type ="hidden" id = "<?php echo $this->resource_type ?>_like_<?php echo $item->$id;?>" value = "<?php echo $like_id; ?>"  />
				</div>
      </li>
      <?php }
        ...
        <div class="sitelikes_tooltip_content_outer">
          <div class="sitelikes_tooltip_content_inner">
            ...
            <div id = "<?php echo $this->resource_type ?>_num_of_like_<?php echo $item->$id;?>" class="tooltip_sitelikes_stat">
              <?php
                $num_of_sitepage = Engine_Api::_()->getApi('like', 'seaocore')->likeCount($this->resource_type , $item->$id);
                echo $this->translate(array('%s like', '%s likes', $num_of_sitepage), $this->locale()->toNumber($num_of_sitepage));
              ?>
            </div>
            <?php
             $like_ids = Engine_Api::_()->getApi('like', 'seaocore')->hasLike(  $this->resource_type ,$item->$id );
