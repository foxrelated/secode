...
Additionally, there is a backup directory on the site server as well.") ?> 
	  ...
	  <li>
			<a href="javascript:void(0);" onClick="faq_show('faq_21');"><?php echo $this->translate("Q : When I am taking the database and file backup then the exception 'RuntimeException' with message 'SplFileInfo::isFile():' open_basedir restriction in effect error is coming. What should I do?");?></a>
