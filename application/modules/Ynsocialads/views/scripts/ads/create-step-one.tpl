...
<div class="package-item">
    ...
    <div class="package-content">
        <p>
			...
			<?php $label = ($this->package->benefit_amount == 1) ? strtoupper($this->package->benefit_type) : strtoupper($this->package->benefit_type.'s');?>
            <b><?php echo($this->package->benefit_amount.' '.$this->translate($label))?></b>
        </p>
        <p>
...
<form id="create-step-one" method="post" enctype="multipart/form-data" onsubmit="return checkValidate()">
                ...
                <div class="left_content">
                    ...
                    <div class="pages_div" class="form_element">
                        ...
                        <?php foreach ($this->pages as $page) : ?>
                            <option value="<?php echo $page['block_id']?>"><?php echo $this->translate($page['displayname'])?></option>
                        <?php endforeach; ?>
                        </select>
        ...
        <div class="form_content">
            <div class="price_div">
                ...
                <p class="description">
					...
					<?php $label = ($this->package->benefit_amount == 1) ? ucwords($this->package->benefit_type) : ucwords($this->package->benefit_type.'s');?>
                    <span class="bold"><?php echo ($this->package->benefit_amount.' '.$this->translate($label))?></span>
                </p>
                <?php else:?>
                <p class="description">
        ...
        <div class="form_content">
            ...
            <div class="sub_div">
                ...
                <div class="content_right">
                    ...
                    <?php foreach ($this->networks as $network) : ?>
                        <option value="<?php echo $network->getIdentity()?>"><?php echo $this->translate($network->getTitle())?></option>
                    <?php endforeach; ?>   
                    </select>
                    <p class="small_description"><?php echo $this->translate('Press Ctrl and click to select multiple types.')?></p>
                </div>
            ...
            <div class="sub_div">
                ...
                <div class="content_right">
                    ...
                    <label for="profile_type_<?php echo $profileType['option_id']?>"><?php echo $this->translate($profileType['label'])?></label> 
                    <?php endforeach; ?>
                </div>
            </div>
            <div class="sub_div">
