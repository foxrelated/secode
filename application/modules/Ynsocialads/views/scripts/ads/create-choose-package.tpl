	...
	<div class="package-item">
		...
		<div class="package-content">
			<p>
				...
				<?php $label = ($package->benefit_amount == 1) ? strtoupper($package->benefit_type) : strtoupper($package->benefit_type.'s');?>
				<b><?php echo($package->benefit_amount.' '.$this->translate($label))?></b>
			</p>
			<p>
