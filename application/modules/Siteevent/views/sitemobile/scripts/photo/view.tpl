...
<div class="ui-page-content">
    ...
    <div class="sm-ui-photo-view-nav">
      ...
      <div id= 'photo_navigation2' class="sm-ui-photo-view-count">
        <?php
        echo $this->translate('%1$s of %2$s', $this->locale()->toNumber($this->image->getCollectionIndex() + 1), $this->locale()->toNumber($this->siteevent->count()))
        ?>
      </div>
    </div>
  <?php endif; ?>
	<div class="sm-ui-photo-view-info">
		...
		<div class="sm-ui-cont-cont-info">
			...
			<div class="sm-ui-photo-view-info-date">
				<a href="<?php echo $this->siteevent->getParent()->getHref(); ?>"><?php echo $this->translate('%1$s', "Photos of ". $this->siteevent->getParent()->getTitle())?></a>
	...
	<?php endif; ?>
     <?php echo $this->content()->renderWidget("sitemobile.comments"); ?>
</div>
<script type="text/javascript">
