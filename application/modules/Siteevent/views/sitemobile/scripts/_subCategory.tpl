...
?>
<?php
$tabel = Engine_Api::_()->getDbTable('categories', 'siteevent');
...
var defaultProfileFieldId = '<?php echo $defaultProfileFieldId; ?>';
  ...
  function showSMFields(cat_value, cat_level) { 
    var content= sm4.siteevent.searchArray.<?php echo $module . '_' . $controller . "_" . $action ?>; 
  ...
  var getSMProfileType = function(category_id) {
    var mapping = <?php echo Zend_Json_Encoder::encode(Engine_Api::_()->getDbTable('categories', 'siteevent')->getMapping(null, 'profile_type')); ?>;
