        ...
        <form class="global_form">
            <div>
                ...
                <p class="form-description">
                    <?php echo $this->translate("This mapping will associate a Review Profile Type with a Category / Sub-category / 3rd Level Category. After such a mapping for a category, sub-category or 3rd level category, review owner of reviews belonging an event associated with that category, sub-category or 3rd level category will be able to fill profile information fields for that profile type by editing the review. With this mapping, you will also be able to associate a profile type with multiple categories / sub-categories / 3rd level categories.<br /><br />For information on event profile types, profile fields and to create new profile types or profile fields, please visit the 'Profile Fields' section. An example use case of this feature would be associating category books with profile type having profile fields related to books and so on.<br /><br /><b>Note:</b> If you map a Category, then all its sub-categories and 3rd level categories will be automatically mapped with the same Review Profile Type. If you want to map different Review Profile Types for sub-categories and 3rd level categories, then you can anytime remove the mapping from Category and add new mapping for sub-categories and 3rd level categories. Same will happen when you map a sub-category, i.e. all its 3rd level categories will be automatically mapped with the same Review Profile Type.") ?>
                </p>

                <?php if (empty($this->allowReviews)): ?>  
                    <div class="tip">
                        <span>
                            <?php echo $this->translate("You have not allowed reviews. Please goto 'Global Settings' section to allow reviews for events."); ?>
                        </span>
                    </div> 
                <?php endif; ?>          
                                    ...
                                    <td>
                                        ...
                                        <div class="siteevent_mapping_table_option fleft">
                                            <?php if (empty($category['cat_profile_type_review_id'])): ?>
                                                <?php
                                                echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'siteevent', 'controller' => 'profilemaps-review', 'action' => 'map', 'category_id' => $category['category_id']), $this->translate('Add'), array(
                                                    'class' => 'smoothbox',
                                                ))
                                                ?>
                                            <?php else: ?>
                                                ...
                                                <?php if ($this->totalProfileTypes > 1): ?>
                                                    <?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'siteevent', 'controller' => 'profilemaps-review', 'action' => 'edit', 'category_id' => $category['category_id'], 'profile_type_review' => $category['cat_profile_type_review_id']), $this->translate('Edit'), array('class' => 'smoothbox')) ?> | 
                                                <?php endif; ?>   

                                                <?php
                                                echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'siteevent', 'controller' => 'profilemaps-review', 'action' => 'remove', 'category_id' => $category['category_id']), $this->translate('Remove'), array(
                                                    'class' => 'smoothbox',
                                                ))
                                                ?>
                                <?php endif; ?>
                                        ...
                                        <td>
                                            ...
                                            <div class="siteevent_mapping_table_option fleft">
                                                ...
                                                <?php elseif (empty($subcategory['subcat_profile_type_review_id'])): ?>
                                                    <?php
                                                    echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'siteevent', 'controller' => 'profilemaps-review', 'action' => 'map', 'category_id' => $subcategory['sub_cat_id']), $this->translate('Add'), array(
                                                        'class' => 'smoothbox',
                                                    ))
                                                    ?>
                                                <?php else: ?>
                                                    <?php if ($this->totalProfileTypes > 1): ?>
                                                        <?php
                                                        echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'siteevent', 'controller' => 'profilemaps-review', 'action' => 'edit', 'category_id' => $subcategory['sub_cat_id'], 'profile_type_review' => $subcategory['subcat_profile_type_review_id']), $this->translate('Edit'), array(
                                                            'class' => 'smoothbox',
                                                        ))
                                                        ?> | 
                                                <?php endif; ?>                                    
                                                ...
                                                <?php
                                                echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'siteevent', 'controller' => 'profilemaps-review', 'action' => 'remove', 'category_id' => $subcategory['sub_cat_id']), $this->translate('Remove'), array(
                                                    'class' => 'smoothbox',
                                                ))
                                                ?>
                                                <?php endif; ?>
                                            ...
                                            <td>
                                                ...
                                                <div class="siteevent_mapping_table_option fleft">
                                                    ...
                                                    <?php elseif (empty($subsubcategory['tree_profile_type_review_id'])): ?>
                                                        <?php
                                                        echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'siteevent', 'controller' => 'profilemaps-review', 'action' => 'map', 'category_id' => $subsubcategory['tree_sub_cat_id']), $this->translate('Add'), array(
                                                            'class' => 'smoothbox',
                                                        ))
                                                        ?>
                                                    <?php else: ?>
                                                        ...
                                                        <?php if ($this->totalProfileTypes > 1): ?>
                                                            <?php
                                                            echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'siteevent', 'controller' => 'profilemaps-review', 'action' => 'edit', 'category_id' => $subsubcategory['tree_sub_cat_id'], 'profile_type_review' => $subsubcategory['tree_profile_type_review_id']), $this->translate('Edit'), array(
                                                                'class' => 'smoothbox',
                                                            ))
                                                            ?> | 
                                                    <?php endif; ?>        
                                                        ...
                                                        <?php
                                                        echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'siteevent', 'controller' => 'profilemaps-review', 'action' => 'remove', 'category_id' => $subsubcategory['tree_sub_cat_id']), $this->translate('Remove'), array(
                                                            'class' => 'smoothbox',
                                                        ))
                                                        ?>
                                                    <?php endif; ?>
