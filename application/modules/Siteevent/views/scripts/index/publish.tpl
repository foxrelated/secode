...
<div class='global_form_popup'>
    <?php if ($this->success): ?>
        ...
        <div class="global_form_popup_message">
            <?php echo $this->translate('Your event has been published.'); ?> 
        </div>
    <?php else: ?>
        <form method="POST" action="<?php echo $this->url() ?>">
            <div>
                <h3><?php echo $this->translate("Publish event?"); ?></h3>
                <p>
                    <?php echo $this->translate("Are you sure that you want to publish this event?"); ?>
                </p>
                <p>&nbsp;
                </p>
                <p>
                    ...
                    <?php echo $this->translate("Show this event in search results"); ?>
                    <br />
                    <br />
