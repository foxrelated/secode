 ...
 * @version    $Id: add-special-events.tpl 6590 2014-01-02 00:00:00Z SocialEngineAddOns $
...
<script type="text/javascript">
    ...
    window.addEvent('domready', function() {
        ...
        var request = new Request.JSON({
            url: '<?php echo $this->url(array('module' => 'siteevent', 'controller' => 'settings', 'action' => 'get-widget-params'), "admin_default"); ?>',
            method: 'get',
            data: {
                format: 'json',
...
//                $('endtime-ampm').value = responseJSON.endAMPM;                
    ...
    en4.core.runonce.add(function() {
        if ($('event_ids')) {
            new Autocompleter.Request.JSON('event_ids', '<?php echo $this->url(array('module' => 'siteevent', 'controller' => 'admin-settings', 'action' => 'get-events'), 'default', true) ?>', {
                'postVar': 'text',
                'postData': false,
                'minLength': 1,
                'delay': 250,
...
//          }
            ...
            new Composer.OverText($('event_ids'), {
...
<div class="form-wrapper">
    ...
    <div id="event_ids-element" class="form-element">
        <?php echo "Start typing the name of the Event."; ?>
        <input type="text" style="width:300px;" class="text" value="" id="event_ids" name="event_ids">
    </div>
</div>