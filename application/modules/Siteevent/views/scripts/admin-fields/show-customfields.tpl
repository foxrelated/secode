 ...
 * @version    $Id: show-customfields.tpl 6590 2014-01-02 00:00:00Z SocialEngineAddOns $
...
<?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'siteevent', 'controller' => 'importevent'), $this->translate('Back to Import Events from a CSV file'), array('class' => 'buttonlink seaocore_icon_back')) ?>
<br /><br />
...
<div class="importlisting_form">
    <div>
        ...
        <p>
            ...
            <a href='<?php echo $this->url(array('module' => 'siteevent', 'controller' => 'importevent', 'action' => 'manage'), "admin_default", true) ?>' target="_blank"><?php echo $this->translate("clicking here."); ?></a>
        </p>
        <ul class="importevent_form_siteevent">
            ...
            <li>
                <?php echo $this->translate('For creating accurate events from the CSV file, it is recommended that you fill all the required fields in the file to be imported.'); ?>
            </li>
            <li>
                ...
                <div>
                    ...
                    [<a href="<?php echo $this->url(array('module' => 'siteevent', 'controller' => 'importevent', 'action' => 'show-country', 'field' => 'country')) ?>" class="smoothbox bold">?</a>]
                </div>
                <div>
                    - <?php echo $this->translate('Ethnicity'); ?>
                    [<a href="<?php echo $this->url(array('module' => 'siteevent', 'controller' => 'importevent', 'action' => 'show-country', 'field' => 'ethnicity')) ?>" class="smoothbox bold">?</a>]
                </div>
                <div>
                    - <?php echo $this->translate('Occupation'); ?>
                    [<a href="<?php echo $this->url(array('module' => 'siteevent', 'controller' => 'importevent', 'action' => 'show-country', 'field' => 'occupation')) ?>" class="smoothbox bold">?</a>]
                </div>
                <div>
                    - <?php echo $this->translate('Education'); ?>
                    [<a href="<?php echo $this->url(array('module' => 'siteevent', 'controller' => 'importevent', 'action' => 'show-country', 'field' => 'education_level')) ?>" class="smoothbox bold">?</a>]
                </div>
                <div>
                    - <?php echo $this->translate('Relationship Status'); ?>
                    [<a href="<?php echo $this->url(array('module' => 'siteevent', 'controller' => 'importevent', 'action' => 'show-country', 'field' => 'relationship_status')) ?>" class="smoothbox bold">?</a>]
                </div>
                <div>
                    - <?php echo $this->translate('Looking For'); ?>
                    [<a href="<?php echo $this->url(array('module' => 'siteevent', 'controller' => 'importevent', 'action' => 'show-country', 'field' => 'looking_for')) ?>" class="smoothbox bold">?</a>]
                </div>
                <div>
                    - <?php echo $this->translate('Weight'); ?>
                    [<a href="<?php echo $this->url(array('module' => 'siteevent', 'controller' => 'importevent', 'action' => 'show-country', 'field' => 'weight')) ?>" class="smoothbox bold">?</a>]
                </div>
                <div>
                    - <?php echo $this->translate('Religion'); ?>
                    [<a href="<?php echo $this->url(array('module' => 'siteevent', 'controller' => 'importevent', 'action' => 'show-country', 'field' => 'religion')) ?>" class="smoothbox bold">?</a>]
                </div>
                <div>
                    - <?php echo $this->translate('Political Views'); ?>
                    [<a href="<?php echo $this->url(array('module' => 'siteevent', 'controller' => 'importevent', 'action' => 'show-country', 'field' => 'political_views')) ?>" class="smoothbox bold">?</a>]
                </div>
                <div>
                    - <?php echo $this->translate('Income'); ?>
                    [<a href="<?php echo $this->url(array('module' => 'siteevent', 'controller' => 'importevent', 'action' => 'show-country', 'field' => 'income')) ?>" class="smoothbox bold">?</a>]
                </div>
                <div>
                    - <?php echo $this->translate('Interested In'); ?>
                    [<a href="<?php echo $this->url(array('module' => 'siteevent', 'controller' => 'importevent', 'action' => 'show-country', 'field' => 'partner_gender')) ?>" class="smoothbox bold">?</a>]
                </div>
                <div>
                    - <?php echo $this->translate('Zodiac'); ?>
                    [<a href="<?php echo $this->url(array('module' => 'siteevent', 'controller' => 'importevent', 'action' => 'show-country', 'field' => 'zodiac')) ?>" class="smoothbox bold">?</a>]
                    <div>
                        - <?php echo $this->translate('Date'); ?>
                        [<a href="<?php echo $this->url(array('module' => 'siteevent', 'controller' => 'importevent', 'action' => 'show-country', 'field' => 'date')) ?>" class="smoothbox bold">?</a>]
                    </div>
            </li>	
        </ul>
        <br />
        <form method="post" class="global_form_box" id="customfield" action="<?php echo $this->url(array('action' => 'show-customfields')) ?><?php echo '?path=' . urlencode('example_event_import.csv'); ?>" width="100%">
            <?php foreach ($this->topLevelOptions as $key => $profile): ?>
                ...
                <?php $this->secondLevelMaps = Engine_Api::_()->getApi('core', 'siteevent')->getsecondLevelMaps($key); ?>
                ...
                <?php endif; ?>
                <ul class="admin_fields siteevent_custom_fields">
                    <?php foreach ($this->secondLevelMaps as $map): ?>
                        <?php if (!empty($map->option_id)): ?>
                            <?php $profileTypeLabel = Engine_Api::_()->sitereview()->getProfileTypeName($map->option_id); ?>
                        <?php endif; ?>
            ...
            <?php if (empty($this->import_id)): ?>
                <a href="javascript:void(0);" onclick="showErrorMessage();
                        return false;" class="buttonlink icon_siteevents_download_csv"><?php echo $this->translate('Download New CSV Template File') ?></a> &nbsp;&nbsp;&nbsp;
<?php else: ?>
                <div class="tip">
                    <span>     
                        <?php echo $this->translate("You have already imported a csv file. To generate a new csv template file from here, please delete the existing imported file by "); ?><a href='<?php echo $this->url(array('module' => 'siteevent', 'controller' => 'importevent', 'action' => 'manage'), "admin_default", true) ?>' target="_blank"><?php echo $this->translate("clicking here."); ?></a>
                    </span>
                </div>
            <?php endif; ?>
            <a href="<?php echo $this->url(array('module' => 'siteevent', 'controller' => 'importevent', 'action' => 'download')) ?><?php echo '?path=' . urlencode('previous_listing_import.csv'); ?>" class="buttonlink icon_siteevents_download_csv"><?php echo $this->translate('Download Previous CSV Template File') ?></a>
        </form>
    </div>
</div>
