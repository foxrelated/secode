 ...
 * @version    $Id: add-featured-editor.tpl 6590 2014-01-02 00:00:00Z SocialEngineAddOns $
...
<script type="text/javascript">
    en4.core.runonce.add(function() {
        var contentAutocomplete = new Autocompleter.Request.JSON('editor_title', '<?php echo $this->url(array('module' => 'siteevent', 'controller' => 'admin-editors', 'action' => 'get-member', 'featured_editor' => 1), 'default', true) ?>', {
            'postVar': 'text',
            'minLength': 1,
            'selectMode': 'pick',
