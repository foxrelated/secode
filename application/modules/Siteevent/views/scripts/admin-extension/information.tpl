 ...
 * @version    $Id: information.tpl 6590 2014-01-02 00:00:00Z SocialEngineAddOns $
...
<h3><?php echo $this->translate('Advanced Events Extensions Information'); ?></h3>
...
<?php echo $this->content()->renderWidget('siteevent.extension-information') ?>