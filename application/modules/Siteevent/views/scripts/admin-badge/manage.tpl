...
<?php if (count($this->paginator->getTotalItemCount())): ?>	
    <?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'siteevent', 'controller' => 'badge', 'action' => 'create'), $this->translate('Add New Badge'), array('class' => 'buttonlink smoothbox', 'style' => 'background-image: url('.$this->layout()->staticBaseUrl.'application/modules/Siteevent/externals/images/badge.png);')) ?>
    <br /><br />
<?php endif; ?>
...
<?php if ($this->paginator->getTotalItemCount()): ?>	
    ...
    <div class="admin_files_wrapper siteevent_manage_wrapper">
                            ...
                            foreach ($this->paginator as $item): $i = 0;
                                ...
                                <tr>
                                            ...
                                            <?php if (!empty($main_path)): ?>
                                                <li class="admin_file admin_file_type_image" id="<?php echo $id ?>">
                                                    ...
                                                    <div class="admin_file_preview admin_file_preview_image" style="display:none;">
                                                        <?php echo '<img src="' . $main_path . '" class="photo siteevent_img_pre" />'; ?>
                                                    </div>
                                                </li>
                                            <?php endif; ?>
                                        <?php endif; ?>
                                    ...
                                    <td width="10%" class="admin_table_options">
                                        <?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'siteevent', 'controller' => 'badge', 'action' => 'edit', 'id' => $item->badge_id), $this->translate('edit'), array('class' => 'smoothbox')) ?>
                                        | 
                                        <?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'siteevent', 'controller' => 'badge', 'action' => 'delete', 'id' => $item->badge_id), $this->translate('delete'), array('class' => 'smoothbox')) ?>
                                    </td>
...
<?php else: ?>
    <div class="tip">
        <span>
            <?php
            echo $this->translate('You have not created any badges yet. Get started by ') . $this->htmlLink(array(
                'route' => 'admin_default', 'module' => 'siteevent', 'controller' => 'badge', 'action' => 'create'
