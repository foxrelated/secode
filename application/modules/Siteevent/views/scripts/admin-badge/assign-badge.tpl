 ...
 * @version    $Id: assign-badge.tpl 6590 2014-01-02 00:00:00Z SocialEngineAddOns $
 * @author     SocialEngineAddOns
 */
?>

<?php if (Count($this->badgeData)): ?>
    <div class="settings siteevent_assign_badge_list_popup">
        <form method="post" class="global_form">
            <div>
                ...
                <ul class="siteevent_assign_badge_list">
                    <?php foreach ($this->badgeData as $item): ?>
                        <?php if ($this->previous_badge_id == $item->badge_id): ?>
                            ...
                            if (!empty($item->badge_main_id)) {
                                ...
                                if (!empty($thumb_path)) {
                                    echo '<center><img src="' . $thumb_path . '" />';
                                    ?></center> <?php
                                    ;
                                }
                            }
                    ...
                    <?php if ($this->previous_badge_id): ?>
                        <li>
                        <center class="siteevent_assign_badge_list_tip_wrapper">
                            <img src="<?php echo $this->layout()->staticBaseUrl ?>application/modules/Siteevent/externals/images/remove_badge_icon.png" />
                            <div class="siteevent_assign_badge_list_tip">
                        ...
                        <div class="badge_name siteevent_assign_badge_list_tip_wrapper">
            ...
            <div class="tip">
                <span>
                    ...
                    echo $this->translate('You have not created any badges yet. Get started by ') . $this->htmlLink(array(
                        'route' => 'admin_default', 'module' => 'siteevent', 'controller' => 'badge', 'action' => 'manage'
