...
<p>
    <?php echo $this->translate('This page lists all the reviews posted by members and editors of your site. Here, you can monitor reviews, delete them. Entering criteria into the filter fields will help you find specific review entries. Leaving the filter fields blank will show all the review entries on your social network. Here, you can also make reviews featured / un-featured by clicking on the corresponding icons.'); ?>
</p>
...
<script type="text/javascript">
    ...
    {
        return confirm('<?php echo $this->string()->escapeJavascript($this->translate("Are you sure you want to delete selected Event reviews ?")) ?>');
    }
        ...
        <form method="post" class="global_form_box" action="">
            ...
            <div>
                ...
                <select id="" name="review_type">
                    ...
                    if ($this->review_type == 'user')
                        echo "selected";
                    ?> ><?php echo $this->translate("User") ?></option>
                    <option value="visitor" <?php
                            if ($this->review_type == 'visitor')
                                echo "selected";
                            ?> ><?php echo $this->translate("Visitor") ?></option>
                    <option value="editor" <?php
                    if ($this->review_type == 'editor')
                        echo "selected";
                            ?> ><?php echo $this->translate("Editor") ?></option>
                </select>
            </div>
...
<?php echo $this->translate("Email") ?>
            ...
            <div>
                <label>
<?php echo $this->translate("Event Title") ?>
                </label>
                <input type="text" name="event_title" value="<?php echo $this->event_title; ?>"/>
            </div>   
...
<br />
        <?php $reviewHelpful = Engine_Api::_()->getDbtable('helpful', 'siteevent'); ?>
            ...
            <table class='admin_table seaocore_admin_table'>
                <thead>
                    <tr>
                        ...
                        <th align="left" title="<?php echo $this->translate('Event Title'); ?>"><a href="javascript:void(0);" onclick="javascript:changeOrder('event_title', 'ASC');"><?php echo $this->translate('Event Title'); ?></a></th>
    ...
    <?php if (count($this->paginator)): ?>
        <?php foreach ($this->paginator as $item): ?>
                                <?php $editor_content_id = Engine_Api::_()->siteevent()->existWidget('editor_reviews_siteevent', 0); ?>
                            <tr>
                                ...
                                <?php if ($item->type == 'user' || $item->type == 'visitor'): ?>
                                    ...
                                    <?php elseif ($item->type == 'editor'): ?>
                                        <td class='admin_table_bold'><?php echo $this->htmlLink($this->item('siteevent_event', $item->resource_id)->getHref() . '/tab/' . $editor_content_id, Engine_Api::_()->seaocore()->seaocoreTruncateText($item->title, 10), array('title' => $item->title, 'target' => '_blank')) ?>  </td>
                                    <?php endif; ?>
                                ...
                                <td class='admin_table_bold'><?php echo $this->htmlLink($this->item('siteevent_event', $item->resource_id)->getHref(), Engine_Api::_()->seaocore()->seaocoreTruncateText($item->event_title, 10), array('title' => $item->event_title, 'target' => '_blank')) ?></td>

                                            <?php if ($item->type == 'user') : ?>
                                    <td>
                                        <div>
                                            <span title="<?php echo $item->review_rating . $this->translate(' rating '); ?>">
                                    <?php echo $this->ShowRatingStarSiteevent($item->review_rating, 'user', 'big-star'); ?>
                                            </span>
                                        </div>
                                    </td>
            <?php elseif ($item->type == 'visitor'): ?>
                ...
                <?php echo $this->ShowRatingStarSiteevent($item->review_rating, 'user', 'big-star'); ?>
                                    ...
                                    <td>
                                        <div>
                                            <span title="<?php echo $item->review_rating . $this->translate('rating '); ?>">
                                    <?php echo $this->ShowRatingStarSiteevent($item->review_rating, 'editor', 'big-star'); ?>
                                            </span>
                                        </div>
                                    </td>
            <?php endif; ?>
                                ...
                                <?php if ($item->featured == 1): ?>
                                    <td align="center" class="admin_table_centered"> <?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'siteevent', 'controller' => 'review', 'action' => 'featured', 'review_id' => $item->review_id, 'resource_id' => $item->resource_id), $this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Seaocore/externals/images/featured.png', '', array('title' => $this->translate('Make Un-featured')))) ?> 
                                    </td>       
                                <?php else: ?>  
                                    <td align="center" class="admin_table_centered"> <?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'siteevent', 'controller' => 'review', 'action' => 'featured', 'review_id' => $item->review_id, 'resource_id' => $item->resource_id), $this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Seaocore/externals/images/unfeatured.png', '', array('title' => $this->translate('Make Featured')))) ?>
                                    </td>
                                <?php endif; ?>
            ...
            <?php else: ?>
                                    <td align="center" class="admin_table_centered"><span title="<?php echo $this->translate('No member marked this EVENT as helpful !'); ?>">---</span></td>
            <?php endif; ?>
                                ...
                                <td class="admin_table_centered" align="middle">					
                                    <?php if ($item->status == 0 && $item->type == 'visitor') : ?>
                                        <a class="smoothbox" href="<?php echo $this->url(array('module' => 'siteevent', 'controller' => 'review', 'action' => 'take-action', 'review_id' => $item->review_id), "admin_default", true); ?>"><span title="<?php echo $this->translate("Approval Pending"); ?>"><img src="<?php echo $this->layout()->staticBaseUrl ?>application/modules/Siteevent/externals/images/pending.png"/></span></a>
                                    <?php elseif ($item->status == 0 && $item->type == 'editor') : ?>
                                        <span title="<?php echo $this->translate("Draft"); ?>"><img src="<?php echo $this->layout()->staticBaseUrl ?>application/modules/Siteevent/externals/images/draft.png"/></span>
            ...
            <?php else: ?>
                                ...
                                <td class='admin_table_options' align="left">
                                    ...
                                    <?php if (empty($item->owner_id) && ($item->status != '1' && $item->status != '2' )): ?> 
                                        <?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'siteevent', 'controller' => 'review', 'action' => 'take-action', 'review_id' => $item->review_id), $this->translate('Take Action'), array('class' => 'smoothbox',)) ?>
                                        |
                            <?php endif; ?>
                            <?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'siteevent', 'controller' => 'review', 'action' => 'delete', 'review_id' => $item->review_id), $this->translate('Delete'), array('class' => 'smoothbox')) ?> 
                                </td>
                            </tr>
        <?php endforeach; ?>
            <?php endif; ?>
