...
<form method="post" class="global_form_popup">
    <div>
        <h3><?php echo $this->translate('Delete Diary?'); ?></h3>
        <p>
            <?php echo $this->translate('Are you sure that you want to delete this Diary? It will not be recoverable after being deleted.'); ?>
        </p>
        <br />
        <p>
