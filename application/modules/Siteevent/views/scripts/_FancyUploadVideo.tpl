 ...
 * @version    $Id: _FancyUploadVideo.tpl 6590 2014-01-02 00:00:00Z SocialEngineAddOns $
...
<script type="text/javascript">
    ...
    window.addEvent('domready', function() { // wait for the content
        ...
        up = new FancyUpload2($('demo-status'), $('demo-siteevent'), {// options object
...
?>',
             ...
             *
             * This example creates a siteevent of error elements directly in the file siteevent, which
             * hide on click.
             */
            ...
            onFileRemove: function(file) {
                ...
                var demositeevent = document.getElementById("demo-siteevent");
                var demosubmit = document.getElementById("upload-wrapper");
            ...
            onSelectSuccess: function(file) {
                $('demo-siteevent').style.display = 'block';
