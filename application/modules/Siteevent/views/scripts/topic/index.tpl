...
<div class="layout_middle">
    <div class="siteevent_siteevents_options">
        ...
        <?php
        if ($this->can_post) {
            echo $this->htmlLink(array('route' => "siteevent_extended", 'controller' => 'topic', 'action' => 'create', 'event_id' => $this->siteevent->getIdentity(), 'content_id' => $this->tab_selected_id), $this->translate('Post New Topic'), array('class' => 'buttonlink icon_siteevent_post_new'));
        }
        ?>
    </div>
