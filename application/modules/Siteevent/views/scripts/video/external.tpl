 ...
 * @version    $Id: external.tpl 6590 2014-01-02 00:00:00Z SocialEngineAddOns $
...
<div class='video_view_container' style="max-width: 500px;">
    <div class="video_view video_view_container">
        ...
        <div class="video_date">
            <?php
            echo $this->translate('Posted by %1$s on %2$s', $this->htmlLink($this->video->getParent(), $this->video->getParent()->getTitle()), $this->timestamp($this->video->creation_date)
            )
            ?>
