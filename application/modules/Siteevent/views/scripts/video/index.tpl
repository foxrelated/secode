...
<?php if ($this->canEdit): ?>
    ...
    <div id="box">
        <h3><?php echo $this->translate("Event Videos"); ?></h3>
        <div class="siteevent_video_add_options" >
            <p><?php echo $this->translate('You may add a video to your event either by choosing from your existing videos, or by posting a new video:') ?></p>
            <div>
        ...
        <div class="siteevent_video_add_source">
            <div id='search'>
                <form id='video_selected' method='post' action='<?php echo $this->url(array('action' => 'load', 'content_id' => $this->content_id, 'event_id' => $this->event_id), "siteevent_video_upload") ?>' class="global_form">
                    <div>
                        <div>
        ...
        <?php if (($this->current_count >= $this->quota) && !empty($this->quota)): ?>
            <div class="tip">
                <span>
                    ...
                    <?php echo $this->translate('If you would like to upload a new video, please %1$sdelete%2$s an old one first.', "<a href='$url'>", "</a>"); ?>
                </span>
            </div>
        <?php else: ?>
...
<script type="text/javascript">
    ...
    {
        var contentAutocomplete = new Autocompleter.Request.JSON('searchtext', '<?php echo $this->url(array('module' => 'siteevent', 'controller' => 'video', 'action' => 'suggest',), 'default', true) ?>', {
            'postVar': 'text',
            'minLength': 0,
            'selectMode': 'pick',
