 ...
 * @version    $Id: editorReviewElements.tpl 6590 2014-01-02 00:00:00Z SocialEngineAddOns $
...
<div class="form-wrapper" id="overall_rating">
    ...
    <div class="form-element">
        <ul id= 'rate_0' class='siteevent_eg_rating <?php echo $rating_value; ?>'  style="position:relative;">
