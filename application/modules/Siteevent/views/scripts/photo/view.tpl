...
<script type="text/javascript">
    ...
    en4.core.runonce.add(function() {
        taggerInstance = new Tagger('media_image_next', {
            ...
            'tagSiteeventElement': 'media_tags',
...
<h2>
    <?php echo $this->translate('%1$s ' . "&#187; Photos", $this->siteevent->getParent()->__toString()) ?>
</h2>

<div class='siteevent_photo_view'>
    <div class="siteevent_photo_nav">
        <div>
            <?php
            echo $this->translate('Picture %1$s of %2$s', $this->locale()->toNumber($this->image->getCollectionIndex() + 1), $this->locale()->toNumber($this->siteevent->count()))
            ?>
        </div>
        <?php if ($this->siteevent->count() > 1): ?>
            <div>
    ...
    <div class='albums_viewmedia_info siteevent_photo_info'>
        <div class='siteevent_photo_container' id='media_image_div'>
        ...
        <?php if ($this->image->getTitle()): ?>
            <div class="siteevent_photo_title">
                <?php echo $this->image->getTitle(); ?>
            </div>
        <?php endif; ?>

        <?php if ($this->image->getDescription()): ?>
            <div class="siteevent_photo_description">
                <?php echo $this->image->getDescription() ?>
            </div>
        <?php endif; ?>

        <div class="event_photo_tags" id="media_tags" class="tag_siteevent" style="display: none;">
            <?php echo $this->translate('Tagged:'); ?>
        </div>
        <div class="siteevent_photo_date">
            ...
            <?php if ($this->canEdit): ?>
                ...
                - <?php echo $this->htmlLink(array('route' => "siteevent_photo_extended", 'controller' => 'photo', 'action' => 'edit', 'photo_id' => $this->image->getIdentity(), 'format' => 'smoothbox'), $this->translate('Edit'), array('class' => 'smoothbox')) ?>

                - <?php echo $this->htmlLink(array('route' => "siteevent_photo_extended", 'controller' => 'photo', 'action' => 'remove', 'photo_id' => $this->image->getIdentity(), 'format' => 'smoothbox'), $this->translate('Delete'), array('class' => 'smoothbox')) ?>
            <?php endif; ?>
