...
<script type="text/javascript">
    ...
    function doDefaultRating(element_id, ratingparam_id, classstar) {
        ...
        $(element_id + '_' + ratingparam_id).getParent().getParent().className = 'siteevent_eg_rating ' + classstar;
        $('review_rate_' + ratingparam_id).value = $(element_id + '_' + ratingparam_id).getParent().id;
    }
</script>
...
<div class='layout_middle siteevent_editor_review_form'>
...
<?php include APPLICATION_PATH . '/application/modules/Siteevent/views/scripts/editorReviewElements.tpl'; ?>
