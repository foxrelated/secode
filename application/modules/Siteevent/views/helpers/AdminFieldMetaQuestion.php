 ...
 * @version    $Id: AdminFieldMeta1.php 6590 2014-01-02 00:00:00Z SocialEngineAddOns $
 * @author     SocialEngineAddOns
 */
class Siteevent_View_Helper_AdminFieldMetaQuestion extends Zend_View_Helper_Abstract {

    public function adminFieldMetaQuestion($map) {
        $meta = $map->getChild();

        if (!empty($map->option_id)) {
            $profileTypeLabel = Engine_Api::_()->siteevent()->getProfileTypeName($map->option_id);
        }
