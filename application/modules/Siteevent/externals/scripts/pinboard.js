/* $Id: pinboard.js 6590 2014-01-02 00:00:00Z SocialEngineAddOns Copyright 2013-2014 BigStep Technologies Pvt. Ltd. $ */
      ...
      onSuccess : function(responseTree, responseElements, responseHTML, responseJavaScript) {
        ...
        if(params.requestParams.contentpage==1){
          var elem=new Element('div',{
            id:'siteevent_board_wrapper_'+params.widgetId,
            'class':'siteevent_board_wrapper'
          }).inject(params.responseContainer);
          params.responseContainer.getElements('.siteevent_list_wrapper').inject(elem);
...
en4.srpinboard.comments = {
  ...
  loadComments : function(type, id, page,widget_id){
    en4.core.request.send(new Request.HTML({
      url : en4.core.baseUrl + 'siteevent/pin-board-comment/list',
      data : {
        format : 'html',
        type : type,
        id : id,
  ...
  submit:function(formElement,type,id,widget_id){
    ...
    en4.core.request.send(new Request.JSON({
      url : en4.core.baseUrl + 'siteevent/pin-board-comment/create',
      data : form_values,
      onSuccess : function(responseJSON) {
        en4.srpinboard.comments.setLayout();
  ...
  like : function(type, id, widget_id, comment_id) {
    en4.core.request.send(new Request.JSON({
      url : en4.core.baseUrl + 'siteevent/pin-board-comment/like',
      data : {
        format : 'json',
        type : type,
        id : id,
  ...
  unlike : function(type, id, widget_id, comment_id) {
    en4.core.request.send(new Request.JSON({
      url : en4.core.baseUrl + 'siteevent/pin-board-comment/unlike',
      data : {
        format : 'json',
        type : type,
        id : id,
