...
<?php if (count($this->categories)): ?>
    <ul class="siteevent_browse_side_category">
                ...
                <li>
                    <a href="javascript:show_subcat('<?php echo $category['category_id'] ?>')" id='button_<?php echo $category['category_id'] ?>' class="right_bottom_arrow">
                        <?php if ($this->category_id != $category['category_id']): ?>
                            <img alt=""  src='<?php echo $this->layout()->staticBaseUrl ?>application/modules/Siteevent/externals/images/bullet-right.png' border='0' id='img_<?php echo $category['category_id'] ?>'/>
                        <?php elseif ($this->subcategory_id != 0 && $this->category_id == $category['category_id']): ?>
                            <img alt="" src='<?php echo $this->layout()->staticBaseUrl ?>application/modules/Siteevent/externals/images/bullet-bottom.png' border='0' id='img_<?php echo $category['category_id'] ?>'/>
                    ...
                    <a <?php if ($this->category_id == $category['category_id']): ?>class="bold"<?php endif; ?> href='<?php echo $this->url(array('action' => $url_action, 'category_id' => $category['category_id'], 'categoryname' => Engine_Api::_()->getItem('siteevent_category', $category['category_id'])->getCategorySlug()), $categoryRouteName) ?>'>
                                ...
                                <li>
                                    <a href="javascript:show_subsubcat('<?php echo $subcategory['sub_cat_id'] ?>')" id='button_<?php echo $subcategory['sub_cat_id'] ?>' class="right_bottom_arrow">
                                        <?php if ($this->subcategory_id != $subcategory['sub_cat_id']): ?>
                                            <img alt=""  src='<?php echo $this->layout()->staticBaseUrl ?>application/modules/Siteevent/externals/images/bullet-right.png' border='0' id='img_<?php echo $subcategory['sub_cat_id'] ?>'/>
                                        <?php elseif ($this->subsubcategory_id != 0 && $this->subcategory_id == $subcategory['sub_cat_id']): ?>
                                            <img alt="" src='<?php echo $this->layout()->staticBaseUrl ?>application/modules/Siteevent/externals/images/bullet-bottom.png' border='0' id='img_<?php echo $subcategory['sub_cat_id'] ?>'/>
                                    ...
                                    <a <?php if ($this->subcategory_id == $subcategory['sub_cat_id']): ?>class="bold"<?php endif; ?>  href='<?php echo $this->url(array('action' => $url_action, 'category_id' => $category['category_id'], 'categoryname' => Engine_Api::_()->getItem('siteevent_category', $category['category_id'])->getCategorySlug(), 'subcategory_id' => $subcategory['sub_cat_id'], 'subcategoryname' => Engine_Api::_()->getItem('siteevent_category', $subcategory['sub_cat_id'])->getCategorySlug()), "siteevent_general_subcategory") ?>'>
                                        ...
                                        <?php if (isset($subcategory['tree_sub_cat'])): ?>
                                            <?php foreach ($subcategory['tree_sub_cat'] as $subsubcategory) : ?>
                                                <li>
                                                    ...
                                                    <a <?php if ($this->subsubcategory_id == $subsubcategory['tree_sub_cat_id']): ?>class="bold"<?php endif; ?>  href='<?php echo $this->url(array('action' => $url_action, 'category_id' => $category['category_id'], 'categoryname' => Engine_Api::_()->getItem('siteevent_category', $category['category_id'])->getCategorySlug(), 'subcategory_id' => $subcategory['sub_cat_id'], 'subcategoryname' => Engine_Api::_()->getItem('siteevent_category', $subcategory['sub_cat_id'])->getCategorySlug(), 'subsubcategory_id' => $subsubcategory['tree_sub_cat_id'], 'subsubcategoryname' => Engine_Api::_()->getItem('siteevent_category', $subsubcategory['tree_sub_cat_id'])->getCategorySlug()), "siteevent_general_subsubcategory") ?>'>
