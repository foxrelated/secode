...
$breadcrumb = array(
array("href"=>$this->url(array('action' => 'home'), "siteevent_general"),"title"=>$this->translate("Events Home"),"icon"=>"arrow-r"),
	...
	array("title"=>$this->htmlLink($this->siteevent->getHref(), $this->siteevent->getTitle()),"icon"=>"arrow-r"),
	array("href"=>$this->url(array('event_id' => $this->siteevent->event_id, 'slug' => $this->siteevent->getSlug(), 'tab' => $this->tab_id), 'siteevent_entry_view', true), "title" => "Reviews", "icon"=>"arrow-r"),
