...
<?php if ($this->viewer_id):?>
  ...
  <script type="text/javascript">
    sm4.core.runonce.add(function(){
      $('#rsvp_options input[type=radio]').bind('click', function(){
        ...
        $('#siteevent_radio_' + option_id).addClass("siteevent_radio_loading");
        $.ajax({
          type: "POST", 
          dataType: "json", 
          ...
          $('#siteevent_radio_' + option_id).removeClass("siteevent_radio_loading").addClass("siteevent_radio");
        });
      });
    });
  </script>
  ...
  <div data-role="collapsible" id="collapsible" data-mini="true" data-collapsed='false'>
    ...
    <form class="siteevent_rsvp_form" action="<?php echo $this->url() ?>" method="post" onsubmit="return false;">
