...
<script type="text/javascript">
  ...
  function videoRate(rating,video_id) {
    ...
    sm4.core.request.send({
      ...
      'data': {
        ...
        'rating': rating,
        'video_id' : video_id,
        'event_id': <?php echo $this->video->event_id; ?>
      },
      beforeSend: function() {
  ...
  sm4.core.runonce.add(function() { 
    ...
    $.mobile.activePage.data('event_id',<?php echo $this->video->event_id; ?>);
    set_rating();
  });
...
$breadcrumb = array(
    ...
    array("href"=>$this->siteevent->getHref(array('tab' => $this->tab_selected_id)),"title"=>"Videos","icon"=>"arrow-r"),
			...
			<div class="sm-ui-cont-cont-date">
				...
				<?php if (count($this->videoTags )):?>
					...
					<?php  foreach ($this->videoTags as $tag): ?>
						...
						<?php if(!empty($tag->getTag()->text)):?>#<?php endif;?><?php echo $tag->getTag()->text?>&nbsp;
				<?php endforeach; ?>
				<?php  endif; ?>
			</div>
			<div class="sm-ui-cont-cont-date">
