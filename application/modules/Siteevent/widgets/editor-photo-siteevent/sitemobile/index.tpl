...
<?php if (in_array('emailMe', $this->showContent) && !$this->user->isSelf($this->viewer()) && $this->user->email): ?>
	<div class="seaocore_profile_cover_buttons">
		<table cellpadding="2" cellspacing="0" style="width:100%">
			<tr>
				<td>
					<a href ="<?php echo $this->url(array('action' => 'editor-mail','user_id' =>$this->user->user_id), 'siteevent_editor_general', true);?>"  data-role='button' data-inset='false' data-mini='true' data-corners='false' data-shadow='true'>
