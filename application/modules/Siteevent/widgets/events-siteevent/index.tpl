...
<?php if( !empty($this->titleLink) && ($this->titleLinkPosition == 'top') ) : ?>
  <span class="siteevent_top_link">
...
<?php if ($this->is_ajax_load): ?>
    ...
    <?php else: ?>
                ...
                <li class="siteevent_grid_view" style="width: <?php echo $this->columnWidth; ?>px;height:<?php echo $this->columnHeight; ?>px;">
                    <div class="siteevent_grid_thumb">
                        ...
                        <a href="<?php echo $siteevent->getHref(array('showEventType' => $this->showEventType)) ?>" class ="siteevent_thumb">
                            ...
                            $url = $siteevent->getPhotoUrl($isLarge ? $photo_type : $photo_type);
        ...
        <?php if( !empty($this->titleLink) && ($this->titleLinkPosition == 'bottom') ) : ?>
          <span class="siteevent_bottom_link">
            <?php echo $this->titleLink; ?>
          </span>
        <?php endif; ?>
    <?php endif; ?>
<?php else: ?>
    ...
    <div id="layout_siteevent_events_siteevent_<?php echo $this->identity; ?>">
    ...
    <script type="text/javascript">
        ...
        var params = {
            ...
            'responseContainer': 'layout_siteevent_events_siteevent_<?php echo $this->identity; ?>',
