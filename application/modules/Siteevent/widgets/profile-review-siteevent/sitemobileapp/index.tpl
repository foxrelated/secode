...
<div class="ui-page-content">
  <div class="sm-ui-cont-head">
    ...
    <div class="sm-ui-cont-cont-info">
      ...
      <div class="sm-ui-cont-cont-date">
        ...
        <?php echo $this->htmlLink($this->siteevent->getHref(array('profile_link' => 1)), $this->siteevent->getTitle()) ?>
      </div>
      <div class="sm-ui-cont-cont-date">
    ...
    <td class="rating-title">
        ...
        <?php if(!empty($reviewcat['ratingparam_name'])): ?>
          <div class="review_cat_rating">
            <?php echo $this->showRatingStarSiteeventSM($reviewcat['rating'], 'user', 'small-box', 1, $reviewcat['ratingparam_name']);?>
          </div>
        <?php else:?>
          <div class="review_cat_rating">
           <?php echo $this->showRatingStarSiteeventSM($reviewcat['rating'], $review->type, 'big-star', 1); ?>
          </div>
        <?php endif;?>
        </td>
      </tr>
  ...
  <section>
    ...
    <div class="sr_reviews_listing_info">
        ...
        <?php
        include APPLICATION_PATH . '/application/modules/Siteevent/views/sitemobile/scripts/_formReplyReview.tpl';
        ?> 
      </div>
</div>
</div>
