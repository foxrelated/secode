...
class Siteevent_Widget_ExtensionUpgradeController extends Engine_Content_Widget_Abstract
{
  public function indexAction()
  {
    ...
    $includeModules = array("siteeventdocument" => "Document", "siteeventemail" => "Email", "siteeventinvite" => "Inviter", "siteeventrepeat" => "Repeat Email");            
    ...
    $key_firld = NULL;
		switch($product_type) {
			...
			break;
			case 'contacteventowners':
			  $name = 'siteeventadmincontact';
			break;
			case 'siteeventshorturl':
			  $name = 'Siteeventurl';
			break;
			default:
				$name = $product_type;
