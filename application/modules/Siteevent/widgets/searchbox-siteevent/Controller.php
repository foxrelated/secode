 ...
 */
class Siteevent_Widget_SearchboxSiteeventController extends Engine_Content_Widget_Abstract {
    ...
    public function indexAction() {
        ...
        //PREPARE FORM
        $this->view->form = $form = new Siteevent_Form_Searchbox(array('widgetSettings' => $widgetSettings));
