...
<?php else: ?>
    ...
    <div id="layout_siteevent_related_events_view_siteevent_<?php echo $this->identity; ?>">
    ...
    <script type="text/javascript">
        ...
        var params = {
            ...
            'responseContainer': 'layout_siteevent_related_events_view_siteevent_<?php echo $this->identity; ?>',
