...
<script language="JavaScript">
    ...
    function saveAbout()
    {
        ...
        en4.core.request.send(new Request.HTML({
            url: en4.core.baseUrl + 'siteevent/index/display',
            data: {
                format: 'html',
                strr: str_temp,
...
<?php if ($this->isOwner): ?>
    <div class="siteevent_write_about">
        <div id="write">
        ...
        <div class="des_edit b_medium" style='display:none;' id="id_saveimage">
            <center>
                <img src="<?php echo $this->layout()->staticBaseUrl ?>application/modules/Siteevent/externals/images/loading.gif" alt="" />
            </center>
        </div>
    </div>
