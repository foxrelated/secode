 ...
 */
class Siteevent_View_Helper_FieldValueLoopQuickInfoSiteevent extends Fields_View_Helper_FieldAbstract {

    public function fieldValueLoopQuickInfoSiteevent($subject, $partialStructure, $itemCount = 5) {
