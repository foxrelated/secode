 ...
 * @version    $Id: ShowRatingStarSiteevent.php 2013-09-02 00:00:00Z SocialEngineAddOns $
 * @author     SocialEngineAddOns
 */
class Siteevent_View_Helper_ShowRatingStarSiteeventSM extends Zend_View_Helper_Abstract {
   ...
   * @return string
   */
  public function showRatingStarSiteeventSM($rating, $type='user', $sizeType='small-star', $html_title=null, $isCompare = false) { 
    ...
    return $this->view->partial(
                    '_showRatingStar.tpl', 'siteevent', $data
    );
  }
