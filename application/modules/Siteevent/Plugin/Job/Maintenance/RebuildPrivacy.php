 ...
 * @version    $Id: RebuildPrivacy.php 6590 2014-01-02 00:00:00Z SocialEngineAddOns $
 * @author     SocialEngineAddOns
 */
class Siteevent_Plugin_Job_Maintenance_RebuildPrivacy extends Core_Plugin_Job_Abstract {

    protected function _execute() {
        // Start custom prepare
        $table = Engine_Api::_()->getItemTable('siteevent_video');
        $auth = Engine_Api::_()->authorization()->context;
        $roles = array('leader', 'owner', 'owner_member', 'owner_member_member', 'owner_network', 'registered', 'everyone');
