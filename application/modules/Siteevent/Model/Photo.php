 ...
 * @version    $Id: Photo.php 6590 2014-01-02 00:00:00Z SocialEngineAddOns $
 * @author     SocialEngineAddOns
 */
class Siteevent_Model_Photo extends Core_Model_Item_Collectible {

    protected $_parent_type = 'siteevent_album';
    protected $_owner_type = 'user';
    protected $_searchColumns = array("");
    protected $_collection_type = 'siteevent_album';
    ...
    public function getHref($params = array()) {
        ...
        $params = array_merge(array(
            'route' => "siteevent_image_specific",
            'reset' => true,
    ...
    protected function _postDelete() {
        ...
        try {
            ...
            if (($album instanceof Core_Model_Item_Collection) && ($nextPhoto instanceof Core_Model_Item_Collectible) &&
                ...
                $album->save();
                $subject_siteevent = Engine_Api::_()->getItem('siteevent_event', $this->event_id);
                $subject_siteevent->photo_id = $nextPhoto->file_id;
                $subject_siteevent->save();
                $subject_siteevent->updateAllCoverPhotos();
            } elseif (($album instanceof Core_Model_Item_Collection) && (int) $album->photo_id == (int) $this->file_id) {
                Engine_Api::_()->getItemTable('siteevent_event')->update(array('photo_id' => 0), array('photo_id = ?' => $this->file_id, 'event_id = ? ' => $this->event_id));
                Engine_Api::_()->getItemTable('siteevent_album')->update(array('photo_id' => 0), array('photo_id = ? ' => $this->file_id, 'album_id = ? ' => $this->album_id));
            }
        } catch (Exception $e) {
