 ...
 * @version    $Id: Helpful.php 6590 2014-01-02 00:00:00Z SocialEngineAddOns $
 * @author     SocialEngineAddOns
 */
class Siteevent_Model_DbTable_Helpful extends Engine_Db_Table {

    /**
     * Get previous helpful answer
     * @param int $review_id : siteevent id
    ...
    public function setHelful($review_id, $owner_id, $helpful) {
        ...
        Engine_Api::_()->getDbtable('reviews', 'siteevent')->update(array(
