 ...
 * @version    $Id: Editors.php 6590 2014-01-02 00:00:00Z SocialEngineAddOns $
 * @author     SocialEngineAddOns
 */
class Siteevent_Model_DbTable_Editors extends Engine_Db_Table {

    protected $_rowClass = 'Siteevent_Model_Editor';
    ...
    public function getEditorsEvent($params = null) {
     ...
     * @return Editors Ids
     */
    public function getAllEditors($user_id = 0, $email_notify = 0) {
