 ...
 * @version    $Id: MetaReview.php 6590 2014-01-02 00:00:00Z SocialEngineAddOns $
 * @author     SocialEngineAddOns
 */
class Siteevent_Model_DbTable_MetasReview extends Engine_Db_Table {

    protected $_name = 'siteevent_review_fields_meta';
    ...
    public function getProfileFieldsReview($map_id) {
        ...
        $maptable = Engine_Api::_()->getDBTable('mapsReview', 'siteevent');
