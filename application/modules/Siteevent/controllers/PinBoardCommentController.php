 ...
 * @version    $Id: PinBoardCommentController.php 6590 2014-01-02 00:00:00Z SocialEngineAddOns $
 * @author     SocialEngineAddOns
 */
class Siteevent_PinBoardCommentController extends Core_Controller_Action_Standard {
    ...
    public function createAction() {
        ...
        try {
            ...
            $action = $activityApi->addActivity($viewer, $subject, 'comment_' . $subject->getType(), '', array(
                ...
                'body' => $body,
                'eventtype' => $subject->getShortType(),
            ));
...
//      }
        ...
        $this->view->body = $this->view->action('list', 'pin-board-comment', 'siteevent', array(
            'type' => $this->_getParam('type'),
