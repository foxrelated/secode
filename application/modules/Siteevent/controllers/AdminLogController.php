 ...
 * @version    $Id: AdminLogController.php 6590 2014-01-02 00:00:00Z SocialEngineAddOns $
 * @author     SocialEngineAddOns
 */
class Siteevent_AdminLogController extends Core_Controller_Action_Admin {
    ...
    public function indexAction() {
        ...
        foreach (scandir($logPath) as $file) {
            if ($file == 'EventToSiteeventImport.log') {
        ...
        $this->view->formFilter = $formFilter = new Siteevent_Form_Admin_Import_Log();
