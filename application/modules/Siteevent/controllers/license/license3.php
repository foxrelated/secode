						...
						foreach($explode_base_url as $url_key) {
							if($url_key != 'install') {
								$core_final_url .= $url_key . '/';
                                                        ...
                                                        $final_url_2 = 'http://' . $core_final_url . 'index.php/admin/seaocore/module/index/type/' . $PRODUCT_TYPE . '/call_from/' . $calling_from . '/plugin_title/' . @base64_encode($PRODUCT_TITLE);
							$final_url_1 = 'http://' . $core_final_url . 'admin/seaocore/module/index/type/' . $PRODUCT_TYPE . '/call_from/' . $calling_from . '/plugin_title/' . @base64_encode($PRODUCT_TITLE);
