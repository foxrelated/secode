 ...
 * @version    $Id: AdminEditorsController.php 6590 2014-01-02 00:00:00Z SocialEngineAddOns $
 * @author     SocialEngineAddOns
 */
class Siteevent_AdminEditorsController extends Core_Controller_Action_Admin {

    public function manageAction() {

        //GET NAVIGATION
        $this->view->navigation = Engine_Api::_()->getApi('menus', 'core')
                ->getNavigation('siteevent_admin_main', array(), 'siteevent_admin_main_editors');
        ...
        //GET EDITOR TABLE
        $this->view->tableEditor = $tableEditor = Engine_Api::_()->getDbtable('editors', 'siteevent');
    ...
    public function createAction() {
        ...
        //FORM
        $this->view->form = $form = new Siteevent_Form_Admin_Editors_Create();
        ...
        if ($this->getRequest()->isPost() && $form->isValid($this->getRequest()->getPost())) {
            ...
            //GET EDITORS TABLE
            $tableEditor = Engine_Api::_()->getDbTable('editors', 'siteevent');
            ...
            try {
                ...
                Engine_Api::_()->getApi('mail', 'core')->sendSystem($newEditor->email, 'SITEEVENT_EDITOR_ASSIGN_EMAIL', array(
            ...
            return $this->_helper->redirector->gotoRoute(array('module' => 'siteevent', 'controller' => 'editors', 'action' => 'manage'), "admin_default", true);
        }
    }
    ...
    function getMemberAction() {
        ...
        //FETCH USER LIST
        $userLists = Engine_Api::_()->getDbTable('editors', 'siteevent')->getMembers($text, $limit, $featured_editor);
    ...
    public function editAction() {
        ...
        //GENERATE FORM
        $this->view->form = $form = new Siteevent_Form_Admin_Editors_Edit(array('item' => $editor));
        ...
        if ($this->getRequest()->isPost() && $form->isValid($this->getRequest()->getPost())) {
            ...
            try {
                ...
                foreach ($previousIds as $previousId) {
                    ...
                    $tableEditor->delete(array('user_id = ?' => $editor->user_id));
                }
    ...
    public function addAction() {
        ...
        //GENERATE FORM
        $this->view->form = $form = new Siteevent_Form_Admin_Editors_Add();
        $form->populate($editor->toArray());
    ...
    public function deleteAction() {
        ...
        //GET FORM
        $this->view->form = $form = new Siteevent_Form_Admin_Editors_Map();
            ...
            try {
                ...
                foreach ($form->getValues() as $key => $value) {
                    ...
                    $select = $reviewTable->select()
                            ...
                            ->joinInner($eventTableName, "$reviewTableName.resource_id = $eventTableName.event_id", array())
                    ...
                    if (!empty($value)) {
                        foreach ($reviews as $review) {
                            ...
                            Engine_Api::_()->getDbTable('ratings', 'siteevent')->update(array('user_id' => $value), array('review_id = ?' => $review->review_id, 'type' => 'editor'));
                        }
                    } else {
                        foreach ($reviews as $review) {
                            Engine_Api::_()->getItem('siteevent_review', $review->review_id)->delete();
                        }
                    }
