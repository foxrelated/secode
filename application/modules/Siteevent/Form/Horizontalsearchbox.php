 ...
 */
class Siteevent_Form_Searchbox extends Engine_Form {
    ...
    public function init() {
        ...
        $this->setAction($view->url(array('action' => 'index'), "siteevent_general", true))->getDecorator('HtmlTag');
        ...
        if (!empty($this->_widgetSettings['formElements']) && in_array('locationElement', $this->_widgetSettings['formElements']) && Engine_Api::_()->getApi('settings', 'core')->getSetting('siteevent.location', 1)) {
        ...
        if (!empty($this->_widgetSettings['formElements']) && in_array('categoryElement', $this->_widgetSettings['formElements']) && !empty($this->_widgetSettings['categoriesLevel'])) {
            $categories = Engine_Api::_()->getDbTable('categories', 'siteevent')->getCategoriesHavingNoChield($this->_widgetSettings['categoriesLevel'], $this->_widgetSettings['showAllCategories']);
        ...
        if (!empty($this->_widgetSettings['formElements']) && in_array('linkElement', $this->_widgetSettings['formElements'])) {
            ...
            $url = $view->url(array('action' => 'index'), "siteevent_general");
