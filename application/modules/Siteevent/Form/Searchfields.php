 ...
 * @version    $Id: Searchfields.php 6590 2014-01-02 00:00:00Z SocialEngineAddOns $
 * @author     SocialEngineAddOns
 */
class Siteevent_Form_Searchfields extends Engine_Form {
    ...
    public function generate() {
        ...
        if ($this->_fieldType == 'siteevent_review') {
            $profile_type = 'profile_type_review';
        } elseif ($this->_fieldType == 'siteevent_event') {
        ...
        $structure = Engine_Api::_()->siteevent()->getFieldsStructureSearch($this->_fieldType, $this->_topLevelId, $this->_topLevelValue, true, $profileTypeIds);
