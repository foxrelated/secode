...
class Ynlistings_IndexController extends Core_Controller_Action_Standard {
	...
	public function placeOrderAction()
	{
		...
		if (!$listing)
		{
			$message = $this -> view -> translate('Please select listing!');
	...
	public function payCreditAction()
    {
		...
		{
			$params['module'] = 'ynlistings';
			$params['user_id'] = $order->user_id;
			$params['rule_name'] = 'publish_listing';
	...
	public function editAction()
	{
		...
		$this -> view -> location = $listing->location;
	...
	protected function _redirector($message = null) {
		...
		$this -> _forward('success', 'utility', 'core', array('parentRedirect' => Zend_Controller_Front::getInstance() -> getRouter() -> assemble(array(), 'ynlistings_general', true), 'messages' => array($message)));
	}
