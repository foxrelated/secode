    ...
    new Request.JSON({
        ...
        onComplete: function(responseJSON, responseText) {
            if (responseJSON.error) {
            	...
            	var parent = ele.getParent('.ynlisting_detail_layout');
            	var like_count_div = (parent) ? parent.getElement('.listing_like_count') : null;
            	var like_count = (like_count_div) ? parseInt(like_count_div.getElement('span.count').get('text')) : null;
                if (ele.className=="ynlistings_like") {
                    ...
                    if (like_count_div) {
                    	like_count++;
                    	var str = (like_count == 1) ? '<?php echo $this->translate('like')?>' : '<?php echo $this->translate('likes')?>';
                    	str = '<span class="count">'+like_count+'</span>' + ' ' + str;
                    	like_count_div.innerHTML = str;
                    }                   
                } else {    
            ...
            <div class="listing_category">
                ...
                <?php if($category) :?>
				 ...
				 <?php endif;?>
	         	 ...
	         	 <div class="listing_like_count">
	            	<?php echo $this->translate(array('<span class="count">%s</span> like', '<span class="count">%s</span> likes', $this->listing->like_count), $this->listing->like_count)?>
	             </div>
            </div>
...
<?php if ($this->listing->theme == 'theme1') : ?>
    ...
    <div class="ynlisting_style_1">
        ...
        <div class="ynlisting-detail-content">
			...
			<div class="listing_category_count">
	            <div class="listing_category">
	                <span class="fa fa-folder-open-o"></span>
	                 <?php $i = 0;  $category = $this->listing->getCategory();  ?>
	                 <?php if($category) :?>
...
<?php elseif ($this->listing->theme == 'theme2') : ?>
    ...
    <div class="ynlisting_style_2 clearfix">
        ...
        <script type="text/javascript">
            ...
            window.onload = function(){
                var theme_height = $$('.ynlisting_style_2')[0].getSize().y;
                // alert(theme_height);

                $$('.ynlisting_layout_theme2 .layout_core_content')[0].setStyles({
                    'height': theme_height,
                    'margin-top': -theme_height,
                });

                $$('.ynlisting_layout_theme2 .layout_middle').setStyle( 'padding-top', theme_height );
                $$('.ynlisting_layout_theme2 .layout_right').setStyle( 'padding-top', theme_height );
            };
...
<?php elseif ($this->listing->theme == 'theme3') : ?>
    ...
    <div class="ynlisting_style_3">
        ...
        <script type="text/javascript">
            ...
            window.onload = function(){
                var theme_height = $$('.ynlisting_style_3')[0].getSize().y;
                // alert(theme_height);

                $$('.ynlisting_layout_theme3 .layout_core_content')[0].setStyles({
                    'height': theme_height,
                    'margin-top': -theme_height,
                });

                $$('.ynlisting_layout_theme3 .layout_middle').setStyle( 'padding-top', theme_height );
                $$('.ynlisting_layout_theme3 .layout_right').setStyle( 'padding-top', theme_height );
            };
        ...
        <div class="listing_contact">
            ...
            <div class="listings-addthis-theme3">
            	<!-- Add-This Button BEGIN -->
				<div class="addthis_toolbox addthis_default_style">
				   <a class="addthis_button_google_plusone addthis_32x32_style"></a>
				   <a class="addthis_button_facebook_like" fb:like:layout="button_count"></a>
...
<script type="text/javascript">   
    ...
    $$('.layout_page_ynlistings_index_view .layout_main').addClass('ynlisting_layout_<?php echo $this->listing->theme; ?> <?php if ( defined("YNRESPONSIVE_ACTIVE")) echo YNRESPONSIVE_ACTIVE; ?>');
</script>
<?php endif; ?>