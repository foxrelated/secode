<?php return array(
    ...
    'routes' => array(
        ...
        'ynvideochannel_video' => array(
            ...
            'reqs' => array(
                'video_id' => '\d+',
                'action' => '(edit|delete|favorite|unfavorite|render-playlist-list|external|rate)', // all actions in VideoController
            )
        ),
        ...
        'ynvideochannel_channel' => array(
            ...
            'reqs' => array(
                'channel_id' => '\d+',
                'action' => '(edit|delete|subscribe|auto-update|add-more-videos|ajax-get-videos)', // all actions in ChannelController
            )
        ),
