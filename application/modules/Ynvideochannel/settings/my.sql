...
CREATE TABLE IF NOT EXISTS `engine4_ynvideochannel_channel_fields_maps` (
  `field_id` int(11) unsigned NOT NULL,
  `option_id` int(11) unsigned NOT NULL,
  `child_id` int(11) unsigned NOT NULL,
  `order` smallint(6) NOT NULL,
...
--
-- Dumping data for table `engine4_ynvideochannel_channel_fields_maps`
--

INSERT IGNORE INTO `engine4_ynvideochannel_channel_fields_maps` (`field_id`, `option_id`, `child_id`, `order`) VALUES
(0, 0, 1, 1);

-- --------------------------------------------------------

--
-- Table structure for table `engine4_ynvideochannel_channel_fields_meta`
--

CREATE TABLE IF NOT EXISTS `engine4_ynvideochannel_channel_fields_meta` (
  `field_id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `type` varchar(24) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
  `label` varchar(64) COLLATE utf8_unicode_ci NOT NULL,
  `description` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
...
--
-- Dumping data for table `engine4_ynvideochannel_channel_fields_meta`
--

INSERT IGNORE INTO `engine4_ynvideochannel_channel_fields_meta` (`field_id`, `type`, `label`, `description`, `alias`, `required`, `display`, `publish`, `search`, `order`, `config`, `validators`, `filters`, `style`, `error`) VALUES
(1, 'profile_type', 'Profile Type', '', 'profile_type', 1, 0, 0, 2, 999, '', NULL, NULL, NULL, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `engine4_ynvideochannel_channel_fields_options`
--

CREATE TABLE IF NOT EXISTS `engine4_ynvideochannel_channel_fields_options` (
  `option_id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `field_id` int(11) unsigned NOT NULL,
  `label` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `order` smallint(6) NOT NULL DEFAULT '999',
...
--
-- Table structure for table `engine4_ynvideochannel_channel_fields_search`
--

CREATE TABLE IF NOT EXISTS `engine4_ynvideochannel_channel_fields_search` (
  `item_id` int(11) unsigned NOT NULL,
  `profile_type` enum('1','4') COLLATE utf8_unicode_ci DEFAULT NULL,
  `first_name` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `last_name` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
...
--
-- Table structure for table `engine4_ynvideochannel_channel_fields_values`
--

CREATE TABLE IF NOT EXISTS `engine4_ynvideochannel_channel_fields_values` (
  `item_id` int(11) unsigned NOT NULL,
  `field_id` int(11) unsigned NOT NULL,
  `index` smallint(3) unsigned NOT NULL DEFAULT '0',
  `value` text COLLATE utf8_unicode_ci NOT NULL,
...
('comment_ynvideochannel_playlist', 'ynvideochannel', '{item:$subject} commented on {item:$owner}\'s {item:$object:video}: {body:$body}', 1, 1, 1, 1, 1, 0),
...
('ynvideochannel_processed', 'ynvideochannel', 'Your {item:$object:video} is ready to be viewed.', 0, '', 1),
('ynvideochannel_processed_failed', 'ynvideochannel', 'Your {item:$object:video} has failed to process.', 0, '', 1),
