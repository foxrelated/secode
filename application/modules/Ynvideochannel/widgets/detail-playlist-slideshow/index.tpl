<?php
    ...
    $this->headScript()->appendFile($staticBaseUrl . 'jquery-1.10.2.min.js')
        ->appendFile($staticBaseUrl . 'masterslider/jquery.easing.min.js')
        ->appendFile($staticBaseUrl . 'masterslider/masterslider.min.js')
...
<div id="ynvideochannel_playlist_slideshow" class="ms-videogallery-template  ms-videogallery-vertical-template">
    <div class="master-slider ms-skin-default" id="ynvideochannel_playlist_slideshow_masterslider">
        <a class="ynvideochannel_playbutton ynvideochannel_btn_playlist_pre" href="javascript:void(0)" onclick="ynvideochannelPrev();"><i class="fa fa-angle-left"></i></a>
        ...
        <a class="ynvideochannel_playbutton ynvideochannel_btn_playlist_next" href="javascript:void(0)" onclick="ynvideochannelNext();"><i class="fa fa-angle-right"></i></a>
        <div class="ynvideochannel_playlist_detail_actions">
            ...
            <span>
                <?php echo $this->translate(array('%1$s video', '%1$s videos', $playlist->video_count), $this->locale()->toNumber($playlist->video_count)) ?>
            </span>
        </div>
