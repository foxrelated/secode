    ...
    public function indexAction()
    {
        ...
        switch($type)
        {
            case "videos":
                ...
                $form->keyword->setAttrib('placeholder', 'Enter video name');
                break;
            case "channels":
                $form->keyword->setLabel('Search channel');
                $form->keyword->setAttrib('placeholder', 'Enter channel name');
                break;
            case "playlists":
                $form->keyword->setLabel('Search playlist');
                $form->keyword->setAttrib('placeholder', 'Enter playlist name');
                break;
        }
