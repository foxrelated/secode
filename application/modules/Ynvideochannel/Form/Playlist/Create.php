 ...
 */
class Ynvideochannel_Form_Playlist_Create extends Engine_Form {

    protected $_roles;

    public function init() {
        // Init form
        $this->setAttrib('name', 'ynvideochannel_playlist_create')
...
//                new Engine_Filter_HtmlSpecialChars(),
        ...
        $viewOptions = (array) Engine_Api::_()->authorization()->getAdapter('levels')->getAllowed('ynvideochannel_playlist', $viewer, 'auth_view');
        ...
        $commentOptions = (array) Engine_Api::_()->authorization()->getAdapter('levels')->getAllowed('ynvideochannel_playlist', $viewer, 'auth_comment');
