...
class Ynvideochannel_Form_Admin_Global extends Engine_Form
{
    ...
    public function init()
    {
        ...
        $this->addElement('Text', 'ynvideochannel_apikey', array(
            ...
            'description' => 'Please fill in the API key for parsing Youtube video',
        ...
        $this->addElement('Text', 'ynvideochannel_photo_size', array(
            'label' => 'Photo size',
            'description' => 'Maximum file size of photos upload in Kilobytes (KB). For unlimited add "0" without quotes',
            'value' => Engine_Api::_()->getApi('settings', 'core')->getSetting('ynvideochannel.photo.size', 0),
            'validators' => array(
                array('Float', true),
