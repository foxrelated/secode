...
* @version    $Id: _formButtonCancel.tpl 6590 2010-12-31 9:40:21Z SocialEngineAddOns $
...
<div id="submit-wrapper" class="form-wrapper">
  ...
  <div id="submit-element" class="form-element">
   ...
   <?php echo $this->htmlLink(array('route' => 'list_gernal', 'action' => 'manage'), $this->translate('cancel')) ?>
  </div>
</div>