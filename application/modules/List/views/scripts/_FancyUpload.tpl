...
* @version    $Id: _FancyUpload.tpl 6590 2010-12-31 9:40:21Z SocialEngineAddOns $
		...
		onFileStart: function() {
		  ...
		  file_id = file.photo_id;
                  ...
                  request = new Request.JSON({
                   'format' : 'json',
                   'url' : '<?php echo $this->url(Array('module' => 'list', 'controller' => 'photo', 'action' => 'remove'), 'default') ?>',
                   'data': {
                     'photo_id' : file_id,
                     'is_ajax' : 1
...
<div id="demo-status" class="hide">
  <div>
    <?php echo $this->translate('Click "Add Photos" to select one or more photos from your computer. After you have selected the photos, they will begin to upload right away. When your upload is finished, click the button below your photo list to save them to your listing.');?>
  </div>
  <div>
