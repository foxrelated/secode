...
* @version    $Id: editlocation.tpl 6590 2010-12-31 9:40:21Z SocialEngineAddOns $
...
<div class='layout_middle'>
	<h2><?php echo $this->translate('Edit Listing Location') ?></h2>
	<p>
		<?php echo $this->translate('Edit the location of your listing by clicking on Edit Listing Location below. You can accurately mark the position of your listing on the map by dragging-and-dropping the marker on the map at the right position, and then clicking on Save Changes to save the position.') ?>
	</p>
	<br />
			...
			<div class="global_form_box">
				<div>
					...
					<?php
						...
						'route' => 'list_specific',
						'action' => 'editaddress',
						'listing_id' => $this->list->listing_id
						), $this->translate('Edit Listing Location'), array(
						'class' => 'smoothbox icon_lists_map_edit buttonlink floatR'
						));
					?>
				</div>
			</div>
  ...
  <?php else: ?>
		<div class="tip">
			<span>
				<?php echo $this->translate('You have not added a Location for your listing. Click'); ?>
        <a  onclick="javascript:Smoothbox.open('<?php echo Zend_Controller_Front::getInstance()->getRouter()->assemble(array('action' => 'editaddress', 'listing_id' => $this->list->listing_id), 'list_specific', true) ?>');" href="javascript:void(0);"><?php echo $this->translate('here'); ?></a>
        <?php echo $this->translate('to add a location for your listing.'); ?>
      </span>
    </div>
  <?php endif; ?>
</div>
