...
* @version    $Id: partialloop.tpl 6590 2010-12-31 9:40:21Z SocialEngineAddOns $
...
<li>
  ...
  <div class='seaocore_sidebar_list_info'>
		...
		<div class='seaocore_sidebar_list_details'>    	
			<?php echo $this->translate(array('%s view', '%s views', $this->list->view_count), $this->locale()->toNumber($this->list->view_count)) ?>,
	    <?php echo $this->translate(array('%s like', '%s likes', $this->list->like_count), $this->locale()->toNumber($this->list->like_count)) ?>
    </div>
	</div>
</li>