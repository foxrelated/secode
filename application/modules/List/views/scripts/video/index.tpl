...
<div class="layout_middle">
    ...
    <div class="list_video_options" >
		...
		<div class="list_video_source">
			<div id='search'>
				<form id='video_selected' method='post' action='<?php echo $this->url(array('action' => 'load', 'content_id' => $this->content_id, 'listing_id' => $this->listing_id), 'list_video_upload') ?>' class="global_form">
					<div>
						<div>
						...
						<div class="form-elements">
							...
							<div class="form-wrapper" style="display: block;">
								...
								<div class="form-element">
									...
									<button type="submit" name="submit" class="mtop_10"><?php echo $this->translate('Continue &raquo;') ?></button>
								</div>
							</div>
						</div>
					</div>
...
<script type="text/javascript">
	...
	{
		var contentAutocomplete = new Autocompleter.Request.JSON('searchtext', '<?php echo $this->url(array('module' => 'list', 'controller' => 'video', 'action' => 'suggest'), 'default', true) ?>', {
			'postVar' : 'text',
			'minLength': 0,
			'selectMode': 'pick',
