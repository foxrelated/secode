...
* @version    $Id: AdminLogController.php 6590 2010-12-31 9:40:21Z SocialEngineAddOns $
* @author     SocialEngineAddOns
*/
class List_AdminLogController extends Core_Controller_Action_Admin {
  ...
  public function indexAction() {
    ...
    //MAKE FORM
		$csvImportVar = $this->view->translate('Listing Import From a CSV File');
    $labels = array(
        'CSVToListImport' => $csvImportVar,
    );
    ...
    $this->view->formFilter = $formFilter = new List_Form_Admin_Import_Log();
