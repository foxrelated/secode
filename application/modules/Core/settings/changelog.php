...
return array(
  '4.8.9' => array(
    'Controller/Action/Admin.php' => 'Fixed issue with "Language packs could not be converted to PHP Arrays." message',
    'controllers/AdminSettingsController.php' => 'Disabled display of values in form when _ENGINE_ADMIN_NEUTER mode is enabled',
    'controllers/PagesController.php' => 'Fixed issue with some pages url (like xxx-123, xxx-123-zzz) not working.',
    'settings/manifest.php' => 'Incremented version',
    'settings/my.sql' => 'Incremented version',
    'views/scripts/admin-themes/index.tpl' => 'Added type="submit" in Activate Theme button',
    'widgets/admin-statistics/index.tpl' => 'Hide license key in administration when _ENGINE_ADMIN_NEUTER mode is enabled.',
    'Bootstrap.php' => 'Added method: _initAdminNeuter',
    'externals/styles/admin/main.css' => ' Increase the width of the column that lists pages in Layout Editor'
  ),
  '4.8.8' => array(
    'Bootstrap.php' => 'Resolved notice of E_DEPRECATED appearing on websites having PHP version less than 5.3.0',
    'Controller/Action/Admin.php' => 'Fixed issue with PHP array file not being generated properly',
    'Model/Link.php' => 'Removed unnecessary "comments" and "likes" methods',
    'settings/manifest.php' => 'Incremented version',
    'settings/my.sql' => 'Incremented version',
  ),
  '4.8.7' => array(
