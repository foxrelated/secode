	...
	$.fn.sti = function( options ) {
		...
		var methods = {
			...
			shareData: function(el, network) {
				...
				data.page     =  opts.sharer + '?url=' + encodeURIComponent(data.link) + '&img=' + data.media.replace('https://','') + '&title=' + encodeURIComponent(methods.replaceChars(data.title)) + '&desc=' + encodeURIComponent(methods.replaceChars(data.summary)) + data.hash;				
				data.page2    =  opts.sharer + '?url=' + encodeURIComponent(data.link) + '&img=' + data.media.replace('https://','') + '&title=' + methods.replaceChars(data.title) + '&desc=' + methods.replaceChars(data.summary) + data.hash;
