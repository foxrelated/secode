...
var MiniCart = new Class({
    ...
    init: function () {
        ...
        $('core_menu_mini_menu_update').getChildren().addEvent('click', function () {
                if ($$('.store_mini_cart').hasClass('updates_pulldown_active')) {
                    $$('.store_mini_cart').removeClass('updates_pulldown_active').addClass('updates_pulldown');
                }
            }
        );
    ...
    toggle: function (event, element) {
        if ($('core_menu_mini_menu_update') && $('core_menu_mini_menu_update').getChildren().hasClass('updates_pulldown_active')) {
            $('core_menu_mini_menu_update').getChildren().removeClass('updates_pulldown_active').addClass('updates_pulldown');
        }
