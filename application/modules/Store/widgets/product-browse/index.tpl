 ...
 */
$this->headScript()
  ->appendFile($this->layout()->staticBaseUrl . 'application/modules/Store/externals/scripts/pinfeed.js');
?>
    ...
    <ul id="main_tabs">
      <li class="<?php if ($this->sort == 'recent') echo 'active'; ?>">
        <a class="store_sort_buttons" id="store_sort_recent"
           href="javascript:product_manager.setSort('recent');"><?php echo $this->translate("Recents") ?></a>
      </li>
      ...
      <li class="<?php if ($this->sort == 'sponsored') echo 'active'; ?>">
        <a class="store_sort_buttons" id="store_sort_sponsored"
           href="javascript:product_manager.setSort('sponsored');"><?php echo $this->translate("STORE_Sponsored Products") ?></a>
      </li>
      <li class="<?php if ($this->sort == 'featured') echo 'active'; ?>">
        <a class="store_sort_buttons" id="store_sort_featured"
           href="javascript:product_manager.setSort('featured');"><?php echo $this->translate("STORE_Featured Products") ?></a>
      </li>
...
<?php if ($this->count > 0) : ?>
  <div class="he-items" id="stores-items" style="display:<?php echo ($this->view == 'list') ? 'block' : 'none'; ?>;">
	...
	<span id="owner_product_show">
                  <?php
                      $subject = Engine_Api::_()->user()->getUser($item->owner_id);
                  ?>
            ...
            <div class="he-item-desc">
              <?php echo $this->viewMore(Engine_String::strip_tags($item->getDescription()), 300) ?>
            </div>
          </div>
