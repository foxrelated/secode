...
<span style="float: right; margin-top: -42px; margin-right: 40px;">
	<a href="/certified-items" class="buttonlink"><?php echo $this->translate('My Items want to be here') ?></a>
</span>

<span class="sponsored-product">
    <img src="application/modules/Store/externals/images/sponsoredBig.png" title="<?php echo $this->translate('STORE_Sponsored'); ?>">
  </span>
    ...
    <?php foreach ($this->products as $product): ?>
        <div class="item">
            ...
            <div class="content_info">
                ...
                <div class="descr">
                    <?php echo $this->string()->truncate(str_replace('<br />', ' ', $product->getDescription()), 300, '...'); ?>
                </div>
