...
return array(
  ...
  array(
    ...
    'description' => 'Displays products? similar to current. Put this widget on product profile page.',
    'category' => 'Store',
    'type' => 'widget',
    'name' => 'store.product-profile-similar',
    'isPaginated' => true,
    'defaultParams' => array(
      'title' => 'STORE_Similar Products',
      'titleCount' => true
    ),
    'requirements' => array(
      'no-subject'
  ...
  array(
    'title' => 'Product Profile Tags',
    'description' => 'Displays current product tags and allows to filter products by tags. Please put this widget on Product Profile page.',
    'category' => 'Store',
    'type' => 'widget',
    'name' => 'store.product-profile-tags',
    'defaultParams' => array(
      'title' => 'STORE_Product Profile Tags',
    )
  ),
  array(
    'title' => 'Product Description',
    'description' => 'Displays current product full description. Please put this widget on Product Profile page.',
    'category' => 'Store',
    'type' => 'widget',
    'name' => 'store.product-description',
    'defaultParams' => array(
      'title' => 'STORE_Product Description'
    )
  ),
  array(
    'title' => 'Items Widget',
    'description' => 'Displays the member\'s items in Profile page.',
    'category' => 'Store',
    'type' => 'widget',
    'name' => 'store.product-profile',
      ...
      array(
        'title' => 'Recent Items',
        'description' => 'Displays the Recent Items list in Home page.',
        'category' => 'Store',
        'type' => 'widget',
        'name' => 'store.product-recent',
        'defaultParams' => array(
            'title' => 'STORE_Recent',
        )
    ),
