...
class Store_Plugin_Core extends Zend_Controller_Plugin_Abstract
{
  ...
  public function onRenderLayoutDefault($event)
  {
    ...
    $view->headScript()->appendFile($view->layout()->staticBaseUrl . 'application/modules/Store/externals/scripts/quick_slider.js');
    $view->headScript()->appendFile($view->layout()->staticBaseUrl . 'application/modules/Store/externals/scripts/Zoomer.js');
    $view->layout()->content .= $view->render('application/modules/Store/views/scripts/product/_quick_view.tpl');
    ...
    $view->headTranslate(
      array('STORE_In Wishlist', 'STORE_Add to Wishlist', 'Loading ...')
    );
    $view->layout()->content .= $view->render('application/modules/Store/views/scripts/product/_details.tpl');
  }
}