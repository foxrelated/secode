...
class Store_Form_Admin_Products_Copy extends Engine_Form
{
  ...
  public function init()
  {
    ...
    $this
      ->setTitle('STORE_Copy Product')
      ->setDescription('You can copy product here, or <a href="'.$href.'">back</a> to the list of products.')
