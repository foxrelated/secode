 ...
 * @license    http://www.hire-experts.com
 */
class Store_Form_Page_Products_Create extends Engine_Form
{
    public function init()
    {
        ...
        if (get_class($this) == 'Store_Form_Page_Products_Create') {
      ...
      $fin[$it]=$row;
        ...
        // Element: Type
        if ($settings->getSetting('store.digital.product', 1)) {
            $types = array(
	...
	'label' => 'Photos'
	   ...
	   $this->addElement('TinyMce', 'description', array(
        ...
        //Currency
        //he@todo - currency is for to do for now
        ...
        $this->list_price
            ...
            ->addValidator('float', true, array('locale' => 'en_US'))
            ->addValidator('greaterThan', true, array('min' => 0))
            ->addValidator(new Engine_Validate_AtLeast($settings->getSetting('store.minimum.price', 0.15) + 0.01));
        $this->addElement($this->list_price);
