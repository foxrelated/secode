...
class Store_Form_Page_Products_Edit extends Engine_Form
{
...
// Element: Categories
  ...
  // Element: Quantity
    ...
    $this->addElement('Cancel', 'cancel', array(
      ...
      'class' => 'button',
      'style' => 'color: #FFF;',
      'href' => Zend_Controller_Front::getInstance()->getRouter()->assemble(array('module'=>'store', 'controller'=>'products'), 'store_panel', true),
      'decorators' => array(
        'ViewHelper',
      ),
    ));
