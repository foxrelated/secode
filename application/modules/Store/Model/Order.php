...
class Store_Model_Order extends Store_Model_Item_Abstract
{
    ...
    public function getDetails()
    {
        ...
        if ($this->item_type == 'store_cart' || $this->item_type == 'store_product') {
            ...
            foreach ($this->getItems() as $item) {
			    ...
			    " . $translate->_('Price') . ": OGV " . $item->item_amt . "
			    ...
			    " . $translate->_("Name") . " - " . $this->shipping_details['first_name'] . ' ' . $this->shipping_details['last_name'] . "
			    ...
			    " . $translate->_("Zip Code") . " - " . $this->shipping_details['zip'] . "
    ...
    {
        $name = $this->shipping_details['first_name'] . " " . $this->shipping_details['last_name'] . " " . $this->shipping_details['middle_name'];
        return $name;
    }
	
	public function getCountry() {
		if (isset($this->shipping_details) && isset($this->shipping_details['location_id_1']) && null != ($country = Engine_Api::_()->getDbTable('locations', 'store')->findRow($this->shipping_details['location_id_1']))) {
