 ...
 * @version    $Id: IpnController.php 2011-08-19 17:22:12 mirlan $
 * @author     Mirlan
 */
 ...
 * @license    http://www.hire-experts.com
 */
class Store_IpnController extends Core_Controller_Action_Standard
{
    public function __call($method, array $arguments)
    {
        ...
        // Log ipn
        $ipnLogFile = APPLICATION_PATH . '/temporary/log/store-payment-ipn.log';
        ...
        // Get gateways
        $gatewayTable = Engine_Api::_()->getDbtable('gateways', 'store');
