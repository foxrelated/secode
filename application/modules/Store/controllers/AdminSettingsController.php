...
class Store_AdminSettingsController extends Store_Controller_Action_Admin
{
    public function indexAction()
    {
        ...
        $values['new_shipping'] = (int)$settings->getSetting('store.new.shipping', 0);
        $values['free_products'] = (int)$settings->getSetting('store.free.products', 0);
        ...
        $settings->__set('store.new.shipping', $values['new_shipping']);
        $settings->__set('store.free.products', $values['free_products']);
