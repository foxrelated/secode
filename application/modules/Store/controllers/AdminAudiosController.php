...
class Store_AdminAudiosController extends Core_Controller_Action_Admin
{
    ...
    {
      if ($this->next) {
        $this->view->nextHref = $this->view->url(array('module' => 'store', 'controller' => 'audios', 'action' => 'edit-audio', 'product_id' => $this->next->getIdentity()));
      }
      if ($this->prev) {
        $this->view->prevHref = $this->view->url(array('module' => 'store', 'controller' => 'audios', 'action' => 'edit-audio', 'product_id' => $this->prev->getIdentity()));
      }
      $this->view->section_title = $this->view->translate('STORE_Admin Section Edit audio');
    ...
    public function createAudioAction()
    {
      ...
      if ($this->next) {
        $this->view->nextHref = $this->view->url(array('module' => 'store', 'controller' => 'audios', 'action' => 'create-audio', 'product_id' => $this->next->getIdentity()));
      }
      if ($this->prev) {
        $this->view->prevHref = $this->view->url(array('module' => 'store', 'controller' => 'audios', 'action' => 'create-audio', 'product_id' => $this->prev->getIdentity()));
      }
        $this->view->section_title = $this->view->translate('STORE_Admin Section Add audio');
