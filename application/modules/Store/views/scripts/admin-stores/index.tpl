...
<?php if ($this->isPageEnabled) : ?>
  ...
  <?php if ($storeCount) : ?>
    <table class='admin_table'>
      <thead>
        <tr>
          <th class='admin_table_short'><a href="javascript:void(0);" onclick="javascript:changeOrder('page_id', 'DESC');"><?php $this->translate("Store"); ?></a></th>
          ...
          <tr class="<?php if ($item->sponsored) echo "admin_featured_page"; ?>">
            <td>
              <div class="store-products-list-thumb"
                   style="background-image: url('<?php echo $item->getPhotoUrl(); ?>');">
            </td>
