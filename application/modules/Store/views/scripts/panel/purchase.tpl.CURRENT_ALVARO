...
<h3>
    ...
    &nbsp;<img src="/application/modules/Core/externals/images/next.png">&nbsp;<?php echo $this->translate('Purchase'); ?>
</h3>
...
<div class="profile_fields">
    ...
    <ul>
        <li>
            ...
            <span class="request-key"><?php echo $this->order->ukey ?></span>
        </li>
        <li>
            <span><?php echo $this->translate('Status'); ?>:</span>
            <span><?php echo $this->translate(ucfirst($this->order->status)); ?></span>
        </li>
    </ul>
    ...
    <ul>
      ...
      <span>
        <?php if (isset($this->gateway)): ?>
            <?php echo str_replace("Credit","OGV",$this->gateway->getTitle()); ?>
        <?php else: ?>
        	<?php if ($this->order->gateway_id == '99') :?>
        ...
        <li>
          ...
          <?php echo str_replace("US$","OGV",$this->locale()->toCurrency($this->order->item_amt, $this->order->currency)); ?>
        </span>
            <?php endif; ?>
        </li>
        <li>
          ...
          <span class="store-credit-price"><?php echo $this->api->getCredits($this->order->tax_amt); ?></span>
            ...
            <?php else : ?>
                <span class="store-price">
          <?php echo str_replace("US$","OGV",$this->locale()->toCurrency($this->order->tax_amt, $this->order->currency)); ?>
        </span>
            <?php endif; ?>
        </li>
        <li style="display: none;">
          ...
          <span class="store-credit-price"><?php echo $this->api->getCredits($this->order->shipping_amt); ?></span>
            ...
            <?php else : ?>
                <span class="store-price">
          <?php echo str_replace("US$","OGV",$this->locale()->toCurrency($this->order->shipping_amt, $this->order->currency)); ?>
        </span>
            <?php endif; ?>
        </li>
        <li>
          ...
          <span class="store-credit-price"><?php echo $this->api->getCredits($this->order->total_amt); ?></span>
            ...
            <?php else : ?>
                <span class="store-price">
          <?php echo str_replace("US$","OGV",$this->locale()->toCurrency($this->order->total_amt, $this->order->currency)); ?>
        </span>
            <?php endif; ?>
        </li>
    </ul>
        ...
        <ul>
            <?php if (isset($this->country)): ?>
                <li>
                    ...
                    <span><?php echo $this->translate($this->country->location); ?></span>
                </li>
            <?php endif; ?>
    ...
    <ul class="he-item-list">
        ...
        foreach ($this->items as $item): $product = $item->getItem();?>
            ...
            <span class="store-credit-price"><?php echo $this->api->getCredits($item->total_amt); ?></span>
                    ...
                    <?php else : ?>
                        <span class="store-price">
            <?php echo str_replace("US$","OGV",$this->locale()->toCurrency((double)$item->total_amt, $item->currency)); ?>
          </span>
                    <?php endif; ?>
                    <br/>
                ...
                <div class="he-item-info">
                    ...
                    <div class="he-item-details">
                        ...
                        <?php if ($product == null): ?>
                            <span class="store-item-removed"><?php echo $this->translate('STORE_Removed'); ?></span>
                            <br/>
                        <?php elseif ($product->isDigital()): ?>
                            ...
                            <b>
                                <?php if ($this->downloadCount <= 0): ?>  <?php echo $this->translate('STORE_Unlimited') ?>
                                    <?php ;
                                elseif (($count = ((int)($this->downloadCount - $item->download_count))) <= 0): ?><?php echo $this->translate('STORE_Over') ?>
                                    <?php ;
                                else: ?><?php echo $this->locale()->toNumber($count); ?><?php endif; ?>
                            </b>
                        <?php endif; ?>
                    </div>
                </div>
