...
<div class="layout_middle">
    ...
    <?php if (count($this->paginator) == 0): ?>
        <div class="tip">
            <span><?php echo $this->translate("There are no stores."); ?> <?php echo $this->htmlLink($this->url(array(), 'page_create'), $this->translate('STORE_Create Store')); ?>
                .</span>
        </div>
    <?php endif; ?>
                        ...
                        <div class="store_layoutbox_menu">
                            <ul>
                                ...
                                <?php if ($page->isOwner($this->viewer)) : ?>
                                    ...
                                    <li id="pages_layoutbox_menu_gateway">
                                        <?php echo $this->htmlLink($this->url(array('action' => 'gateway', 'page_id' => $page->page_id), 'store_settings', true), $this->translate('Gateway'), array('class' => 'buttonlink')); ?>
                                    </li>
                                    <li id="pages_layoutbox_menu_locations">
                                        <?php echo $this->htmlLink($this->url(array('controller' => 'locations', 'page_id' => $page->page_id), 'store_settings', true), $this->translate('Locations'), array('class' => 'buttonlink')); ?>
                                    </li>
