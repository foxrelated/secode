        ...
        <li id="store-cart-product-<?php echo $item->getIdentity(); ?>"
          ...
          <div class="he-item-options store-item-options">
            <div class="store-price-block">
              <?php
                if(in_array($product->getIdentity(), $this->bIds)) {
                  echo $this->getPrice($product, $item);
                } else {
              ...
              <div class="store-remove-from-cart">
                <?php echo $this->htmlLink(
                  'javascript:store_cart.product.remove(false, ' . $product->getIdentity() . ', ' . $item->getIdentity() . ')',
              ...
              <div class="store-checkout-from-cart">
              	<button onclick="window.location='<?php echo $this->url(array('product_id' => $product->getIdentity()),'store_checkout_product',true)?>';"><?php echo $this->translate("Confirm");?></button>
            	</div>
            </div>
