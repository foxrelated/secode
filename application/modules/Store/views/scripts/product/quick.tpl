...
<div class="quick-product-title">
  <h3>
    <a title="<?php echo $this->translate('Item Profile Page')?>" href="<?php echo $this->product->getHref(); ?>" alt="<?php echo $this->product->getTitle(); ?>">
			...
			<tr>
				...
				<a href="/profile/<?php echo($subject->username);?>" target="_blank" ><?php echo($subject->username);?>
                  ...
                  <?php if ($this->product->type == 'simple') : ?>
                    <tr class="quick-product-options" style="display: <?php echo (!$this->product->isAddedToCart()) ? '' : 'none'; ?>;">
                      <td>
                          <?php echo $this->translate('STORE_Quantity'); ?>:&nbsp;&nbsp;</td>
                      <td class="options">
                        <input type="text" name="quantity" id="quantity" onchange="quickToCart.check()" style="width: 53px" value="1">
                      </td>
                    </tr>
                    ...
                    <tr>
                      <td  class="options" id="add-to-cart-button" colspan="2">
                        <button
                          ...
                          <span
                            class="store-add-button product_button"><?php echo $this->translate('STORE_exchange'); ?></span>
                        </button>
...
<div style="clear: both;"></div>
	...
	<button name="cancel" id="cancel" type="button" href='javascript:void(0);' onclick='javascript:hideQuickViewWindow()'>
