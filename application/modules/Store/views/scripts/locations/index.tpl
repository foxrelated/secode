...
<div class="headline store">
    <h2><?php echo $this->translate('Locations'); ?></h2>
...
<div class="settings">
    <div class="settings-descr">
        <?php if ($this->isAdmin): ?>
            <a href="<?php echo $this->url(array('action' => 'index', 'admin' => 0)) ?>"
               style="text-decoration: none">
                <button>
                    <?php echo $this->translate("STORE_Use Store Locations"); ?>
                </button>
            </a>
            <p>
                <?php echo $this->translate('STORE_Use Admin Locations Description'); ?>
            </p>
        <?php else: ?>
            <a href="<?php echo $this->url(array('action' => 'index', 'admin' => 1)) ?>"
               style="text-decoration: none">
                <button>
                    <?php echo $this->translate("STORE_Use Admin Locations"); ?>
                </button>
            </a>
            <p>
                <?php echo $this->translate('STORE_Use Store Locations Description'); ?>
            </p>
        <?php endif; ?>
    </div>
    <br/>
    ...
    <?php if ($this->count > 0): ?>
        <table class='store-product-list locations'>
            ...
            <tr>
                ...
                <th class="center"><?php echo $this->translate("STORE_Shipping Tax") ?></th>
            ...
            <?php foreach ($this->paginator as $item): ?>
                <tr>
                    ...
                    <td class="center">
                        ...
                        <a href="<?php echo $this->url(array('action' => 'remove', 'location_id' => $item->getIdentity())); ?>"
                           class="smoothbox">
                        ...
                        <?php if ($this->parent_id === 0): ?>
                            <a href="<?php echo $this->url(array('controller' => 'locations',
                                ...
                                <img title="<?php echo $this->translate('STORE_Edit Sub-location') ?>"
                                     class="product-icon"
                                     src="application/modules/Store/externals/images/sub_location.png"></a>
                        <?php endif; ?>
                    </td>
                </tr>
            <?php endforeach; ?>
