            ...
            <ul>
                ...
                <?php if ($this->page->isOwner($this->viewer)) : ?>
                    ...
                    <li id="pages_layoutbox_menu_gateway">
                        <?php echo $this->htmlLink($this->url(array('action' => 'gateway', 'page_id' => $this->page->page_id), 'store_settings', true), $this->translate('Gateway')); ?>
                    </li>
                    <li id="pages_layoutbox_menu_locations">
                        <?php echo $this->htmlLink($this->url(array('controller' => 'locations', 'page_id' => $this->page->page_id), 'store_settings', true), $this->translate('Locations')); ?>
                    </li>
