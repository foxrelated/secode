...
<div id="demo-status" class="hide">
  <div>
    <?php echo $this->translate('STORE_UPLOAD_A_VIDEO_DESCRIPTION'); ?>
  </div>
  <div>
...
<div><br/>
  <a class="buttonlink" href="javascript://;" id="demo-upload"
     style='display:none; background-image: url(<?php echo $this->layout()->staticBaseUrl ?>application/modules/Store/externals/images/new_file.png);'><?php echo $this->translate('Post Video'); ?></a>
</div>
