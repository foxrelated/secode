...
<div class="layout_middle">
	...
	<h3><?php echo $this->htmlLink($this->url(array('action' => 'edit', 'product_id' => $this->product->getIdentity()), 'store_products'), $this->translate('Edit Item'), array(
                        'id' => 'store_product_editsettings',
                    )) ?> <img src="/application/modules/Core/externals/images/next.png"> <?php echo $this->translate("Edit Photos") ?> <img src="/application/modules/Core/externals/images/next.png"> <?php echo $this->translate('%s', $this->htmlLink($this->product->getHref(), $this->product->getTitle())); ?>
	</h3>


    <p class="flying-text-imp">
      <?php echo $this->translate("STORE_PAGE_PRODUCTS_PHOTOS_DESCRIPTION") ?>
    </p>
...
<table class="admin-edit-product-header he-item-list-bg">
    <tr>
        <td class="product-header-title">
            <span><?php echo $this->translate("Item Cover Photo") ?></span>
        </td>
        <td id="product_preview" width=120px" class="product_preview">
      ...
      <?php
        ...
        function reOrder() {
            ...
            showLoader('-2');
            new Request.JSON({
                url: '<?php echo $this->url(array('module'=>'store', 'controller'=>'products', 'action'=>'re-order')); ?>',
                data: {
                    ids: ids,
                    format: 'json'
                },
        ...
        function initEvents() {
            ...
            $$('.photo-item-cover').removeEvent('click').addEvent('click', function() {
                ...
                showLoader(id);
                new Request.JSON({
                    url: '<?php echo $this->url(array('module'=>'store', 'controller'=>'products', 'action'=>'set-cover')); ?>',
                    data: {
            ...
            $$('.remove-icon').removeEvent('click').addEvent('click', function () {
                ...
                showLoader(id);
                new Request.JSON({
                    url: '<?php echo $this->url(array('module'=>'store', 'controller'=>'products', 'action'=>'removephoto')); ?>',
                    data: {
                        product_id: '<?php echo $this->product->getIdentity(); ?>',
                        photo_id: id,
                        format: 'json'
        ...
        function loadMore() {
            ...
            new Request.JSON({
                url: "<?php echo $this->url(array('module'=>'store', 'controller'=>'products', 'action'=>'editphotos')); ?>",
                data: {
                    product_id: '<?php echo $this->product->getIdentity(); ?>',
                    page: page,
                    format: 'json'
      ...
      . $_SERVER['HTTP_HOST'] . $this->url(array(
        ...
        'default', true) ?>',
                    ...
                    url: '<?php echo $this->url(array('module'=>'store','controller'=>'products', 'action'=>'uploadphotos'));?>' + '?ul=1',
                    data: {
...
<div class="block_content">
        <div class="admin-photos-list">
            ...
            <div class="admin-photos-controls-wrapper">
                <a disabled="true" class="buttonlink icon_photos_new" id="product-images-uploader-button"><?php echo $this->translate('Store_Add Photo'); ?></a>

                <div style="float: left; display: none;" id="photo-item-loader--1">
                    <div class="he-loader-animation photo-item-loader-item"></div>
                </div>

                <a class="store-admin-upload-button" href="javascript:void(0)" id="photos-save-positions">
            ...
            <ul id="sortable-list">
                <?php foreach ($this->paginator as $photo): ?>
                    ...
                    <li>
                    <div id='store_photo_<?php echo $photo->getIdentity(); ?>' class="photo-item" data-id="<?php echo $photo->getIdentity(); ?>"
