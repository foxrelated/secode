 ...
 * @version    $Id: _FancyUpload.tpl 2011-08-19 17:07:11 mirlan $
 * @author     Mirlan
 */
...
function _fancyUpload() {
  var up = new FancyUpload2($('demo-status'), $('demo-list'), { // options object
    ...
    onLoad: function () {
      ...
      var demosubmit = document.getElementById("buttons-wrapper");
//      demosubmit.setStyle('display', 'none');
...
<div id="demo-status" class="hide">
  ...
  <div>
    ...
    <a class="buttonlink icon_clearlist" href="javascript:void(0);" id="demo-clear"
