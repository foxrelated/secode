  ...
  'routes' => array(
		...
		'ynfeedback_extended' => array(
	  	 ...
	  	 'ynfeedback_general' => array(
			...
			'reqs' => array(
	            'action' => '(index|simple-helpful|create|author-suggest|vote|show-result|manage-follow|helpful|detail-popup|create-popup|manage|listing|vote-feedback|unvote-feedback|suggest-feedback|render-create-popup|check-limit-email)',
	        )
		),
