...
class Ynfeedback_Form_Admin_Settings_Global extends Engine_Form {
    public function init() {
		...
		$this->addElement('Integer', 'ynfeedback_email_maxfeedback', array(
            'label' => 'Maximum feedbacks can post per email address',
            'description' => 'Set 0 is unlimited',
            'required' =>true,
            'validators' => array(
                new Engine_Validate_AtLeast(0),
            ),
            'value' => $settings->getSetting('ynfeedback_email_maxfeedback', 0),
        ));
		...
		$this->addElement('Text', 'ynfeedback_addthis_pubid', array(
            'label' => 'AddThis - Profile ID',
            'required' =>true,
            'value' => $settings->getSetting('ynfeedback_addthis_pubid', 'younet'),
        ));
