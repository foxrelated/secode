...
<div class="ynfeedback-detail-main-content">
    ...
    <?php endif;?>
	<script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=<?php echo Engine_Api::_()->getApi('settings', 'core') -> getSetting('ynfeedback_addthis_pubid', 'younet');?>" async="async"></script>
