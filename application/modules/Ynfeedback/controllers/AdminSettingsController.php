...
class Ynfeedback_AdminSettingsController extends Core_Controller_Action_Admin {
    public function globalAction() {
        ...
        ->getNavigation('ynfeedback_admin_main', array(), 'ynfeedback_admin_settings_global');
         ...
         if ($this->getRequest()->isPost()&& $form->isValid($this->getRequest()->getPost())) {
			...
			$settings->setSetting('ynfeedback_email_maxfeedback', $values['ynfeedback_email_maxfeedback']);
			...
			$settings->setSetting('ynfeedback_addthis_pubid', $values['ynfeedback_addthis_pubid']);
    ...
    public function levelAction() {
        ...
        if ($level->type != 'public') {
            $numberFieldArr = Array('max_screenshot', 'max_file', 'max_screenshotsize', 'max_filesize', 'max_feedback');
