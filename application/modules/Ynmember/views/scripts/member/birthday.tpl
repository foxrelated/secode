<script src="<?php $this->layout()->staticBaseUrl?>application/modules/Ynmember/externals/scripts/picker/Locale.en-US.DatePicker.js" type="text/javascript"></script> 
<script src="<?php $this->layout()->staticBaseUrl?>application/modules/Ynmember/externals/scripts/picker/Picker.js" type="text/javascript"></script> 
<script src="<?php $this->layout()->staticBaseUrl?>application/modules/Ynmember/externals/scripts/picker/Picker.Attach.js" type="text/javascript"></script> 
<script src="<?php $this->layout()->staticBaseUrl?>application/modules/Ynmember/externals/scripts/picker/Picker.Date.js" type="text/javascript"></script> 
<link href="<?php $this->layout()->staticBaseUrl?>application/modules/Ynmember/externals/styles/picker/datepicker_dashboard.css" rel="stylesheet">
	...
	<li>
		<div class="ynmember-member-item">
			...
			<div class="ynmember-member-item-avatar">
				...
				<?php $background_image = $this->layout()->staticBaseUrl."application/modules/User/externals/images/nophoto_user_thumb_profile.png"; ?>
