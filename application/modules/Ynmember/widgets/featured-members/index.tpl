<?php 
	$this->headScript()
        ->appendFile($this->layout()->staticBaseUrl . 'application/modules/Ynmember/externals/scripts/jquery-1.7.1.min.js')
        ->appendFile($this->layout()->staticBaseUrl . 'application/modules/Ynmember/externals/scripts/jquery.content_slider.min.js');
	$this->headLink()
        ->appendStylesheet($this->layout()->staticBaseUrl . 'application/modules/Ynmember/externals/styles/content_slider_style.css');
	...
	(function($){
		$(document).ready(function() {
			...
			$('#advmember_slider').content_slider({		// bind plugin to div id="slider1"
				...
				no_image_path: '<?php echo $this->layout()->staticBaseUrl; ?>application/modules/Ynmember/externals/images/slide_profile_blank.png',
			});
		});
	})(jQuery);
</script>
