...
<?php if(Engine_Api::_()->getDbtable('modules', 'core')->isModuleEnabled('sitebusinessmusic')) :?>
<?php 
  $this->headScript()
       ->appendFile($this->layout()->staticBaseUrl . 'externals/soundmanager/script/soundmanager2'
           . (APPLICATION_ENV == 'production' ? '-nodebug-jsmin' : '' ) . '.js')
...
<?php if($this->tabtype == 1): ?> title="<?php echo $this->translate("LinkedIn"); ?>" <?php endif; ?> >
      ...
      <?php endif; ?>
       ...
       <?php if ($this->isInstagramEnable && empty($this->instagramloginURL)  && !empty($this->web_values)): ?>
...
?>" <?php endif; ?> >
            ...
            <i class="aaf_tabs_icon aaf_icon_facebook_add"></i>			 
	        	<?php elseif (2 & $this->tabtype && ! (1 & $this->tabtype)): ?> 
              <i class="aaf_tabs_icon aaf_icon_app_add aaf_main_tabs_icon"></i>
					 		<span class="aaf_main_tabs_txt"><?php echo $this->translate("Facebook"); ?></span>
					 	<?php else: ?>
              <i class="aaf_tabs_icon aaf_icon_facebook_add aaf_main_tabs_icon"></i>
					 		<span class="aaf_main_tabs_txt"><?php echo $this->translate("Facebook"); ?></span>
					 	<?php endif; ?>
	        </a>
        </li>  
...
?>" <?php endif; ?> >
      	  <a href="javascript:void(0);" onclick="AAF_ShowFeedDialogue_Linkedin('<?php echo $this->LinkedinloginURL; ?>')" title="<?php echo $this->translate("Connect to LinkedIn");?>">
	        	<?php if (1 & $this->tabtype && ! (2 & $this->tabtype)): ?> 
	        		<i class="aaf_tabs_icon aaf_icon_linkedin_add"></i>			 
	        	<?php elseif (2 & $this->tabtype && ! (1 & $this->tabtype)): ?> 
	        		<i class="aaf_tabs_icon aaf_icon_app_add aaf_main_tabs_icon"></i>
					 		<span class="aaf_main_tabs_txt"><?php echo $this->translate("LinkedIn"); ?></span>
					 	<?php else: ?>
					 		<i class="aaf_tabs_icon aaf_icon_linkedin_add aaf_main_tabs_icon"></i>
					 		<span class="aaf_main_tabs_txt"><?php echo $this->translate("LinkedIn"); ?></span>
					 	<?php endif; ?>
	        </a>
        </li>
      ...
      <?php if ($this->isInstagramEnable &&!empty($this->isInstagramEnable) && !empty($this->instagramloginURL) && !empty($this->web_values) && in_array("instagram", $this->web_values)): ?>
        <li <?php if($this->activeTab==6): ?> class="aaf_tab_active" <?php endif; ?>
id="instagram_activityfeed" <?php if($this->tabtype == 1): ?> title="<?php echo $this->translate("Instagram");
?>" <?php endif; ?> >
...
<?php endif; ?>
 ...
 <?php if (!empty($this->instagramloginURL)) : ?>
 ...
 <?php endif;?>
  ...
  <?php if (!empty($this->instagramloginURL_temp)) : ?>
