...
class Advancedactivity_AdminSettingsController extends Core_Controller_Action_Admin {
  ...
  public function indexAction() {
    ...
    $onactive_disabled = array('advancedactivity_sitetabtitle', 'advancedactivity_post_canedit', 'advancedactivity_tabtype', 'advancedactivity_maxautoload',
        ...
        'advancedactivity_update_frequency', 'advancedactivity_icon1', 'logo_photo_preview1', 'submit', "advancedactivity_post_searchable", "advancedactivity_comment_show_bottom_post", "aaf_tagging_module", "linkedin_settings_temp", "seaocore_google_map_key", "linkedin_enable", "aaf_largephoto_enable", "advancedactivity_networklist_privacy", "facebook_enable", "twitter_enable", 'advancedactivity_feed_autoload', 'advancedactivity_composer_menuoptions', 'aaf_comment_like_box', 'advancedactivity_nestedcomment_setting', "instagram_enable");
