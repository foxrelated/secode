        ...
        en4.core.runonce.add(function(){
          ...
          en4.advancedactivity.attachComment($('<?php echo $this->commentForm->getAttrib('id') ?>'),allowQuickComment);
           ...
           if(allowQuickComment == '1' && <?php echo $this->submitComment ? '1': '0' ?>){
            ...
            <?php if( Engine_Api::_()->getApi('settings', 'core')->getSetting('aaf.comment.like.box', 0)):?>$('comment-likes-activityboox-item-<?php echo $action->action_id;?>').toggle();  <?php endif; ?>
...
document.getElementById("' . $this->commentForm->body->getAttrib('id') . '").focus();document.getElementById("'."comment-likes-activityboox-item-$actionBaseId".'").style.display = "block"; ', 'title' =>
    ...
    <div class='comments' id='comment-likes-activityboox-item-<?php echo $actionBaseId ?>' <?php if( Engine_Api::_()->getApi('settings', 'core')->getSetting('aaf.comment.like.box', 0)):?>style="display: none;"  <?php endif; ?>>
        <ul>  
          <?php // Share Count  ?>
