...
//        'description' => 'Select the tabs that you want to be available in this block. Note: Facebook has restricted the feature of displaying Facebook Feeds on other social sites. Please <a href="' . $faqlink . '" target="_blank">click here</a> to read more details.',
        'description' => 'Select the tabs that you want to be available in this block. <br> [Note 1: Facebook has restricted the feature of displaying Facebook Feeds on other social sites. Please <a href="' . $faqlink . '" target="_blank">click here</a> to read more details.]<br>[Note 2: The Welcome, Instagram, Twitter and Linkedin tabs will only work for Member Home Page. Instagram, Twitter and Linkedin tabs will show the logged-in user\'s Instagram, Twitter and Linkedin feeds. It is recommended to place this widget where SocialEngine\'s Core Activity Feed widget is placed.]',
//        'label' => 'Tabs',
        'multiOptions' => array("welcome" => "Welcome", "aaffeed" => "Site Activity Feeds", "facebook" => "Facebook Feeds", "twitter" => "Twitter Feeds", "linkedin" => "LinkedIn Feeds", "instagram" => "Instagram Feeds"),
            //'value' => $coreSettingsApi->getSetting('advancedactivity_tabs', array("0" => "facebook", "1" => "twitter")),
    ));
