...
//'placement' , 'APPEND', 'escape' => false));
    ...
    $this->addElement('Radio', 'advancedactivity_feed_autoload', array(
        'label' => ' Auto-Loading New Activity Feeds',
        'description' => "Do you want to enable auto-loading of new activity feeds? (If set to No, then user would need to click on a link to see new Activity Feeds.This setting will be applied to the Site Activity Feeds.)",
        'multiOptions' => array(
            1 => 'Yes',
            0 => 'No'
        ),
        'value' => $coreSettingsApi->getSetting('advancedactivity.feed.autoload', 0),
    ));
    ...
    'description' => 'Choose the attachment menus from below that you want to be enabled in the Status Update Box in site activity feeds.',
    'label' => 'Status Box Attachment Menus',
        'multiOptions'=>$composerList,
         'value' => $coreSettingsApi->getSetting('advancedactivity.composer.menuoptions', Engine_Api::_()->advancedactivity()->getComposerMenuList())
    ));
