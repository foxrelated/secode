...
<div class='generic_layout_container layout_middle'>
	...
	<div class="ynevent-action-view-method ynevent-my-event-manage-btn-top ynclearfix">
	  <div class="ynevent_home_page_list_content" rel="map_view">
        	<a href="<?php echo $this -> url(array('action' => 'calendar'), 'event_general', true);?>"  class="ynevent_home_page_list_content_icon">
                <i class="fa fa-calendar"></i>
            </a>
      </div>

      <div class="ynevent_home_page_list_content" rel="map_view">
        	<a href="javascript:;" class="ynevent_home_page_list_content_icon active">
