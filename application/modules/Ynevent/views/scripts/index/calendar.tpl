...
<div class="ynevent-action-view-method">
  <div class="ynevent_home_page_list_content" rel="map_view">
    	<a href="javascript:;"   class="ynevent_home_page_list_content_icon tab_icon_calendar active"><i class="fa fa-calendar"></i></a>
  </div>
  <div class="ynevent_home_page_list_content" rel="map_view">
    	<a href="<?php echo $this -> url(array('action' => 'manage'), 'event_general', true);?>" class="ynevent_home_page_list_content_icon"><i class="fa fa-th-list"></i></a>
  </div>
 </div>
<?php
/* date settings */
