	...
	<?php endif;?>
			...
			?>
				<li class="ynfs_item"
					...
					<div class="ynfs_name_column">
						...
						<a href="<?php echo Engine_Api::_() -> ynevent() ->getFolderHref(array('parent_type' => $this->parentType, 'parent_id' => $this->parentId), $folder)?>"
					...
					<div class="ynfs_owner_column">
						<?php
							$owner = Engine_Api::_() -> getDbTable('mappings', 'ynevent') -> getOwner($folder);
						?>
			...
			<?php foreach ($this->files as $file) : ?>
				...
				>
					...
					<div class="ynfs_owner_column">
						<?php
							$owner = Engine_Api::_() -> getDbTable('mappings', 'ynevent') -> getOwner($file);
						?>
						<a href="<?php echo $owner->getHref()?>" title="<?php echo $this->string()->stripTags($owner->getTitle())?>">
							<?php echo $this->string()->truncate($owner->getTitle(), 30)?>
						</a>
