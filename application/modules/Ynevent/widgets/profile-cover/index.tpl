...
<div class="ynevent-widget-profile-cover">
    ...
    <div class="ynevent-title" title="<?php echo $this->event->getTitle();?>"><?php echo $this->event->getTitle()?></div>
    ...
    <div class="ynevent-detail-info">
        <div class="info-top ynclearfix">
            ...
            <div class="ynevent-detail-main">
                	...
                	?>
                        <i class="fa fa-clock-o"></i><span title="<?php echo $this -> translate("Time of event")?>">
                        <?php echo $this->translate('%1$s %2$s',
    			            $this->locale()->toDate($startDateObject),
    			            $this->locale()->toTime($startDateObject)
    			          	) ?> <a>-</a> <?php echo $this->translate('%1$s <b>%2$s</b>',
                ...
                <div>
                    <?php if($this->event->address):?>
                        <div>
                            <span title="<?php echo $this->event->address?>">
                                <i class="fa fa-map-marker"></i>
                                <?php echo $this -> string() -> truncate($this->event->address, 50);?>
                            </span>
                        </div>
                    <?php endif;?>
                </div>
                ...
                <div>
                    <span>
                        ...
                        <strong title="<?php echo $this->user->getTitle()?>"><?php echo $this->htmlLink($this->user->getHref(), $this -> string() -> truncate($this->user->getTitle(), 15), array()); ?>
                        </strong>
                    </span>

                    <span title="<?php echo $this -> translate("Guests")?>">
                        <i class="fa fa-users"></i>
                        <?php echo $this->translate(array('%s guest', '%s guests', $this->event->member_count),$this->locale()->toNumber($this->event->member_count)); ?>
                    </span>

                    <span>
                        <i title="<?php echo $this -> translate("Rating")?>" class="<?php echo (Engine_Api::_()->ynevent()->checkRated($this->event->getIdentity(), $this->viewer()->getIdentity())) ? "ynicon-rating-w" : "ynicon-rating"; ?>">
                        </i>
                        <?php echo number_format($this->event->rating, 1); ?>
                    </span>
                </div>
        ...
        <div class="info-bottom ynclearfix">
            <div class="ynevent-detail-contact">
            	...
            	<?php if($this->event->email) :?>
            		<div class=""><i class="fa fa-envelope"></i><a href="mailto:<?php echo $this->event->email; ?>"><?php echo $this -> translate("Contact Us"); ?></a></div>
            	<?php endif;?>
                <?php if($this->event->url) :?>
            		<div class=""><i class="fa fa-globe"></i><a href="<?php echo $this->event->url; ?>"><?php echo $this->event->url; ?></a></div>
            	<?php endif;?>
                <?php if($this->event->phone) :?>
            		<div class=""><i class="fa fa-phone"></i><?php echo $this->event->phone; ?></div>
            	<?php endif;?>
            </div>
            ...
            <div class="ynevent-detail-more">
                        ...
                        <?php 
            				if($this->event->host)
				            {
				            	if(strpos($this->event->host,'younetco_event_key_') !== FALSE)
								{
									...
									echo $this->translate('Host by <b>%1$s</b>',
            	...
            	<?php if ($this->event->location):?>
            		<div class="">
                        ...
                        <strong><?php echo $this->event->location; ?></strong>
                    </div>
            	<?php endif;?>
