 	...
 	<div id="yn_event_tabs_time_time_<?php echo $this -> identity;?>" class="tabs_alt tabs_parent">
          ...
          <div class="ynevent-action-view-method clearfix">
              ...
              <div class="ynevent_home_page_list_content_<?php echo $this -> identity;?>" rel="map_view">
                	<span id="map_view_<?php echo $this->identity;?>" class="ynevent_home_page_list_content_icon" onclick="ynevent_view_map_p_time(<?php echo $this -> identity;?>);">
    		  ...
    		  <div class="ynevent_home_page_list_content_<?php echo $this -> identity;?>" rel="grid_view">
                	<span id="grid_view_<?php echo $this->identity;?>" class="ynevent_home_page_list_content_icon" onclick="ynevent_view_grid_p_time(<?php echo $this -> identity;?>);">
              ...
              <div class="ynevent_home_page_list_content_<?php echo $this -> identity;?>" rel="list_view">
                	<span id="list_view_<?php echo $this->identity;?>" class="ynevent_home_page_list_content_icon" onclick="ynevent_view_list_p_time(<?php echo $this -> identity;?>)">
