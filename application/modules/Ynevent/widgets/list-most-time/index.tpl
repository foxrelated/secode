<div id="ynevent_list_time_<?php echo $this -> identity;?>" class="<?php echo $this -> class_mode;?>"> 	
 	<div id="yn_event_tabs_time_time_<?php echo $this -> identity;?>" class="tabs_alt tabs_parent">
          ...
          <div class="ynevent-action-view-method clearfix">
              ...
              <div class="ynevent_home_page_list_content_<?php echo $this -> identity;?>" rel="map_view">
                	<span id="map_view_<?php echo $this->identity;?>" class="ynevent_home_page_list_content_icon" onclick="ynevent_view_map_time(<?php echo $this -> identity;?>);"><i class="fa fa-map-marker"></i></span>
              </div>
              <?php endif;?>
              <?php if(in_array('grid', $this -> mode_enabled)):?>
    		      <div class="ynevent_home_page_list_content_<?php echo $this -> identity;?>" rel="grid_view">
                	<span id="grid_view_<?php echo $this->identity;?>" class="ynevent_home_page_list_content_icon" onclick="ynevent_view_grid_time(<?php echo $this -> identity;?>);"><i class="fa fa-th"></i></span>
              </div>
              <?php endif;?>
              <?php if(in_array('list', $this -> mode_enabled)):?>
              <div class="ynevent_home_page_list_content_<?php echo $this -> identity;?>" rel="list_view">
                	<span id="list_view_<?php echo $this->identity;?>" class="ynevent_home_page_list_content_icon" onclick="ynevent_view_list_time(<?php echo $this -> identity;?>)"><i class="fa fa-th-list"></i></span>
              </div>
             <?php endif;?>
        </div>
    </div>
    <div id="ynevent_list_time_content_<?php echo $this -> identity;?>" class="ynevent-tabs-content ynclearfix">
     ...
     <script type="text/javascript">
       var yn_event_tabs_time = new ynEventTabcontent("yn_event_tabs_time_time_<?php echo $this -> identity;?>", "<?php echo $this -> identity;?>");
