    ...
    <form method="POST" action="<?php echo $this->url() ?>">
      <div>
        <?php if ($this->highlighted == 0): ?>
          ...
          <p>
            <?php echo $this->translate('Are you sure that you want to make this Store Video highlighted?'); ?>
          </p>
          <p>&nbsp;
          </p>
          <p>
        ...
        <?php elseif ($this->highlighted == 1): ?>
          ...
          <p>
            <?php echo $this->translate('Are you sure that you want to make this Store Video un-highlighted ?'); ?>
          </p>
          <p>&nbsp;
          </p>
          <p>
