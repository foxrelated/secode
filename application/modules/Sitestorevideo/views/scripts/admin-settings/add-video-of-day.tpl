 ...
 * @version    $Id: add-video-of-day.tpl 2013-09-02 00:00:00Z SocialEngineAddOns $
...
<script type="text/javascript">
  ...
  {
    var contentAutocomplete = new Autocompleter.Request.JSON('title', '<?php echo $this->url(array('module' => 'sitestorevideo', 'controller' => 'settings', 'action' => 'get-video'), 'admin_default', true) ?>', {
      'postVar' : 'text',
      'minLength': 1,
      'selectMode': 'pick',
