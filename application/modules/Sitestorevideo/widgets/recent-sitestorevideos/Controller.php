 ...
 */
class Sitestorevideo_Widget_RecentSitestorevideosController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $sitestorevideo_getRecent = Zend_Registry::isRegistered('sitestorevideo_getRecent') ? Zend_Registry::get('sitestorevideo_getRecent') : null;
    if (empty($sitestorevideo_getRecent)) {
      return $this->setNoRender();
    }
