 ...
 */
class Sitestorevideo_Widget_TagcloudSitestorevideoController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $tag_array = array();
    $tag_cloud_array = Engine_Api::_()->getDbtable('videos', 'sitestorevideo')->getTagCloud(20);
