 ...
 */
class Sitestorevideo_Widget_SearchSitestorevideoController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    //FORM CREATION
    $this->view->form = $form = new Sitestorevideo_Form_Searchwidget(array('type' => 'sitestore_store'));
    $populateValue = 0;
    if( isset($form->show) ) {
