		...
		<div id='order-element'>
			<ul>
              ...
              <?php echo $this->profileMapViewArray[$listingType->listingtype_id] ?>
						...
						<div style="width:10%;">
              <?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'siteandroidapp', 'controller' => 'view-maps-listing-type', 'action' => 'map', 'listingtype_id' => $listingType->listingtype_id), $this->translate('Edit'),array(
	                            'class' => 'smoothbox',
	                          )) ?> 
						</div>               
					</li>
