 ...
 */
class Siteandroidapp_AdminViewMapsListingTypeController extends Core_Controller_Action_Admin {
    ...
    public function mapAction() {
        ...
        //GENERATE THE FORM
        $this->view->form = $form = new Siteandroidapp_Form_Admin_ViewMapsListingType_Map(array('listingTypeId' => $listingtype_id));
            ...
            try {
                ...
                if (isset($_POST['yes_button'])) {
                    ...
                    if (isset($isViewRowExist) && !empty($isViewRowExist)) {
                        $db->query("UPDATE `engine4_siteandroidapp_listingtypeViewMaps` SET `profileView_id` ='$profileViewType', `browseView_id` =  '$browseViewType' WHERE `engine4_siteandroidapp_listingtypeViewMaps`.`listingtype_id` = '$listingtype_id'  LIMIT 1");
                    } else {
                        $db->query("INSERT INTO `engine4_siteandroidapp_listingtypeViewMaps` (`listingtype_id`, `profileView_id`, `browseView_id`) VALUES ('$listingtype_id', '$profileViewType', '$browseViewType')");
                    }
                }
