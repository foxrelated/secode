 ...
 */
class Siteandroidapp_Model_DbTable_NotificationSettings extends Activity_Model_DbTable_NotificationSettings {
    ...
    public function getEnabledNotifications(User_Model_User $user) {
        $types = Engine_Api::_()->getDbtable('notificationTypes', 'siteandroidapp')->getNotificationTypes();
