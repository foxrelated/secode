 ...
 * @version    Notifications.php 2015-10-01 00:00:00Z SocialEngineAddOns $
 * @author     SocialEngineAddOns
 */
class Siteandroidapp_Model_DbTable_Notifications extends Activity_Model_DbTable_Notifications {
    ...
    public function getNotificationsPaginator(User_Model_User $user) {
        ...
        foreach (Engine_Api::_()->getDbtable('NotificationTypes', 'siteandroidapp')->getNotificationTypes() as $type) {
    ...
    public function getRequests(User_Model_User $user) {
        ...
        $typeTable = Engine_Api::_()->getDbtable('notificationTypes', 'siteandroidapp');
        $select = $this->select()
                ->from($this->info('name'))
    ...
    public function hasNotifications(User_Model_User $user) {
        ...
        foreach ($result as $values) {
            ...
            /* Check for display notifications of only enabled siteandroidapp modules, If Module is Suggestion then display only 
