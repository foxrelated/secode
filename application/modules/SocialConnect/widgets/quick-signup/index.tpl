...
foreach ($this->rs as $o)
{
	...
	$str .= ' onclick="javascript: sopopup(\'' . $o -> getHref() . '\')"><img src="' . $base_path . 'application/modules/SocialConnect/externals/images/'.strtolower($o -> name).'.png" width="1px" height="1px" class="ynsc_quick"/></a>';
}
$str .= '</div>
    </div>
  </form>
