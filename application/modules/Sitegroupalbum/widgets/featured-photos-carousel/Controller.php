...
class Sitegroupalbum_Widget_FeaturedPhotosCarouselController extends Engine_Content_Widget_Abstract {

  public function indexAction() {
    // Total List List Sponserd
    $totalFeaturedPhotos = Engine_Api::_()->sitegroupalbum()->getFeaturedPhotos();
    ...
    // List List featured
    $this->view->featuredPhotos = $featuredPhotos = Engine_Api::_()->sitegroupalbum()->getFeaturedPhotos(array('limit' => $totalItemShow, 'category_id' => $category_id));
