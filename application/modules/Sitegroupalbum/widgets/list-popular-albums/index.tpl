    ...
    <li>
      ...
      <div class="info">
        ...
        <div class="owner">
					...
					?>
					<?php echo $this->translate("in ") . $this->htmlLink(Engine_Api::_()->sitegroup()->getHref($item->group_id, $item->owner_id, $item->getSlug()),  $group_title,array('title' => $item->group_title)) ?>      
