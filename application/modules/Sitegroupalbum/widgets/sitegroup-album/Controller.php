 ...
 */
class Sitegroupalbum_Widget_SitegroupAlbumController extends Seaocore_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $form = new Sitegroupalbum_Form_Searchwidget(array('type' => 'sitegroup_group'));
    ...
    //GET ALBUMS DATA
    $this->view->paginator = $paginator = Engine_Api::_()->getDbtable('albums', 'sitegroup')->getAlbums($values,$widgetType);
    ...
    $this->view->totalPages = ceil(($this->view->totalCount) /$totalAlbums);
