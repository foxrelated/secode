 ...
 * @version    $Id: _teamtemplate4.tpl 2015-10-11 00:00:00 SocialEngineSolutions $
...
<div class="sesteam_temp4_wrap">
  <div class="sesteam_temp4_list sesbasic_clearfix<?php if ($this->center_block): ?> iscenter<?php endif; ?>">
