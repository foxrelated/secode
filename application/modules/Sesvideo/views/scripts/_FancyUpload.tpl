...
<div id="demo-status" class="hide">
  ...
  <div>
    <a class="buttonlink sesvideo_icon_video_add" href="javascript:void(0);" id="demo-browse"><?php echo $this->translate('Add Video');?></a>
  </div>
...
<div><br/>
  <a class="buttonlink" href="javascript:startUpload();" id="demo-upload" style='display:none; background-image: url(<?php echo $this->layout()->staticBaseUrl ?>application/modules/Sesvideo/externals/images/new.png);'><?php echo $this->translate('Post Video');?></a>
</div>
