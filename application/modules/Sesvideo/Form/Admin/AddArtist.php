 ...
 * @version    $Id: AddArtist.php 2015-10-11 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

class Sesvideo_Form_Admin_AddArtist extends Engine_Form {
  ...
  public function init() {
    ...
    if ($artist_id) {
      $artist = Engine_Api::_()->getItem('sesvideo_artists', $artist_id);
