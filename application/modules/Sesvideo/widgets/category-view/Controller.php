 ...
 */
class Sesvideo_Widget_CategoryViewController extends Engine_Content_Widget_Abstract {
  public function indexAction() {
    ...
    $this->view->paginator = $paginator = Engine_Api::_()->getDbtable('videos', 'sesvideo')->getVideo(array($columnCategory => $category->category_id, 'status' => 1, 'watchLater' => true));
