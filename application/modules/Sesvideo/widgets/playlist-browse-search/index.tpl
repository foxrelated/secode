...
<script type="text/javascript">
  ...
  en4.core.runonce.add(function() {
    var searchAutocomplete = new Autocompleter.Request.JSON('title_name', "<?php echo $this->url(array('module' => 'sesvideo', 'controller' => 'index', 'action' => 'search', 'actonType' => 'browse', 'sesvideo_commonsearch' => 'sesvideo_playlist'), 'default', true) ?>", {
      'postVar': 'text',
      'delay' : 250,      
      'minLength': 1,
      'selectMode': 'pick',
