...
function showCategory(id) {
  if($('subcategory_' + id)) {
    if ($('subcategory_' + id).style.display == 'block') {
      $('sesvideo_toggle_' + id).removeClass('cattoggel cattoggeldown');
      $('sesvideo_toggle_' + id).addClass('cattoggel cattoggelright');
      $('subcategory_' + id).style.display = 'none';
    } else {
      $('sesvideo_toggle_' + id).removeClass('cattoggel cattoggelright');
      $('sesvideo_toggle_' + id).addClass('cattoggel cattoggeldown');
  ...
  if($('subsubcategory_' + id)) {
    if ($('subsubcategory_' + id).style.display == 'block') {
      $('sesvideo_subcat_toggle_' + id).removeClass('cattoggel cattoggeldown');
      $('sesvideo_subcat_toggle_' + id).addClass('cattoggel cattoggelright');      
      $('subsubcategory_' + id).style.display = 'none';
    } else {
      $('sesvideo_subcat_toggle_' + id).removeClass('cattoggel cattoggelright');
      $('sesvideo_subcat_toggle_' + id).addClass('cattoggel cattoggeldown');
