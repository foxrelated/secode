 ...
 * @version    $Id: AdvancedActivityLoopSM.php 6590 2013-06-03 00:00:00Z SocialEngineAddOns $
  ...
  public function advancedActivityLoopSM($actions = null, array $data = array()) {
    ...
    if (Engine_Api::_()->seaocore()->checkEnabledNestedComment('advancedactivity')) {
        return $this->view->partial(
                        'application/modules/Nestedcomment/views/sitemobile/scripts/_activityText.tpl', null,
                        /*  Customization End */ $data
        );
    } else {
        return $this->view->partial(
                        'application/modules/Sitemobile/modules/Advancedactivity/views/scripts/_activityText.tpl', null,
                        /*  Customization End */ $data
        );
    }
