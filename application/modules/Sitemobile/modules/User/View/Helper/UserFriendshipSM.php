...
class User_View_Helper_UserFriendshipSM extends Zend_View_Helper_Abstract {
  ...
  public function userFriendshipSM($user, $viewer = null) {//echo "asdfsadf";die;
    ...
    if (!$direction) {
      // one-way mode
      if (null === $row) {
        return $this->view->htmlLink("javascript:void(0);", $this->view->translate('Follow'), array(
                    'class' => 'smoothbox  userlink userlink-cancel',
                    'onclick' => "sm4.activity.addFriend(this);return false;",
                    'data-href' => $this->view->url(array(
                    'controller' => 'friends',
                    'action' => 'add',
        ...
        return $this->view->htmlLink("javascript:void(0);", $this->view->translate('Cancel Follow Request'), array(
        ...
        return $this->view->htmlLink("javascript:void(0);", $this->view->translate('Unfollow'), array(
      ...
      if (null === $row || empty($row->resource_id)) {
        return $this->view->htmlLink("javascript:void(0);", $this->view->translate('Add'), array(
                    'class' => 'smoothbox userlink userlink-add',
                    'onclick' => "sm4.activity.addFriend(this);return false;",
                    'data-href' => $this->view->url(array(
                    'controller' => 'friends',
        ...
        return $this->view->htmlLink("javascript:void(0);", $this->view->translate('Cancel Request'), array(
                    'class' => 'smoothbox userlink userlink-cancel',
                    'onclick' => "sm4.activity.addFriend(this);return false;",
                    'data-href' => $this->view->url(array(
                    'controller' => 'friends',
        ...
        return $this->view->htmlLink("javascript:void(0);", $this->view->translate('Accept Request'), array(
        ...
        return $this->view->htmlLink("javascript:void(0);", $this->view->translate('Remove'), array(
                    'class' => 'smoothbox userlink userlink-remove',
                    'onclick' => "sm4.activity.addFriend(this);return false;",
                    'data-href' => $this->view->url(array(
                    'controller' => 'friends',
