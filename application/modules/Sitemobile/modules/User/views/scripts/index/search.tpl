...
<script type="text/javascript">
  ...
  {
    $('browsemembers_viewmore').innerHTML = "<div><img src='" + en4.core.staticBaseUrl + "application/modules/Sitemobile/modules/Core/externals/images/loading.gif' style='float:left;margin-right: 5px;'/><?php echo $this->translate('Loading...'); ?></div>";
  ...
  {
    $('browsemembers_results').innerHTML = "<div><img src='" + en4.core.staticBaseUrl + "application/modules/Sitemobile/modules/Core/externals/images/loading.gif' style='float:left;margin-right: 5px;'/><?php echo $this->translate('Loading...'); ?></div>";
    $('form_ajax').value = "";
