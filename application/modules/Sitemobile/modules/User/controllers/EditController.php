 ...
 * @version    $Id: EditController.php 9800 2012-10-17 01:16:09Z richard $
 * @author     John
 */
...
class User_EditController extends Core_Controller_Action_User {
  ...
  public function init() {
    ...
    $activeItem = null;
    if ($this->_getParam('action', null)) {
      $activeItem = 'user_edit_' . $this->_getParam('action', null);
    }
    // Set up navigation
    $this->view->navigation = $navigation = Engine_Api::_()
            ->getApi('menus', 'sitemobile')
            ->getNavigation('user_edit', array('params' => array('id' => $id)), $activeItem);
  ...
  public function profileAction() {
    ...
    $form = $this->view->form = new Fields_Form_Standard(array(
     ...
     if (Engine_Api::_()->sitemobile()->isApp()) {
      ...
      Zend_Registry::set('setFixedCreationHeaderTitle', str_replace(' New ', ' ', "Edit Personal Info"));
      Zend_Registry::set('setFixedCreationHeaderSubmit', 'Save');
      $this->view->form->setAttrib('id', 'form_user_edit_profile');
      Zend_Registry::set('setFixedCreationFormId', '#form_user_edit_profile');
  ...
  public function photoAction() {
    ...
    $this->view->form = $form = new User_Form_Edit_Photo();
     if (Engine_Api::_()->sitemobile()->isApp()) {
      Zend_Registry::set('setFixedCreationForm', true);
      Zend_Registry::set('setFixedCreationHeaderTitle', str_replace(' New ', ' ', "Edit My Photo"));
      Zend_Registry::set('setFixedCreationHeaderRemove', '');
      $this->view->form->setAttrib('id', 'form_user_edit_photo');
      Zend_Registry::set('setFixedCreationFormId', '#form_user_edit_photo');
//      $this->view->form->removeElement('done');
      $this->view->form->removeElement('remove');
//      $this->view->form->removeDisplayGroup('buttons');
      $form->setTitle('');
    }
    ...
    $form->Filedata->setAttribs(array('onchange' => ""));
    ...
    if ($form->Filedata->getValue() !== null) {
      ...
      try {
        ...
        Engine_Api::_()->sitemobile()->autoRotationImage($_FILES['Filedata'], $fileElement->getFileName());
  ...
  public function externalPhotoAction() {
    ...
    if (Engine_Api::_()->sitemobile()->isApp()) {
      Zend_Registry::set('setFixedCreationForm', true);
      Zend_Registry::set('setFixedCreationHeaderTitle', str_replace(' New ', ' ', 'Make Profile Photo'));
      Zend_Registry::set('setFixedCreationHeaderSubmit', 'Done');
      $this->view->form->setTitle('');
      $this->view->form->removeElement('cancel');
      $this->view->form->setAttrib('id', 'form_photo_make_profile');
      Zend_Registry::set('setFixedCreationFormId', '#form_photo_make_profile');
      $this->view->form->removeElement('submit');
