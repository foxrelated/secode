 ...
 * @license    http://www.socialengine.com/license/
 */
class Sitemobile_View_Helper_ViewMore extends Zend_View_Helper_HtmlElement {
  ...
  public function viewMore($string, $moreLength = null, $maxLength = null, $lessLength = null, $nl2br = true) {
    ...
    $content = '<'
            ...
            . $shortText
            . $this->view->translate('... &nbsp;')
            . '<a class="view_more_link" href="javascript://" onclick="$(this).parent().next().show();$(this).parent().hide();">' . $this->view->translate('more') . '</a>'
            . '</'
            . $this->_tag
            . '>'
            . '<'
    ...
    if ($strLen >= $lessLength) {
      $content .= '<a class="view_less_link" href="javascript://" onclick="$(this).parent().prev().show();$(this).parent().hide();">' . $this->view->translate('less') . '</a>';
    }
