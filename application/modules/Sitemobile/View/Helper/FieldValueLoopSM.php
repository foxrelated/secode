 ...
 * @version    $Id: MemberFieldValueLoop.php 6590 2013-06-03 00:00:00Z SocialEngineAddOns $
 * @author     SocialEngineAddOns
 */
class Sitemobile_View_Helper_FieldValueLoopSM extends Fields_View_Helper_FieldAbstract
{
  public function FieldValueLoopSM($subject, $partialStructure)
  {
...
$count++;
      ...
      $partialStructure = null)
  {
    ...
    if($field->type == 'birthdate') {
      if(!$value->value) {
        $tmp = $this->view->FieldBirthdateSM($subject, $field, $value);
      } else {
