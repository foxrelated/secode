 ...
 * @version    $Id: _noobSlideshow.tpl 2011-08-026 9:40:21Z SocialEngineAddOns $
      ...
      <?php if ($this->thumbPosition == 'bottom'): ?>
        ...
        <style type="text/css">
          ...
          .sr_media_slidebox_fullscreen i{
            background-image:url(<?php echo $this->layout()->staticBaseUrl ?>application/modules/Sitealbum/externals/images/fullscreen.png);
            display:block;
            height:15px;
            width:15px;
          }
