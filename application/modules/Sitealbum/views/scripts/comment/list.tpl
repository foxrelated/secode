...
<?php endif; ?>
  <div class='comments_options'>
    ...
    <?php if( isset($this->form) ): ?>
      - <a href='javascript:void(0);' onclick="if($('comment-form-open-li_<?php echo $this->subject->getType()?>_<?php echo $this->subject->getIdentity() ?>')){ $('comment-form-open-li_<?php echo $this->subject->getType()?>_<?php echo $this->subject->getIdentity() ?>').style.display = 'none';}
        $('comment-form_<?php echo $this->subject->getType()?>_<?php echo $this->subject->getIdentity() ?>').style.display = '';$('comment-form_<?php echo $this->subject->getType()?>_<?php echo $this->subject->getIdentity() ?>').body.focus();"><?php echo $this->translate('Post Comment') ?></a>
    <?php endif; ?>

    <?php if( $this->viewer()->getIdentity() && $this->canComment ): ?>
      <?php if( $this->subject->likes()->isLike($this->viewer()) ): ?>
        - <a href="javascript:void(0);" onclick="en4.sitealbum.comments.unlike('<?php echo $this->subject->getType()?>', '<?php echo $this->subject->getIdentity() ?>')"><?php echo $this->translate('Unlike This') ?></a>
      <?php else: ?>
        - <a href="javascript:void(0);" onclick="en4.sitealbum.comments.like('<?php echo $this->subject->getType()?>', '<?php echo $this->subject->getIdentity() ?>')"><?php echo $this->translate('Like This') ?></a>
      <?php endif; ?>
    <?php endif; ?>
  </div>
  <ul>
        ...
        <?php else: ?>
          ...
          <div class="comments_likes">
            <?php echo $this->htmlLink('javascript:void(0);', 
                          ...
                          array('onclick' => 'en4.sitealbum.comments.showLikes("'.$this->subject->getType().'", "'.$this->subject->getIdentity().'");')
                      ); ?>
          </div>
        <?php endif; ?>
    <?php endif; ?>
        ...
        <li>
          ...
          <div class="comments_viewall">
            <?php echo $this->htmlLink('javascript:void(0);', $this->translate('View previous comments'), array(
              'onclick' => 'en4.sitealbum.comments.loadComments("'.$this->subject->getType().'", "'.$this->subject->getIdentity().'", "'.($this->page - 1).'")'
            )) ?>
          </div>
        </li>
      <?php endif; ?>
        ...
        <li>
          ...
          <div class="comments_viewall">
            <?php echo $this->htmlLink('javascript:void(0);', $this->translate('View more comments'), array(
              'onclick' => 'en4.sitealbum.comments.loadComments("'.$this->subject->getType().'", "'.$this->subject->getIdentity().'", "'.($this->comments->getCurrentPageNumber()).'")'
            )) ?>
          </div>
        </li>
      <?php endif; ?>
        ...
        <li id="comment-<?php echo $comment->comment_id ?>">
          ...
          <div class="comments_info">
            ...
            <div class="comments_date">
              ...
              <?php if( $canDelete ): ?>
                -
                <a href="javascript:void(0);" onclick="en4.sitealbum.comments.deleteComment('<?php echo $this->subject->getType()?>', '<?php echo $this->subject->getIdentity() ?>', '<?php echo $comment->comment_id ?>')">
              ...
              <?php if( $this->canComment ):
                ...
                -
                <?php if( !$isLiked ): ?>
                  <a href="javascript:void(0)" onclick="en4.sitealbum.comments.like(<?php echo sprintf("'%s', %d, %d", $this->subject->getType(), $this->subject->getIdentity(), $comment->getIdentity()) ?>)">
                    <?php echo $this->translate('like') ?>
                  </a>
                <?php else: ?>
                  <a href="javascript:void(0)" onclick="en4.sitealbum.comments.unlike(<?php echo sprintf("'%s', %d, %d", $this->subject->getType(), $this->subject->getIdentity(), $comment->getIdentity()) ?>)">
  ...
  <script type="text/javascript">
    en4.core.runonce.add(function(){
      ...
      en4.sitealbum.comments.attachCreateComment($('comment-form_<?php echo $this->subject->getType()?>_<?php echo $this->subject->getIdentity() ?>'),'<?php echo $this->subject->getType()?>',<?php echo $this->subject->getIdentity() ?>);
    });
  </script>
