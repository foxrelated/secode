 ...
 */
class Sitealbum_Form_Searchfields extends Engine_Form {
  ...
  public function generate() {
    ...
    $structure = Engine_Api::_()->sitealbum()->getFieldsStructureSearch($this->_fieldType, $this->_topLevelId, $this->_topLevelValue, true, $profileTypeIds);
