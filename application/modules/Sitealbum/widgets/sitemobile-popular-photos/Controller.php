 ...
 */ 
class Sitealbum_Widget_SitemobilePopularPhotosController extends Seaocore_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $params['popularity'] = $popularity = $this->view->popularity = $this->_getParam('popularity', 'recentphotos');
    ...
    $this->view->sitealbums = $paginator = Engine_Api::_()->getDbTable('photos', 'sitealbum')->photoBySettings($params);
