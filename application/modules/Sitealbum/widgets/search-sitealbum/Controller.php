 ...
 */
class Sitealbum_Widget_SearchSitealbumController extends Seaocore_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $this->view->form = $form = new Sitealbum_Form_Search_Search(array('widgetSettings' => $widgetSettings));
