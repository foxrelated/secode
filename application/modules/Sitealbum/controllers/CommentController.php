 ...
 */
class Sitealbum_CommentController extends Core_Controller_Action_Standard {
  ...
  public function createAction() {
    ...
    $this->view->body = $this->view->action('list', 'comment', 'sitealbum', array(
                'type' => $this->_getParam('type'),
  ...
  public function getDisplayComment() {
    ...
    $value = $settings->getSetting('sitealbum_viewerphoto');
    $status = (int) ($code == $value);
    $settings->setSetting('sitealbum_coreview', $status);
    $settings->setSetting('sitealbum_albumtype', $status);
    $settings->setSetting('sitealbum_badgeviewer', $status);
  }
