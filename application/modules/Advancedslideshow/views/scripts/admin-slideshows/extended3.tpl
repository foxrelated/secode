 ...
 * @version    $Id: extended3.tpl 2011-10-22 9:40:21Z SocialEngineAddOns $
 * @author     SocialEngineAddOns
 */
?>
<style type="text/css">
.slideshow-thumbnailsextended3{
	width:<?php echo $this->width ?>px;
}
.slideshow-thumbnailsextended3 ul {
...
.slideshow-thumbnailsextended3 img {
