 ...
 * @version    $Id: fullwidth4.tpl 2011-10-22 9:40:21Z SocialEngineAddOns $
 * @author     SocialEngineAddOns
 */
?>
<style type="text/css">
.slideshow-thumbnailsfullwidth4{
	width:<?php echo $this->width ?>px;
}
.slideshow-thumbnailsfullwidth4 ul {
...
.slideshow-thumbnailsfullwidth4 img {
