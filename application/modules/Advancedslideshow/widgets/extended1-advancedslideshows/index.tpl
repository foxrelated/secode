...
elseif($this->type == 'flom'): ?>
	...
	<style type="text/css">
		#blindsextended1-cont{width:<?php echo $this->width ?>px;height:<?php echo $this->height ?>px;}
		#blindsextended1{width:<?php echo $this->width ?>px;height:<?php echo $this->height ?>px;}
		<?php if($this->position_caption == 1):?>
			.floom_captionextended1{	bottom: 0px;background: <?php echo $this->colorback_caption; ?>;}
		<?php else: ?>
			.floom_captionextended1{	top: 0px;background: <?php echo $this->colorback_caption; ?>;}
		<?php endif; ?>		

		<?php if($this->caption == 'false'):?>
			.floom_captionextended1{display:none;}
		<?php endif; ?>
	</style>
	...
	<script type="text/javascript" charset="utf-8">
		...
		$('blindsextended1').floom(slides, {
				slideshowName: 'extended1',
	...
	<div id="blindsextended1-cont">
		<div id="blindsextended1">
		</div>
	</div>
<?php else: ?>
   ...
   ->prependStylesheet($this->layout()->staticBaseUrl.'application/modules/Advancedslideshow/externals/styles/slideshow.css');
	...
	<?php include_once APPLICATION_PATH . '/application/modules/Advancedslideshow/views/scripts/admin-slideshows/extended1.tpl'; ?>
		...
		<script type="text/javascript">		
			//<![CDATA[
				window.addEvent('domready', function(){
					...
					var myShowextended1 = new Slideshow('id_advancedslideshow_extended1', data, { slide: <?php echo $this->start_index; ?>, captions: <?php echo $this->caption; ?>, controller: <?php echo $this->controller; ?>, delay: <?php echo $this->delay; ?>, duration: <?php echo $this->duration; ?>, height: <?php echo $this->height; ?>, hu: '<?php echo $path; ?>', thumbnails: <?php echo $this->thumb;?>, width: <?php echo $this->width; ?>, titles: <?php echo $this->title?>, random: <?php echo $this->random;?>, slideshowName: 'extended1' });
				});
			//]]>
		</script>
		...
		<script type="text/javascript">		
			//<![CDATA[
				window.addEvent('domready', function(){
					...
					var myShowextended1 = new Slideshow.Fold('id_advancedslideshow_extended1', data, { slide: <?php echo $this->start_index; ?>, captions: <?php echo $this->caption; ?>, thumbnails: <?php echo $this->thumb;?>, center: false, controller: <?php echo $this->controller; ?>, delay: <?php echo $this->delay; ?>, duration: <?php echo $this->duration; ?>, height: <?php echo $this->height?>, hu: '<?php echo $path; ?>', transition: '<?php echo $this->transition; ?>', width: <?php echo $this->width?>, titles: <?php echo $this->title?>, overlap: <?php echo $this->overlap; ?>, random: <?php echo $this->random;?>, slideshowName: 'extended1' });
				});
			//]]>
		...
		<script type="text/javascript">		
			//<![CDATA[
				window.addEvent('domready', function(){
					...
					var myShowextended1 = new Slideshow.KenBurns('id_advancedslideshow_extended1', data, { slide: <?php echo $this->start_index; ?>, captions: <?php echo $this->caption; ?>, thumbnails: <?php echo $this->thumb;?>, controller: <?php echo $this->controller; ?>, delay: <?php echo $this->delay; ?>, duration: <?php echo $this->duration; ?>, height: <?php echo $this->height?>, hu: '<?php echo $path; ?>', width: <?php echo $this->width?>, titles: <?php echo $this->title?>, slideshowName: 'extended1' });
				});
			//]]>	
		</script>
	...
	<?php elseif($this->type == 'push'): ?>
		<style type="text/css">
			...
			.slideshow-imagesextended1-visible { 
				margin-left: 0;
			}	
			.slideshow-imagesextended1-prev { 
				margin-left: <?php echo $this->width; ?>px;
			}
			.slideshow-imagesextended1-next { 
				margin-left: -<?php echo $this->width; ?>px;
			}
		</style>
		...
		<script type="text/javascript">		
			//<![CDATA[
				window.addEvent('domready', function(){
					...
					var myShowextended1 = new Slideshow.Flash('id_advancedslideshow_extended1', data, { slide: <?php echo $this->start_index; ?>, captions: <?php echo $this->caption; ?>, thumbnails: <?php echo $this->thumb;?>, color: ['<?php echo $this->color1; ?>', '<?php echo $this->color2; ?>'], controller: <?php echo $this->controller; ?>, delay: <?php echo $this->delay; ?>, duration: <?php echo $this->duration; ?>, height: <?php echo $this->height?>, hu: '<?php echo $path; ?>', width: <?php echo $this->width?>, titles: <?php echo $this->title?>, random: <?php echo $this->random;?>, slideshowName: 'extended1' });
				});
			//]]>
		</script>
	...
	<style type="text/css">
		<?php if($this->position_caption == 1):?>
			.slideshow-captionsextended1{background: <?php echo $this->colorback_caption; ?>;bottom: 65px;}		
			.slideshow-thums-off .slideshow-captionsextended1{bottom:0;}
		<?php else: ?>
			.slideshow-captionsextended1{background: <?php echo $this->colorback_caption; ?>;top: 0px;}		
		<?php endif; ?>	

		.slideshow-captionsextended1-hidden {
			height: 0;
			opacity: 0;
		}
		.slideshow-captionsextended1-visible {
			height: 22px;
			opacity: .7;
		}
	...
	<?php if($this->thumb == 'true'): ?>
		...
		<div id="id_advancedslideshow_extended1" class="slideshow" style="height:<?php echo $height1 ?>px;">
	...
	<?php else:?>
		<div id="id_advancedslideshow_extended1" class="slideshow slideshow-thums-off">
			<?php //if($this->total_ur != 1):?>
				<?php if($this->target == 1):?>
					<span style="display:none;"><a href="" target="_blank"></a></span>
				<?php else: ?>
