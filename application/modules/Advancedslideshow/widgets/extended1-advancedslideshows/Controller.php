 ...
 */
class Advancedslideshow_Widget_Extended1AdvancedslideshowsController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $slideType = Zend_Registry::isRegistered('advancedslideshow_extended1') ? Zend_Registry::get('advancedslideshow_extended1') : null;
    $slide_position = 'extreme1';
