 ...
 */
class Advancedslideshow_Widget_Extended2AdvancedslideshowsController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $slideType = Zend_Registry::isRegistered('advancedslideshow_extended2') ? Zend_Registry::get('advancedslideshow_extended2') : null;
    $slide_position = 'extreme2';
