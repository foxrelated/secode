...
elseif($this->type == 'flom'): ?>
	...
	<style type="text/css">
		#blindsfullwidth1-cont{width:<?php echo $this->width ?>px;height:<?php echo $this->height ?>px;}
		#blindsfullwidth1{width:<?php echo $this->width ?>px;height:<?php echo $this->height ?>px;}
		<?php if($this->position_caption == 1):?>
			.floom_captionfullwidth1{	bottom: 0px;background: <?php echo $this->colorback_caption; ?>;}
		<?php else: ?>
			.floom_captionfullwidth1{	top: 0px;background: <?php echo $this->colorback_caption; ?>;}
		<?php endif; ?>		

		<?php if($this->caption == 'false'):?>
			.floom_captionfullwidth1{display:none;}
		<?php endif; ?>
	</style>
	...
	<script type="text/javascript" charset="utf-8">
		...
		$('blindsfullwidth1').floom(slides, {
				slideshowName: 'fullwidth1',
	...
	<div id="blindsfullwidth1-cont">
		<div id="blindsfullwidth1">
		</div>
	</div>
<?php else: ?>
   ...
   ->prependStylesheet($this->layout()->staticBaseUrl.'application/modules/Advancedslideshow/externals/styles/slideshow.css');
	...
	<?php include_once APPLICATION_PATH . '/application/modules/Advancedslideshow/views/scripts/admin-slideshows/fullwidth1.tpl'; ?>
		...
		<script type="text/javascript">		
			//<![CDATA[
				window.addEvent('domready', function(){
					...
					var myShowfullwidth1 = new Slideshow('id_advancedslideshow_fullwidth1', data, { slide: <?php echo $this->start_index; ?>, captions: <?php echo $this->caption; ?>, controller: <?php echo $this->controller; ?>, delay: <?php echo $this->delay; ?>, duration: <?php echo $this->duration; ?>, height: <?php echo $this->height; ?>, hu: '<?php echo $path; ?>', thumbnails: <?php echo $this->thumb;?>, width: <?php echo $this->width; ?>, titles: <?php echo $this->title?>, random: <?php echo $this->random;?>, slideshowName: 'fullwidth1' });
				});
			//]]>
		</script>
		...
		<script type="text/javascript">		
			//<![CDATA[
				window.addEvent('domready', function(){
					...
					var myShowfullwidth1 = new Slideshow.Fold('id_advancedslideshow_fullwidth1', data, { slide: <?php echo $this->start_index; ?>, captions: <?php echo $this->caption; ?>, thumbnails: <?php echo $this->thumb;?>, center: false, controller: <?php echo $this->controller; ?>, delay: <?php echo $this->delay; ?>, duration: <?php echo $this->duration; ?>, height: <?php echo $this->height?>, hu: '<?php echo $path; ?>', transition: '<?php echo $this->transition; ?>', width: <?php echo $this->width?>, titles: <?php echo $this->title?>, overlap: <?php echo $this->overlap; ?>, random: <?php echo $this->random;?>, slideshowName: 'fullwidth1' });
				});
			//]]>
		...
		<script type="text/javascript">		
			//<![CDATA[
				window.addEvent('domready', function(){
					...
					var myShowfullwidth1 = new Slideshow.KenBurns('id_advancedslideshow_fullwidth1', data, { slide: <?php echo $this->start_index; ?>, captions: <?php echo $this->caption; ?>, thumbnails: <?php echo $this->thumb;?>, controller: <?php echo $this->controller; ?>, delay: <?php echo $this->delay; ?>, duration: <?php echo $this->duration; ?>, height: <?php echo $this->height?>, hu: '<?php echo $path; ?>', width: <?php echo $this->width?>, titles: <?php echo $this->title?>, slideshowName: 'fullwidth1' });
				});
			//]]>	
		</script>
	...
	<?php elseif($this->type == 'push'): ?>
		<style type="text/css">
			...
			.slideshow-imagesfullwidth1-visible { 
				margin-left: 0;
			}	
			.slideshow-imagesfullwidth1-prev { 
				margin-left: <?php echo $this->width; ?>px;
			}
			.slideshow-imagesfullwidth1-next { 
				margin-left: -<?php echo $this->width; ?>px;
			}
		</style>
	...
	<style type="text/css">
		<?php if($this->position_caption == 1):?>
			.slideshow-captionsfullwidth1{background: <?php echo $this->colorback_caption; ?>;bottom: 65px;}		
			.slideshow-thums-off .slideshow-captionsfullwidth1{bottom:0;}
		<?php else: ?>
			.slideshow-captionsfullwidth1{background: <?php echo $this->colorback_caption; ?>;top: 0px;}		
		<?php endif; ?>	

		.slideshow-captionsfullwidth1-hidden {
			height: 0;
			opacity: 0;
		}
		.slideshow-captionsfullwidth1-visible {
			height: 22px;
			opacity: .7;
		}
	...
	<?php if($this->thumb == 'true'): ?>
		...
		<div id="id_advancedslideshow_fullwidth1" class="slideshow" style="height:<?php echo $height1 ?>px;">
	...
	<?php else:?>
		<div id="id_advancedslideshow_fullwidth1" class="slideshow slideshow-thums-off">
			<?php //if($this->total_ur != 1):?>
				<?php if($this->target == 1):?>
					<span style="display:none;"><a href="" target="_blank"></a></span>
				<?php else: ?>
