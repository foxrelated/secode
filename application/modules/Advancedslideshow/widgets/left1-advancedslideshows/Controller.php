 ...
 */
class Advancedslideshow_Widget_Left1AdvancedslideshowsController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $slideType = Zend_Registry::isRegistered('advancedslideshow_left') ? Zend_Registry::get('advancedslideshow_left') : null;
    $slide_position = 'left_column1';
