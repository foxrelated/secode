...
if(!session_id())
    session_start();
     ...
     {
         header('Location:'.$core_path.'/admin/groupbuy/refund/1/req5/'.$pstatus.'/req6/'.$req4);
         exit;
     }
     if($pstatus == 'success' && $payer_status =="verified")
     {
         header('Location:'.$core_path.'/admin/groupbuy/refund/1/req5/'.$pstatus.'/req6/'.$req5);
         exit;
     }
     header('Location:'.$core_path.'/admin/groupbuy/refund/1/req5/'.$pstatus);
