 ...
 public function create()
  {
    ...
    $mailTemplateTable = Engine_Api::_()->getDbtable('MailTemplates', 'Groupbuy');
	...
	$vars = array();
    $params = Engine_Api::_()->getApi('ConvertMailVars', 'Groupbuy')->process($params, $vars, $type);
	...
	/*  Engine_Api::_()->getDbTable('emails','groupbuy')->add(array(
  ...
  public function sendRaw($mail) {
	...
	public function sendMailQueue($send_limit =  NULL){
		...
		$table =Engine_Api::_()->getDbTable('emails','groupbuy');
