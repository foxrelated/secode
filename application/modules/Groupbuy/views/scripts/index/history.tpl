                             ...
                             <?php foreach($this->history as $track):?>
                                <tr style="border:1px solid">
                                    <td class="stat_number" style="border: 1px solid black;text-align:center" align="center" ><?php
                                     $bider = Engine_Api::_()->getItem('user', $track->auction_user_id);  
                                     echo $bider->username; ?> </td>
                                    <td class="stat_number" style="border: 1px solid black;text-align:center" align="center" ><?php echo $track->bid_time?> </td>
                                </tr>
