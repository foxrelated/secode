...
<div class='clear'>
    ...
    <form class="global_form">
      <div>
        ...
        <div>
		<?php if(is_object($this->category)): $category_id = $this->category->getIdentity();?>
         <?php foreach($this->category->getBreadCrumNode() as $node): ?>
        		<?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'groupbuy', 'controller' => 'category', 'action' => 'index', 'parent_id' =>$node->category_id), $this->translate($node->shortTitle()), array()) ?>
        		&raquo;
         <?php endforeach; ?>
         <strong><?php
      ...
      <?php endif;?>
        <br/>
        <?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'groupbuy', 'controller' => 'category', 'action' => 'add-category','parent_id'=>$category_id), $this->translate('Add Category'), array(
