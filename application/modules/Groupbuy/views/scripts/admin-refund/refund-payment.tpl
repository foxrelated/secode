...
.tabs > ul {  
 display: table;
  ...
  <h2>
    <?php echo $this->translate('Confirm Refund');?>
  </h2>
    ...
    <tr>
        ...
        <td width="60%">
            <div class="cart_id" style="height: 270px;overflow: scroll;">
                <table>
                    <tr>
                         <td><?php echo $this->translate('Leave the message for this refund');?> </td>
                    </tr>
                      
                    <tr>
                       <td> <textarea cols="50" rows="12" id="message" name="pay[message]"><?php if ($this->status == 1): echo $this->translate('I have paid for your refund.'); else: echo $this->translate("I don't accept your refund because of some reasons..."); endif; ?></textarea> </td>
                    </tr>
        ...
        <td width="40%" align="left" style="vertical-align:text-top;">
            <div style="position: ;">
                    ...
                    <?php echo $this->translate('Reason'); ?>:<span>
                     ...
                     <div class="p_4">
                   <?php echo $this->translate('Refund'); ?>:<span style="color: red;">
                        <?php echo $this->currencyadvgroup($this->account['request_amount']);?> <?php echo $this->currency ?>
                    </span>
                    </div>
                    <div class="p_4">
                     ...
                     <?php echo $this->translate('by using'); ?>
                        <?php if ($this->status == 1): ?>
                                   <div class="p_4">
                                       ...
                                       <input type="submit" class="button" name="submit_p" value="Send Money" >
                        ...
                        <?php else: ?>
                            ...
                            <input type="submit" class="button" value="I don't accept this refund" name="pay[cancel]">
