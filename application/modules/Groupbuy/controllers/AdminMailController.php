<?php
class Groupbuy_AdminMailController extends Core_Controller_Action_Admin
{

  public function templatesAction()
  {
  	$this->view->navigation = $navigation = Engine_Api::_()->getApi('menus', 'core')
      ->getNavigation('groupbuy_admin_main', array(), 'groupbuy_admin_main_emailtemplates');
      
    $this->view->form = $form = new Groupbuy_Form_Admin_Mail_Templates();
    ...
    $this->view->templateObject = $templateObject = Engine_Api::_()->getItem('groupbuy_mail_template', $template);
    if( !$templateObject ) {
  ...
  public function manageEmailsAction(){
  	$this->view->form =  $form =  new Groupbuy_Form_Admin_Mail_Search();
	$table = Engine_Api::_()->getDbTable('LogEmails','Groupbuy');
	$select =  $table->select();
