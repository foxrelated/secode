<?php
class Groupbuy_Model_Photo extends Core_Model_Item_Collectible
{
  protected $_parent_type = 'groupbuy_album';

  protected $_owner_type = 'user';

  protected $_collection_type = 'groupbuy_album';
  ...
  public function getHref($params = array())
  {
    $params = array_merge(array(
      ...
      'controller' => 'photo',
      'action' => 'view',
      'deal_id' => $this->getCollection()->getOwner()->getIdentity(),
  ...
  {
    return Engine_Api::_()->getItem('deal', $this->deal_id);
  }
