 ...
 * @version    $Id: VideoCategory.php 6590 2016-3-3 00:00:00Z SocialEngineAddOns $
 * @author     SocialEngineAddOns
 */
class Sitevideo_Model_VideoCategory extends Core_Model_Item_Abstract {
    ...
    public function getHref($params = array()) {
        ...
        $route = "sitevideo_video_general_" . $type;
        if ($type == 'category' && Engine_API::_()->seaocore()->checkSitemobileMode('fullsite-mode')) {
            $route = Engine_Api::_()->sitevideo()->getVideoCategoryHomeRoute();
        }
