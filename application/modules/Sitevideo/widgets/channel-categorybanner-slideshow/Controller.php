 ...
 */
class Sitevideo_Widget_ChannelCategorybannerSlideshowController extends Engine_Content_Widget_Abstract {
    ...
    public function indexAction() {
        ...
        $this->view->paginator = $paginator = Engine_Api::_()->getDbtable('channelCategories', 'sitevideo')->getCategoriesPaginator($params);
