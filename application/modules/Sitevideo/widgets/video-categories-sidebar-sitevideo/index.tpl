...
<?php endif; ?>
<?php $categoryRouteName = Engine_Api::_()->sitevideo()->getVideoCategoryHomeRoute(); ?>
        ...
        <?php foreach ($this->categories as $category): ?>
            ...
            <?php if ($total_subcat > 0): ?>
                <li>
                    ...
                    <a <?php if ($this->category_id == $category['category_id']): ?>class="bold"<?php endif; ?> href='<?php echo $this->url(array('action' => $url_action, 'category_id' => $category['category_id'], 'categoryname' => Engine_Api::_()->getItem('sitevideo_video_category', $category['category_id'])->getCategorySlug()), $categoryRouteName) ?>'>
                        ...
                        <?php foreach ($category['sub_categories'] as $subcategory) : ?>
                            ...
                            <?php if ($total_subsubcat > 0): ?>
                                <li>
                                    ...
                                    <a <?php if ($this->subcategory_id == $subcategory['sub_cat_id']): ?>class="bold"<?php endif; ?>  href='<?php echo $this->url(array('action' => $url_action, 'category_id' => $category['category_id'], 'categoryname' => Engine_Api::_()->getItem('sitevideo_video_category', $category['category_id'])->getCategorySlug(), 'subcategory_id' => $subcategory['sub_cat_id'], 'subcategoryname' => Engine_Api::_()->getItem('sitevideo_video_category', $subcategory['sub_cat_id'])->getCategorySlug()), "sitevideo_video_general_subcategory") ?>'>
                                        ...
                                        <?php if (isset($subcategory['tree_sub_cat'])): ?>
                                            <?php foreach ($subcategory['tree_sub_cat'] as $subsubcategory) : ?>
                                                <li>
                                                    ...
                                                    <a <?php if ($this->subsubcategory_id == $subsubcategory['tree_sub_cat_id']): ?>class="bold"<?php endif; ?>  href='<?php echo $this->url(array('action' => $url_action, 'category_id' => $category['category_id'], 'categoryname' => Engine_Api::_()->getItem('sitevideo_video_category', $category['category_id'])->getCategorySlug(), 'subcategory_id' => $subcategory['sub_cat_id'], 'subcategoryname' => Engine_Api::_()->getItem('sitevideo_video_category', $subcategory['sub_cat_id'])->getCategorySlug(), 'subsubcategory_id' => $subsubcategory['tree_sub_cat_id'], 'subsubcategoryname' => Engine_Api::_()->getItem('sitevideo_video_category', $subsubcategory['tree_sub_cat_id'])->getCategorySlug()), "sitevideo_video_general_subsubcategory") ?>'>
