        ...
        <?php if (!empty($this->categoriesArray)): ?>
            <?php foreach ($this->categoriesArray as $categorylist): ?>
                ...
                <li class="level<?php echo $level . " " . (!empty($subcategories) ? 'parent' : '') ?> ">
                    ...
                    ?>" href="<?php echo $this->url(array('category_id' => $category->getIdentity(), 'categoryname' => Engine_Api::_()->getItem('sitevideo_video_category', $category->getIdentity())->getCategorySlug()), "sitevideo_video_general_category"); ?>">
                        ...
                        <ul class="level<?php echo $level ?>">
                            <?php foreach ($subcategories as $subcategorieslist): ?>
                                ...
                                <li class="level<?php echo $level . "  " ?> ">
                                    ...
                                    ?>" href="<?php echo $this->url(array('category_id' => $category->getIdentity(), 'categoryname' => Engine_Api::_()->getItem('sitevideo_video_category', $category->getIdentity())->getCategorySlug(), 'subcategory_id' => $subcategory->getIdentity(), 'subcategoryname' => Engine_Api::_()->getItem('sitevideo_video_category', $subcategory->getIdentity())->getCategorySlug()), "sitevideo_video_general_subcategory"); ?>">
