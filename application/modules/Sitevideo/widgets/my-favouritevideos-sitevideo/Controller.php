 ...
 */
class Sitevideo_Widget_MyFavouritevideosSitevideoController extends Seaocore_Content_Widget_Abstract {
    ...
    public function indexAction() {
        ...
        $this->view->order = $params['order'] = $this->_getParam('orderby');
        ...
        $this->view->widgetPath = 'widget/index/mod/sitevideo/name/my-favouritevideos-sitevideo';
        $this->view->message = 'You do not have any favourite videos.';

        if (isset($params['search']) && !empty($params['search']))
            $this->view->message = 'No favourite videos found in search criteria.';
        ...
        $paginator = $this->view->paginator = Engine_Api::_()->getDbTable('videos', 'sitevideo')->getFavouriteVideoPaginator($params);
