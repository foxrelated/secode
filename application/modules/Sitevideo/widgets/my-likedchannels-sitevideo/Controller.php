 ...
 */
class Sitevideo_Widget_MyLikedchannelsSitevideoController extends Seaocore_Content_Widget_Abstract {
    ...
    public function indexAction() {
        ...
        $this->view->widgetPath = 'widget/index/mod/sitevideo/name/my-likedchannels-sitevideo';
        $this->view->message = "You do not have any liked channels.";

        if (isset($params['search']) && !empty($params['search']))
            $this->view->message = 'No liked channels found in search criteria.';
        ...
        $paginator = $this->view->paginator = Engine_Api::_()->getDbTable('channels', 'sitevideo')->getLikedChannelPaginator($params);
