 ...
 */
class Sitevideo_Widget_MyLikedvideosSitevideoController extends Seaocore_Content_Widget_Abstract {
    ...
    public function indexAction() {
        ...
        $this->view->widgetPath = 'widget/index/mod/sitevideo/name/my-likedvideos-sitevideo';
        $this->view->message = 'You do not have any liked videos.';

        if (isset($params['search']) && !empty($params['search']))
            $this->view->message = 'No liked videos found in search criteria.';

        $this->view->params = $params;
        $params['paginator'] = 1;
        //FIND THE PLAYLIST MODELS
        $paginator = $this->view->paginator = Engine_Api::_()->getDbTable('videos', 'sitevideo')->getLikedVideoPaginator($params);
