...
<div class='categories_manage sitevideo_horizontal_carausel' id='categories_manage' >
    <div id="featured_slideshow_wrapper_<?php echo $id; ?>" class="featured_slideshow_wrapper">
        ...
        <div id="sitevideo_featured_channel_prev8_div_<?php echo $id; ?>" class="sitevideo_horizontal_carausel_nav sitevideo_horizontal_carausel_nav_left" style="display:<?php echo $this->showPagination ? 'block' : 'none' ?> " >
                      ...
                      <div class='featured_slidebox sitevideo_featured_horizontal_slidebox <?php echo $class; ?>'>
                          <div class='featured_slidshow_content sitevideo_featured_slidebox_content'>
                                  ...
                                  <?php if ($i % 2 == $liBuildCond) : ?>
                                      ...
                                      <div id="channel_<?php echo $channel->channel_id; ?>" class="sitevideo_featured_block sitevideo_featured_block_other sitevideo_thumb_wrapper" style="width:<?php echo $this->channelWidth; ?>px;height:<?php echo $this->channelHeight; ?>px;">
                                          ...
                                          <?php if (in_array('numberOfVideos', $this->channelOption)) : ?>
                                              <?php $fsContent = '<div class="sitevideo_channels_videos_count">' . $this->translate(array('%s video', '%s videos', $channel->videos_count), $this->locale()->toNumber($channel->videos_count)) . '</div>' ?>
                                          <?php endif; ?>
                                          <?php
                                          if ($channel->file_id) {
                                              echo $this->htmlLink($channel->getHref(), "<span class='video_overlay'></span> <span class='watch_now_btn'>" . $this->translate('watch now') . "</span>" . $fsContent . "<i style='background-image:url(" . $channel->getPhotoUrl($this->thumbnailType) . ")'></i>" . $content);
                                          } else {
                                              echo $this->htmlLink($channel->getHref(), "<span class='video_overlay'></span> <span class='watch_now_btn'>" . $this->translate('watch now') . "</span>" . $fsContent . $content);
                                          }
                                          ?>
                                          <div class="sitevideo_channel_horizontal_info">
                                              <?php if (in_array('title', $this->channelOption)) : ?>
                              ...
                              <?php if ($i == $rowLimit): ?>
                                  <?php $rowLimit = $limit; ?>
                                  <?php if ($k) : ?>
                                      <div class="sitevideo_featured_block sitevideo_featured_block_other sitevideo_thumb_wrapper sitevideo_blank" style="width:<?php echo $this->channelWidth; ?>px;height:<?php echo $this->channelHeight; ?>px;">
                                      </div>
                                  <?php endif; ?>
        ...
        <div id="sitevideo_featured_channel_next8_div_<?php echo $id; ?>" class="sitevideo_horizontal_carausel_nav sitevideo_horizontal_carausel_nav_right" style="display:<?php echo $this->showPagination ? 'block' : 'none' ?> " >
...
if ($this->showLink == 0) :
    ...
    <?php else : ?>
        <div class="widthfull txt_center mtop10"><button onClick="window.location = '<?php echo $this->url(array('action' => 'browse'), 'sitevideo_general', true); ?>'"><?php echo $this->translate("Popular Channels") ?></button> </div>
    <?php endif; ?>
<?php endif; ?>
                ...
                var nS8 = new noobSlide({
                    ...
                    onWalk: function (currentItem, currentHandle) {
                        if ((this.currentIndex + 1) == (this.items.length))
                            $('sitevideo_featured_channel_next8_div_' + uid).hide();
                        else
                            $('sitevideo_featured_channel_next8_div_' + uid).show();

                        if (this.currentIndex > 0)
                            $('sitevideo_featured_channel_prev8_div_' + uid).show();
                        else
                            $('sitevideo_featured_channel_prev8_div_' + uid).hide();
                    }
                });
                //more handle buttons
