 ...
 */
class Sitevideo_Widget_TagcloudSitevideoChannelController extends Engine_Content_Widget_Abstract {
    ...
    public function indexAction() {
        ...
        if (($module == 'sitevideo' && $controller == 'channel' && $action == 'tagscloud') || $this->_getParam('notShowExploreTags', false)) {
        ...
        $params['channeltype'] = $this->_getParam('channeltype');
        $this->view->allParams = $params;
        //CONSTRUCTING TAG CLOUD
        $tag_array = array();
        $sitevideo_api = Engine_Api::_()->sitevideo();
        $this->view->count_only = $sitevideo_api->getTags($owner_id, 0, 1, $params);
        ...
        //FETCH TAGS
        $tag_cloud_array = $sitevideo_api->getTags($owner_id, $total_tags, 0, $params);
