 ...
 */
class Sitevideo_Widget_CategoriesSponsoredController extends Engine_Content_Widget_Abstract {
    ...
    public function indexAction() {
        ...
        $sitevideoCategorySponsored = Zend_Registry::isRegistered('sitevideoCategorySponsored') ? Zend_Registry::get('sitevideoCategorySponsored') : null;
        //GET STORAGE API
        ...
        if(empty($sitevideoCategorySponsored)) {
            return $this->setNoRender();
        }
    }
