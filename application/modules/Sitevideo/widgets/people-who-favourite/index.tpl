    ...
    <li>
        <div class="seaocore_like_users_block_links">
            ...
            if (!empty($this->detail)) {
                echo '<a class="smoothbox fright" href="' . $this->url(array('module' => 'seaocore', 'controller' => 'favourite', 'action' => 'favouritelist', 'resource_type' => $this->resource_type, 'resource_id' => $this->resource_id, 'call_status' => 'public'), 'default', true) . '">' . $this->translate('See all') . '</a>';
            }
            ?>
        </div>	
    </li>
