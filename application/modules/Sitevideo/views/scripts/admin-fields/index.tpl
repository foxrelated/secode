...
<?php endif; ?>
<h3><?php echo $this->translate('Profile Fields for Channels'); ?></h3>

<p>
    <?php echo $this->translate('Profile information will enable channel owner to add additional information about their channel. This non-generic additional information will help others to know more specific details about the channel. Below, you can create Profile Types for the Channels on your site, and then create Profile Information Fields for those profile types. Multiple profile types enable you to have different profile information fields for different types of channels. You can also map the Categories for channels with Profile Types from the "Category-Channel Profile Mapping" section such that if a channel belongs to a category, it will automatically have the corresponding profile fields.<br /><br />You can set the sequence of the profile fields by drag-and-drop. You can also enable the "Profile Information Fields" to be displayed on Channel View Page from “Channel Profile: Quick Information (Profile Fields)” widegt. <br /><br />An example use case of this feature would be creating different profile information fields for Channel\'s Genre, Weekly Show Schedule etc.'); ?>
</p>

<br />

<div class="admin_fields_type">
    <h3><?php echo $this->translate("Editing Profile Information Fields for Channel Profile Type:") ?></h3>
