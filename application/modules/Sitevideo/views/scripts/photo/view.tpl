 ...
 * @version    $Id: view.tpl 6590 2016-3-3 00:00:00Z SocialEngineAddOns $
...
<script type="text/javascript">
    ...
    en4.core.runonce.add(function() {
        taggerInstance = new Tagger('media_image_next', {
            ...
            'tagSitevideoElement': 'media_tags',
...
<h2>
    <?php echo $this->translate('%1$s ' . "&#187; Photos", $this->album->getParent()->__toString()) ?>
</h2>

<div class='sitevideo_photo_view'>
    <div class="sitevideo_photo_nav">
        <div>
            <?php
            echo $this->translate('Picture %1$s of %2$s', $this->locale()->toNumber($this->image->getCollectionIndex() + 1), $this->locale()->toNumber($this->album->count()))
            ?>
        </div>
    ...
    <div class='albums_viewmedia_info sitevideo_photo_info'>
        <div class='sitevideo_photo_container' id='media_image_div'>
        ...
        <?php if ($this->image->getTitle()): ?>
            <div class="sitevideo_photo_title">
                <?php echo $this->image->getTitle(); ?>
            </div>
        <?php endif; ?>

        <?php if ($this->image->getDescription()): ?>
            <div class="sitevideo_photo_description">
                <?php echo $this->image->getDescription() ?>
            </div>
        <?php endif; ?>

        <div class="event_photo_tags" id="media_tags" class="tag_sitevideo" style="display: none;">
            <?php echo $this->translate('Tagged:'); ?>
        </div>
        <div class="sitevideo_photo_date">
            ...
            <?php if ($this->canEdit): ?>
                ...
                - <?php echo $this->htmlLink(array('route' => "sitevideo_photo_extended", 'controller' => 'photo', 'action' => 'edit', 'photo_id' => $this->image->getIdentity(), 'format' => 'smoothbox'), $this->translate('Edit'), array('class' => 'smoothbox')) ?>

                - <?php echo $this->htmlLink(array('route' => "sitevideo_photo_extended", 'controller' => 'photo', 'action' => 'remove', 'photo_id' => $this->image->getIdentity(), 'format' => 'smoothbox'), $this->translate('Delete'), array('class' => 'smoothbox')) ?>
            <?php endif; ?>
