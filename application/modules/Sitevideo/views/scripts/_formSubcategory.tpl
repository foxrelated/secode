 ...
 * @version    $Id: _formSubcategory.tpl 6590 2016-3-3 00:00:00Z SocialEngineAddOns $
 * @author     SocialEngineAddOns
 */
?>

<?php
$defaultProfileFieldId = Engine_Api::_()->getDbTable('metas', 'sitevideo')->defaultProfileId();
$defaultProfileFieldId = "0_0_$defaultProfileFieldId";
$channel_id = Zend_Controller_Front::getInstance()->getRequest()->getParam('channel_id', 0);
$profile_type = 0;

if (!empty($channel_id)) {
    $channel = Engine_Api::_()->getItem('sitevideo_channel', $channel_id);
    $profile_type = Engine_Api::_()->getDbTable('channelCategories', 'sitevideo')->getProfileType(array('categoryIds' => null, 'category_id' => $channel->category_id));
...
<script type="text/javascript">
    ...
    var actionType = '<?php echo $channel_id; ?>';
