...
<?php $sponsored_color = Engine_Api::_()->getApi('settings', 'core')->getSetting('sitevideo.sponsoredcolor', '#FC0505'); ?>
    ...
    window.addEvent('domready', function() {
        var s = new MooRainbow('myRainbow2', {
            ...
            'onChange': function(color) {
                $('sitevideo_sponsoredcolor').value = color.hex;
            }
        });
    });
</script>
...
echo '
	<div id="sponsored_color-wrapper" class="form-wrapper">
		...
		<div id="sponsored_color-element" class="form-element">
			...
			<input name="sitevideo_sponsoredcolor" id="sitevideo_sponsoredcolor" value=' . $sponsored_color . ' type="text">
