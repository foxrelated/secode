 ...
 * @version    $Id: _formEditImage.tpl 6590 2016-3-3 00:00:00Z SocialEngineAddOns $
...
<?php if ($channel->file_id !== null): ?>
    <div>
        <?php echo $this->itemPhoto($channel, 'thumb.profile', "", array('id' => 'lassoImg', 'class' => 'thumb_profile_edit')) ?>
    </div>
    <br />
    <div id="preview-thumbnail" class="preview-thumbnail">
        <?php echo $this->itemPhoto($channel, 'thumb.icon', "", array('id' => 'previewimage')) ?>
    </div>
    <div id="thumbnail-controller" class="thumbnail-controller">
        <?php
        if (!empty($channel->file_id) && $channel->getPhotoUrl())
