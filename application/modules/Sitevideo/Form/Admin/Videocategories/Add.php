 ...
 */
class Sitevideo_Form_Admin_Videocategories_Add extends Engine_Form {
    ...
    public function init() {
        ...
        $this->addElement('Text', 'category_slug', array(
            'label' => 'URL Component',
            'description' => "This will be the end of the URL of your video browse page, for example : $link/videos/categoryid/URL-COMPONENT"
        ));
        ...
        $this->addElement('Textarea', 'top_content', array(
            'label' => 'Top Content',
            'description' => 'Please enter the content to be shown below the category name and above the videos on the category page. (Useful for SEO. For ex: You can enter the category description here.)'
        ));

        $this->addElement('Textarea', 'bottom_content', array(
            'label' => 'Bottom Content',
            'description' => 'Please enter the content to be shown below the videos on the category page. (Useful for SEO.)'
        ));
        if ($isSubCategory == false) {
