 ...
 */
class Sitevideo_Form_Admin_Settings_Mapping extends Engine_Form {

    public function init() {

        $this->setTitle('Delete Category')
                ->setDescription('If you want to map Channels belongs to this category, with other category then select the new category.');

        $this->addElement('dummy', 'message', array(
            'description' => '<div class="tip"><span>Note: If you do not map channels belonging to this category with any other, then channels associated with this category will also be deleted from your website. This data is not recoverable.</span></div>',
        ));
