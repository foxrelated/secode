    ...
    Composer.Plugin.SiteVideo = new Class({
        ...
        activate: function () {
            ...
            if (this.options.embedcodeEnabled == 1) {
                $('compose-video-form-type').options[options++] = new Option(this._lang('Embed Code'), '5');
            }
            ...
            if (DetectMobileQuick() || DetectIpad()) {
                ...
                this.elements.previewDescription = new Element('div', {
                    ...
                    'class': 'compose-video-upload',
                    'html': this._lang('To upload a video from your device, please use our <a href="' + this.options.videoHref + '" ' + additionalAttr + '>full uploader</a>.'),
                    'style': 'display:none;'
                }).inject(this.elements.body);
            }
            else {
