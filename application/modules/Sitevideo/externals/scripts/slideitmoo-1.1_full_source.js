...
Implements: [Events, Options],
        ...
        this.options.contentstartIndex = startindex;
                ...
                url : url,
                        ...
                        {
                        var containerWidth = $(obj.options.overallContainer).getStyle('width');
                        ...
                        $(obj.options.thumbsContainer).innerHTML = responseHTML;
                                ...
                                new SlideItMoo(obj.options).slide(direction);
                        ...
                        $(obj.options.overallContainer).setStyle('width', containerWidth);
                        }
                });
                request.send();
        }
