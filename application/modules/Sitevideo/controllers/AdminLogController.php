 ...
 * @version    $Id: AdminLogController.php 6590 2016-3-3 00:00:00Z SocialEngineAddOns $
 * @author     SocialEngineAddOns
 */
class Sitevideo_AdminLogController extends Core_Controller_Action_Admin {
    ...
    public function indexAction() {
        ...
        $this->view->navigation = Engine_Api::_()->getApi('menus', 'core')
                ->getNavigation('sitevideo_admin_main', array(), 'sitevideo_admin_main_import');
        ...
        foreach (scandir($logPath) as $file) {
            if ($file == 'VideoToSitevideoImport.log') {
        ...
        $this->view->formFilter = $formFilter = new Sitevideo_Form_Admin_Import_Log();
