 ...
 * @version    $Id: AdminFieldsController.php 6590 2016-3-3 00:00:00Z SocialEngineAddOns $
 * @author     SocialEngineAddOns
 */
class Sitevideo_AdminFieldsController extends Fields_Controller_AdminAbstract {
    ...
    public function indexAction() {
        ...
        $this->view->navigationGeneral = Engine_Api::_()->getApi('menus', 'core')
                ->getNavigation('sitevideo_admin_main_fields', array(), 'sitevideo_admin_main_fields_channel');
    ...
    public function fieldCreateAction() {
        ...
        $form->setTitle('Add Channel Question');
        $form->removeElement('show');
        $form->addElement('hidden', 'show', array('value' => 0));

        $display = $form->getElement('display');
        $display->setLabel('Show on Channel View page?');
        $display->setOptions(array('multiOptions' => array(
                1 => 'Show on Channel View page',
                0 => 'Hide from Channel View page'
        )));
    ...
    public function fieldEditAction() {
        ...
        //START CUSTOMIZATION BY SOCIALENGINEADDONS
        $form->setTitle('Edit Channel Question');
        $form->removeElement('show');
        $form->addElement('hidden', 'show', array('value' => 0));
    ...
    public function typeDeleteAction() {
        ...
        if (!empty($option_id)) {
            ...
            Engine_Api::_()->getDbtable('channels', 'sitevideo')->update(array('profile_type' => 0), array('profile_type = ?' => $option_id));

            //DELETE MAPPING
            Engine_Api::_()->getDbtable('channelCategories', 'sitevideo')->update(array('profile_type' => 0), array('profile_type = ?' => $option_id));
        }
