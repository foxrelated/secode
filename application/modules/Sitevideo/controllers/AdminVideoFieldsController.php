 ...
 * @version    $Id: AdminVideoFieldsController.php 6590 2016-3-3 00:00:00Z SocialEngineAddOns $
 * @author     SocialEngineAddOns
 */
class Sitevideo_AdminVideoFieldsController extends Fields_Controller_AdminAbstract {
    ...
    public function indexAction() {
        ...
        $this->view->navigation = Engine_Api::_()->getApi('menus', 'core')
                ->getNavigation('sitevideo_admin_main', array(), 'sitevideo_admin_main_fields');
        $this->view->navigationGeneral = Engine_Api::_()->getApi('menus', 'core')
                ->getNavigation('sitevideo_admin_main_fields', array(), 'sitevideo_admin_main_fields_video');
    ...
    public function fieldEditAction() {
        ...
        //START CUSTOMIZATION BY SOCIALENGINEADDONS
        $form->setTitle('Edit Video Question');
        $form->removeElement('show');
        $form->addElement('hidden', 'show', array('value' => 0));
    ...
    public function typeCreateAction() {
        ...
        // Create form
        $this->view->form = $form = new Sitevideo_Form_Admin_Type();
        ...
        if ($form->getValue('duplicate') != 'null') {
            // Create New Option in engine4_video_fields_options
    ...
    public function typeDeleteAction() {
        ...
        if (!empty($option_id)) {
            ...
            Engine_Api::_()->getDbtable('videos', 'sitevideo')->update(array('profile_type' => 0), array('profile_type = ?' => $option_id));

            //DELETE MAPPING
            Engine_Api::_()->getDbtable('videoCategories', 'sitevideo')->update(array('profile_type' => 0), array('profile_type = ?' => $option_id));
        }
