 ...
 * @version    $Id: CommentController.php 6590 2016-3-3 00:00:00Z SocialEngineAddOns $
 * @author     SocialEngineAddOns
 */
class Sitevideo_CommentController extends Core_Controller_Action_Standard {
    ...
    public function createAction() {
        ...
        $sitevideoComment = Zend_Registry::isRegistered('sitevideoComment') ? Zend_Registry::get('sitevideoComment') : null;
        if (empty($sitevideoComment))
            return;
        ...
        $this->view->body = $this->view->action('list', 'comment', 'sitevideo', array(
            'type' => $this->_getParam('type'),
