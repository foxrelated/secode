 ...
 */
class Sitestoreoffer_Form_ItemOfDayday extends Engine_Form {

  protected $_field;

  public function init() {
    $this->setMethod('post');
    $this->setTitle('Add an Coupon of the Day')
            ->setDescription('Select a start date and end date below.This coupon will be displayed as "Coupon of the Day" for this duration. If more than one coupons of the day are found for a date then randomly one will be displayed.');
