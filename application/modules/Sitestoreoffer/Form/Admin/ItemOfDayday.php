 ...
 * @version    $Id: ItemOfDayday.php 2013-09-02 00:00:00Z SocialEngineAddOns $
 * @author     SocialEngineAddOns
 */
class Sitestoreoffer_Form_Admin_ItemOfDayday extends Engine_Form {

  protected $_field;

  public function init() {
    $this->setMethod('post');
    $this->setTitle('Add a Coupon of the Day')
            ->setDescription('Select a start date and end date below and the corresponding Coupon from the auto-suggest Coupon field. The selected Coupon will be displayed as "Coupon of the Day" for this duration and if more than one coupons are found to be displayed in the same duration then they will be dispalyed randomly one at a time.');

    $label = new Zend_Form_Element_Text('title');
    $label->setLabel('Coupon')
