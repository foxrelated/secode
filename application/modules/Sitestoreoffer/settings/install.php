 ...
 */
class Sitestoreoffer_Installer extends Engine_Package_Installer_Module {
...
//			$db->query("INSERT IGNORE INTO `engine4_sitemobile_modules` (`name`, `visibility`) VALUES ('sitestoreoffer','1')");
//			$select = new Zend_Db_Select($db);
//			$select
...
//					$redirector->gotoUrl($baseUrl . 'admin/sitemobile/module/enable-mobile/enable_mobile/1/name/sitestoreoffer/integrated/0/redirect/install');
//				} 
//      }
//    }
//  }
