...
$application = new Engine_Application(APPLICATION_ENV, array('bootstrap' => array('path' => APPLICATION_PATH . '/application/modules/' . APPLICATION_NAME . '/Bootstrap.php', 'class' => ucfirst(APPLICATION_NAME) . '_Bootstrap', ), 'autoloadernamespaces' => array('Engine_', )));
