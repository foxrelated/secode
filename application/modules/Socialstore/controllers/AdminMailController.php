<?php
class Socialstore_AdminMailController extends Core_Controller_Action_Admin
{
	
	public function init(){
		parent::init();
		Zend_Registry::set('admin_active_menu', 'socialstore_admin_main_emailtemplates');
	}
	

  public function templatesAction()
  {
    $this->view->form = $form = new Socialstore_Form_Admin_Mail_Templates();
    ...
    $this->view->templateObject = $templateObject = Engine_Api::_()->getItem('social_template', $template);
    if( !$templateObject ) {
