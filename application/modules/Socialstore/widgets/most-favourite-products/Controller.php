...
class Socialstore_Widget_MostFavouriteProductsController extends Socialstore_Content_Widget_ProductList{
	public function indexAction(){
		...
		//$this -> view -> title = $this->_getParam('title','Most Favourite');
