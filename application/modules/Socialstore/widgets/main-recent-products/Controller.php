...
class Socialstore_Widget_MainRecentProductsController extends Socialstore_Content_Widget_MainProductList {
	public function indexAction() {
		...
		$this->view->className = "layout_socialstore_main_recent_products";
