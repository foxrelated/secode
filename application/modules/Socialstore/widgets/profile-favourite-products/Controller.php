...
class Socialstore_Widget_ProfileFavouriteProductsController extends Engine_Content_Widget_Abstract {
	public function indexAction() {
		...
		$favouriteTable  = Engine_Api::_()->getDbtable('favourites', 'Socialstore');
		...
		$this->view->className = "layout_socialstore_profile_favourite_products";
	}
