...
?>
	<li class="main-cat">
		...
		<?php echo $this->htmlLink($this->url(array('module'=> 'socialstore', 'controller'=>'product', 'action'=>'listing', 'category_id'=>$cat_id), 'default'),
                    ($cat->name),
                    array('class'=>''))
                    ?>
        <?php $subcat = $cat->getDescendantIds(); ?>
	        <?php 
	        	foreach ($subcat as $cat):
	        		...
	        		<?php 	echo $this->htmlLink($this->url(array('module'=> 'socialstore', 'controller'=>'product', 'action'=>'listing', 'category_id'=>$cat->storecategory_id), 'default'),
                    ($cat->name),
                    array('class'=>'')); ?>
                    </li>
                    <?php endif;
