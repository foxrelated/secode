<?php
class Socialstore_Model_ProductPhoto extends Core_Model_Item_Collectible
{
  protected $_parent_type = 'socialstore_product_album';

  protected $_owner_type = 'user';

  protected $_collection_type = 'socialstore_product_album';
  ...
  {
    return Engine_Api::_()->getItem('social_product', $this->product_id);
  }
