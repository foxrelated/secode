...
include_once  APPLICATION_PATH . '/application/modules/Socialstore/externals/scripts/adaptivelib/CallerServices.php'  ;
include_once  APPLICATION_PATH . '/application/modules/Socialstore/externals/scripts/adaptivelib/Stub/AP/AdaptivePaymentsProxy.php'  ;
include_once  APPLICATION_PATH . '/application/modules/Socialstore/externals/scripts/adaptivelib/SOAPEncoder/SOAPEncoder.php'  ;
include_once  APPLICATION_PATH . '/application/modules/Socialstore/externals/scripts/adaptivelib/XMLEncoder/XMLEncoder.php'  ;
include_once  APPLICATION_PATH . '/application/modules/Socialstore/externals/scripts/adaptivelib/JSONEncoder/JSONEncoder.php'  ;
...
class AdaptivePayments extends CallerServices {
	...
	private function callAPI($request, $URL,$SerializeOption=null)
	{
		...
		try {
			 ...
			 Zend_Registry::get('Zend_Log')->log(print_r($request,true), 7);
			switch(X_PAYPAL_REQUEST_DATA_FORMAT) {
				case "JSON" :
					...
					break;
				case "SOAP11" :
					$requestXML = SoapEncoder::Encode($request,$SerializeOption);
					$response = parent::call($request,$requestXML, $URL);
					break;
				case "XML" :
