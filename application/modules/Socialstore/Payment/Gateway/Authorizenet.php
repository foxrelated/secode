 ...
 */
class Socialstore_Payment_Gateway_Authorizenet extends Socialstore_Payment_Gateway_Abstract
{
    ...
    const GATEWAY_URL   = 'https://secure.authorize.net/gateway/transact.dll';
    ...
    protected function _initQueryOrderAddresses($order)
    {
        ...
        /*if ($billing) {
        	$values = Zend_Json::decode($billing->value);
            $this->_queryParams['x_first_name'] = $values['fullname'];
            $this->_queryParams['x_address']    = $values['street'];
            $this->_queryParams['x_city']       = $values['city'];
            $this->_queryParams['x_state']      = $values['region'];
            $this->_queryParams['x_zip']        = $values['postcode'];
            $this->_queryParams['x_country']    = $values['country'];
            $this->_queryParams['x_phone']      = $values['phone'];
        }*/
       /* if ($shipping) {
