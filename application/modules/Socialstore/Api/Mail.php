...
class Socialstore_Api_Mail extends Core_Api_Abstract {
	/**
 ...
 public function create()
  {
	 ...
	 */
  	public function getTemplate($type, $locale = 'en') {
		...
		$table = Engine_Api::_()->getDbtable('SocialTemplates', 'Socialstore');
    ...
    $mailTemplateTable = Engine_Api::_()->getDbtable('SocialTemplates', 'Socialstore');
	...
	$vars = array();
    $params = Engine_Api::_()->getApi('ConvertMailVars', 'Socialstore')->process($params, $vars, $type);
    ...
    foreach( $recipients as $recipient ) {
	  ...
	  Engine_Api::_()->getDbTable('emails','Socialstore')->add(array(
			...
			'body_html'=>$bodyHtmlTemplate,
			'body_text'=>$bodyTextTemplate			
		));
  ...
  public function sendRaw($mail) {
	...
	public function sendMailQueue($send_limit =  NULL){
		...
		$table =Engine_Api::_()->getDbTable('emails','Socialstore');
