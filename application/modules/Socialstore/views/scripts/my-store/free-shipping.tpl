...
<?php if (count($this->methods) <= 0) : ?>
	<div class="tip">
		<span>
			<?php echo $this->translate("You have no free shipping yet!") ?>
	  </span>
	</div>
<?php else: ?>
		...
		<table class="admin_table">
	        <thead>
	            <tr>
	                  ...
	                  <th class = "ynstore_table_text"><?php echo $this->translate("Minimum Purchase Amount") ?></th>
