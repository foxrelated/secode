...
<div class='global_form'>
  ...
  <form method="post">
    <div>
      <h3><?php echo $this->translate("Delete the selected Store(s)?") ?></h3>
      <p>
        <?php echo $this->translate("Are you sure that you want to delete the selected store(s)? They will not be recoverable after being deleted.") ?>
      </p>
      <br />
      <p>
  ...
  <?php else: ?>
    <?php echo $this->translate("Please select a store to delete.") ?> <br/><br/>
