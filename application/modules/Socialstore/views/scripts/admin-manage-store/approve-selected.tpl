...
<div class='global_form'>
  ...
  <form method="post">
    <div>
      <h3><?php echo $this->translate("Approve the selected Stores?") ?></h3>
      <p>
        <?php echo $this->translate("Are you sure that you want to approve the selected stores?") ?>
      </p>
      <br />
      <p>
  ...
  <?php else: ?>
    <?php echo $this->translate("Please select a store to approve.") ?> <br/><br/>
