...
#global_page_socialstore-gda-requests form#filter_form {
    height: 35px;

}
#global_page_socialstore-gda-requests form#filter_form div {
    height: 20px;
    float: left;
    margin-left: 15px;
}
#global_page_socialstore-gda-requests  form#filter_form div div.buttons button#productsearch {
    margin-top: 6px;
}
#global_page_socialstore-gda-requests #status-element
{
    height: 25px !important;
}
#global_page_socialstore-gda-requests #status-label
{
    float: none !important;
    height: 15px !important;
}
#global_page_socialstore-gda-requests #gda
{
    margin-top: 7px;
}
 </style>
