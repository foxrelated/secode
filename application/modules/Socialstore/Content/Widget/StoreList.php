<?php
class Socialstore_Content_Widget_StoreList extends Engine_Content_Widget_Abstract {
	...
	public function init() {
		...
		$this -> setScriptPath('application/modules/Socialstore/views/scripts/widgets/store-list');
