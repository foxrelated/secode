...
class Advgroup_Form_Admin_Global extends Engine_Form
{
  public function init()
  {
    ...
    $this->addElement('Text', 'advgroup_page', array(
      ...
      $this->addElement('Text', 'advgroup_addthis_pubid', array(
          'label' => 'AddThis - Profile ID',
          'required' => true,
          'value' => Engine_Api::_()->getApi('settings', 'core')->getSetting('advgroup.addthis.pubid', 'younet'),
      ));
   ...
   public function saveValues()
  {
	...
	Engine_Api::_()->getApi('settings','core')->setSetting('advgroup_addthis_pubid',$values['advgroup_addthis_pubid']);
