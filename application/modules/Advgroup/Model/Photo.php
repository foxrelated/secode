<?php
class Advgroup_Model_Photo extends Core_Model_Item_Collectible
{
	protected $_parent_type = 'advgroup_album';

	protected $_owner_type = 'user';

	protected $_collection_type = 'advgroup_album';
	...
	public function getHref($params = array())
	{
		$params = array_merge(array(
			...
			'controller' => 'photo',
			'action' => 'view',
			'group_id' => $this -> getCollection() -> getGroup() -> getIdentity(),
	...
	public function setPhoto($photo)
	{
		...
		if ($angle != 0)
				$image -> rotate($angle);
		@$image -> resize(140, 105) -> write($normalPath) -> destroy();
