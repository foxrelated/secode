...
<div class="generic_layout_container layout_main advgroup_list">
	...
	<div class="generic_layout_container layout_middle">
		...
		<div class="group_discussions_options">
			...
			<?php echo $this->htmlLink(array('route' => 'group_extended', 'controller'=>'ynultimatevideo','action'=>'list','subject' => $this->subject()->getGuid()), $this->translate('Browse Videos'), array(
        ...
        <?php foreach ($this->paginator as $item): ?>
            <li>
                ...
                <div class='video_options'>
					...
					$select = $table -> select() -> where("group_id = ?", $this->group->group_id) -> where('item_id = ?', $item->getIdentity()) -> where("type = 'ynultimatevideo_video'") -> limit(1);
