	...
	<!-- Menu Bar -->
		...
		<div class="group-profile-header-content">
			<?php if( $this->paginator->getTotalItemCount() > 0 ): ?>
				...
				<?php echo $this-> translate(array("ynmusic_album_count", "Albums", $this->paginator->getTotalItemCount()), $this->paginator->getTotalItemCount());?>
			<?php endif; ?>
		</div>
		<?php if( $this->paginator->getTotalItemCount() > 0 ): ?>
		<div id="ynmusic_listing_album_<?php echo $this->identity;?>" class="music-listing">
			<div id="ynmusic-listing-content-<?php echo $this ->identity;?>" class="ynmusic-listing-content">
				<?php echo $this->partial('_album-listing.tpl', 'ynmusic', array('paginator' => $this->paginator, 'formValues' => $this->formValues, 'paging' => false, 'ajaxPaging' => true, 'group_id' => $this->subject()->getIdentity()));?>
			</div>
