...
<div class="generic_layout_container layout_main advgroup_list">
	...
	<!-- Menu Bar -->
		<div class="group_discussions_options">
			<?php if ($this->canCreate):?>
				<?php echo $this->htmlLink(array(
					...
					'parent_type' => 'group',
				), $this->translate('Create Song'), array(
		...
		<?php if( $this->paginator->getTotalItemCount() > 0 ): ?>
		<div id="ynmusic_listing_songs_<?php echo $this->identity;?>" class="music-listing">
			<div id="ynmusic-listing-content-<?php echo $this ->identity;?>" class="ynmusic-listing-content">
				<?php echo $this->partial('_song-listing.tpl', 'ynmusic', array('paginator' => $this->paginator, 'formValues' => $this->formValues, 'paging' => false, 'ajaxPaging' => true, 'group_id' => $this->subject()->getIdentity()));?>
			</div>
		...
		en4.core.runonce.add(function(){
		    <?php if (!$this->renderOne): ?>
		        ...
		        var anchor = $('ynmusic_listing_songs_<?php echo $this->identity;?>').getParent();
