 ...
 */
class Sitestorealbum_AdminAlbumController extends Core_Controller_Action_Admin {
  ...
  public function indexAction() {
    ...
    $this->view->subNavigation = $subNavigation = Engine_Api::_()->getApi('menus', 'core')->getNavigation('sitestorealbum_admin_submain', array(), 'sitestorealbum_admin_submain_album_tab');
    $this->view->tabs = Engine_Api::_()->getItemTable('seaocore_tab')->getTabs(array('module' => 'sitestorealbum', 'type' => 'albums'));
  }
  ...
  public function manageDayItemsAction() {
    ...
    $this->view->navigationStore = Engine_Api::_()->getApi('menus', 'core')
		...
		//TAB CREATION
    $this->view->navigation = Engine_Api::_()->getApi('menus', 'core')->getNavigation('sitestorealbum_admin_main', array(), 'sitestorealbum_admin_widget_settings');
    $this->view->subNavigation = $subNavigation = Engine_Api::_()->getApi('menus', 'core')->getNavigation('sitestorealbum_admin_submain', array(), 'sitestorealbum_admin_submain_dayitems');
    ...
    $this->view->albumOfDaysList = $albumOfDay = Engine_Api::_()->getDbtable('itemofthedays', 'sitestore')->getItemOfDayList($values, 'album_id', 'sitestore_album');
    $albumOfDay->setItemCountPerPage(50);
    $albumOfDay->setCurrentPageNumber($store);
  }
  ...
  public function addAlbumOfDayAction() {
    ...
    //FORM GENERATION
    $form = $this->view->form = new Sitestorealbum_Form_Admin_ItemOfDayday();
    ...
    if ($this->getRequest()->isPost() && $form->isValid($this->getRequest()->getPost())) {
      ...
      try {
        ...
        $select = $dayItemTime->select()->where('resource_id = ?', $values["resource_id"])->where('resource_type = ?', 'sitestore_album');
  ...
  public function editTabAction() {
    //FORM GENERATION
    $this->view->form = $form = new Sitestorealbum_Form_Admin_EditTab();
  ...
  public function enabledAction() {
    ...
    $this->_redirect('admin/sitestorealbum/album');
  }
}
