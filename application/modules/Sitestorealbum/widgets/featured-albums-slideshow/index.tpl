...
foreach ($this->show_slideshow_object as $type => $album) {
  ...
  if (!empty($album->title)) {
    ...
    $sitestore_object = Engine_Api::_()->getItem('sitestore_store', $album->store_id);
    ...
    $image_text_var .= $this->translate("in ") . $this->htmlLink(Engine_Api::_()->sitestore()->getHref($album->store_id, $album->owner_id, $album->getSlug()),  $store_title,array('title' => $sitestore_object->title)); 
    $image_text_var .= "</div>";
    ...
    window.addEvent('domready',function(){
     ...
     for(var i=0;i < divElements.length;i++)
      ...
      var nS8 = new noobSlide({
        box: $('sitestorealbum_featured_album_im_te_advanced_box'),
        items: $$('#sitestorealbum_featured_album_im_te_advanced_box h3'),
        size: (width-10),
        handles: $$('#handles8 span'),
        addButtons: {previous: $('sitestorealbum_featured_album_prev8'), stop: $('sitestorealbum_featured_album_stop8'), play: $('sitestorealbum_featured_album_play8'), next: $('sitestorealbum_featured_album_next8') },
        interval: 5000,
        fxOptions: {
          duration: 500,
          transition: '',
        ...
        onWalk: function(currentItem,currentHandle){
          ...
          {
            $('sitestorealbum_featured_album_caption').innerHTML =   current_caption_link;
          }
          else {
            $('sitestorealbum_featured_album_caption').innerHTML =  '';
          }


          $('sitestorealbum_featured_album_current_numbering').innerHTML =  current_index + '/' + num_of_slidehsow ;
        }
      });
...
<div class="featured_slideshow_wrapper">
  <div class="featured_slideshow_mask">
    <div id="sitestorealbum_featured_album_im_te_advanced_box" class="featured_slideshow_advanced_box">
  ...
  <div class="featured_slideshow_option_bar">
    <div>
      <p class="buttons">
        <span id="sitestorealbum_featured_album_prev8" class="featured_slideshow_controllers-prev featured_slideshow_controllers prev" title=<?php echo $this->translate("Previous") ?> ></span>
        <span id="sitestorealbum_featured_album_stop8" class="featured_slideshow_controllers-stop featured_slideshow_controllers" title=<?php echo $this->translate("Stop") ?> ></span>
        <span id="sitestorealbum_featured_album_play8" class="featured_slideshow_controllers-play featured_slideshow_controllers" title=<?php echo $this->translate("Play") ?> ></span>
        <span id="sitestorealbum_featured_album_next8" class="featured_slideshow_controllers-next featured_slideshow_controllers" title=<?php echo $this->translate("Next") ?> ></span>
      </p>
    </div>
    <span id="sitestorealbum_featured_album_caption"></span>
    <span id="sitestorealbum_featured_album_current_numbering" class="featured_slideshow_pagination"></span>
  </div>
</div>  
