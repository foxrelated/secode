...
if (Engine_Api::_()->getDbtable('modules', 'core')->isModuleEnabled('sitestoremember')) {
	...
	$showContent_cover['joinButton'] = 'Join Store Button';
...
return array(
    array(
        'title' => 'Store Profile Albums',
        'description' => 'This widget forms the Albums tab on the Store Profile and displays the albums of the Store. It also displays the photos added by the Store visitors other than the owner. It should be placed in the Tabbed Blocks area of the Store Profile.',
    ...
    array(
        'title' => 'Store Profile Random Albums',
        'description' => 'Displays random albums and photos of Store on its Profile.',
        'category' => 'Stores / Marketplace - Store Profile',
        'type' => 'widget',
    ...
    array(
        'title' => 'Store Profile Most Commented Photos',
        'description' => 'Displays list of store’s most commented photos. This widget should be placed on the Store Profile.',
        'category' => 'Stores / Marketplace - Store Profile',
        'type' => 'widget',
    ...
    array(
        'title' => 'Store Profile Most Liked Photos',
        'description' => 'Displays list of store’s most liked photos. This widget should be placed on the Store Profile.',
        'category' => 'Stores / Marketplace - Store Profile',
        'type' => 'widget',
    ...
    array(
        'title' => 'Store Profile Photos Strip',
        'description' => "Displays some photos out of all the albums of a Store in a strip. Store Admin can choose which photos to be shown in the strip by hiding the ones that should not be displayed. Hidden photos are replaced by new photos and so on. This widget should be placed on the Store Profile.",
        'category' => 'Stores / Marketplace - Store Profile',
        'type' => 'widget',
    ...
    array(
        'title' => 'Recent Photos',
        'description' => 'Displays list of recent photos of stores on the site.',
        'category' => 'Stores / Marketplace - Stores',
        'type' => 'widget',
        'name' => 'sitestore.mostrecentphotos-sitestore',
        'defaultParams' => array(
            'title' => 'Recent Photos',
            'titleCount' => '',
        ),
        'adminForm' => array(
            'elements' => array(
                ...
                array(
                    ...
                    'showStoreName',
                    array(
                        'label' => 'Do you want to show the Store name along with the photos ?',
                        'multiOptions' => array(
                            1 => 'Yes',
                            0 => 'No'
                        ),
    ...
    array(
			'title' => 'Search Store Albums form',
			'description' => 'Displays the form for searching Store Albums on the basis of various filters. You can edit the fields to be available in this form.',
			'category' => 'Stores / Marketplace - Stores',
			'type' => 'widget',
			...
			'adminForm' => array(
              'elements' => array(
							array(
									...
									'search_column',
									array(
											'label' => 'Choose the fields that you want to be available in the Search Store Albums form widget.',
											'multiOptions' => array("1" => "Show","2" => "Browse By", "3" => "Store Title", "4" => "Album Title", "5" => "Store Category"),
									),
							),
					),
			)
    ...
    array(
        'title' => 'Store Albums',
        'description' => 'Displays the list of Albums from Stores created on your community. This widget should be placed in the widgetized Store Albums store. Results from the Search Store Albums form are also shown here.',
        'category' => 'Stores / Marketplace - Stores',
        'type' => 'widget',
    ...
    array(
        ...
        'description' => 'Displays the Albums from Paid Stores. You can choose the number of entries to be shown.',
        'category' => 'Stores / Marketplace - Stores',
        'type' => 'widget',
        'name' => 'sitestorealbum.sitestore-sponsoredalbum',
        'defaultParams' => array(
            'title' => 'Sponsored Albums',
            'titleCount' => true,
        ),
    ...
    array(
			'title' => 'Store Album View',
			'description' => "This widget should be placed on the Store Album View Page.",
      'category' => 'Stores / Marketplace - Stores',
			'type' => 'widget',
  ...
  array(
        'title' => 'Store’s Photo of the Day',
        'description' => 'Displays the Photo of the Day as selected by the Admin from the Photo Album >> Photo of the Day section of this plugin.',
        'category' => 'Stores / Marketplace - Stores',
        'type' => 'widget',
  ...
  array(
        'title' => 'Most Liked Photos',
        'description' => 'Displays list of store’s most liked photos.',
        'category' => 'Stores / Marketplace - Stores',
        'type' => 'widget',
    ...
    array(
        'title' => 'Most Commented Photos',
        'description' => 'Displays list of store’s most commented photos.',
        'category' => 'Stores / Marketplace - Stores',
        'type' => 'widget',
    ...
    array(
        ...
        'category' => 'Stores / Marketplace - Stores',
        'type' => 'widget',
        'name' => 'sitestore.homephotocomment-sitestore',
        'defaultParams' => array(
            'title' => 'Most Commented Photos',
            'titleCount' => '',
        ),
    ...
    array(
        'title' => 'Store’s Featured Photos Carousel',
    ...
    array(
        'title' => 'Store’s Ajax based Tabbed widget for Photos',
        'description' => ' Displays the Recent, Most Liked, Most Viewed, Most Commented and Featured Photos in separate AJAX based tabs. Settings for this widget are available in the Widget Settings section of Photo Albums section.',
        'category' => 'Stores / Marketplace - Stores',
        'type' => 'widget',
    ...
    array(
        'title' => 'Store’s Ajax based Tabbed widget for Albums',
        'description' => ' Displays the Recent, Most Liked, Most Viewed, Most Commented and Featured Albums in separate AJAX based tabs. Settings for this widget are available in the Widget Settings section of Photo Albums section.',
        'category' => 'Stores / Marketplace - Stores',
        'type' => 'widget',
    ...
    array(
        'title' => 'Store’s Featured Albums Slideshow',
    ...
    array(
        'title' => 'Store Albums Browse Store',
        'description' => 'Displays the link to view Store’s Albums Browse store.',
        'category' => 'Stores / Marketplace - Stores',
        'type' => 'widget',
    ...
    array(
        'title' => 'Store’s Album of the Day',
        'description' => 'Displays the Album of the Day as selected by the Admin from the widget settings section of Photo Albums section.',
        'category' => 'Stores / Marketplace - Stores',
        'type' => 'widget',
    ...
    array(
    'title' => 'Top Creators : Store Albums',
    'description' => 'Displays the Stores which have the most number of Store Albums added in them. Motivates Store Admins to add more content on your website.',
    'category' => 'Stores / Marketplace - Stores',
    'type' => 'widget',
    'name' => 'sitestorealbum.topcreators-sitestorealbum',
   // 'isPaginated' => true,
    'defaultParams' => array(
      'title' => 'Top Creators',
    ),
    ...
    array(
        ...
        'description' => 'Displays the store cover photo with store profile photo, title and various action links that can be performed on the store from their Profile store (Like, Follow, etc.). You can choose various options from the Edit Settings of this widget. This widget should be placed on the Store Profile page.',
        'category' => 'Stores / Marketplace - Store Profile',
        'type' => 'widget',
