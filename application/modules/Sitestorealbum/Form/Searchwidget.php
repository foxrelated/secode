 ...
 */
class Sitestorealbum_Form_Searchwidget extends Engine_Form {
  ...
  public function init() {
    ...
    $this->setAction($view->url(array(), 'sitestorealbum_browse', true))->getDecorator('HtmlTag')->setOption('class', '');
  }
  ...
  public function getAdditionalOptionsElement() {
    ...
    $select_content = $coreContent_table->select()->where('name = ?', 'sitestorealbum.search-sitestorealbum');
     ...
     if (in_array("3", $enabledColumns)) {
      ...
      $show_multiOptions["creation_date"] = "Everyone’s Albums";
			...
			if(!empty($viewer_id)) {
				...
				$show_multiOptions["my_like"] = 'Albums of Stores I Like';
			}
      ...
      $this->addElement('Select', 'show', array(
              ...
              'onchange' => $this->gethasMobileMode() ? '' : 'searchSitestorealbums();',
              'order' => $row->order - 2,
      ));
