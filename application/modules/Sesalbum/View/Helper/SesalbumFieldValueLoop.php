 ...
 * @version    $Id: SesalbumFieldValueLoop.php 2015-06-16 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */
class Sesalbum_View_Helper_SesalbumFieldValueLoop extends Fields_View_Helper_FieldAbstract {

  public function sesalbumFieldValueLoop($subject, $partialStructure) {
    ...
    if ($module == 'sesalbum' && $controller == 'admin-manage' && $action == 'view')
      $show_hidden = false;
    else 
