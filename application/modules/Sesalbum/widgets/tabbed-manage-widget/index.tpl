...
<div class="sesbasic_v_tabs_container sesbasic_clearfix sesbasic_bxs">
  <div class="sesbasic_v_tabs sesbasic_clearfix" id="sesalbum_tabbed_widget_container_<?php echo $randonNumber; ?>"> 
    <ul id="tab-widget-sesalbum-<?php echo $randonNumber; ?>">
      ...
      <?php } ?>
      <li>
      	<a href="<?php echo $this->url(array('action' => 'create','controller'=>'index'),'sesalbum_general',true); ?>">
		 	 <?php echo $this->translate("Add New Photos"); ?></a></li>
    </ul>
  </div>
           ...
           ?>
            ...
            <?php }
             ...
             <?php } ?>             
              ...
              ?>
              	<a href="javascript:void(0);" class="sesalbum_list_grid_option_button sesalbum_icon_btn"><i class="fa fa-ellipsis-v"></i></a>
                <div class="sesalbum_option_box">
                  <?php if($editItem){ ?>
                    <a href="<?php echo $this->url(array('module' => 'sesalbum', 'action' => 'editphotos', 'album_id' => $photo->album_id), 'sesalbum_specific', true); ?>" title="<?php echo $this->translate('Manage Photos');?>"><i class="fa fa-picture-o"></i><?php echo $this->translate('Manage Photos');?></a>
                    <a href="<?php echo $this->url(array('module' => 'sesalbum', 'action' => 'edit', 'album_id' => $photo->album_id), 'sesalbum_specific', true); ?>" title="<?php echo $this->translate('Edit Settings');?>"><i class="fa fa-pencil"></i><?php echo $this->translate('Edit Settings');?></a>
                   <?php } ?>
                   <?php if($deleteItem){ ?>
                    <a href="<?php echo $this->url(array('module' => 'sesalbum', 'action' => 'delete', 'album_id' => $photo->album_id), 'sesalbum_specific', true); ?>" class="smoothbox sesalbum_album_thumb_delete manageLinkClickSesalbum" title="<?php echo $this->translate('Delete Album');?>"><i class="fa fa-trash"></i><?php echo $this->translate('Delete Album');?></a>
                  <?php } ?>
                </div>
              <?php } ?>
             </span>
