...
<div class="admin_seaocore_files_wrapper">
    <ul class="admin_seaocore_files seaocore_faq">
        <li>
            <a href="javascript:void(0);" onClick="faq_show('faq_<?php echo $i; ?>');"><?php echo $this->translate('What should i do to configure push notifications with my ios app?'); ?></a>
            <div class='faq' style='display: none;' id='faq_<?php echo $i++; ?>'>
                <div class="code">
                    <?php echo $this->translate('To configure push notification to your ios app follow the below steps:'); ?>
                    <br />
                    <?php echo $this->translate('Step 1: Generate <a href="https://developers.google.com/cloud-messaging/" target="_blank">Google API Key</a> for your ios app and enter it in <a href="' . $GlobalTabUrl . '">Global Settings</a> form.'); ?>
                    <br />
                    <?php echo $this->translate('Step 2: Send "device_uuid" and "token" to your ios device with login and signup api call.'); ?><br />
                    <?php echo $this->translate('Step 3: Congratulation !! push notification has been configured for your ios app. You may also enable / disable these notifications from <a href="' . $pushNotificationTabUrl . '">Push Notification Settings</a>.'); ?>
                </div>
            </div>
        </li>
        <li>
            ...
            <div class='faq' style='display: none;' id='faq_<?php echo $i++; ?>'>
                <div class="code">
                    ...
                    <?php echo $this->translate('Step 3: It might be that you have not sent "device_uuid" or "token" with login or signup api call.'); ?><br />
                    <?php echo $this->translate('Step 4: It might be that your sent "device_uuid" and "token" is not valid.'); ?>
                </div>
            </div>
        </li>
        <li>
            ...
            <div class='faq' style='display: none;' id='faq_<?php echo $i++; ?>'>
                <div class="code">
                    <?php echo $this->translate('Yes, you need to send "device_uuid" and "token" with login or signup api call.'); ?>
                </div>
            </div>
        </li>
        <li>
