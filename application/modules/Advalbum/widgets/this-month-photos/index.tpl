...
<?php if ($this->is_ajax): ?>
<div id="photo_listing_this_month<?php echo $strRand?>"></div>
<script type="text/javascript">
 function do_onload() {
    var l = document.getElementById('photo_listing_this_month<?php echo $strRand?>');
    ...
    var limit = <?php echo $this->limit?>;
     var makeRequest = new Request(
            {
                url: en4.core.baseUrl + "advalbum/ajax/this-month-photos/rand/"+rand+"/number/"+ limit,
...
<?php
	$css = "global_form_box";
	$photo_listing_id = 'advalbum_this_month_photos';
