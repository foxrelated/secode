...
<?php if ($this->is_ajax): ?>
<div id="photo_listing_most_liked<?php echo $strRand?>"></div>
<script type="text/javascript">
 function do_onload() {
    var l = document.getElementById('photo_listing_most_liked<?php echo $strRand?>');
    ...
    var makeRequest = new Request(
            {
                url: en4.core.baseUrl + "advalbum/ajax/most-liked-photos/rand/"+rand+"/number/"+ limit,
...
$photo_listing_id = 'advalbum_most_liked_photos';
