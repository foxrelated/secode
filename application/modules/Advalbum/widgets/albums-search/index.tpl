<?php
$this->headLink()
        ->prependStylesheet($this->layout()->staticBaseUrl.'application/modules/Advalbum/widgets/albums-search/styles.css')
?>
...
<div>
	<div style="margin-bottom:15px;">
    	...
    	<ul class="advalbum_color_patterns clearfix">
    		...
    		<?php endif;?>
    		<br><br>
    		<p> <button name="Search" id="advalbum_button_search" type="submit"><?php echo $this -> translate("Search")?></button></p>
    	</ul>	
