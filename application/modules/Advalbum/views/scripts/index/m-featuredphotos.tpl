...
<?php $tmp = date("YmdHis"); ?>
<link rel="stylesheet" href="<?php echo $this->layout()->staticBaseUrl ?>application/modules/Advalbum/externals/slideshow/idangerous.swiper.css">
<?php
...
<script type="text/javascript" src="<?php echo $this->layout()->staticBaseUrl ?>application/modules/Advalbum/externals/slideshow/jquery.min.js"></script>
