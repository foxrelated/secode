...
function check_send(error_message,result){
 ...
 function do_send() {
      ...
      var photo_title   =   $("photo_title").value;
      var sender_href   =   $("sender_href").value;
        new Request.JSON({
    ...
    <div id="div_minitoolbar" style="padding:8px 0px 8px 0px;">
      ...
      <script type="text/javascript">
       ...
       <div class="minitoolbar" style="vertical-align:bottom; padding-left: 2px;">
          <div id = "url" style="float:left"><img src="<?php echo $this->layout()->staticBaseUrl; ?>application/modules/Advalbum/externals/images/icons/icon_url.png" alt="" align="absmiddle"> <?php echo $this->translate("URL")?></div>
          <div id="url_inactive" style="display:none; float:left"><a href="javascript:void(0)" onclick="get_url('url','<?php echo selfURL();?>albums/photo/view/album_id/<?php echo $this->photo->album_id; ?>/photo_id/<?php echo $this->photo->getIdentity(); ?>')"><img src="<?php echo $this->layout()->staticBaseUrl; ?>/application/modules/Advalbum/externals/images/icons/icon_url.png" alt="" align="absmiddle"> <?php echo $this->translate("URL")?></a></div>
          <div style="float:left">&nbsp; | &nbsp;</div>
          <div id = "html_code" style="display:none; float:left"><img src="<?php echo $this->layout()->staticBaseUrl; ?>application/modules/Advalbum/externals/images/icons/icon_html.png" alt="" align="absmiddle"> <?php echo $this->translate("HTML code")?></div>
          <div style="float:left" id = "html_code_inactive"><a href="javascript:void(0)" onclick='get_url("html_code",html_code_for_blog)'><img src="<?php echo $this->layout()->staticBaseUrl; ?>application/modules/Advalbum/externals/images/icons/icon_html.png" alt="" align="absmiddle"> <?php echo $this->translate("HTML code")?></a></div>
          <div style="float:left">&nbsp; | &nbsp;</div>
          <div id = "bb_code" style="display:none; float:left"><img src="<?php echo $this->layout()->staticBaseUrl; ?>application/modules/Advalbum/externals/images/icons/icon_forum.png" alt="" align="absmiddle"> <?php echo $this->translate("Forum code")?></div>
          <div id = "bb_code_inactive" style="float:left"><a  href="javascript:void(0)" onclick='get_url("bb_code",url_forum)'><img src="<?php echo $this->layout()->staticBaseUrl; ?>application/modules/Advalbum/externals/images/icons/icon_forum.png" alt="" align="absmiddle"> <?php echo $this->translate("Forum code")?></a></div>
          <div style="float:left">&nbsp; | &nbsp;</div>
          <div id = "send_friend" style="display:none; float:left"><img src="<?php echo $this->layout()->staticBaseUrl; ?>application/modules/Advalbum/externals/images/icons/icon_send.png" alt="" align="absmiddle"> <?php echo $this->translate("Send to friend")?></div>
          <div id = "send_friend_inactive" style="float:left"><a  href="javascript:void(0)" onclick="show_send_friend('div_send_friend')"><img src="<?php echo $this->layout()->staticBaseUrl; ?>application/modules/Advalbum/externals/images/icons/icon_send.png" alt="" align="absmiddle"> <?php echo $this->translate("Send to friend")?></a></div>
          <div style="float:left">&nbsp; | &nbsp;</div>
          <div id = "send_yahoo" style="display:none; float:left"><img src="<?php echo $this->layout()->staticBaseUrl; ?>application/modules/Advalbum/externals/images/icons/icon_yahoo.png" alt="" align="absmiddle"> <?php echo $this->translate("Send to yahoo")?></div>
          <div id = "send_yahoo_inactive" style="float:left"><a  href="ymsgr:sendIM?m=%20<?php echo selfURL();?>albums/photo/view/album_id/<?php echo $this->photo->album_id; ?>/photo_id/<?php echo $this->photo->getIdentity(); ?>"><img src="<?php echo $this->layout()->staticBaseUrl; ?>application/modules/Advalbum/externals/images/icons/icon_yahoo.png" alt="" align="absmiddle"> <?php echo $this->translate("Send to yahoo")?></a></div>
        </div>
        <div style="clear:both"></div>
        </div>
        ...
        <div id="photo_view_form_comment" style="padding-left:4px;">
          <div id="div_send_friend" style="border:1px #CCCCCC solid; display:none; width:90%; padding: 10px;"  class="border_box paddingbox">
              <?php if(Engine_Api::_()->user()->getViewer()->getIdentity() == 0): ?>
                  ...
                  <input type="hidden" name="sender_href" id="sender_href" value="" />
              <?php else: ?>
                  <input type="hidden" name="name" id="name" value="<?php echo Engine_Api::_()->user()->getViewer()->getTitle(); ?>" />
                  <input type="hidden" name="sender_href" id="sender_href" value="<?php echo Engine_Api::_()->user()->getViewer()->getHref(); ?>" />
              <?php endif; ?>
              ...
              <input type="hidden" name="url_send" id="url_send" value="/albums/photo/view/album_id/<?php echo $this->photo->album_id; ?>/photo_id/<?php echo $this->photo->getIdentity(); ?>" />
              <input type="hidden" name="photo_title" id="photo_title" value="<?php echo $this->photo->getTitle(); ?>" />
