...
<div class="ynmultilisting_widget_location_direction">
...
<div class="ynmultilisting_widget_location_direction get_current_position">
...
<div class="ynmultilisting_widget_location_direction ynmultilisting_widget_location_destination">
	<label for="destination"><?php echo $this->translate("Destination");?></label>
	<img src="application/modules/Ynmultilisting/externals/images/location_pin.png" />
	<span><?php echo $this->listing->location;?></span>
</div>
<div class="ynmultilisting_widget_location_direction ynmultilisting_widget_location_direction_button">
    <label>&nbsp;</label>
...
{
	$('ynmultilisting_location_direction_close_btn').addEvent('click', function(e) {
		$('pac-input').set('value','');
		fromPoint = null;
    });
});
