<script type="text/javascript">
	...
	function multiSelected(action){
	    ...
	    $('multiselect').action = en4.core.baseUrl +'admin/ynmultilisting/packages/multiselected';
...
array('route' => 'admin_default', 'module' => 'ynmultilisting', 'controller' => 'packages', 'action' => 'create'),
'<i class="fa fa-plus"></i>'.$this->translate('Add Package'), 
array(
    'class' => 'buttonlink',
)) ?>
</div>
