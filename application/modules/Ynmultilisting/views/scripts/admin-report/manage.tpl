...
en4.core.runonce.add(function(){
    $$('th.admin_table_short input[type=checkbox]').addEvent('click', function(){
        ...
        var checkboxes =$$('td.ynmultilisting_check input[type=checkbox]');
...
function actionSelected(actionType){
    ...
    $('action_selected').action = en4.core.baseUrl +'admin/ynmultilisting/report/' + actionType + '-selected';
...
<p>
	<?php
		$description = $this->translate('REPORTS_VIEW_YNMULTILISTING_ADMINMANAGE_INDEX_DESCRIPTION');
  ...
  <table class='admin_table'>
    ...
    <tbody>
      <?php foreach ($this->paginator as $item): ?>
        <tr>
          <td class="ynmultilisting_check"><input type='checkbox' class='checkbox' value='<?php echo $item->report_id ?>' /></td>
          ...
          ?>
            ...
            <a href="<?php echo $this->url(array('controller'=>'index', 'action'=>'view', 'id' => $item->listing_id), 'ynmultilisting_general') ?>">
            ...
            <?php echo $this->htmlLink(
                array('route' => 'default', 'module' => 'ynmultilisting', 'controller' => 'admin-report', 'action' => 'delete', 'id' => $item->report_id),
