...
<script type="text/javascript">
	...
	function initialize() {
		var mapOptions = {
	  	...
	  	map = new google.maps.Map(document.getElementById('layout_ynmultilisting_list_most_items-map-canvas'),mapOptions);
...
<div id="layout_ynmultilisting_list_most_items-map-canvas" style="height: 450px;"></div>
