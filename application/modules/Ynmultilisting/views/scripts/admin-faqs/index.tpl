...
function deleteSelected(){
    ...
    $('multidelete').action = en4.core.baseUrl +'admin/ynmultilisting/faqs/multidelete';
...
<p><?php echo $this->translate("YNMULTILISTING_FAQ_MANAGE_DESCRIPTION") ?></p>

<div class="add_link">
<?php echo $this->htmlLink(
    array('route' => 'admin_default', 'module' => 'ynmultilisting', 'controller' => 'faqs', 'action' => 'create'),
    ...
    <table class='admin_table' style="position: relative;">
        ...
        <?php foreach ($this->paginator as $item): ?>
            <tr id="faq-item_<?php echo $item->getIdentity()?>">
                ...
                <td>
                <?php echo $this->htmlLink(
                    array('route' => 'admin_default', 'module' => 'ynmultilisting', 'controller' => 'faqs', 'action' => 'edit', 'id' => $item->faq_id),
                    $this->translate('edit')
                )?>
                |
                <?php echo $this->htmlLink(
                    array('route' => 'admin_default', 'module' => 'ynmultilisting', 'controller' => 'faqs', 'action' => 'delete', 'id' => $item->faq_id),
