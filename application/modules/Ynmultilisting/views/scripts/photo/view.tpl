...
<div class='ynmultilisting_photo_view'>
  ...
  <div class='ynmultilisting_photo_info'>
    ...
    <?php if( $this->photo->getTitle() ): ?>
      <div class="ynmultilisting_photo_title">
    ...
    <div class="ynmultilisting_photo_tags" id="media_tags" class="tag_list" style="display: none;">
    ...
    <div class="ynmultilisting_photo_date">
      ...
      <?php if($this -> viewer -> getIdentity()):?>
	      <?php if( $this->canEdit ): ?>
	        - <?php echo $this->htmlLink(array('route' => 'ynmultilisting_extended', 'controller' => 'photo', 'action' => 'edit', 'photo_id' => $this->photo->getIdentity(), 'format' => 'smoothbox'), $this->translate('Edit'), array('class' => 'smoothbox')) ?>
	        - <?php echo $this->htmlLink(array('route' => 'ynmultilisting_extended', 'controller' => 'photo', 'action' => 'delete', 'photo_id' => $this->photo->getIdentity(), 'format' => 'smoothbox'), $this->translate('Delete'), array('class' => 'smoothbox')) ?>
	      <?php endif; ?>
