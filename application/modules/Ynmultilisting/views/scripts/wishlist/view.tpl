<div class="wishlist-view-info" style="margin-bottom:15px;">
	<div class="wishlist-title"><?php echo $this->wishlist?></div>
	<div class="wishlist-owner">
		<span class="label"><?php echo $this->translate('Created by: ')?></span>
		<span class="owner"><?php echo $this->wishlist->getOwner();?></span>
	</div>
	<div class="wishlist-description">
		<?php echo $this->wishlist->getDescription();?>
	</div>
</div>

<div class="wishlist-listings">
	<?php
	$this->headScript()
	...
	<div id="ynmultilisting_list_item_browse" class="<?php echo $this -> class_mode;?>">
	        ...
	        <ul id="yn_listings_tab_list_browse" class = "main_tabs">
	            <li class="active">
	                <a href="javascript:;" rel="tab_browse_listings" class="selected">
	                   	<?php echo $this->translate(array('%s listing', '%s listings', $this->paginator->getTotalItemCount()), $this->paginator->getTotalItemCount());?>
	                </a>
	            </li>
	        </ul>
	    ...
	    <div id="ynmultilisting_list_item_browse_content" class="ynmultilisting-tabs-content ynclearfix">
	        <div id="tab_listings_browse_listings">
	            <?php
				echo $this->partial('_list_most_item.tpl', 'ynmultilisting', array('listings' => $this->paginator, 'tab' => 'wishlist_listings', 'wishlist' => $this->wishlist));
	            ?>
	        </div>
	    </div>
	    ...
	    <script type="text/javascript">
	        ...
	        var ynmultilisting_view_map_browse = function() {
	            ...
	            var tab = $$('#yn_listings_tab_list_browse li .selected')[0].get('rel');
