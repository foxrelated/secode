...
<table class='admin_table ynsocial_table' style="width: 100%">
  <thead>
    <tr>
      ...
      <th><a href="javascript:void(0);" onclick="javascript:changeOrder('listing.title', 'ASC');"><?php echo $this->translate('Listing') ?></a></th>
  ...
  <tbody>
    <?php foreach ($this->paginator as $item): ?>
      <tr>
        ...
        <?php endif;?>
        <td>
        	<?php $listing = Engine_Api::_() -> getItem('ynmultilisting_listing', $item -> item_id); ?>
        	<?php if($listing) :?>
        		<?php echo $this->htmlLink($listing->getHref(), $listing->getTitle()); ?>
        	<?php else :?>
        		<i><?php echo $this -> translate('Deleted listing');?></i>
        	<?php endif;?>
