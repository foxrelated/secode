...
<?php
  $this->headScript()
    ...
    ->appendFile($this->layout()->staticBaseUrl . 'application/modules/Ynmultilisting/externals/scripts/Autocompleter.js')
...
<script type="text/javascript">
  ...
  en4.core.runonce.add(function() {
    if( !isPopulated ) { // NOT POPULATED
      new Autocompleter2.Request.JSON('to', '<?php echo $this->url(array('module' => 'ynmultilisting', 'controller' => 'editors', 'action' => 'suggest'), 'admin_default', true) ?>', {
        'minLength': 1,
        'delay' : 250,
        'selectMode': 'pick',
