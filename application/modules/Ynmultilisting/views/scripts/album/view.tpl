...
<div class="ynmultilisting_listing_action">
  <?php echo $this->htmlLink(array('route' => 'ynmultilisting_extended', 'controller' => 'album', 'action' => 'list','subject' => $this->listing->getGuid(),'album_id'=>$this->album->getIdentity()), $this->translate('Back to Album List'), array(
