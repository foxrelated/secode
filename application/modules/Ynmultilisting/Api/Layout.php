...
class Ynmultilisting_Api_Layout {
    ...
    /**
     * @var Ynmultilisting_Model_DbTable_Proxies
     */
    ...
    public function getProxyTable() {
        if ($this->_proxyTable === NULL) {
            $this->_proxyTable = Engine_Api::_()->getDbTable('proxies', 'ynmultilisting');
        }
        return $this->_proxyTable;
    }

    /**
     * @return Ynmultilisting_Model_DbTable_Pages
     */
    public function getPagesTable() {
        return Engine_Api::_()->getDbTable('pages', 'ynmultilisting');
    }
     ...
     * @return Ynmultilisting_Model_Proxy
     */
    ...
    public function checkLocked($page_name, $name) {
        if(in_array($name, array('ynmultilisting.main-menu', 'ynmultilisting.listing-type-menu'))) {
            return true;
        }
        return false;
    }
    ...
    /**
     * @return Ynmultilisting_Model_Proxy|NULL
     */
