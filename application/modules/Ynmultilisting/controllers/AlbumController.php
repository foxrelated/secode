<?php
class Ynmultilisting_AlbumController extends Core_Controller_Action_Standard
{
	public function init()
	{
		if (!Engine_Api::_() -> core() -> hasSubject())
		{
			if (0 !== ($album_id = (int)$this -> _getParam('album_id')) && null !== ($album = Engine_Api::_() -> getItem('ynmultilisting_album', $album_id)))
			{
	...
	public function createAction()
	{
		...
		$this -> view -> canUpload = $canUpload = $listing->isAllowed('photo');
        if (!$canUpload) {
            return $this -> _helper -> requireAuth -> forward();
        }
		$this -> view -> form = $form = new Ynmultilisting_Form_Album_Create();
	...
	public function viewAction()
	{
		...
		$this -> view -> listing = $listing = Engine_Api::_() -> getItem('ynmultilisting_listing', $params['listing_id']);
		$this -> view -> album = $album = Engine_Api::_() -> getItem('ynmultilisting_album', $params['album_id']);
	...
	public function editAction()
	{
		...
		$listing = Engine_Api::_() -> getItem('ynmultilisting_listing', $values['listing_id']);
		$album = Engine_Api::_() -> getItem('ynmultilisting_album', $values['album_id']);
		$this -> view -> form = $form = new Ynmultilisting_Form_Album_Edit();
		...
		// Process
		$db = Engine_Api::_() -> getDbtable('albums', 'ynmultilisting') -> getAdapter();
		$db -> beginTransaction();
	...
	public function listAction()
	{
		...
		$viewer = Engine_Api::_() -> user() -> getViewer();
		$this -> view -> listing = $listing = Engine_Api::_() -> core() -> getSubject();
		$this -> view -> form = $form = new Ynmultilisting_Form_Album_Search;
	...
	{
		$params = $this -> _getAllParams();
		$listing = Engine_Api::_() -> getItem('ynmultilisting_listing', $params['listing_id']);
		$album = Engine_Api::_() -> getItem('ynmultilisting_album', $params['album_id']);
		$viewer = Engine_Api::_() -> user() -> getViewer();
		...
		$this -> view -> form = $form = new Ynmultilisting_Form_Album_Delete();
