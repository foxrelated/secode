<?php
class Ynmultilisting_AdminMailController extends Core_Controller_Action_Admin
{

  public function templatesAction()
  {
  	$this->view->navigation = $navigation = Engine_Api::_()->getApi('menus', 'core')
      ->getNavigation('ynmultilisting_admin_main', array(), 'ynmultilisting_admin_main_emailtemplates');
      
    $this->view->form = $form = new Ynmultilisting_Form_Admin_Mail_Templates();
    ...
    // Get template
    $this->view->template = $template = $this->_getParam('template', '2');
    $this->view->templateObject = $templateObject = Engine_Api::_()->getItem('ynmultilisting_mail_template', $template);
    if( !$templateObject ) {
