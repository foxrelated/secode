<?php
class Ynmultilisting_AdminReportController extends Core_Controller_Action_Admin
{
	public function init()
	{
		$this->view->navigation = $navigation = Engine_Api::_()->getApi('menus', 'core')
		->getNavigation('ynmultilisting_admin_main', array(), 'ynmultilisting_admin_main_reports');
	}
		...
		if( $this->getRequest()->isPost() && $confirm == true )
		{
			...
			try{
				...
				foreach( $ids_array as $id ){
					$report = Engine_Api::_()->getItem('ynmultilisting_report', $id);
	...
	public function deleteAction()
	{
		...
		if( $this->getRequest()->isPost())
		{
			...
			try
			{
				$group = Engine_Api::_()->getItem('ynmultilisting_report', $id);
				$group->delete();
				$db->commit();
			}
