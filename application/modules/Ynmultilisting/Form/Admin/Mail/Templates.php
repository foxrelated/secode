...
class Ynmultilisting_Form_Admin_Mail_Templates extends Engine_Form
{
  public function init()
  {
    ...
    foreach( Engine_Api::_()->getDbtable('MailTemplates', 'ynmultilisting')->fetchAll() as $mailTemplate ) {
	  	if($mailTemplate->type == 'ynmultilisting_subscribe_listing')
		{
			continue;
		}
