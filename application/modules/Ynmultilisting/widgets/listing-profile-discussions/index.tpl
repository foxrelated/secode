<?php $empty = true;
  ...
  <div class="ynmultilisting_discussions_list">
    ...
    <?php endif;?>
        ...
        <div style="float:right;margin-right: 10px;">
          <?php echo $this->htmlLink(array(
              ...
              'class'=>'buttonlink item_icon_ynmultilisting_post')); ?>
        </div>
          <?php endif;?>
      </li>
      <?php foreach( $this->paginator as $topic ):
        ...
        <li>
          ...
          <div class="ynmultilisting_discussions_replies">
            ...
            <?php echo $this->translate(array('ynmultilistng_reply_count', 'replies', $topic->post_count - 1), $topic->post_count - 1);?>
          </div>
