...
<div id="ynmultilisting_list_item_browse-most-rated" class="<?php echo $this -> class_mode;?>">
    ...
    <div id="ynmultilisting_list_item_browse-most-rated_content" class="ynmultilisting-tabs-content ynclearfix">
...
<script type="text/javascript">
    ...
    var ynmultilisting_view_map_browse<?php echo $this->identity ?> = function() {
        document.getElementById('ynmultilisting_list_item_browse-most-rated').set('class','ynmultilisting_map-view');
        var tab = '';
        if ($$('.layout_ynmultilisting_most_rated_listing #yn_listings_tab_list_browse li .selected')[0])
        {
            tab = $$('.layout_ynmultilisting_most_rated_listing #yn_listings_tab_list_browse li .selected')[0].get('rel');
        }
        var html =  '<?php echo $this->url(array('action'=>'display-map-view', 'ids' => $this->listingIds), 'ynmultilisting_general') ?>';
		$$('#ynmultilisting_list_item_browse-most-rated_content #browse-iframe').destroy();
        ...
        iframe.inject($$('#ynmultilisting_list_item_browse-most-rated_content')[0]);
    ...
    {   
        ...
        document.getElementById('ynmultilisting_list_item_browse-most-rated').set('class','ynmultilisting_pin-view');
        setCookie('browse_view_mode-<?php echo $this->identity ?>','pin');

        jQuery.noConflict();
        (function (jQuery){
            var handler = jQuery('#ynmultilisting_list_item_browse-most-rated .listing_pin_view_content li');

            handler.wookmark({
                // Prepare layout options.
                autoResize: true, // This will auto-update the layout when the browser window is resized.
                container: jQuery('#ynmultilisting_list_item_browse-most-rated .listing_pin_view_content'), // Optional, used for some extra CSS styling
    ...
    {
        document.getElementById('ynmultilisting_list_item_browse-most-rated').set('class','ynmultilisting_grid-view');
    ...
    {
        document.getElementById('ynmultilisting_list_item_browse-most-rated').set('class','ynmultilisting_list-view');
...
<script type="text/javascript">
    window.addEvent('domready', function(){
    	...
    	$$('.tab_layout_ynmultilisting_most_rated_listing a').addEvent('click', function() {
    		renderViewMode<?php echo $this->identity ?>();
    	});
