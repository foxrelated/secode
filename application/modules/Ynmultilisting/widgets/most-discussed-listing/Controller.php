<?php
class Ynmultilisting_Widget_MostDiscussedListingController extends Engine_Content_Widget_Abstract {
	public function indexAction() {
        ...
        if ($listingtype) {
			...
			$view_mode = $listingtype->most_discussed_widget;
