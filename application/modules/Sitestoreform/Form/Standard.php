...
class Sitestoreform_Form_Standard extends Engine_Form {
    ...
    public function generate() {
        ...
        if (Engine_Api::_()->core()->hasSubject() && isset(Engine_Api::_()->core()->getSubject()->store_id)) {
            $store_id = Engine_Api::_()->core()->getSubject()->store_id;
        } else {
        ...
        $form_title = $select_sitestoreform_result->title;
        $form_description = $select_sitestoreform_result->description;

        if ($select_sitestoreform_result->activeyourname == 1 || $select_sitestoreform_result->activeemail == 1 || ($select_sitestoreform_result->activeemail == 1) || $select_sitestoreform_result->activemessage == 1) {
            $var = 0;
        } else {
            $var = 1;
        }
        ...
        // SEND COPY TO ME
        if (($select_sitestoreform_result->activeemail == 1) && ($select_sitestoreform_result->activeemailself == 1)) {
