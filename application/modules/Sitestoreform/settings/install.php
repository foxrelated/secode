 ...
 */
class Sitestoreform_Installer extends Engine_Package_Installer_Module {
...
//			$db->query("INSERT IGNORE INTO `engine4_sitemobile_modules` (`name`, `visibility`) VALUES ('sitestoreform','1')");
//			$select = new Zend_Db_Select($db);
//			$select
//							->from('engine4_sitemobile_modules')
//							->where('name = ?', 'sitestoreform')
//							->where('integrated = ?', 0);
//			$is_sitemobile_object = $select->query()->fetchObject();
...
//					$redirector->gotoUrl($baseUrl . 'admin/sitemobile/module/enable-mobile/enable_mobile/1/name/sitestoreform/integrated/0/redirect/install');
//				} 
//      }
//    }
//  }
