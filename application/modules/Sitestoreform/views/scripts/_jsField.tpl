 ...
 * @version    $Id: _jsAdmin.tpl 2013-09-02 00:00:00Z SocialEngineAddOns $
...
<script type="text/javascript">
  ...
  var store_id = '<?php echo sprintf('%d', $this->store_id) ?>';
  var logging = true;
  var sortablesInstance;
  var urls = {
    option : {
      create : en4.core.baseUrl + 'sitestoreform/siteform/option-create',
      edit :   en4.core.baseUrl + 'sitestoreform/siteform/option-edit',
      remove : en4.core.baseUrl + 'sitestoreform/siteform/option-delete'
    },
    field : {
      create : en4.core.baseUrl + 'sitestoreform/siteform/field-create',
      edit :   en4.core.baseUrl + 'sitestoreform/siteform/field-edit',
      remove : en4.core.baseUrl + 'sitestoreform/siteform/field-delete'
    },

    map : {
      remove : en4.core.baseUrl + 'sitestoreform/siteform/map-delete'
    },
    order : en4.core.baseUrl + 'sitestoreform/siteform/order',
    index : en4.core.baseUrl + 'sitestoreform/siteform/index'
  };
  ...
  var uiSmoothCreateField = function(spec) {
    ...
    url += '/option_id/' + ids.suboption_id + '/parent_id/' + ids.parent_id +'/store_id/'+store_id+'/format/smoothbox';
    Smoothbox.open(url);
  }

  var uiSmoothTopFieldCreate = function(spec) {
    var url = urls.field.create;
    url += '/option_id/' + topLevelOptionId  +'/parent_id/'+ topLevelFieldId +'/store_id/'+store_id+ '/format/smoothbox';
    Smoothbox.open(url);
  }
  ...
  var uiSmoothEditField = function(spec) {
    ...
    url += '/field_id/' + ids.child_id +'/store_id/'+ store_id + '/format/smoothbox';
    Smoothbox.open(url);
  }
