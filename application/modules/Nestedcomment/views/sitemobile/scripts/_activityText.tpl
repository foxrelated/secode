...
<!--              <span class="sep">-</span>-->
              ...
              <?php if ($commentCount > 0) : echo '<span class="sep">-</span>' ?> 
                <a href="javascript:void(0);" onclick='ActivityAppCommentPopup("<?php echo $this->url(array('module' => 'advancedactivity', 'controller' => 'index', 'action' => 'viewcomment', 'action_id' => $action->getIdentity(), 'showLikeWithoutIcon' => $showLikeWithoutIcon), 'default', 'true'); ?>", "feedsharepopup", <?php echo $action->getIdentity();?>)' class="feed_comments">
...
<!--              <span class="sep">-</span>-->
              <a href="javascript:void(0);" onclick='ActivityAppCommentPopup("<?php echo $this->url(array('module' => 'advancedactivity', 'controller' => 'index', 'action' => 'viewcomment', 'action_id' => $action->getIdentity(), 'showLikeWithoutIcon' => $showLikeWithoutIcon), 'default', 'true'); ?>", "feedsharepopup", <?php echo $action->getIdentity();?>)' class="feed_comments">
                ...
                <span><?php echo $this->translate(array('%s comment', '%s comments',$commentCount), $this->locale()->toNumber($commentCount)); ?></span>
              </a>
            <?php endif; ?>
          </div>	
          ...
          <?php else:?>
            ...
            <?php if (($action->likes()->getLikeCount() > 0 && (count($action->likes()->getAllLikesUsers()) > 0)) || ($action->dislikes()->getDislikePaginator()->getTotalItemCount() > 0)): ?>
              <?php if($action->likes()->getLikeCount() > 0 && (count($action->likes()->getAllLikesUsers()) > 0)):?>
                <a href="javascript:void(0);" onclick='ActivityAppCommentPopup("<?php echo $this->url(array('module' => 'advancedactivity', 'controller' => 'index', 'action' => 'viewcomment', 'action_id' => $action->getIdentity(), 'showLikeWithoutIcon' => $showLikeWithoutIcon), 'default', 'true'); ?>", "feedsharepopup", <?php echo $action->getIdentity();?>)' class="feed_likes">

                    <?php if($showLikeWithoutIcon != 3):?>
                      <span><?php echo $this->translate(array('%s like', '%s likes', $action->likes()->getLikeCount()), $this->locale()->toNumber($action->likes()->getLikeCount())); ?></span>
                    <?php else:?>
                      <span><?php echo $this->translate(array('%s vote up', '%s vote ups', $action->likes()->getLikeCount()), $this->locale()->toNumber($action->likes()->getLikeCount())); ?></span>
                  <?php endif;?>
                </a>	
             <?php endif;?>
             
             <?php if($action->dislikes()->getDislikePaginator()->getTotalItemCount() > 0):?>
             
                 <?php if($action->likes()->getLikeCount() > 0 && (count($action->likes()->getAllLikesUsers()) > 0)):?>
                  <?php echo '<span class="sep">-</span>' ?>
                 <?php endif;?>
              
                    <a href="javascript:void(0);" onclick='ActivityAppCommentPopup("<?php echo $this->url(array('module' => 'advancedactivity', 'controller' => 'index', 'action' => 'viewcomment', 'action_id' => $action->getIdentity(), 'showLikeWithoutIcon' => $showLikeWithoutIcon), 'default', 'true'); ?>", "feedsharepopup", <?php echo $action->getIdentity();?>)' class="feed_dislikes">
                        <?php if($showLikeWithoutIcon != 3):?>
                             <span><?php echo $this->translate(array('%s dislike', '%s dislikes', $action->dislikes()->getDislikePaginator()->getTotalItemCount()), $this->locale()->toNumber($action->dislikes()->getDislikePaginator()->getTotalItemCount())); ?></span>
                        <?php else:?>
                          <span><?php echo $this->translate(array('%s vote down', '%s vote downs', $action->dislikes()->getDislikePaginator()->getTotalItemCount()), $this->locale()->toNumber($action->dislikes()->getDislikePaginator()->getTotalItemCount())); ?></span>
                        <?php endif;?>
                    </a>
              <?php endif;?>
