 ...
 * @version    $Id: activity-like.tpl 6590 2014-11-07 9:40:21Z SocialEngineAddOns $
...
<script type="text/javascript">
 ...
 var url = en4.core.baseUrl + 'nestedcomment/like/activity-like';

 en4.core.runonce.add(function() {
    document.getElementById('like_members_search_input').addEvent('keyup', function(e) {
		$('likes_popup_content').innerHTML = '<center><img src="<?php echo $this->layout()->staticBaseUrl ?>application/modules/Nestedcomment/externals/images/spinner.gif" alt="" style="margin-top:10px;" /></center>';
...
<div class="seaocore_members_popup">
	<div class="top">
        ...
        if($this->showLikeWithoutIcon == 3) 
				$title = $this->translate('People who have voted up for this');
        else 
        $title = $this->translate('People who like this');
			}	else	{
        if($this->showLikeWithoutIcon == 3) 
				$title = $this->translate('Friends who have voted up for this');
        else 
        $title = $this->translate('Friends who like this');
			}
		?>
        ...
        <div class="link" style="display:none;">
			...
			<div class="seaocore_members_search fright" style="display:none;">
