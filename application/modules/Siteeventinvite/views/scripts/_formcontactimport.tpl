 ...
 * @version    $Id: _formcontactimport.tpl 6590 2014-01-02 00:00:00Z SocialEngineAddOns $
...
<div class="form-sub-heading">
  ...
  <div><a href="javascript:void(0);" onclick="show_instruction('id_yahoo');"><img src="<?php echo $this->layout()->staticBaseUrl ?>application/modules/Siteeventinvite/externals/images/admin/help.gif"></a></div>
</div>
    ...
    <div style="display:none" id="id_yahoo">
      <div class="siteevent_admin_popup">
        <div>
          ...
          <?php echo $this->translate("e) After verifying your domain successfully, you will be redirected to a success group where you will get your 'API Key' and 'Shared Secret Key'. Copy them and paste these values in your site's Yahoo contact importer settings fields."); ?>
          <br /><br />
...
<div class="form-sub-heading">
  ...
  <div><a href="javascript:void(0);" onclick="show_instruction('id_windowlive');"><img src="<?php echo $this->layout()->staticBaseUrl ?>application/modules/Siteeventinvite/externals/images/admin/help.gif"></a></div>
</div>
...
<div class="form-sub-heading">
	...
	<div><a href="<?php echo $this->url(array('module' => 'seaocore', 'controller' => 'admin-settings', 'action' => 'help-invite'), 'default', true); ?>" ><img src="<?php echo $this->layout()->staticBaseUrl ?>application/modules/Siteeventinvite/externals/images/admin/help.gif"></a></div>
</div>
