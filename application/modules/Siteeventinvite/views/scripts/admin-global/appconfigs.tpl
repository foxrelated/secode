 ...
 * @version    $Id: appconfigs.tpl 6590 2014-01-02 00:00:00Z SocialEngineAddOns $
...
<div class='clear'>
  <a href="<?php echo $this->url(array('module' => 'siteeventinvite', 'controller' => 'global'), 'siteeventinvite_global_global', true) ?>" class="buttonlink" style="background-image:url(<?php echo $this->layout()->staticBaseUrl; ?>application/modules/Siteeventinvite/externals/images/back.png);"><?php echo $this->translate("Back to Global Settings") ?></a>
          ...
          <div class='faq' style='display: none;' id='guideline_2'>
            ...
            <div class="steps">
              ...
              <div id="yahoostep-1" style='display: none;'>
                ...
                <?php echo $this->translate("d) Now click on the 'Get API Key' button. After clicking on this button you will be redirected to a group where it would ask you to verify your domain. So, verify your domain."); ?><br />


                </p>
                <img src="<?php echo $this->layout()->staticBaseUrl ?>application/modules/Siteeventinvite/externals/images/yahst1.gif" alt="Step 1" />
              </div>
            </div>
            ...
            <div class="steps">
              ...
              <div id="yahoostep-2" style='display: none;'>
                <p>
                  ...
                  <?php echo $this->translate("b) After verifying your domain successfully, you will be redirected to a success group where you will get your 'API Key' and 'Shared Secret Key'. Copy them and paste these values in your site's Yahoo contact importer settings fields."); ?><br />
            ...
            <div class="steps">
              ...
              <div id="yahoostep-3" style='display: none;'>
                ...
                <img src="<?php echo $this->layout()->staticBaseUrl ?>application/modules/Siteeventinvite/externals/images/yahst3.gif" alt="Step 3" />
              </div>
            </div>
          ...
          <div class='faq' style='display: none;' id='guideline_4'>
            ...
            <div class="steps">
              ...
              <div id="msnstep-5" style='display: none;'>
                ...
                <img src="<?php echo $this->layout()->staticBaseUrl ?>application/modules/Siteeventinvite/externals/images/msnst5.gif" alt="Step 5" />
              </div>
            </div>
            ...
            <div class="steps">
              ...
              <div id="msnstep-6" style='display: none;'>
                <p>
                  <?php echo $this->translate("Verify your domain. Follow the instructions given on this group for verifying your domain."); ?><br/>
            ...
            <div class="steps">
              ...
              <div id="msnstep-7" style='display: none;'>
                <p>
                  <?php echo $this->translate("After verifying your domain successfully, you will be redirected to the below success group where you will get your 'Client ID' and 'Secret Key'. Copy them and paste these values in your site's Windows Live contact importer settings fields."); ?><br/>
                </p>
