...
<script type="text/javascript">
 ...
 function showprofileOption(options) {
  ...
  en4.core.runonce.add(function() {
   // if( !isPopulated ) { 
      new Autocompleter.Request.JSON('user_ids', '<?php echo $this->url(array('module' => 'sitegroupmember', 'controller' => 'index', 'action' => 'getusers', 'group_id' => $this->resource_id), 'default', true) ?>', {
      'postVar' : 'user_ids',
      'postData' : false,
			'minLength': 1,
			'delay' : 250,
...
<div class="global_form_popup sitegroupmember_message_popup">
