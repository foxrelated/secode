...
<div>
	<?php if ($this->memberOfDaysList->getTotalItemCount() > 0): ?>
	  ...
	  <form id='multidelete_form' method="post" action="<?php echo $this->url(array('module' => 'sitegroupmember', 'controller' => 'widgets', 'action' => 'multi-delete-member'), 'admin_default'); ?>" onSubmit="return multiDelete()">
