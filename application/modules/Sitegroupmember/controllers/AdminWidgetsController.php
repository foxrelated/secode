...
class Sitegroupmember_AdminWidgetsController extends Core_Controller_Action_Admin {
  ...
  public function indexAction() {
    ...
    //GET NAVIGATION
    $this->view->navigation = $navigation = Engine_Api::_()->getApi('menus', 'core')->getNavigation('sitegroupmember_admin_main', array(), 'sitegroupmember_admin_widget_settings');
    ...
    $this->view->memberOfDaysList = $memberOfDay = Engine_Api::_()->getDbtable('itemofthedays', 'sitegroup')->getItemOfDayList($values, 'user_id', 'user');

    $memberOfDay->setItemCountPerPage(50);
    $memberOfDay->setCurrentPageNumber($group);
  ...
  public function addMemberOfDayAction() {
    ...
    //FORM GENERATION
    $form = $this->view->form = new Sitegroupmember_Form_Admin_MemberOfDay();
  ...
  public function getitemAction() {
    ...
    include APPLICATION_PATH . '/application/modules/Sitegroupmember/controllers/license/license2.php';
