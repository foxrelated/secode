...
<script type="text/javascript">
  ...
  var searchSitegroupvideos = function() {
...
<div class="seaocore_search_criteria">
	<?php 
		if ($this->sitegroup_post == 'enabled') {
...
<script type="text/javascript">
  en4.core.runonce.add(function()
  {
    var contentAutocomplete = new Autocompleter.Request.JSON('title', '<?php echo $this->url(array('module' => 'sitegroup', 'controller' => 'items', 'action' => 'getitem'), 'admin_default', true) ?>', {
      'postVar' : 'text',
      'minLength': 1,
      'selectMode': 'pick',
