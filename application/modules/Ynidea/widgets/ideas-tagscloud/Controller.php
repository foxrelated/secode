...
class Ynidea_Widget_IdeasTagscloudController extends Engine_Content_Widget_Abstract
{
    public function indexAction()
    {
        $t_table = Engine_Api::_()->getDbtable('tags', 'core');
        $tm_table = Engine_Api::_()->getDbtable('tagMaps', 'core');
        $p_table = Engine_Api::_()->getDbTable('ideas', 'ynidea');
        ...
        $filter_select = $tm_table->select()->from($tmName,"$tmName.*")
                         ...
                         ->joinLeft($pName,"$pName.idea_id = $tmName.resource_id",'')
