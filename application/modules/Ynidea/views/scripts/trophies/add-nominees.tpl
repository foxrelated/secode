...
<script type="text/javascript">
  ...
  en4.core.runonce.add(function() {
    if( !isPopulated ) { // NOT POPULATED
      new Autocompleter.Request.JSON('to', '<?php echo $this->url(array('module' => 'ynidea', 'controller' => 'trophies', 'action' => 'suggest-ideas','trophy_id' => $this->trophy_id), 'default', true) ?>', {
        'minLength': 1,
        'delay' : 250,
        'selectMode': 'pick',
      ...
      new Composer.OverText($('to'), {
        'textOverride' : '<?php echo $this->translate('Choose ideas...') ?>',
        'element' : 'label',
        'isPlainText' : true,
        'positionOptions' : {
...
<div class='global_form_popup' style="width: 300px">
