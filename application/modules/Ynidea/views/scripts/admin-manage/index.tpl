...
<table class='admin_table'>
  <thead>
    <tr>
      ...
      <th><a href="javascript:void(0);" onclick="javascript:changeOrder('idea_id', 'DESC');"><?php echo $this->translate("ID");?></a></th>
      ...
      <th><a href="javascript:void(0);" onclick="javascript:changeOrder('decision', 'DESC');"><?php echo $this->translate("Decision") ?></a></th>
  ...
  <tbody>
    <?php foreach ($this->paginator as $item): ?>
      <tr>
        <td class="ynidea_check"><input type='checkbox' class='checkbox' name='delete_<?php echo $item->idea_id; ?>' value="<?php echo $item->idea_id ?>"/></td>
        ...
        <td>
        	<div><?php echo $item->decision; ?></div>
        	<div><?php echo $this->htmlLink(
                  array('route' => 'default', 'module' => 'ynidea', 'controller' => 'admin-manage', 'action' => 'edit-decision', 'id' => $item->idea_id),
                  $this->translate('edit decision'),
        ...
        <td>
          ...
          <?php echo $this->htmlLink(
                  array('route' => 'default', 'module' => 'ynidea', 'controller' => 'admin-manage', 'action' => 'delete', 'id' => $item->idea_id),
