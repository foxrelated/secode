...
<script type="text/javascript">
  ...
  en4.core.runonce.add(function() {
    if( !isPopulated ) { // NOT POPULATED
      new Autocompleter.Request.JSON('to', '<?php echo $this->url(array('module' => 'ynidea', 'controller' => 'index', 'action' => 'suggest','idea_id' => $this->idea_id), 'default', true) ?>', {
        'minLength': 1,
        'delay' : 250,
        'selectMode': 'pick',
      ...
      new Composer.OverText($('to'), {
        'textOverride' : '<?php echo $this->translate('Choose authors...') ?>',
        'element' : 'label',
        'isPlainText' : true,
        'positionOptions' : {
