...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body id="image" style="display: none">
        <div class="tabs">
            <ul>
                <li id="general_tab" class="<?php if ($this->status)
    echo'current' ?>"><span><a href="<?php echo $this->baseUrl() . '/externals/tinymce/themes/advanced/image.htm'; ?>" onmousedown="return false;">{#advanced_dlg.image_title}</a></span></li>
                <li id="general_tab" class="<?php if (!$this->status)
    echo'current' ?>"><span><a href="<?php echo $this->baseUrl() . '/externals/tinymce/themes/advanced/upload.htm'; ?>" onmousedown="return false;">Upload</a></span></li>
            </ul>
        </div>

        <form class="myform" onsubmit="ImageDialog.update();return false;" action="#" style="<?php if (!$this->status)
    echo'display:none;' ?>">
                    ...
                    <table border="0" cellpadding="4" cellspacing="0">
                        <tr>
                            ...
                            <td><table border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        <td><input id="src" name="src" type="text" class="mceFocus" value="<?php if ($this->photo_url)
    echo $this->photo_url; ?>" style="width: 200px" onchange="ImageDialog.getImageData();" /></td>
                        ...
                        <tr>
                            ...
                            <td><input id="width" name="width" type="text" value="<?php echo $this->photo_width?>" size="3" maxlength="5" />
                                x
                                <input id="height" name="height" type="text" value="<?php echo $this->photo_height?>" size="3" maxlength="5" /></td>
                        </tr>
                        <tr>
        ...
        <div id="upload_panel" class="panel_wrapper" style="height: 200px;<?php if ($this->status)
    echo'display:none;' ?>">
