...
class Ynidea_Api_phptoPDF_Html2fpdf extends Ynwiki_Api_phptoPDF_Fpdf
{
//internal attributes
var $HREF; //! string
var $pgwidth; //! float
...
function Ynwiki_Api_phptoPDF_Html2fpdf($orientation='P',$unit='mm',$format='A4')
{
//! @desc Constructor
//! @return An object (a class instance)
	//Call parent constructor
	$this->Ynwiki_Api_phptoPDF_Fpdf($orientation,$unit,$format);
