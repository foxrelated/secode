                  ...
                  <div style="height: 14px; margin-top: 4px;">
                   ...
                   $acc = Mp3music_Api_Cart::getFinanceAccount($album->user_id);
                    if($album->price == 0 || in_array($album->album_id,$hiddencartsalbum) || $acc == null):
                        ?>
                          <a href="javascript:void(0)" onclick = "alert('<?php echo $this->translate('The album already in your cartshop or in download list or it is not allowed to sell or owner of item does not have finance account. Please check again!');?>')"> <img style="position: absolute;" src="./application/modules/Mp3music/externals/images/addtocart_ic_ds.jpg" /></a>
                      <?php else: 
                   ?>
                   <span id="album_newid_cart_<?php echo $album->album_id; ?>">  
                   <?php $selling_settings = Mp3music_Api_Cart::getSettingsSelling($user->level_id);  
                     if($selling_settings['can_buy_song'] ==  1):?>
                         <a href="javascript:addtocart(<?php echo $album->album_id; ?>,'album','new')"> <img style="position: absolute;" src="./application/modules/Mp3music/externals/images/addtocart_ic.jpg" /></a>
                         <?php else:?>
