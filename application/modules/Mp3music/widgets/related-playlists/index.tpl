...
<?php 
        ...
        <li class="mp3_title_link">
             ...
             <div class="mp3_title_album_right" >    
                 <a title="<?php echo strip_tags($playlist->getTitle()); ?>" class="mp3_title_link_album" rel="balloon_playlist_<?php echo $playlist->playlist_id; ?>" href="javascript:;" onClick="return openPage('<?php echo $this->url(array('playlist_id'=>$playlist->playlist_id), 'mp3music_playlist');?>',500,890)">
...
<script type="text/javascript">
	window.addEvent('domready', function() {
		if(<?php echo $index?> == 0)
		{
			$$('.layout_mp3music_related_playlists').each(function(e){
