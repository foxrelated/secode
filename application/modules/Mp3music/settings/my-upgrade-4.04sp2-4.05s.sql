...
ALTER TABLE `engine4_mp3music_cats` ADD `parent_cat` INT( 11 ) NOT NULL DEFAULT '0' AFTER `title_url`; 

UPDATE `engine4_core_modules` SET `version` = '4.05s' WHERE `engine4_core_modules`.`name` = 'mp3music' LIMIT 1 ;