...
<div class='layout_middle'>
  <?php if (0 == count($this->albumPaginator) ): ?>
    ...
    <!-- one more ending div for 'layout_middle' --></div>
  <?php return; endif; ?>
    ...
    <li id="mp3music_album_item_<?php echo $album->getIdentity() ?>">
      <div class="mp3music_browse_options music_browse_options">
        ...
        <ul>
          ...
          <li>
            ...
            if($album->type == 1)
							$title = $this->translate('Edit Track');
            echo $this->htmlLink($album->getEditHref(),
              $title,
          ...
          <li>
            ...
            if($album->type == 1)
							$title = $this->translate('Delete Track');
            echo $this->htmlLink($album->getDeleteHref(),
             $title,
      ...
      <div class="mp3music_browse_info music_browse_info">
       ...
       <?php echo $this->itemPhoto($album, 'thumb.normal')?> </a> 
        ...
        <div class="mp3music_browse_info_desc music_browse_info_desc">
