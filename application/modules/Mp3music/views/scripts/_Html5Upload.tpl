...
;	
 ?>
<div id="upload_album" style="display: none">
 <div id="file-wrapper">
 	<div class="form-label">&nbsp;</div>
  <div class="form-element">
		<div style="padding-bottom: 15px" id = "upload_desc">
			<?php echo $this->translate('_MP3MUSIC_UPLOAD_DESCRIPTION'); ?>
		</div>
		<div id="button_upload">
		  ...
		  <span class="btn fileinput-button btn-success" type="button">
		      ...
		      <input id="fileupload" type="file" name="files[]" multiple accept="audio/*">
		  </span>
