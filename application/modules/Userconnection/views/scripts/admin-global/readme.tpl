 ...
 * @version    $Id: readme.tpl 2010-07-27 9:40:21Z SocialEngineAddOns $
...
<div class="tabs">
	<ul class="navigation">
    <li class="active">
       <a href="<?php echo $this->seaddonsBaseUrl() .'/admin/userconnection/global/readme'?>" ><?php echo $this->translate('Please go through these important points and proceed by clicking the button at the bottom of this page.') ?></a>
    </li>
	</ul>	
</div>		
...
function form_submit() {
	...
	var url='<?php echo $this->url(array('module' => 'userconnection', 'controller' => 'settings'), 'admin_default', true) ?>';
