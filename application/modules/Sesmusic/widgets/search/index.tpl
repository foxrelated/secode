...
<script type="text/javascript">
  ...
  function typevalue(value) {    
    setCookie("sesmusic_commonsearch", value, 1);
  }
  
  //Take refrences from "/application/modules/Blog/views/scripts/index/create.tpl"
  en4.core.runonce.add(function() {
    setCookie("sesmusic_commonsearch", "", - 3600);
    var searchAutocomplete = new Autocompleter.Request.JSON('title', "<?php echo $this->url(array('module' => 'sesmusic', 'controller' => 'index', 'action' => 'search'), 'default', true) ?>", {
      'postVar': 'text',
      'delay' : 250,      
      'minLength': 1,
      'selectMode': 'pick',
