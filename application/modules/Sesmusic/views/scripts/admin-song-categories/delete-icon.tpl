 ...
 * @version    $Id: delete-icon.tpl 2015-03-30 00:00:00 SocialEngineSolutions $
...
<form method="post" class="global_form_popup">
  <div>
    ...
    <p>
      <?php echo $this->translate("Are you sure that you want to remove this icon? It will not be recoverable after being deleted.") ?>
    </p>
    <br />
    <p>
