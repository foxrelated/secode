            ...
            <div class="sesmusic_songslist_options sesmusic_options_buttons">
              <?php if( $this->viewer()->getIdentity()): ?>
                <?php if (($this->album->owner_id == $this->viewer_id  || $this->viewer->level_id == 1) && $this->canEditSong): ?>
                  <?php echo $this->htmlLink($album->getHref(array('route' => 'sesmusic_albumsong_specific', 'action' => 'edit', 'albumsong_id' => $song->albumsong_id)), $this->translate('Edit Song'), array('class'=>'fa fa-pencil', 'title' => $this->translate('Edit Song'))); ?> 
                <?php endif; ?> 
                <?php if (($this->album->owner_id == $this->viewer_id  || $this->viewer->level_id == 1) && $this->canDeleteSong): ?>
                  <?php echo $this->htmlLink(array('route' => 'sesmusic_albumsong_specific', 'module' => 'sesmusic', 'controller' => 'song', 'action' => 'delete', 'albumsong_id' => $song->albumsong_id, 'format' => 'smoothbox'), $this->translate('Delete Song'), array('class' => 'smoothbox fa fa-trash')); ?>
                <?php endif; ?> 
