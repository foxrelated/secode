 ...
 */
class Sesmusic_Plugin_Task_Maintenance_Cleanup extends Core_Plugin_Task_Abstract {

  public function execute() {

    $albumSongTable = Engine_Api::_()->getDbTable('albumsongs', 'sesmusic');
    $albumSongsTableName = $albumSongTable->info('name');
