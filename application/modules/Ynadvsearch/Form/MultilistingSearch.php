<?php
class Ynadvsearch_Form_MultilistingSearch extends Fields_Form_Search {
    public function init() {
        $this
        -> setAttribs(array('class' => 'global_form_box search_form', 'id' => 'filter_form'))
        -> setMethod('GET');
		...
		foreach ($listingtypes as $listingtype) {
			$options[$listingtype->getIdentity()] = $listingtype->getTitle();
		}
        ...
        $this -> addElement('Text', 'location', array(
            ...
            'decorators' => array( array(
                'ViewScript',
                array(
                    'viewScript' => 'application/modules/Ynadvsearch/views/scripts/_location_search.tpl',
                )
            )),
        ));
