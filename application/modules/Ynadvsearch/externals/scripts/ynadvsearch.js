...
var YnAdsAutocompleter = new Class({
    ...
    initialize: function (element, options) {
        ...
        this.setOptions(options);
        this.build();
        this.observer = new YnAdsObserver(this.element, this.prefetch.bind(this), $merge({
            ...
            switch (e.key) {
                ...
                case 'down':
                    ...
                    if (!this.prefetch() && this.queryValue !== null) {
                        ...
                        (this.selected) ? ((up) ? 'getPrevious' : 'getNext') : ((up) ? 'getLast' : 'getFirst')](this.options.choicesMatch), true);
    ...
    setSelection: function (finish) {
        ...
        }.bind(this)); // This seems to be throwing an error sometimes
    ...
    doPushSpan: function (name, toID, newItem, hideLoc, list) {
        ...
        document.id('toValues-wrapper').setStyle('height', 'auto');
...
YnAdsAutocompleter.Base = YnAdsAutocompleter;
...
YnAdsAutocompleter.Local = new Class({

    Extends: YnAdsAutocompleter,
...
YnAdsAutocompleter.RequestAdSearch = new Class({
    ...
    query: function () {
        ...
        if (ynadvsearch.is_space == null || ynadvsearch.is_space == false) 
        {
	        this.request.send({
	        	'data': data
	        });
...
YnAdsAutocompleter.RequestAdSearch.JSON = new Class({

    Extends: YnAdsAutocompleter.RequestAdSearch,
...
YnAdsAutocompleter.RequestAdSearch.HTML = new Class({
...
YnAdsAutocompleter.Ajax = {
    Base: YnAdsAutocompleter.RequestAdSearch,
    Json: YnAdsAutocompleter.RequestAdSearch.JSON,
    Xhtml: YnAdsAutocompleter.RequestAdSearch.HTML
};