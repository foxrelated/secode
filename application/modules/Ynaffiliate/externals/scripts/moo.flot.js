    ...
    function Plot(placeholder, data_, options_, plugins) {
        ...
        var series = [],
            options = {
                ...
                colors: ['#f54545', '#1dacd6', '#ffb600', '#6ecd05', '#9a4aa1', '#747a82', '#eb6f63', '#a3815b', '#84cfda', '#f75aa8', '#f1d729', '#05cd9c', '#466ee0', '#aeaeae', '#19afba', '#407197'],
        ...
        function triggerClickHoverEvent(eventname, event, seriesFilter) {
            ...
            function controlArray(itm){
                if (eventname === 'plotclick'){
                    ...
                    if(positionArray[0] && positionArray[0].length)
