...
if( $settings->getSetting('user.support.links', 0) == 1 ) {
	echo '     More info: <a href="http://www.nullrefer.com/?http://support.socialengine.com/questions/196/Admin-Panel-Plugins-Classifieds" target="_blank">See KB article</a>.';	
} 
?>		
<br />
<br />
