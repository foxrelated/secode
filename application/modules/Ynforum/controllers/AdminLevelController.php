 ...
 * @author     DangTH
 */
class Ynforum_AdminLevelController extends Core_Controller_Action_Admin {

    public function indexAction() {
        $this->view->navigation = $navigation = Engine_Api::_()->getApi('menus', 'core')
                ->getNavigation('ynforum_admin_main', array(), 'ynforum_admin_main_level');
        ...
        // Make form
        $this->view->form = $form = new Ynforum_Form_Admin_Settings_Level(array(
