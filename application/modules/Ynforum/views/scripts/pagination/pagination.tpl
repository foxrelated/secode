<?php if ($this->pageCount > 1): ?>
  <ul class="paginationControl" style="float: right">
    <?php /* Previous page link */ ?>
    <?php if (isset($this->previous)): ?>
    	<li>
          <a href="javascript:void(0)" onclick="javascript:pageAction(1)"><?php echo "<b>".$this->translate('&#171; First')."</b>";?></a>
        </li>
        <li>
    ...
    <?php if (isset($this->next)): ?>
        ...
        <li>
          <a href="javascript:void(0)" onclick="javascript:pageAction(<?php echo $this->pageCount;?>)"><?php echo "<b>".$this->translate('Last &#187;')."</b>";?></a>
        </li>
    <?php endif; ?>
  </ul>
<?php endif; ?>