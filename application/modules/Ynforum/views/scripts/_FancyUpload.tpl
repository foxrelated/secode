...
<script type="text/javascript">
    ...
    window.addEvent('domready', function() { // wait for the content
        ...
        var up = new FancyUpload2($('demo-status'), $('demo-list'), { // options object
            ...
            limitFiles: <?php echo $this->element->limitFiles ?>,
            ...
            onFileRemove: function(file) {
                ...
                request = new Request.JSON({
                    'format' : 'json',
                    'url' : '<?php echo $this->url(Array('module' => 'socialstore', 'controller' => 'photo', 'action' => 'remove'), 'default') ?>',
                    'data': {
                        'photo_id' : file_id
                    },
...
<input type="hidden" name="<?php echo $this->element->getName(); ?>" id="fancyuploadfileids" value ="" />
...
<div id="demo-status" class="hide">
    <div>
        <?php echo $this->translate('Click "Add photos" to select one or more photos from your computer. After you have selected the photos, they will begin to upload right away. When your upload is finished, click the button below your photo list to save them to your store.'); ?>
    </div>
    <div>
        <a class="buttonlink icon_photos_new" href="javascript:void(0);" id="demo-browse"><?php echo $this->translate('Add photos'); ?></a>
        <?php if ($this->element->limitFiles) : ?>
            (<?php echo $this->translate('maximum')?>&nbsp;<?php echo $this->element->limitFiles?> <?php echo $this->translate('files')?>)
        <?php endif; ?>
...
<ul id="demo-list">
    <!--<li class="file file-success">
        <span class="file-size">3.5 kB</span>
        <a class="file-remove" href="#" title="Click to remove this entry.">Remove</a>
        <span class="file-name">_fill_100_47327.jpg</span>
