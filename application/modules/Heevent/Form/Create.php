...
class Heevent_Form_Create extends Engine_Form
{
...
<a href="javascript://" onclick="$('addendtime-wrapper').hide(); $('endtime-wrapper').setStyle('display', 'inline-block');">{$view->translate('HEEVENT_Add End Time')}</a>
ADDENDTIME;
