 ...
 * @license    http://www.socialengine.net/license/
 */
class Heevent_Model_Gateway extends Core_Model_Item_Abstract
{
  ...
  public function getButtonUrl()
  {
    if ($this->button_url) {
      ...
      return $view->layout()->staticBaseUrl . 'application/modules/Heevent/externals/images/buttons/' . strtolower($this->title) . '.gif';
    }
  }
