 ...
 * @license    http://www.hire-experts.com
 */
class Heevent_Model_Subscription extends Core_Model_Item_Abstract
{
  ...
  public function getEvent()
  {
    ...
    if (null === $this->_event) {
      $this->_event = Engine_Api::_()->getItem('event', $this->event_id);
    }
    return $this->_event;
  }
  ...
  public function onPaymentSuccess()
  {
    ...
    if (in_array($this->status, array('initial', 'trial', 'pending', 'active'))) {
      ...
      $event = $this->getEvent();
   /*   $expiration = $event->getExpirationDate();
      if ($expiration) {
