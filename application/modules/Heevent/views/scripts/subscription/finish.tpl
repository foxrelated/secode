...
<form method="get" action="<?php echo $this->escape($this->url(array('action'=>'tickets','type'=> 'upcoming'), 'heevent_general', true)) ?>"
  ...
  <div>
    <div>
      ...
      <?php elseif( $this->status == 'accept' ): ?>

        <h3>
          <?php echo $this->translate('Payment Complete') ?>
        </h3>
        <p class="form-description">
          <?php echo $this->translate('You have accepted event successfully.') ?>
        </p>
        <div class="form-elements">
          <div id="buttons-wrapper" class="form-wrapper">
            <button type="submit">
