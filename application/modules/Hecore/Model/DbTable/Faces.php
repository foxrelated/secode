 ...
 */
class Hecore_Model_DbTable_Faces extends Engine_Db_Table
{
  protected $_rowClass = 'Hecore_Model_Faces';
  protected $urls = array();
  protected $detector;
  public function __construct($config = array())
  {
    $settings = Engine_Api::_()->getApi('settings', 'core');
    if($key = $settings->getSetting('hecore.sky.biometry.key'))
      $this->detector = new Apptouch_FCClientPHP($key, $settings->getSetting('hecore.sky.biometry.secret'));
