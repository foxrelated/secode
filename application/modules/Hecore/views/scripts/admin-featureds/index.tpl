    ...
    <form id='multimodify_form' method="post" action="<?php echo $this->url(array('action' => 'multi-modify'));?>">
        <table class='admin_table'>
            ...
            <tr>
                ...
                <th style='width: 4%;' class='admin_table_centered'><a href="javascript:void(0);"
                                                                       onclick="javascript:changeOrder('level_id', 'ASC');"><?php echo $this->translate("User Level") ?></a>
                </th>
                <th style='width: 7%;'><a href="javascript:void(0);"
            ...
            <?php if (count($this->paginator)): ?>
                ...
                <tr>
                    ...
                    <td class='admin_table_bold'>
                        ...
                        $display_name = Engine_String::strlen($display_name) > 25 ? Engine_String::substr($display_name, 0, 10) . '...' : $display_name;
        ...
        <div class='buttons'>
            ...
            <button type='submit' name="submit_button"
                    value="unset_featured" style="float: right;"><?php echo $this->translate("hecore_UnFeatured Selected") ?></button>
