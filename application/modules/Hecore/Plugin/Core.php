    ...
    private function _installFontAwesome(Zend_View $view)
    {
        ...
        $content = <<<CONTENT
          @font-face {
            ...
            src: url('/externals/fonts/fontawesome-webfont.eot?v=4.3.0');
            src: url('/externals/fonts/fontawesome-webfont.eot?#iefix&v=4.3.0') format('embedded-opentype'), url('/externals/fonts/fontawesome-webfont.woff2?v=4.3.0') format('woff2'), url('/externals/fonts/fontawesome-webfont.woff?v=4.3.0') format('woff'), url('/externals/fonts/fontawesome-webfont.ttf?v=4.3.0') format('truetype'), url('/externals/fonts/fontawesome-webfont.svg?v=4.3.0#fontawesomeregular') format('svg');
            font-weight: normal;
            font-style: normal;
          }
CONTENT;
